	...
	Если ИмяРаздела = "Раздел1" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				Если СтрЧислоВхождений(СтруктЗависимыхЯчеек["П000010002001"], ОбластьИмя) > 0 Тогда
					ТДО["П000010002001"].Значение = ТДО["П000010002101"].Значение + ТДО["П000010002201"].Значение
					+ ТДО["П000010002301"].Значение + ТДО["П000010002401"].Значение;
				КонецЕсли;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	//
	Структ = Новый Структура;
	Структ.Вставить("П000010002001", "П000010002101;П000010002201;П000010002301;П000010002401");
...
Функция ПечатьРеестраНаСервере(ВидПечати, ЗаголовокПечатнойФормы)
	...
	Макет = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("ПечатныйБланк2023Кв1_Реестр");
...
Процедура Расшифровать(Команда)
	...
	// в случае раздела 1 - значение строк 010, 031;
	// в случае раздела 2 - значения строк 100, 105.
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
		...
		Если СтрНачинаетсяС(ИмяТекОбласти, "П00001М203201") Тогда
...
Функция ВыполнитьДокументированиеНаСервере()
	...
	Возврат ОбъектОтчета.ВыполнитьДокументированиеОбъект_2023Кв1();
