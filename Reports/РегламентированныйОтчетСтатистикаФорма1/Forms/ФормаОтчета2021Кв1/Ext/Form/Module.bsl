...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "20/02/2020";
...
Процедура Расчет(ПолеТабличногоДокументаФормаОтчета) 
	...
	ПолеТабличногоДокументаФормаОтчета.Области["П013003"].Значение = Гр3;
	ПолеТабличногоДокументаФормаОтчета.Области["П013004"].Значение = Гр4;
КонецПроцедуры
