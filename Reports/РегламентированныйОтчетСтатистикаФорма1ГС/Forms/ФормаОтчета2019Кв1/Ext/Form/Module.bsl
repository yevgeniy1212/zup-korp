...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мКодОтчета   = "0606017";
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено Тогда
		...
		УстановитьФорматВывода(ЭтотОбъект);
	...
	Если ПолеТабличногоДокументаФормаОтчета.Области.ОргУровеньГосОргана.Значение = "Федеральный" Тогда
		ИмяМакета = "АтрибВыгрузкиXML2019Кв1_фед";
	Иначе
		ИмяМакета = "АтрибВыгрузкиXML2019Кв1_рег";
	КонецЕсли;
	
	РегламентированнаяОтчетность.ОбновитьШаблоныЧерезВебСервисНаСервере(ЭтотОбъект, ИмяМакета);
...
Процедура ПоказатьПериод()
	...
	ПериодОтчета = НРег("по состоянию на 1 октября " + Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ = 'гггг'") + " года");
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "ОргУровеньГосОргана" Тогда
		...
		ОписаниеОповещения =
			Новый ОписаниеОповещения("ПолеТабличногоДокументаФормаОтчетаВыборЗавершение", ЭтотОбъект, ДополнительныеПараметры);
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 18 Цикл
		...
		Области["П01103"+ГрСтр].Значение = Области["П01104"+ГрСтр].Значение + Области["П01105"+ГрСтр].Значение + Области["П01106"+ГрСтр].Значение;
		Области["П01107"+ГрСтр].Значение = Области["П01108"+ГрСтр].Значение + Области["П01109"+ГрСтр].Значение + Области["П01110"+ГрСтр].Значение;
		Области["П01111"+ГрСтр].Значение = Области["П01112"+ГрСтр].Значение + Области["П01113"+ГрСтр].Значение + Области["П01114"+ГрСтр].Значение
										 + Области["П01115"+ГрСтр].Значение;
		Области["П01116"+ГрСтр].Значение = Области["П01117"+ГрСтр].Значение + Области["П01118"+ГрСтр].Значение + Области["П01119"+ГрСтр].Значение
										 + Области["П01120"+ГрСтр].Значение;
		Области["П01102"+ГрСтр].Значение = Области["П01103"+ГрСтр].Значение + Области["П01107"+ГрСтр].Значение + Области["П01111"+ГрСтр].Значение
										 + Области["П01116"+ГрСтр].Значение;
		Области["П01121"+ГрСтр].Значение = Области["П01101"+ГрСтр].Значение + Области["П01102"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Гр = 3 По 8 Цикл
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П02203"+ГрСтр].Значение = Области["П02204"+ГрСтр].Значение + Области["П02205"+ГрСтр].Значение + Области["П02206"+ГрСтр].Значение;
		Области["П02207"+ГрСтр].Значение = Области["П02208"+ГрСтр].Значение + Области["П02209"+ГрСтр].Значение + Области["П02210"+ГрСтр].Значение;
		Области["П02211"+ГрСтр].Значение = Области["П02212"+ГрСтр].Значение + Области["П02213"+ГрСтр].Значение + Области["П02214"+ГрСтр].Значение
										 + Области["П02215"+ГрСтр].Значение;
		Области["П02216"+ГрСтр].Значение = Области["П02217"+ГрСтр].Значение + Области["П02218"+ГрСтр].Значение + Области["П02219"+ГрСтр].Значение
										 + Области["П02220"+ГрСтр].Значение;
		Области["П02202"+ГрСтр].Значение = Области["П02203"+ГрСтр].Значение + Области["П02207"+ГрСтр].Значение + Области["П02211"+ГрСтр].Значение
										 + Области["П02216"+ГрСтр].Значение;
		Области["П02221"+ГрСтр].Значение = Области["П02201"+ГрСтр].Значение + Области["П02202"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Гр = 3 По 18 Цикл
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П03303"+ГрСтр].Значение = Области["П03304"+ГрСтр].Значение + Области["П03305"+ГрСтр].Значение + Области["П03306"+ГрСтр].Значение;
		Области["П03307"+ГрСтр].Значение = Области["П03308"+ГрСтр].Значение + Области["П03309"+ГрСтр].Значение + Области["П03310"+ГрСтр].Значение;
		Области["П03311"+ГрСтр].Значение = Области["П03312"+ГрСтр].Значение + Области["П03313"+ГрСтр].Значение + Области["П03314"+ГрСтр].Значение
										 + Области["П03315"+ГрСтр].Значение;
		Области["П03316"+ГрСтр].Значение = Области["П03317"+ГрСтр].Значение + Области["П03318"+ГрСтр].Значение + Области["П03319"+ГрСтр].Значение
										 + Области["П03320"+ГрСтр].Значение;
		Области["П03302"+ГрСтр].Значение = Области["П03303"+ГрСтр].Значение + Области["П03307"+ГрСтр].Значение + Области["П03311"+ГрСтр].Значение
										 + Области["П03316"+ГрСтр].Значение;
		Области["П03321"+ГрСтр].Значение = Области["П03301"+ГрСтр].Значение + Области["П03302"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Гр = 3 По 6 Цикл
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П04402"+ГрСтр].Значение = Области["П04403"+ГрСтр].Значение + Области["П04404"+ГрСтр].Значение + Области["П04405"+ГрСтр].Значение 
											+ Области["П04406"+ГрСтр].Значение + Области["П04407"+ГрСтр].Значение;
											
		Области["П04403"+ГрСтр].Значение = Области["П04404"+ГрСтр].Значение + Области["П04405"+ГрСтр].Значение + Области["П04406"+ГрСтр].Значение;
		Области["П04407"+ГрСтр].Значение = Области["П04408"+ГрСтр].Значение + Области["П04409"+ГрСтр].Значение + Области["П04410"+ГрСтр].Значение;
		Области["П04411"+ГрСтр].Значение = Области["П04412"+ГрСтр].Значение + Области["П04413"+ГрСтр].Значение + Области["П04414"+ГрСтр].Значение
										 + Области["П04415"+ГрСтр].Значение;
		Области["П04416"+ГрСтр].Значение = Области["П04417"+ГрСтр].Значение + Области["П04418"+ГрСтр].Значение + Области["П04419"+ГрСтр].Значение
										 + Области["П04420"+ГрСтр].Значение;
		Области["П04402"+ГрСтр].Значение = Области["П04403"+ГрСтр].Значение + Области["П04407"+ГрСтр].Значение + Области["П04411"+ГрСтр].Значение
										 + Области["П04416"+ГрСтр].Значение;
		Области["П04421"+ГрСтр].Значение = Области["П04401"+ГрСтр].Значение + Области["П04402"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Стр = 301 По 323 Цикл
		Области["П03"+Стр+"03"].Значение = Области["П03"+Стр+"04"].Значение + Области["П03"+Стр+"05"].Значение + Области["П03"+Стр+"07"].Значение
										 + Области["П03"+Стр+"08"].Значение + Области["П03"+Стр+"09"].Значение + Области["П03"+Стр+"13"].Значение
										 + Области["П03"+Стр+"14"].Значение + Области["П03"+Стр+"15"].Значение + Области["П03"+Стр+"16"].Значение;
	КонецЦикла;
	
	Для Стр = 101 По 121 Цикл
		Области["П01"+Стр+"03"].Значение = Области["П01"+Стр+"05"].Значение + Области["П01"+Стр+"06"].Значение + Области["П01"+Стр+"07"].Значение
										 + Области["П01"+Стр+"08"].Значение + Области["П01"+Стр+"09"].Значение + Области["П01"+Стр+"10"].Значение;
		Области["П01"+Стр+"11"].Значение = Области["П01"+Стр+"12"].Значение + Области["П01"+Стр+"13"].Значение + Области["П01"+Стр+"14"].Значение
										 + Области["П01"+Стр+"15"].Значение + Области["П01"+Стр+"17"].Значение + Области["П01"+Стр+"18"].Значение;
	КонецЦикла;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Инд = 1 По 7 Цикл 
		...
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-ГС");
	КонецЦикла;
...
Процедура ОткрытьФормуВыбораСтраниц(ВариантВыбора)
	...
	ДополнительныеПараметры = Новый Структура(
		"ЗначениеАвторасчета, ЗначениеЕдИзм, ЗначениеЗпт", ЗначениеАвторасчета, ЗначениеЕдИзм, ЗначениеЗпт);
	ОписаниеОповещения = Новый ОписаниеОповещения(
...
Функция УниверсальнаяВыгрузкаXMLПроверкаДанныхНаСервере(ТекстВыгрузки, ПараметрыВыгрузки) Экспорт
	...
	Если ПолеТабличногоДокументаФормаОтчета.Области.ОргУровеньГосОргана.Значение = "Федеральный" Тогда
		ИмяМакета = "АтрибВыгрузкиXML2019Кв1_фед";
		ИмяШаблона = "ШаблонРосстата2019Кв1_фед";
	Иначе
		ИмяМакета = "АтрибВыгрузкиXML2019Кв1_рег";
		ИмяШаблона = "ШаблонРосстата2019Кв1_рег";
	КонецЕсли;
	РегламентированнаяОтчетность.ИзменитьВерсиюФорматаСПроверкойСовместимостиШаблонов(
		ЭтотОбъект, ИмяМакета, ИмяШаблона, ПараметрыВыгрузки);
	ЗаполнитьДанными(ДеревоВыгрузки, ПараметрыВыгрузки);
	Если НЕ РегламентированнаяОтчетность.ПроверитьДанные(ЭтотОбъект, ДеревоВыгрузки) Тогда
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	Если ТабДокумент.ОргУровеньГосОргана = "Федеральный" Тогда
		ИмяМакета = "АтрибВыгрузкиXML2019Кв1_фед";
	Иначе
		ИмяМакета = "АтрибВыгрузкиXML2019Кв1_рег";
	КонецЕсли;
...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	ТекТабличноеПоле.Вывести(
		ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаОтчета2019Кв1_ФормаОтчета"));
...
Функция ЗаполнитьАвтоНаСервере()
	...
	РезультатВыполнения =
		...
		ПараметрыОтчета, Контейнер), ПараметрыВыполненияВФоне);
...
Функция ПроверитьКонтрольныеСоотношенияИзШаблонаВФоне()
	...
	ПараметрыПроверкиКонтрольныхСоотношений.Вставить("Атрибуты", ИмяМакета);
