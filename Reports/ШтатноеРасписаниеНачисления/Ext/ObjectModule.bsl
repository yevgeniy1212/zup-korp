...
Процедура ВывестиШапкуДокументаТ3(ДокументРезультат, Данные, СписокНадбавок, Макет)
    ...
    // ЗУПК
	Шапка.Параметры.ОрганизацияНаименованиеПолное = ?(ЗначениеЗаполнено(Данные.Организация.НаименованиеПолное), Данные.Организация.НаименованиеПолное, Данные.Организация.Наименование);
    // ЗУПК
...
Процедура ВывестиШапкуТаблицыТ3(ДокументРезультат, СписокНадбавок, Макет)
	...
	// ЗУПК
	ВалютаЗП = ЗарплатаКадры.ВалютаУчетаЗаработнойПлаты();
	ЗаголовокТаблицыДоНадбавок.Параметры.ВалютаЗП = ВалютаЗП;
	// ЗУПК
	...
	// ЗУПК
	ОбластьЗаголовкаНадбавок.Текст = НСтр("ru = 'Надбавка, '") + ВалютаЗП.Наименование;
	ЗаголовокТаблицыПослеНадбавок.Параметры.ВалютаЗП = ВалютаЗП;
	// ЗУПК
