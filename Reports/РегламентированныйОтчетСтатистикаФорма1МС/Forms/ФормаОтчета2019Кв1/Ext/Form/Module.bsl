...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "30/07/2019";
	// Код отчета, равен коду по ОКУД
	СтруктураРеквизитовФормы.мКодОтчета   = "0606016";
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 18 Цикл
		...
		Области["П01102"+ГрСтр].Значение
			= Области["П01103"+ГрСтр].Значение + Области["П01104"+ГрСтр].Значение + Области["П01105"+ГрСтр].Значение
			+ Области["П01106"+ГрСтр].Значение + Области["П01107"+ГрСтр].Значение;
		Области["П01109"+ГрСтр].Значение = Области["П01101"+ГрСтр].Значение + Области["П01102"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Гр = 3 По 8 Цикл
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П02202"+ГрСтр].Значение
			= Области["П02203"+ГрСтр].Значение + Области["П02204"+ГрСтр].Значение + Области["П02205"+ГрСтр].Значение
			+ Области["П02206"+ГрСтр].Значение + Области["П02207"+ГрСтр].Значение;
		Области["П02209"+ГрСтр].Значение = Области["П02201"+ГрСтр].Значение + Области["П02202"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Гр = 3 По 18 Цикл
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П03302"+ГрСтр].Значение
			= Области["П03303"+ГрСтр].Значение + Области["П03304"+ГрСтр].Значение + Области["П03305"+ГрСтр].Значение
			+ Области["П03306"+ГрСтр].Значение + Области["П03307"+ГрСтр].Значение;
		Области["П03309"+ГрСтр].Значение = Области["П03301"+ГрСтр].Значение + Области["П03302"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Гр = 3 По 6 Цикл
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П04402"+ГрСтр].Значение
			= Области["П04403"+ГрСтр].Значение + Области["П04404"+ГрСтр].Значение + Области["П04405"+ГрСтр].Значение
			+ Области["П04406"+ГрСтр].Значение + Области["П04407"+ГрСтр].Значение;
		Области["П04409"+ГрСтр].Значение = Области["П04401"+ГрСтр].Значение + Области["П04402"+ГрСтр].Значение;
	КонецЦикла;
	
	Для Стр = 301 По 311 Цикл
		Области["П03"+Стр+"03"].Значение
			= Области["П03"+Стр+"04"].Значение + Области["П03"+Стр+"05"].Значение + Области["П03"+Стр+"07"].Значение
	...
	Для Стр = 101 По 109 Цикл
		Области["П01"+Стр+"03"].Значение
			= Области["П01"+Стр+"05"].Значение + Области["П01"+Стр+"06"].Значение + Области["П01"+Стр+"07"].Значение
			+ Области["П01"+Стр+"08"].Значение + Области["П01"+Стр+"09"].Значение + Области["П01"+Стр+"10"].Значение;
		Области["П01"+Стр+"11"].Значение
			= Области["П01"+Стр+"12"].Значение + Области["П01"+Стр+"13"].Значение + Области["П01"+Стр+"14"].Значение
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Инд = 1 По 5 Цикл 
		...
		СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-МС");
	КонецЦикла;
...
Процедура ОткрытьФормуВыбораСтраниц(ВариантВыбора)
	...
	ДополнительныеПараметры =
		Новый Структура("ЗначениеАвторасчета, ЗначениеЕдИзм, ЗначениеЗпт", ЗначениеАвторасчета, ЗначениеЕдИзм, ЗначениеЗпт);
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1.ИмяСтраницы              = "ФормаОтчета";
	СтрокаУровня1.Представление            = "Статистика: Форма 1-МС";
