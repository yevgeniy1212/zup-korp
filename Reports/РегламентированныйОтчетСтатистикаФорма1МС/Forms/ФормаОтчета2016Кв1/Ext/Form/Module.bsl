...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "11/07/2016";
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 18 Цикл 
		...
		Области["П01102"+ГрСтр].Значение = Области["П01103"+ГрСтр].Значение + Области["П01104"+ГрСтр].Значение + Области["П01105"+ГрСтр].Значение 
	...
	Для Гр = 3 По 8 Цикл 
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П02202"+ГрСтр].Значение = Области["П02203"+ГрСтр].Значение + Области["П02204"+ГрСтр].Значение + Области["П02205"+ГрСтр].Значение 
	...
	Для Гр = 3 По 16 Цикл 
		ГрСтр = Формат(Гр, "ЧЦ=2; ЧВН=; ЧН=00");
		Области["П03302"+ГрСтр].Значение = Области["П03303"+ГрСтр].Значение + Области["П03304"+ГрСтр].Значение + Области["П03305"+ГрСтр].Значение 
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета()
	Возврат УниверсальныйОтчетСтатистики.ПолучитьПараметрыИнициализацииУниверсальногоОтчета(ЭтаФорма, "АтрибВыгрузкиXML2016Кв1", "ШаблонРосстата2016Кв1", "СхемаВыгрузкиXML2016Кв1", Ложь, Ложь);
КонецФункции
