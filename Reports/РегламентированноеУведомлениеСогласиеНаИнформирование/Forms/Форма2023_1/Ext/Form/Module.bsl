...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПоказатьТекущуюСтраницу("Титульная_2023_1");
	...
	КонецЕсли;
	Если НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.согл.на инф.зад.5.02") Тогда
...
Процедура ЗаполнитьНачальныеДанные() Экспорт
	...
	Иначе
		СтрокаСведений = "ИННФЛ,ФИО,ТелДом,АдресЭлектроннойПочтыОрганизации";
		СведенияОбОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(Объект.Организация, Объект.ДатаПодписи, СтрокаСведений);
		Если СтрНачинаетсяС(СведенияОбОрганизации.ТелДом, "+7") Тогда 
			СведенияОбОрганизации.ТелДом = Сред(СведенияОбОрганизации.ТелДом, 3);
		КонецЕсли;
...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	Стр001.ИмяМакета = "Титульная_2023_1";
