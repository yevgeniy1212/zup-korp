...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗаявительныйПорядокВозмещенияНДС;
	УведомлениеОСпецрежимахНалогообложения.НачальныеОперацииПриСозданииНаСервере(ЭтотОбъект);
	УведомлениеОСпецрежимахНалогообложения.СформироватьСпискиВыбора(ЭтотОбъект, "СпискиВыбора2022");
...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	Стр001 = КорневойУровень.Добавить();
	Стр001.Наименование = "Сведения о" + Символы.ПС + "возврате суммы";
	Стр001.ИндексКартинки = 1;
	...
	Стр0001.ИмяМакета = "Возврат_2022";
	Стр0001.Многостраничность = Истина;
	Стр0001.Многострочность = Ложь;
	Стр0001.УИД = Новый УникальныйИдентификатор;
	Стр0001.ИДНаименования = "Возврат";
	
	Стр001 = КорневойУровень.Добавить();
	Стр001.Наименование = "Сведения о" + Символы.ПС + "зачете суммы";
	Стр001.ИндексКартинки = 1;
	Стр001.Многостраничность = Истина;
	Стр001.Многострочность = Истина;
	...
	Стр0001.Наименование = "Стр. 1";
	Стр0001.ИндексКартинки = 1;
	Стр0001.ИмяМакета = "Зачет_2022";
	Стр0001.Многостраничность = Истина;
	Стр0001.Многострочность = Ложь;
	Стр0001.УИД = Новый УникальныйИдентификатор;
	Стр0001.ИДНаименования = "Зачет";
КонецПроцедуры
