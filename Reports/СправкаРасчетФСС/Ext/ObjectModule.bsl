...
Процедура СформироватьМакет(ДокументРезультат, ТаблицаОрганизаций)
	...
	Организации         = КоллекцииБЗК.УникальныеЗначенияКолонки(ТаблицаОрганизаций, "Организация");
	ВидФактическийАдрес = Справочники.ВидыКонтактнойИнформации.ФактАдресОрганизации;
	АдресаОрганизаций   = КонтактнаяИнформацияБЗК.КонтактнаяИнформацияОбъектов(Организации, , ВидФактическийАдрес);
	...
	Для каждого СтрокаТЗ Из ТаблицаОрганизаций Цикл
		...
		ПараметрыЗаявления.АдресФактический = КонтактнаяИнформацияБЗК.ПредставлениеКонтактнойИнформации(
			АдресаОрганизаций,
			Организация,
			ВидФактическийАдрес);
