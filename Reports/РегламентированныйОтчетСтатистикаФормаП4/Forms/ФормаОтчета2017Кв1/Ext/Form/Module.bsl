...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "06/10/2016";
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ИмяАтрибутов = ?(СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Месяц, "АтрибВыгрузкиXML2017Кв1_месяц", "АтрибВыгрузкиXML2017Кв1_квартал");
...
Процедура ПроверкаКСШаблоном(Команда)
	ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Проверка контрольных соотношений в неактуальной версии формы не поддерживается'"));
	Возврат;
...
Функция ПолучитьПараметрыИнициализацииУниверсальногоОтчета(НеобходимоЗагрузитьШаблон = Истина, ФормироватьТекстВыгрузки = Истина) Экспорт 
	ИмяШаблона = ?(СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Месяц, "ШаблонРосстата2017Кв1_месяц", "ШаблонРосстата2017Кв1_квартал");
	ИмяАтрибутов = ?(СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Месяц, "АтрибВыгрузкиXML2017Кв1_месяц", "АтрибВыгрузкиXML2017Кв1_квартал");
	...
	Попытка
		...
		Результат.Вставить("ИмяСхемы", "СхемаВыгрузкиXML2017Кв1");
