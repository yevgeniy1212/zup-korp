...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	Если Периодичность = Перечисления.Периодичность.Месяц Тогда
		ИмяМакетаАтр = "АтрибВыгрузкиXML2022Кв1_месяц";
		ИмяШаблона   = "ШаблонРосстата2022Кв1_месяц";
	Иначе
		ИмяМакетаАтр = "АтрибВыгрузкиXML2022Кв1_квартал";
		ИмяШаблона   = "ШаблонРосстата2022Кв1_квартал";
	КонецЕсли;
