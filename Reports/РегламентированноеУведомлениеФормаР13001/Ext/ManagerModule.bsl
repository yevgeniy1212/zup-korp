...
Функция СведенияИзФормРегистрации(ИмяФормы, ДанныеУведомления) Экспорт
	...
	Результат.Вставить("КодЗаявления", "Р13001");
	...
	СвЗаяв.Вставить("Фамилия", Данные.ДанныеУведомления.ЛистМ.М03010100);
	СвЗаяв.Вставить("Имя", Данные.ДанныеУведомления.ЛистМ.М03010200);
	СвЗаяв.Вставить("Отчество", Данные.ДанныеУведомления.ЛистМ.М03010300);
	СвЗаяв.Вставить("ЭлектроннаяПочта", Данные.ДанныеУведомления.ЛистМ.М03060200);
