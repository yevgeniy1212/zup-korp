...
Процедура ПредставлениеУведомленияПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(Область.Имя, "А01020000_") И СтрНачинаетсяС(ТекущееИДНаименования, "ЛистЛ") Тогда 
		Постфикс = Число(СтрЗаменить(Область.Имя, "А01020000_", ""));
		МногострочнаяЧасть = ?(ТекущееИДНаименования = "ЛистЛ1", МногострочнаяЧасть1, МногострочнаяЧасть2);
...
Функция СформироватьВыгрузкуИПолучитьДанные() Экспорт 
	...
	СтруктураВыгрузки.Вставить("ИмяФайла", "1111502_5.01000_06.tif");
