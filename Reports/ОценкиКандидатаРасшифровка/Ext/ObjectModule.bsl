...
Процедура СформироватьОтчет(Кандидат, ТаблицаОтчета) Экспорт
	...
	ЛичныеДанныеКандидатов.Добавить(ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Кандидат, "ЛичныеДанные"));
	ДанныеРасшифровки = ЭлектронноеИнтервью.РасшифровкаХарактеристикПоОтветам(Кандидат.Вакансия, ЛичныеДанныеКандидатов,
