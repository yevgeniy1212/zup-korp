...
Процедура ПоказатьПериод(Форма)
	...
	// В РезультирующаяТаблица - действующие на выбранный период формы. Заполним список выбора форм отчетности.
...
Процедура ОткрытьФормуОтчета(Команда)
	...
	Если мСкопированаФорма <> Неопределено Тогда
		// Документ был скопирован. Проверяем соответствие форм.
