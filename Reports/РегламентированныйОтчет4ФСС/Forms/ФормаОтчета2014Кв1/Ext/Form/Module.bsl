...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45  = "П0004500001";
	...
	СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1 = "П0000700121";
	СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2 = "П0000700122";
	СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3 = "П0000700123";
	
	КолИсхСтрокИдГруппы1         = 1;
	КолИсхСтрокИдМСЧ_Раздел1_45  = 1;
	КолИсхСтрокИдМСЧ_Раздел11_1  = 1;
	КолИсхСтрокИдМСЧ_Раздел11_2  = 1;
	КолИсхСтрокИдМСЧ_Раздел11_3  = 1;
	КолИсхСтрокИдМСЧ_Раздел267_1 = 1;
	КолИсхСтрокИдМСЧ_Раздел267_2 = 1;
	КолИсхСтрокИдМСЧ_Раздел267_3 = 1;
	
	КолКолонокИдГруппы1         = 8;
	КолКолонокИдМСЧ_Раздел1_45  = 9;
	КолКолонокИдМСЧ_Раздел11_1  = 2;
	КолКолонокИдМСЧ_Раздел11_2  = 2;
	КолКолонокИдМСЧ_Раздел11_3  = 2;
	КолКолонокИдМСЧ_Раздел267_1 = 5;
	КолКолонокИдМСЧ_Раздел267_2 = 5;
	КолКолонокИдМСЧ_Раздел267_3 = 5;
	...
	СтруктураДанныхРаздел1_45  = Новый Структура;
	...
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45,  СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45);
	...
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1, СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2, СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3, СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3);
	...
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45,  КолИсхСтрокИдМСЧ_Раздел1_45);
	...
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1, КолИсхСтрокИдМСЧ_Раздел267_1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2, КолИсхСтрокИдМСЧ_Раздел267_2);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3, КолИсхСтрокИдМСЧ_Раздел267_3);

	мСтруктураКолвоКолонокРазделов  = Новый Структура;
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппы1,        КолКолонокИдГруппы1);
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45,  КолКолонокИдМСЧ_Раздел1_45);
	...
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1, КолКолонокИдМСЧ_Раздел267_1);
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2, КолКолонокИдМСЧ_Раздел267_2);
	мСтруктураКолвоКолонокРазделов.Вставить(СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3, КолКолонокИдМСЧ_Раздел267_3);
	...
	// Версия формы.
	СтруктураРеквизитовФормы.мВерсияФормы = "11/03/2014";
	...
	СтруктураРеквизитовФормы.ЕстьРеквизитДополнительныйКодФСС
		= Метаданные.Справочники.Организации.Реквизиты.Найти("ДополнительныйКодФСС") <> Неопределено;
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("ИдМСЧ_Раздел1_45");
	...
	СтруктураРеквизитовФормы.Вставить("ИдМСЧ_Раздел267_1");
	СтруктураРеквизитовФормы.Вставить("ИдМСЧ_Раздел267_2");
	СтруктураРеквизитовФормы.Вставить("ИдМСЧ_Раздел267_3");
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	// Раздел1_45.
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000450000206", "П000450000106");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000450000207", "П000450000107");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000450000208", "П000450000108");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000450000209", "П000450000109");
	// Раздел1_5.
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если (СтруктураРеквизитовФормы.мВПрограммеИзмененаОрганизация)
	 ИЛИ (НЕ ЗначениеЗаполнено(СтруктураДанныхРаздел2_6_7.П000060001006)) Тогда
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Раздел1_45";
	СтрокаУровня1.Представление            = "Раздел I. Табл. 4.5";
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
	СтрокаУровня1.ВыводНаПечать            = 0;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
...
Процедура ФормироватьСтруктуруСвойствСтраниц() Экспорт
	...
	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45;
	НовСтр.Область = "МногострочнаяЧасть";
	НовСтр.ВысотаСтроки = 1;
	...
	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1;
	НовСтр.Область = "МногострочнаяЧасть";
	НовСтр.ВысотаСтроки = 1;
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000450000103", 2, ,
...
Процедура НачальнаяПодготовкаФормы()
	...
	Для Каждого СтрокаУровня1 Из мСвойстваРазделовДекларации.ПолучитьЭлементы() Цикл
		...
		// Если док-т восстановлен и многостраничный, то пропустим установку цветности,
		// т.к. при восстановлении многостраничного раздела
...
Процедура СохранитьДанныеРаздела(НаимРаздела, ОчищатьРазделЕслиЕстьМногострочность, ИзменятьАктивнуюСтраницу = Истина)
	...
	//
	Если НаимРаздела = "Раздел1_31" ИЛИ НаимРаздела = "Раздел1_45" Тогда
	...
	ИначеЕсли НаимРаздела = "Раздел2_6_7" Тогда
		
		ЭтаФорма["СтруктураДанных" + НаимРаздела] = СобратьДанныеТекущегоТаблПоля(ЭтаФорма, "ТабличныйДокумент");
		
		ОбновитьСтруктуруМногострочногоРаздела(ЭтаФорма, "П0000700121");
		ОбновитьСтруктуруМногострочногоРаздела(ЭтаФорма, "П0000700122");
		ОбновитьСтруктуруМногострочногоРаздела(ЭтаФорма, "П0000700123");
...
Процедура ОчиститьТабличноеПолеНаКлиенте(ВыбТабличноеПолеИмя) Экспорт
	...
	Если ВыбТабличноеПолеИмя = "Раздел1_1"
	 ...
	 ИЛИ ВыбТабличноеПолеИмя = "Раздел1_45"
	 ИЛИ ВыбТабличноеПолеИмя = "Раздел2_6_7" Тогда
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	Если Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1_1"
	 ...
	 ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1_45"
	 ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел2_6_7" Тогда
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета)
	...
	// Многострочные разделы.
	//
	Если ИмяТекРаздела = "Раздел1_31" ИЛИ ИмяТекРаздела = "Раздел1_45" Тогда
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2_6_7" Тогда
...
Процедура ВывестиРазделВТабличныйДокумент(Форма, ИмяГруппы, СтруктураГруппы, ИмяТекРаздела)
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2_6_7" Тогда
		Форма.СкорректироватьМакетРаздела2_6_7(ИмяГруппы, СтруктураГруппы.Количество());
	КонецЕсли;
...
Процедура ВосстановитьСведенияОбОрганизацииИзТитульногоЛистаСтарогоОбразца(ПоказателиОтчета)
	...
	Для Каждого Показатель Из ПоказателиТаблПоле Цикл
		...
		ИначеЕсли ИмяПоказателя = "ДополнительныйКод_1" Тогда
			...
			Для Ном = 1 По 10 Цикл
				СтруктураДанныхТитульный.ДополнительныйКод = СокрЛП(
					СтруктураДанныхТитульный.ДополнительныйКод) + ПоказателиТаблПоле["ДополнительныйКод_" + Ном];
...
Процедура ПривестиВСоответствиеЗначенияИзДопСтрокСтруктурамДанныхРазделов()
	...
	Если НЕ РегламентированнаяОтчетность.ЗначенияИзДопСтрокСоответствуютСтруктуреДанныхРаздела(
		СтруктураДанныхРаздел1_45, П0004500001) Тогда
		
		РегламентированнаяОтчетность.ЗаполнитьСтруктуруДанныхРазделаЗначениямиИзДопСтрок(
			СтруктураДанныхРаздел1_45, П0004500001);
	...
	МассивДанныхДопСтрок.Добавить(П0000700121);
	МассивДанныхДопСтрок.Добавить(П0000700122);
	МассивДанныхДопСтрок.Добавить(П0000700123);
	
	Если НЕ РегламентированнаяОтчетность.ЗначенияИзДопСтрокСоответствуютСтруктуреДанныхРаздела(
		СтруктураДанныхРаздел2_6_7, МассивДанныхДопСтрок) Тогда
		
		РегламентированнаяОтчетность.ЗаполнитьСтруктуруДанныхРазделаЗначениямиИзДопСтрок(
			СтруктураДанныхРаздел2_6_7, МассивДанныхДопСтрок);
...
Функция ОпределитьИдМногострочногоРазделаПоАктивнойСтраницеНаСервере(ИмяЛиста = Неопределено, ТекущаяОбласть = Неопределено) Экспорт
	...
	ИдГрупп.Вставить("ИдМСЧ_Раздел1_45", СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45);
	...
	ИдГрупп.Вставить("ИдМСЧ_Раздел267_1", СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1);
	ИдГрупп.Вставить("ИдМСЧ_Раздел267_2", СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2);
	ИдГрупп.Вставить("ИдМСЧ_Раздел267_3", СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3);
...
Функция ОпределитьИдМногострочногоРазделаПоАктивнойСтранице(ИмяЛиста = Неопределено, ТекущаяСтраница = Неопределено, ИдГрупп, ТекущаяОбласть = Неопределено)
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел2_6_7" Тогда
		...
		Если ТекущаяОбласть = "П0000700121" Тогда
			ИмяГруппы = ИдГрупп.ИдМСЧ_Раздел267_1;
		ИначеЕсли ТекущаяОбласть = "П0000700122" Тогда
			ИмяГруппы = ИдГрупп.ИдМСЧ_Раздел267_2;	
		ИначеЕсли ТекущаяОбласть = "П0000700123" Тогда
			ИмяГруппы = ИдГрупп.ИдМСЧ_Раздел267_3;		
		Иначе	
			ИмяГруппы = ИдГрупп.ИдМСЧ_Раздел267_1;
		КонецЕсли;
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел1_45" Тогда
		
		ИмяГруппы = ИдГрупп.ИдМСЧ_Раздел1_45;
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРаздела(ИдГруппы, ИдГрупп) Экспорт
	...
	ИначеЕсли ИдГруппы = ИдГрупп.ИдМСЧ_Раздел267_1
		ИЛИ ИдГруппы = ИдГрупп.ИдМСЧ_Раздел267_2 ИЛИ ИдГруппы = ИдГрупп.ИдМСЧ_Раздел267_3 Тогда
		
		ТекТабличноеПоле = "Раздел2_6_7";
		
	ИначеЕсли ИдГруппы = ИдГрупп.мИдГруппы1 Тогда
		
		ТекТабличноеПоле = "Раздел1_31";
		
	ИначеЕсли ИдГруппы = ИдГрупп.ИдМСЧ_Раздел1_45 Тогда
		
		ТекТабличноеПоле = "Раздел1_45";
...
Процедура Расчет(Форма, ИмяТекущегоРаздела = "", ОбластьИмя = "")
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_3" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) Тогда
			...
			//перенос итоговых данных из таблицы 4.5 в таблицу 3
			Форма.ТабличныйДокумент.Области.П000030008003.Значение = Форма.СтруктураДанныхРаздел1_45.П000450000206;
			Форма.ТабличныйДокумент.Области.П000030008004.Значение = Форма.СтруктураДанныхРаздел1_45.П000450000207;
			Форма.ТабличныйДокумент.Области.П000030008005.Значение = Форма.СтруктураДанныхРаздел1_45.П000450000208;
			Форма.ТабличныйДокумент.Области.П000030008006.Значение = Форма.СтруктураДанныхРаздел1_45.П000450000209;
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_45" Тогда
		//Раздел1_45
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000450000206, ОбластьИмя) > 0 Тогда
			
			Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.ИдМСЧ_Раздел1_45, ТаблицаБлока);
			...
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				...
				Колонка6 = Колонка6 + Форма.ТабличныйДокумент.Области["П000450000106_" + Ном].Значение;
				
			КонецЦикла;
			
			Форма.ТабличныйДокумент.Области.П000450000206.Значение = Колонка6;
			//перенос итоговых данных из таблицы 4.5 в таблицу 3
			Форма.СтруктураДанныхРаздел1_3.П000030008003 = Колонка6;
			
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000450000207, ОбластьИмя) > 0 Тогда
			...
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				...
				Колонка7 = Колонка7 + Форма.ТабличныйДокумент.Области["П000450000107_" + Ном].Значение;
				
			КонецЦикла;
			
			Форма.ТабличныйДокумент.Области.П000450000207.Значение = Колонка7;
			//перенос итоговых данных из таблицы 4.5 в таблицу 3
			Форма.СтруктураДанныхРаздел1_3.П000030008004 = Колонка7;
			
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000450000208, ОбластьИмя) > 0 Тогда
			...
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				...
				Колонка8 = Колонка8 + Форма.ТабличныйДокумент.Области["П000450000108_" + Ном].Значение;
				
			КонецЦикла;
			
			Форма.ТабличныйДокумент.Области.П000450000208.Значение = Колонка8;
			//перенос итоговых данных из таблицы 4.5 в таблицу 3
			Форма.СтруктураДанныхРаздел1_3.П000030008005 = Колонка8;
			
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000450000209, ОбластьИмя) > 0 Тогда
			...
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				...
				Колонка9 = Колонка9 + Форма.ТабличныйДокумент.Области["П000450000109_" + Ном].Значение;
				
			КонецЦикла;
			
			Форма.ТабличныйДокумент.Области.П000450000209.Значение = Колонка9;
			//перенос итоговых данных из таблицы 4.5 в таблицу 3
			Форма.СтруктураДанныхРаздел1_3.П000030008006 = Колонка9;
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел2_6_7" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000070012401, ОбластьИмя) > 0 Тогда
			...
			Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1, ТаблицаБлока);
			...
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				...
				МСЧ1 = МСЧ1 + Форма.ТабличныйДокумент.Области["П000070012101_" + Ном].Значение;
				
			КонецЦикла;
			
			Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2, ТаблицаБлока);
			...
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				...
				МСЧ2 = МСЧ2 + Форма.ТабличныйДокумент.Области["П000070012201_" + Ном].Значение;
				
			КонецЦикла;
			
			Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3, ТаблицаБлока);
			...
			Для Ном = 1 По ТаблицаБлока.Количество() Цикл
				...
				МСЧ3 = МСЧ3 + Форма.ТабличныйДокумент.Области["П000070012301_" + Ном].Значение;
				
			КонецЦикла;
			
			Форма.ТабличныйДокумент.Области.П000070012401.Значение = МСЧ1 + МСЧ2 + МСЧ3;

			Форма.СтруктураДанныхРаздел2_6_7.П000070012401 = МСЧ1 + МСЧ2 + МСЧ3;
	...
	ИначеЕсли ИмяТекущегоРаздела = "" Тогда
		...
		РасчетВСтруктуре(Форма, "Раздел1_45"); // данные из этого раздела переносятся в раздел 1.3
...
Процедура РасчетВСтруктуре(Форма, ИмяТекущегоРаздела)
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000020007003 = Форма.ТабличныйДокумент.Области.П000020008003.Значение
												 + Форма.ТабличныйДокумент.Области.П000020009003.Значение;
			Форма.ТабличныйДокумент.Области.П000020007003.Значение = СтруктураДанныхРаздела.П000020007003;
			
			СтруктураДанныхРаздела.П000020007004 = Форма.ТабличныйДокумент.Области.П000020008004.Значение
												 + Форма.ТабличныйДокумент.Области.П000020009004.Значение;
			Форма.ТабличныйДокумент.Области.П000020007004.Значение = СтруктураДанныхРаздела.П000020007004;
			
			СтруктураДанныхРаздела.П000020007005 = Форма.ТабличныйДокумент.Области.П000020008005.Значение
												 + Форма.ТабличныйДокумент.Области.П000020009005.Значение;
			Форма.ТабличныйДокумент.Области.П000020007005.Значение = СтруктураДанныхРаздела.П000020007005;
			
			СтруктураДанныхРаздела.П000020010005 = Форма.ТабличныйДокумент.Области.П000020010004.Значение;
			Форма.ТабличныйДокумент.Области.П000020010005.Значение = СтруктураДанныхРаздела.П000020010005;
			
			СтруктураДанныхРаздела.П000020012004 = Форма.ТабличныйДокумент.Области.П000020001004.Значение
												 + Форма.ТабличныйДокумент.Области.П000020003004.Значение
												 + Форма.ТабличныйДокумент.Области.П000020005004.Значение
												 + Форма.ТабличныйДокумент.Области.П000020006004.Значение
												 + Форма.ТабличныйДокумент.Области.П000020007004.Значение
			...
			СтруктураДанныхРаздела.П000020012005 = Форма.ТабличныйДокумент.Области.П000020001005.Значение
												 + Форма.ТабличныйДокумент.Области.П000020003005.Значение
												 + Форма.ТабличныйДокумент.Области.П000020007005.Значение
												 + Форма.ТабличныйДокумент.Области.П000020010005.Значение
												 + Форма.ТабличныйДокумент.Области.П000020011005.Значение;
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_3" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			// Перенос итоговых данных из таблицы 4.5 в таблицу 3.
			СтруктураДанныхРаздела.П000030008003 = Форма.СтруктураДанныхРаздел1_45.П000450000206;
			Форма.ТабличныйДокумент.Области.П000030008003.Значение = СтруктураДанныхРаздела.П000030008003;
			
			СтруктураДанныхРаздела.П000030008004 = Форма.СтруктураДанныхРаздел1_45.П000450000207;
			Форма.ТабличныйДокумент.Области.П000030008004.Значение = СтруктураДанныхРаздела.П000030008004;
			
			СтруктураДанныхРаздела.П000030008005 = Форма.СтруктураДанныхРаздел1_45.П000450000208;
			Форма.ТабличныйДокумент.Области.П000030008005.Значение = СтруктураДанныхРаздела.П000030008005;
			
			СтруктураДанныхРаздела.П000030008006 = Форма.СтруктураДанныхРаздел1_45.П000450000209;
			Форма.ТабличныйДокумент.Области.П000030008006.Значение = СтруктураДанныхРаздела.П000030008006;
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_4" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000040000303 =  ?(Форма.ТабличныйДокумент.Области.П000040000103.Значение <> 0,
													 (Форма.ТабличныйДокумент.Области.П000040000203.Значение
													/ Форма.ТабличныйДокумент.Области.П000040000103.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000040000304 =  ?(Форма.ТабличныйДокумент.Области.П000040000104.Значение <> 0,
													 (Форма.ТабличныйДокумент.Области.П000040000204.Значение
													/ Форма.ТабличныйДокумент.Области.П000040000104.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000040000305 =  ?(Форма.ТабличныйДокумент.Области.П000040000105.Значение <> 0,
													 (Форма.ТабличныйДокумент.Области.П000040000205.Значение
													/ Форма.ТабличныйДокумент.Области.П000040000105.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000040000306 =  ?(Форма.ТабличныйДокумент.Области.П000040000106.Значение <> 0,
													 (Форма.ТабличныйДокумент.Области.П000040000206.Значение
													/ Форма.ТабличныйДокумент.Области.П000040000106.Значение) * 100, 0);
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_41" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000410000303  = ? (Форма.ТабличныйДокумент.Области.П000410000103.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000203.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000103.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000410000304  = ? (Форма.ТабличныйДокумент.Области.П000410000104.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000204.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000104.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000410000305  = ? (Форма.ТабличныйДокумент.Области.П000410000105.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000205.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000105.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000410000306  = ? (Форма.ТабличныйДокумент.Области.П000410000106.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000206.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000106.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000410000603  = ? (Форма.ТабличныйДокумент.Области.П000410000403.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000503.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000403.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000410000604  = ? (Форма.ТабличныйДокумент.Области.П000410000404.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000504.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000404.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000410000605  = ? (Форма.ТабличныйДокумент.Области.П000410000405.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000505.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000405.Значение) * 100, 0);
			СтруктураДанныхРаздела.П000410000606  = ? (Форма.ТабличныйДокумент.Области.П000410000406.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000410000506.Значение
													 / Форма.ТабличныйДокумент.Области.П000410000406.Значение) * 100, 0);
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_42" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000420000403  = ? (Форма.ТабличныйДокумент.Области.П000420000203.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000420000303.Значение
													 / Форма.ТабличныйДокумент.Области.П000420000203.Значение) * 100, 0);
													
			СтруктураДанныхРаздела.П000420000404  = ? (Форма.ТабличныйДокумент.Области.П000420000204.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000420000304.Значение
													 / Форма.ТабличныйДокумент.Области.П000420000204.Значение) * 100, 0);
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_43" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000430000303  = ? (Форма.ТабличныйДокумент.Области.П000430000103.Значение <> 0,
													  (Форма.ТабличныйДокумент.Области.П000430000203.Значение
													 / Форма.ТабличныйДокумент.Области.П000430000103.Значение) * 100, 0);
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_44" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000440000503  = ?(Форма.ТабличныйДокумент.Области.П000440000103.Значение <> 0,
													((Форма.ТабличныйДокумент.Области.П000440000203.Значение +
													  Форма.ТабличныйДокумент.Области.П000440000303.Значение +
													  Форма.ТабличныйДокумент.Области.П000440000403.Значение)
													/ Форма.ТабличныйДокумент.Области.П000440000103.Значение) * 100, 0);
			
			СтруктураДанныхРаздела.П000440000504  = ?(Форма.ТабличныйДокумент.Области.П000440000104.Значение <> 0,
													((Форма.ТабличныйДокумент.Области.П000440000204.Значение +
													  Форма.ТабличныйДокумент.Области.П000440000304.Значение +
													  Форма.ТабличныйДокумент.Области.П000440000404.Значение)
													/ Форма.ТабличныйДокумент.Области.П000440000104.Значение) * 100, 0);
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_45" Тогда
		...
		Для Ном = 1 По ТаблицаБлока.Количество() Цикл
			...
			Иначе
				...
				Колонка6 = Колонка6 + ТаблицаБлока[Ном-1]["П000450000106"];
				Колонка7 = Колонка7 + ТаблицаБлока[Ном-1]["П000450000107"];
				Колонка8 = Колонка8 + ТаблицаБлока[Ном-1]["П000450000108"];
				Колонка9 = Колонка9 + ТаблицаБлока[Ном-1]["П000450000109"];
				
			КонецЕсли;
			
		КонецЦикла;
		
		СтруктураДанныхРаздела.П000450000206 = Колонка6;
		//перенос итоговых данных из таблицы 4.5 в таблицу 3
		Форма.СтруктураДанныхРаздел1_3.П000030008003 = Колонка6;
		
		СтруктураДанныхРаздела.П000450000207 = Колонка7;
		//перенос итоговых данных из таблицы 4.5 в таблицу 3
		Форма.СтруктураДанныхРаздел1_3.П000030008004 = Колонка7;
		
		СтруктураДанныхРаздела.П000450000208 = Колонка8;
		//перенос итоговых данных из таблицы 4.5 в таблицу 3
		Форма.СтруктураДанныхРаздел1_3.П000030008005 = Колонка8;
		
		СтруктураДанныхРаздела.П000450000209 = Колонка9;
		//перенос итоговых данных из таблицы 4.5 в таблицу 3
		Форма.СтруктураДанныхРаздел1_3.П000030008006 = Колонка9;
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел1_5" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000050007003 = Форма.ТабличныйДокумент.Области.П000050001003.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002003.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003003.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006003.Значение;
			Форма.ТабличныйДокумент.Области.П000050007003.Значение = СтруктураДанныхРаздела.П000050007003;
			
			СтруктураДанныхРаздела.П000050007005 = Форма.ТабличныйДокумент.Области.П000050001005.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002005.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003005.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006005.Значение;
			Форма.ТабличныйДокумент.Области.П000050007005.Значение = СтруктураДанныхРаздела.П000050007005;
			
			СтруктураДанныхРаздела.П000050007006 = Форма.ТабличныйДокумент.Области.П000050001006.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002006.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003006.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006006.Значение;
			Форма.ТабличныйДокумент.Области.П000050007006.Значение = СтруктураДанныхРаздела.П000050007006;
			
			СтруктураДанныхРаздела.П000050007008 = Форма.ТабличныйДокумент.Области.П000050001008.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002008.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003008.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006008.Значение;
			Форма.ТабличныйДокумент.Области.П000050007008.Значение = СтруктураДанныхРаздела.П000050007008;
			
			СтруктураДанныхРаздела.П000050007009 = Форма.ТабличныйДокумент.Области.П000050001009.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002009.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003009.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006009.Значение;
			Форма.ТабличныйДокумент.Области.П000050007009.Значение = СтруктураДанныхРаздела.П000050007009;
			
			СтруктураДанныхРаздела.П000050007011 = Форма.ТабличныйДокумент.Области.П000050001011.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002011.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003011.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006011.Значение;
			Форма.ТабличныйДокумент.Области.П000050007011.Значение = СтруктураДанныхРаздела.П000050007011;
			
			СтруктураДанныхРаздела.П000050007012 = Форма.ТабличныйДокумент.Области.П000050001012.Значение;
			Форма.ТабличныйДокумент.Области.П000050007012.Значение = СтруктураДанныхРаздела.П000050007012;
			
			СтруктураДанныхРаздела.П000050007014 = Форма.ТабличныйДокумент.Области.П000050001014.Значение;
			Форма.ТабличныйДокумент.Области.П000050007014.Значение = СтруктураДанныхРаздела.П000050007014;
			
			СтруктураДанныхРаздела.П000050007015 = Форма.ТабличныйДокумент.Области.П000050001015.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002015.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003015.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006015.Значение;
			Форма.ТабличныйДокумент.Области.П000050007015.Значение = СтруктураДанныхРаздела.П000050007015;
			
			СтруктураДанныхРаздела.П000050007017 = Форма.ТабличныйДокумент.Области.П000050001017.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002017.Значение
												 + Форма.ТабличныйДокумент.Области.П000050003017.Значение
												 + Форма.ТабличныйДокумент.Области.П000050006017.Значение;
			Форма.ТабличныйДокумент.Области.П000050007017.Значение = СтруктураДанныхРаздела.П000050007017;
			
			СтруктураДанныхРаздела.П000050007018 = Форма.ТабличныйДокумент.Области.П000050001018.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002018.Значение;
			Форма.ТабличныйДокумент.Области.П000050007018.Значение = СтруктураДанныхРаздела.П000050007018;
			
			СтруктураДанныхРаздела.П000050007020 = Форма.ТабличныйДокумент.Области.П000050001020.Значение
												 + Форма.ТабличныйДокумент.Области.П000050002020.Значение;
	...
	ИначеЕсли ИмяТекущегоРаздела = "Раздел2_6_7" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000070002401 = Форма.ТабличныйДокумент.Области.П000070002101.Значение
												 + Форма.ТабличныйДокумент.Области.П000070002201.Значение
												 + Форма.ТабличныйДокумент.Области.П000070002301.Значение;
			СтруктураДанныхРаздела.П000070011401 = Форма.ТабличныйДокумент.Области.П000070011101.Значение
												 + Форма.ТабличныйДокумент.Области.П000070011201.Значение
												 + Форма.ТабличныйДокумент.Области.П000070011301.Значение;
		...
		Для Ном = 1 По ТаблицаБлока.Количество() Цикл
			...
			Иначе
				...
				МСЧ1 = МСЧ1 + ТаблицаБлока[Ном-1]["П000070012101"];
		...
		Для Ном = 1 По ТаблицаБлока.Количество() Цикл
			...
			Иначе
				...
				МСЧ2 = МСЧ2 + ТаблицаБлока[Ном-1]["П000070012201"];
		...
		Для Ном = 1 По ТаблицаБлока.Количество() Цикл
			...
			Иначе
				...
				МСЧ3 = МСЧ3 + ТаблицаБлока[Ном-1]["П000070012301"];
				
			КонецЕсли;
			
		КонецЦикла;
		
		СтруктураДанныхРаздела.П000070012401 = МСЧ1 + МСЧ2 + МСЧ3;
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяТекущегоРаздела Тогда
			...
			СтруктураДанныхРаздела.П000070011003 = Форма.ТабличныйДокумент.Области.П000070011001.Значение
												 + Форма.ТабличныйДокумент.Области.П000070011401.Значение;
			Форма.ТабличныйДокумент.Области.П000070011003.Значение = СтруктураДанныхРаздела.П000070011003;
			
			СтруктураДанныхРаздела.П000070012003 = Форма.ТабличныйДокумент.Области.П000070012001.Значение
												 + Форма.ТабличныйДокумент.Области.П000070012401.Значение;
			...
			СтруктураДанныхРаздела.П000070014003 = Форма.ТабличныйДокумент.Области.П000070010003.Значение
												 + Форма.ТабличныйДокумент.Области.П000070011003.Значение
												 + Форма.ТабличныйДокумент.Области.П000070012003.Значение
												 + Форма.ТабличныйДокумент.Области.П000070013003.Значение;
			Форма.ТабличныйДокумент.Области.П000070014003.Значение = СтруктураДанныхРаздела.П000070014003;
			
			СтруктураДанныхРаздела.П000070009003 = ?(Форма.ТабличныйДокумент.Области.П000070014003.Значение
			...
			СтруктураДанныхРаздела.П000070015003 = ?(Форма.ТабличныйДокумент.Области.П000070008003.Значение
												   > Форма.ТабличныйДокумент.Области.П000070014003.Значение
												   , Форма.ТабличныйДокумент.Области.П000070008003.Значение
												   - Форма.ТабличныйДокумент.Области.П000070014003.Значение, 0);
		...
		Иначе
			...
			СтруктураДанныхРаздела.П000070009003 = ?(СтруктураДанныхРаздела.П000070014003
												   > СтруктураДанныхРаздела.П000070008003
												   , СтруктураДанныхРаздела.П000070014003
												   - СтруктураДанныхРаздела.П000070008003, 0);
			СтруктураДанныхРаздела.П000070015003 = ?(СтруктураДанныхРаздела.П000070008003
												   > СтруктураДанныхРаздела.П000070014003
												   , СтруктураДанныхРаздела.П000070008003
												   - СтруктураДанныхРаздела.П000070014003, 0);
...
&НаСервере
Процедура СкорректироватьМакетРаздела2_6_7(ИмяГруппы, СтруктураГруппыКоличество) Экспорт
	
	Если ИмяГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1 Тогда
	...
	ИначеЕсли ИмяГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2
		  ИЛИ ИмяГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3 Тогда
		
		ВерхСтроки6 = ТабличныйДокумент.Области["П000070012204_1"].Верх;
		НизСтроки6  = ТабличныйДокумент.Области["П000070013003"].Низ;
	...
	ВерхСтроки12 = 33;
	НизСтроки12  = ТабличныйДокумент.Области["П000070013003"].Низ - 1;
	
	ОбъединяемаяОбласть = ТабличныйДокумент.Область(ВерхСтроки12, 11, НизСтроки12, 11);
	ОбъединяемаяОбласть.Объединить();
	
	ОбъединяемаяОбласть = ТабличныйДокумент.Область(ВерхСтроки12, 12, НизСтроки12, 12);
	ОбъединяемаяОбласть.Объединить();
	ОбъединяемаяОбласть.Имя = "П000070012003";
...
Процедура ДобавитьСтроку()
	...
	ИначеЕсли ТекущаяОбласть.Имя = "ДобавитьСтроку1м"
		  ...
		  ИЛИ (СтрНайти(ТекущаяОбласть.Имя, "П0000100163") > 0 ИЛИ СтрНайти(ТекущаяОбласть.Имя, "П0000700121") > 0) Тогда
		Если ТекРаздел = "Раздел1_1" Тогда
			ИмяПараметраАктивнойОбласти = "П0000100163";
		ИначеЕсли ТекРаздел = "Раздел2_6_7" Тогда
			ИмяПараметраАктивнойОбласти = "П0000700121";
		КонецЕсли;
	ИначеЕсли ТекущаяОбласть.Имя = "ДобавитьСтроку2м"
		 ИЛИ ТекущаяОбласть.Имя = "ДобавитьСтрокуЗначок2м"
		 ИЛИ (СтрНайти(ТекущаяОбласть.Имя, "П0000100164") > 0 ИЛИ СтрНайти(ТекущаяОбласть.Имя, "П0000700122") > 0) Тогда
		Если ТекРаздел = "Раздел1_1" Тогда
			ИмяПараметраАктивнойОбласти = "П0000100164";
		ИначеЕсли ТекРаздел = "Раздел2_6_7" Тогда
			ИмяПараметраАктивнойОбласти = "П0000700122";
		КонецЕсли;
	ИначеЕсли ТекущаяОбласть.Имя = "ДобавитьСтроку3м"
		 ИЛИ ТекущаяОбласть.Имя = "ДобавитьСтрокуЗначок3м"
		 ИЛИ (СтрНайти(ТекущаяОбласть.Имя, "П0000100165") > 0 ИЛИ СтрНайти(ТекущаяОбласть.Имя, "П0000700123") > 0) Тогда
		Если ТекРаздел = "Раздел1_1" Тогда
			ИмяПараметраАктивнойОбласти = "П0000100165";
		ИначеЕсли ТекРаздел = "Раздел2_6_7" Тогда
			ИмяПараметраАктивнойОбласти = "П0000700123";
		КонецЕсли;
	КонецЕсли;
...
Процедура ВставитьДополнительнуюСтроку(ТекущаяСтраница, ИмяГруппы)
	...
	ИначеЕсли ТекущаяСтраница = "Раздел2_6_7" Тогда
		СкорректироватьМакетРаздела2_6_7(ИмяГруппы, ЭтаФорма[ИмяГруппы].Количество());
	КонецЕсли;
...
Процедура УдалитьДополнительнуюСтрокуНаСервере(СпециальноеДобавление = Ложь, ИмяКолонкиНомера = Неопределено) Экспорт
	...
	Если ИмяГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел11_1
	 ...
	 ИЛИ ИмяГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1
	 ИЛИ ИмяГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2
	 ИЛИ ИмяГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3 Тогда
...
Процедура ОчиститьНаСервере() Экспорт
	...
	СтруктураДанныхРаздел1_45.Очистить();
...
Процедура ОчисткаРегламентированногоОтчетаНаСервере(ИмяСтраницы, ЗапускатьОтдельнуюОбработкуПослеОчисткиЛиста, РежимОчистки, Многостраничность, КолВоСтраницВРазделе) Экспорт
	...
	ИначеЕсли ИмяСтраницы = "Раздел2_6_7" Тогда
		
		П0000700121.Очистить();
		П0000700122.Очистить();
		П0000700123.Очистить();
		
		П0000700121.Добавить();
		П0000700122.Добавить();
		П0000700123.Добавить();
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Раздел1_31",   "ПечатнаяФормаОтчета2014Кв1_Раздел1_31");
	СоответствиеРазделовМакетам.Вставить("Раздел1_4",    "ПечатнаяФормаОтчета2014Кв1_Раздел1_4");
	СоответствиеРазделовМакетам.Вставить("Раздел1_41",   "ПечатнаяФормаОтчета2014Кв1_Раздел1_41");
	СоответствиеРазделовМакетам.Вставить("Раздел1_42",   "ПечатнаяФормаОтчета2014Кв1_Раздел1_42");
	СоответствиеРазделовМакетам.Вставить("Раздел1_43",   "ПечатнаяФормаОтчета2014Кв1_Раздел1_43");
	СоответствиеРазделовМакетам.Вставить("Раздел1_44",   "ПечатнаяФормаОтчета2014Кв1_Раздел1_44");
	СоответствиеРазделовМакетам.Вставить("Раздел1_45",   "ПечатнаяФормаОтчета2014Кв1_Раздел1_45");
	СоответствиеРазделовМакетам.Вставить("Раздел1_5",    "ПечатнаяФормаОтчета2014Кв1_Раздел1_5");
	СоответствиеРазделовМакетам.Вставить("Раздел2_6_7",  "ПечатнаяФормаОтчета2014Кв1_Раздел2_6_7");
	СоответствиеРазделовМакетам.Вставить("Раздел2_8_9",  "ПечатнаяФормаОтчета2014Кв1_Раздел2_8_9");
	СоответствиеРазделовМакетам.Вставить("Раздел2_10",   "ПечатнаяФормаОтчета2014Кв1_Раздел2_10");
	...
	Если ИдГруппы <> Неопределено Тогда
		...
		ИначеЕсли Парам1.ИмяСтраницы = "Раздел2_6_7" Тогда
			
			Для НомГруппы = 1 По 3 Цикл
				
				ИдГруппы = "П000070012" + НомГруппы;
				...
				Если КолвоСтрокВТаблДок > КолвоСтрокВПечатнойФорме Тогда
					...
					Если ИдГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_1 Тогда
					...
					ИначеЕсли ИдГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_2
						  ИЛИ ИдГруппы = СтруктураРеквизитовФормы.ИдМСЧ_Раздел267_3 Тогда
						
						ВерхСтроки6 = МакетПечатнойФормы.Области["П000070012204_1"].Верх;
						НизСтроки6  = МакетПечатнойФормы.Области["П000070013003"].Низ;
					...
					ВерхСтроки12 = 35;
					НизСтроки12  = МакетПечатнойФормы.Области["П000070013003"].Низ - 1;
...
&НаКлиентеНаСервереБезКонтекста
Функция ЗаполненРаздел1_44(Форма)
	
	ПрефиксПоказателейРаздела = "П" + "00044";
	
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1_44" Тогда
	...
	Иначе
		...
		Для Каждого Показатель Из Форма.СтруктураДанныхРаздел1_44 Цикл
			ЭтоПоказатель = (СтрНайти(Показатель.Ключ, ПрефиксПоказателейРаздела) = 1);
			Если ЭтоПоказатель И ЗначениеЗаполнено(Показатель.Значение) Тогда
				Возврат Истина;
			КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Функция ЗаполненРаздел1_45(Форма)
	
	ПрефиксПоказателейРаздела = "П" + "00045";
	
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1_45" Тогда
	...
	Иначе
		...
		Для Каждого Показатель Из Форма.СтруктураДанныхРаздел1_45 Цикл
			ЭтоПоказатель = (СтрНайти(Показатель.Ключ, ПрефиксПоказателейРаздела) = 1);
			Если ЭтоПоказатель И ЗначениеЗаполнено(Показатель.Значение) Тогда
				Возврат Истина;
			КонецЕсли;
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник И Область.СодержитЗначение Тогда
			...
			ИначеЕсли ПараметрыПечати.ИмяСтраницы = "Раздел2_6_7" Тогда
				...
				ИначеЕсли Область.Имя = "П000060000100" ИЛИ Область.Имя = "П000060000200" Тогда
					...
					// Служебные показатели, не выводятся на печать.
					Продолжить;
...
Функция СформироватьСтруктуруПараметров()
	...
	// (таблица 6).
	Льгота60Процентов = ?(ЗначениеЗаполнено(СтруктураДанныхРаздел2_6_7.П000060000200), 1, 0);
	ПараметрыВыгрузки.Вставить("Льгота60Процентов", Льгота60Процентов);
	ЧастичноеФинансированиеИзБюдж = ?(ЗначениеЗаполнено(СтруктураДанныхРаздел2_6_7.П000060000100), 1, 0);
	...
	Табл7Стр12Месяц1 = СуммаПоказателейМСЧ(мДанныеОтчета.ПолеТабличногоДокументаРаздел2_6_7, "П000070012101");
	Табл7Стр12Месяц2 = СуммаПоказателейМСЧ(мДанныеОтчета.ПолеТабличногоДокументаРаздел2_6_7, "П000070012201");
	Табл7Стр12Месяц3 = СуммаПоказателейМСЧ(мДанныеОтчета.ПолеТабличногоДокументаРаздел2_6_7, "П000070012301");
	
	ПараметрыВыгрузки.Вставить("Табл7Стр12Месяц1", Табл7Стр12Месяц1);
	ПараметрыВыгрузки.Вставить("Табл7Стр12Месяц2", Табл7Стр12Месяц2);
	ПараметрыВыгрузки.Вставить("Табл7Стр12Месяц3", Табл7Стр12Месяц3);
...
Функция СформироватьИмяФайла(ПараметрыВыгрузки)
	...
	КодСтрахователя = ?(ЗначениеЗаполнено(ПараметрыВыгрузки.ДополнительныйКод),
		ПараметрыВыгрузки.ДополнительныйКод, ПараметрыВыгрузки.НомерСтрахователя);
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("СхемаВыгрузкиXML06_2014");
...
Функция ВыгрузкаВозможна(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ЗначениеЗаполнено(ПараметрыВыгрузки.КПП) И СтрДлина(ПараметрыВыгрузки.КПП) <> 9 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
	...
	ВозможныеЗначенияШифра1 = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(
		"071,032,041,042,043,061,051,081,091,101,121,131,141,151,161,171");
	...
	Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ОргДиректор) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			НСтр("ru='На титульном листе не заданы Ф.И.О. руководителя организации (индивидуального предпринимателя, физического лица, представителя страхователя)!'"),
	...
	Пока ДанныеРаздела1_31.Свойство("П000310001002_" + Формат(НомСтроки, "ЧГ="), ФИОСотрудника) Цикл
		...
		Если ЗначениеЗаполнено(ФИОСотрудника)
		 ИЛИ ЗначениеЗаполнено(ДатаВыдачи)
		...
		Если СтрокаЗаполнена Тогда
			...
			Если НЕ ЗначениеЗаполнено(ДатаВыдачи) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					НСтр("ru='В таблице 3.1, строке " + НомерСтроки + " не указана дата выдачи справки!'"),
					"Раздел1_31", "П000310001003_" + НомерСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
	...
	// Таблица 4.5.
	ДанныеРаздела1_45 = мДанныеОтчета.ПолеТабличногоДокументаРаздел1_45;
	НомСтроки = 1;
	...
	Пока ДанныеРаздела1_45.Свойство("П000450000102_" + Формат(НомСтроки, "ЧГ="), НомерПатента) Цикл
		
		НомерСтроки = Формат(НомСтроки, "ЧГ=");
		
		СтрокаЗаполнена = Ложь;
		ДанныеРаздела1_45.Свойство("П000450000103_" + НомерСтроки, ВидПредпДеятельности);
		ДанныеРаздела1_45.Свойство("П000450000104_" + НомерСтроки, СведИзПатентаДатаНач);
		ДанныеРаздела1_45.Свойство("П000450000105_" + НомерСтроки, СведИзПатентаДатаКон);
		ДанныеРаздела1_45.Свойство("П000450000106_" + НомерСтроки, СуммаВсего);
		ДанныеРаздела1_45.Свойство("П000450000107_" + НомерСтроки, Сумма1Месяц);
		ДанныеРаздела1_45.Свойство("П000450000108_" + НомерСтроки, Сумма2Месяц);
		ДанныеРаздела1_45.Свойство("П000450000109_" + НомерСтроки, Сумма3Месяц);
		...
		Если СтрокаЗаполнена Тогда
			Если НЕ ЗначениеЗаполнено(НомерПатента) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					НСтр("ru='В таблице 4.5, в строке " + НомерСтроки
					+ " не указан номер патента!'"),
					"Раздел1_45", "П000450000102_" + НомерСтроки);
				СтатусПроверки = Ложь;
			...
			Если НЕ ЗначениеЗаполнено(ВидПредпДеятельности) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					...
					"Раздел1_45", "П000450000103_" + НомерСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если НЕ ЗначениеЗаполнено(СведИзПатентаДатаНач) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					...
					"Раздел1_45", "П000450000104_" + НомерСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если НЕ ЗначениеЗаполнено(СведИзПатентаДатаКон) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					...
					"Раздел1_45", "П000450000105_" + НомерСтроки);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
		НомСтроки = НомСтроки +1;
	...
	// Многострочные части таблицы 6.
	ДанныеРаздела2_6_7 = мДанныеОтчета.ПолеТабличногоДокументаРаздел2_6_7;
	
	ДанныеПП = Новый Структура;
	ДанныеПП.Вставить("ДанныеМСЧ", ДанныеРаздела2_6_7);
	ДанныеПП.Вставить("ИмяРаздела", "Раздел2_6_7");
	ДанныеПП.Вставить("ОписаниеРаздела", "в разделе II (табл.6, 7)");
	
	ДанныеПП.Вставить("ИмяПоказателяНомераПП", "П000070012104");
	ДанныеПП.Вставить("ИмяПоказателяДатыПП",   "П000070012105");
	ДанныеПП.Вставить("ИмяПоказателяСуммыПП",  "П000070012101");
	
	ПроверитьСведенияПП(ДанныеПП, СтатусПроверки);
	
	ДанныеПП.Вставить("ИмяПоказателяНомераПП", "П000070012204");
	ДанныеПП.Вставить("ИмяПоказателяДатыПП",   "П000070012205");
	ДанныеПП.Вставить("ИмяПоказателяСуммыПП",  "П000070012201");
	
	ПроверитьСведенияПП(ДанныеПП, СтатусПроверки);
	
	ДанныеПП.Вставить("ИмяПоказателяНомераПП", "П000070012304");
	ДанныеПП.Вставить("ИмяПоказателяДатыПП",   "П000070012305");
	ДанныеПП.Вставить("ИмяПоказателяСуммыПП",  "П000070012301");
...
Функция СоздатьНовыйПотокXML() Экспорт
	...
	ПотокXML.ЗаписатьБезОбработки(Символы.ПС + "<?F4FORM version=""0.6""?>");
...
Процедура ЗаполнитьСодержательнуюЧасть(ПараметрыВыгрузки, УзелРодитель)
	...
	Раздел1_45 = мДанныеОтчета.ПолеТабличногоДокументаРаздел1_45;
	...
	Раздел2_6_7.Вставить("Табл7Стр12Месяц1", ПараметрыВыгрузки.Табл7Стр12Месяц1);
	Раздел2_6_7.Вставить("Табл7Стр12Месяц2", ПараметрыВыгрузки.Табл7Стр12Месяц2);
	Раздел2_6_7.Вставить("Табл7Стр12Месяц3", ПараметрыВыгрузки.Табл7Стр12Месяц3);
	Раздел2_6_7.Вставить("Льгота60Процентов", ПараметрыВыгрузки.Льгота60Процентов);
	Раздел2_6_7.Вставить("ЧастичноеФинансированиеИзБюдж", ПараметрыВыгрузки.ЧастичноеФинансированиеИзБюдж);
	...
	ЗаполнитьДаннымиУзел(Раздел1_45, УзелF4INF1);
	...
	// Выгрузка таблицы 4.5 (многострочная).
	УзелF4PATШаблон = ПолучитьПодчиненныйЭлемент(УзелF4INF1, "F4PAT");
	
	НомСтр = 1;
	Пока РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(Раздел1_45, "П000450000101_" + Формат(НомСтр, "ЧГ=")) Цикл
		НомерПатентаЗаполнен = ЗначениеЗаполнено(Раздел1_45["П000450000102_" + Формат(НомСтр, "ЧГ=")]);
		Если НомерПатентаЗаполнен Тогда
			УзелF4PAT = СкопироватьУзел(УзелF4INF1, УзелF4PATШаблон);
			ВыгрузитьСтрокуМногострочнойЧасти(Раздел1_45, УзелF4PAT, НомСтр);
		КонецЕсли;
		НомСтр = НомСтр + 1;
	КонецЦикла;
	...
	ЗаполнитьДаннымиУзел(Раздел2_6_7, Узел_F4INFO);
	...
	ДанныеПП = Новый Структура;
	ДанныеПП.Вставить("ДанныеМСЧ", Раздел2_6_7);
	ДанныеПП.Вставить("ИмяПоказателяНомераПП", "П000070012105");
	ДанныеПП.Вставить("ИмяПоказателяДатыПП",   "П000070012104");
	ДанныеПП.Вставить("ИмяПоказателяСуммыПП",  "П000070012101");
	...
	ДанныеПП = Новый Структура;
	ДанныеПП.Вставить("ДанныеМСЧ", Раздел2_6_7);
	ДанныеПП.Вставить("ИмяПоказателяНомераПП", "П000070012205");
	ДанныеПП.Вставить("ИмяПоказателяДатыПП",   "П000070012204");
	ДанныеПП.Вставить("ИмяПоказателяСуммыПП",  "П000070012201");
	...
	ДанныеПП = Новый Структура;
	ДанныеПП.Вставить("ДанныеМСЧ", Раздел2_6_7);
	ДанныеПП.Вставить("ИмяПоказателяНомераПП", "П000070012305");
	ДанныеПП.Вставить("ИмяПоказателяДатыПП",   "П000070012304");
	ДанныеПП.Вставить("ИмяПоказателяСуммыПП",  "П000070012301");
...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0000100163") > 0
	 ...
	 ИЛИ СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0000700121") > 0
	 ИЛИ СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0000700122") > 0
	 ИЛИ СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0000700123") > 0
	 ИЛИ СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0003100010") > 0
	 ИЛИ СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0004500001") > 0 Тогда
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел1_45", СтруктураДанныхРаздел1_45);
	Контейнер.Вставить("Раздел1_45_ДанныеДопСтрок", П0004500001);
	Контейнер.Вставить("Раздел1_5", СтруктураДанныхРаздел1_5);
	Контейнер.Вставить("Раздел2_6_7", СтруктураДанныхРаздел2_6_7);
	Контейнер.Вставить("Раздел2_6_7_1_ДанныеДопСтрок", П0000700121);
	Контейнер.Вставить("Раздел2_6_7_2_ДанныеДопСтрок", П0000700122);
	Контейнер.Вставить("Раздел2_6_7_3_ДанныеДопСтрок", П0000700123);
	...
	Если П0004500001.Количество() = 0 Тогда
		П0004500001.Добавить();
	КонецЕсли;
	
	Если П0000700121.Количество() = 0 Тогда
		П0000700121.Добавить();
	КонецЕсли;
	
	Если П0000700122.Количество() = 0 Тогда
		П0000700122.Добавить();
	КонецЕсли;
	
	Если П0000700123.Количество() = 0 Тогда
		П0000700123.Добавить();
	КонецЕсли;
...
Процедура Расшифровать(Команда)
	...
	Если СтрЧислоВхождений(Элементы.ТабличныйДокумент.ТекущаяОбласть.Имя, СтруктураРеквизитовФормы.мИдГруппы1) > 0 Тогда
		Раздел31ФИО = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы1 + "02_" + Сред(
			Элементы.ТабличныйДокумент.ТекущаяОбласть.Имя, СтрНайти(
...
Функция РазделЗаполнен(Форма, ИмяСтраницы)
	...
	ИначеЕсли ИмяСтраницы = "Раздел1_44" Тогда
		...
		Возврат ЗаполненРаздел1_44(Форма);
		
	ИначеЕсли ИмяСтраницы = "Раздел1_45" Тогда
		
		Возврат ЗаполненРаздел1_45(Форма);
...
Функция ПреобразованноеИмяПоказателя(ИсходноеИмя)
	...
	СписокПреобразования = "П000010016301,П000010016311,П000010016321,
	                       ...
	                       |П000070012101,П000070012104,П000070012105,
	                       |П000070012201,П000070012204,П000070012205,
	                       |П000070012301,П000070012304,П000070012305";
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ПроверкаТаблицы45Раздела1(СтруктураРезультата);
...
Процедура ПроверкаТаблицы1Раздела1(СтруктураРезультата)
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ должно быть обязательно указано, если значение показателя """ + НазваниеПоказателяПравойЧасти + """ равна 121 или равна 151.";
	
	ЛеваяЧасть = СокрЛП(Раздел1Таблица1.ОКВЭД);
	
	ПраваяЧасть = СокрЛП(Титульный.ШифрСтрах1Часть);
	
	Расшифровка = """" + ЛеваяЧасть + """ <> пустое значение, когда """ + ПраваяЧасть + """ = ""121"" или = ""151""";
	
	Если ЗначениеЗаполнено(ЛеваяЧасть) И (ПраваяЧасть = "121" ИЛИ ПраваяЧасть = "151")
		ИЛИ (НЕ ПраваяЧасть = "121" И НЕ ПраваяЧасть = "151") Тогда
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 1 строки 2 таблицы 1 должно быть " + Знак + " 0, если 1-я часть шифра страхователя в титульном листе = 081, 121, 151, 161, 171.";
	
	ЛеваяЧасть = Раздел1Таблица1.П000010002301;
	
	Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " 0, когда """ + ШифрСтрах1Часть + """ = ""081"", ""121"", ""151"", ""161"", ""171""";
	...
	Если (ЛеваяЧасть = 0
		...
		ИЛИ ШифрСтрах1Часть = "171"))
		ИЛИ (НЕ ШифрСтрах1Часть = "081"
		И НЕ ШифрСтрах1Часть = "121"
		И НЕ ШифрСтрах1Часть = "151"
		И НЕ ШифрСтрах1Часть = "161"
		И НЕ ШифрСтрах1Часть = "171") Тогда
...
Процедура ПроверкаТаблицы3Раздела1(СтруктураРезультата)
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 3 строки 8 таблицы 3 должно быть " + Знак + " 0.";
	
	ЛеваяЧасть = Раздел1Таблица3.П000030008003;
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 3 строки 8 таблицы 3 должно быть " + Знак + 
		" 0, если значение показателя """ + НазваниеПоказателяПравойЧасти + """ не равна 171.";
	
	ЛеваяЧасть = Раздел1Таблица3.П000030008003;
	
	ПраваяЧасть = СокрЛП(Титульный.ШифрСтрах1Часть);
	
	Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " 0, когда """ + ПраваяЧасть + """ <> ""171""";
	
	Если (ЛеваяЧасть = 0 И ПраваяЧасть <> "171") ИЛИ (ПраваяЧасть = "171") Тогда
	...
	Если (Месяц(ОкончаниеПериодаОтчета) = 3 И КонецКвартала(ОкончаниеПериодаОтчета) = Дата(Год(ОкончаниеПериодаОтчета), 3, 31, 23, 59, 59)) Тогда
		
		Знак = "=";
		НазваниеПоказателяЛевойЧасти = "всего с начала расчетного периода";
		
		ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 3 строки 8 таблицы 3 должно быть " + Знак + 
			" сумме значений показателей по графам 4, 5, 6 строки 8 таблицы 3.";
		
		ЛеваяЧасть = Раздел1Таблица3.П000030008003;
		
		ПраваяЧасть = Раздел1Таблица3.П000030008004 + Раздел1Таблица3.П000030008005 + Раздел1Таблица3.П000030008006;
	...
	//
	// Актуально только для декларации за период отличный от 1-го квартала и периодичностью квартал
	ОкончаниеПериодаОтчета = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
	
	Если (Месяц(ОкончаниеПериодаОтчета) = 6 И КонецКвартала(ОкончаниеПериодаОтчета) = Дата(Год(ОкончаниеПериодаОтчета), 6, 30, 23, 59, 59)) ИЛИ
		(Месяц(ОкончаниеПериодаОтчета) = 9 И КонецКвартала(ОкончаниеПериодаОтчета) = Дата(Год(ОкончаниеПериодаОтчета), 9, 30, 23, 59, 59)) ИЛИ
		(Месяц(ОкончаниеПериодаОтчета) = 12 И КонецКвартала(ОкончаниеПериодаОтчета) = Дата(Год(ОкончаниеПериодаОтчета), 12, 31, 23, 59, 59)) Тогда
		...
		Если ДокументПНП <> Неопределено Тогда 
			...
			ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 3 строки 8 таблицы 3 должно быть " + Знак + 
				" значение графы 3 строки 8 таблицы 3 за предыдущий отчетный период плюс сумма значений показателей по графам 4, 5, 6 строки 8 таблицы 3.";
			
			ДанныеПНП = РегламентированнаяОтчетность.ПолучитьДанныеСохрРегОтчета(ДокументПНП);
			Раздел1Таблица3ПНП = Неопределено;
			Если ДанныеПНП.ДанныеРазделовРеглОтчета.Свойство("Раздел1_3", Раздел1Таблица3ПНП) Тогда
				
				ЛеваяЧасть = Раздел1Таблица3.П000030008003;
				
				ПраваяЧасть = Раздел1Таблица3ПНП.П000030008003 + Раздел1Таблица3.П000030008004 + Раздел1Таблица3.П000030008005 + 
				Раздел1Таблица3.П000030008006;
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 3 строки 8 таблицы 3 должно быть " + Знак + 
		" значения показателя по графе 3 строки 4 таблицы 3.";
...
Процедура ПроверкаТаблицы42Раздела1(СтруктураРезультата)
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 3 строки 1 таблицы 4.2 должно быть " + Знак + " 7, если 1-я часть шифра страхователя в титульном листе = 091 и дата по графе 3 строки 5 таблицы 4.2 < 1 октября предыдущего года.";
	...
	Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " 7, когда """ + ШифрСтрахователяЧасть1 + """ = ""091"" и """ + Формат(Раздел1Таблица42.П000420000503, "ДЛФ=Д") + """ < """ + Формат(ПервоеОктябряПредГода, "ДЛФ=Д") + """";
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 4 строки 1 таблицы 4.2 должно быть " + Знак + " 7, если 1-я часть шифра страхователя в титульном листе = 091 и дата по графе 3 строки 5 таблицы 4.2 >= 1 октября предыдущего года.";
...
&НаСервере
Процедура ПроверкаТаблицы45Раздела1(СтруктураРезультата)
	...
	ТитульныйЛист    = мДанныеОтчета.ПолеТабличногоДокументаТитульный;
	Раздел1Таблица3  = мДанныеОтчета.ПолеТабличногоДокументаРаздел1_3;
	Раздел1Таблица45 = мДанныеОтчета.ПолеТабличногоДокументаРаздел1_45;
	
	ТекстФормулы = "Проверка таблицы 4.5 раздела 1";
	
	//
	Знак = "<>";
	НазваниеПоказателяЛевойЧасти = "дата окончания действия";
	НазваниеПоказателяПравойЧасти = "дата начала действия";
	
	КолвоСтрокВМногострочнойЧасти = РегламентированнаяОтчетностьКлиентСервер.ПоказательВходитВМногострочнуюЧасть(ЭтаФорма, "П000450000101_1");
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		НомСтрСтр = Формат(Инд, "ЧГ=0");
		ИмяПоказателяЛевойЧасти = "П000450000105_" + НомСтрСтр;
		ИмяПоказателяПравойЧасти = "П000450000104_" + НомСтрСтр;
		
		ЛеваяЧасть = Раздел1Таблица45[ИмяПоказателяЛевойЧасти];
		ПраваяЧасть = Раздел1Таблица45[ИмяПоказателяПравойЧасти];
		
		Если НЕ ЗначениеЗаполнено(ЛеваяЧасть) И НЕ ЗначениеЗаполнено(ПраваяЧасть) Тогда 
			Продолжить;
		КонецЕсли;
		
		ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 5 должно быть " + Знак + " """ + 
			НазваниеПоказателяПравойЧасти + """ по соответствующей строке графы 4 таблицы 4,5";
		
		ЛеваяЧастьСтр = Формат(ЛеваяЧасть, "ДЛФ=Д");
		
		ПраваяЧастьСтр = Формат(ПраваяЧасть, "ДЛФ=Д");
		
		Расшифровка = ЛеваяЧастьСтр + " " + Знак + " " + ПраваяЧастьСтр;
	...
	Знак = "=";
	НазваниеПоказателяЛевойЧасти = "1 месяц";
	НазваниеПоказателя1ПравойЧасти = "дата начала действия";
	НазваниеПоказателя2ПравойЧасти = "дата окончания действия";
	
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		НомСтрСтр = Формат(Инд, "ЧГ=0");
		ИмяПоказателяЛевойЧасти = "П000450000107_" + НомСтрСтр;
		ИмяПоказателя1ПравойЧасти = "П000450000104_" + НомСтрСтр;
		ИмяПоказателя2ПравойЧасти = "П000450000105_" + НомСтрСтр;
		
		ЛеваяЧасть = Раздел1Таблица45[ИмяПоказателяЛевойЧасти];
		ПраваяЧасть1 = Раздел1Таблица45[ИмяПоказателя1ПравойЧасти];
		ПраваяЧасть2 = Раздел1Таблица45[ИмяПоказателя2ПравойЧасти];
		
		Условие1 = НачалоДня(КонецМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета));
		Условие2 = НачалоМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
		УсловиеВыполнено = ПраваяЧасть1 > Условие1 ИЛИ ПраваяЧасть2 < Условие2;
		
		ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 7 должно быть " + Знак + 
			" 0, если дата в таблице 4.5 графы 4 > последней даты 1-го месяца отчетного периода или если дата в таблице 4,5 графы 5 < первого числа 1-го месяца отчетного периода по соответствующим строкам";
		
		ЛеваяЧастьСтр = Формат(ЛеваяЧасть, "ЧН=0");
		
		ПраваяЧасть1Стр = Формат(ПраваяЧасть1, "ДЛФ=Д");
		
		ПраваяЧасть2Стр = Формат(ПраваяЧасть2, "ДЛФ=Д");
		
		Расшифровка = ЛеваяЧастьСтр + " " + Знак + " 0, когда " + ПраваяЧасть1Стр + " > " + Формат(Условие1, "ДЛФ=Д") + " или " + 
			ПраваяЧасть2Стр + " < " + Формат(Условие2, "ДЛФ=Д");
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		НомСтрСтр = Формат(Инд, "ЧГ=0");
		ИмяПоказателяЛевойЧасти = "П000450000108_" + НомСтрСтр;
		ИмяПоказателя1ПравойЧасти = "П000450000104_" + НомСтрСтр;
		ИмяПоказателя2ПравойЧасти = "П000450000105_" + НомСтрСтр;
		...
		Условие1 = НачалоДня(КонецМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета + 60*60*24*31));
		Условие2 = НачалоМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета + 60*60*24*31);
		УсловиеВыполнено = ПраваяЧасть1 > Условие1 ИЛИ ПраваяЧасть2 < Условие2;
		
		ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 8 должно быть " + Знак + 
			" 0, если дата в таблице 4.5 графы 4 > последней даты 2-го месяца отчетного периода или если дата в таблице 4,5 графы 5 < первого числа 2-го месяца отчетного периода по соответствующим строкам";
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		НомСтрСтр = Формат(Инд, "ЧГ=0");
		ИмяПоказателяЛевойЧасти = "П000450000109_" + НомСтрСтр;
		ИмяПоказателя1ПравойЧасти = "П000450000104_" + НомСтрСтр;
		ИмяПоказателя2ПравойЧасти = "П000450000105_" + НомСтрСтр;
		...
		Условие1 = НачалоДня(КонецМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета + 60*60*24*31*2));
		Условие2 = НачалоМесяца(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета + 60*60*24*31*2);
		УсловиеВыполнено = ПраваяЧасть1 > Условие1 ИЛИ ПраваяЧасть2 < Условие2;
		
		ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 9 должно быть " + Знак + 
			" 0, если дата в таблице 4.5 графы 4 > последней даты 3-го месяца отчетного периода или если дата в таблице 4,5 графы 5 < первого числа 3-го месяца отчетного периода по соответствующим строкам";
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 6 таблицы 4.5 должно быть " + Знак + 
		" значению показателя по графе 3 строки 8 таблицы 3.";
	
	ЛеваяЧасть = Раздел1Таблица45.П000450000206;
	
	ПраваяЧасть = Раздел1Таблица3.П000030008003;
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 7 таблицы 4.5 должно быть " + Знак + 
		" значению показателя по графе 4 строки 8 таблицы 3.";
	
	ЛеваяЧасть = Раздел1Таблица45.П000450000207;
	
	ПраваяЧасть = Раздел1Таблица3.П000030008004;
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 8 таблицы 4.5 должно быть " + Знак + 
		" значению показателя по графе 5 строки 8 таблицы 3.";
	
	ЛеваяЧасть = Раздел1Таблица45.П000450000208;
	
	ПраваяЧасть = Раздел1Таблица3.П000030008005;
	...
	Если (Месяц(ОкончаниеПериодаОтчета) = 3 И КонецКвартала(ОкончаниеПериодаОтчета) = Дата(Год(ОкончаниеПериодаОтчета), 3, 31, 23, 59, 59)) Тогда
		...
		ОписаниеКС = "Количество строк по порядку должно быть " + Знак + " 0, если расчет за 1-й квартал и показатель титульного листа """ + 
			НазваниеПоказателяПравойЧасти + """ <> 171";
		...
		Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
			НомСтрСтр = Формат(Инд, "ЧГ=0");
			Для ИндК = 1 По 9 Цикл
				НомКолСтр = Формат(ИндК, "ЧГ=0");
				ИмяПоказателяЛевойЧасти = "П00045000010" + НомКолСтр + "_" + НомСтрСтр;
				Если ЗначениеЗаполнено(Раздел1Таблица45[ИмяПоказателяЛевойЧасти]) Тогда 
					КоличествоЗаполненныхСтрок = КоличествоЗаполненныхСтрок + 1;
				КонецЕсли;
			КонецЦикла;
		КонецЦикла;
		
		Расшифровка = Строка(КоличествоЗаполненныхСтрок) + " " + Знак + " 0, когда """ + Строка(ПраваяЧасть) + """ <> ""171""";
		
		Если ПраваяЧасть = "171" ИЛИ (ПраваяЧасть <> "171" И КоличествоЗаполненныхСтрок = 0) Тогда
...
Функция ПроверкаТаблицы6Раздела2(СтруктураРезультата)
	...
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 10 таблицы 6 должно быть " + Знак + " значение показателя по графе 6 таблицы 6 * (1 - значение показателя по графе 7 таблицы 6 / 100 + значение показателя по графе 9 таблицы 6 / 100). Значение должно быть округлено до двух десятичных знаков после запятой.";
...
Функция ПроверкаТаблицы7Раздела2(СтруктураРезультата)
	...
	Иначе
		ПраваяЧасть = Раздел2Таблица6.П000060001010 / 100 * (Раздел2Таблица6.П000060001403 - Раздел2Таблица6.П000060001404 + 60 / 100 * Раздел2Таблица6.П000060001404);
	КонецЕсли;
	...
	Иначе 
		ПраваяЧасть = Раздел2Таблица6.П000060001010 / 100 * (Раздел2Таблица6.П000060001503 - Раздел2Таблица6.П000060001504 + 60 / 100 * Раздел2Таблица6.П000060001504);
	КонецЕсли;
	...
	Иначе 
		ПраваяЧасть = Раздел2Таблица6.П000060001010 / 100 * (Раздел2Таблица6.П000060001103 - Раздел2Таблица6.П000060001104 + 60 / 100 * Раздел2Таблица6.П000060001104);
	КонецЕсли;
...
Функция ПроверкаТаблицы10Раздела2(СтруктураРезультата)
	...
	//
	Знак = ">=";
	НазваниеПоказателяЛевойЧасти = "общее количество рабочих мест страхователя, подлежащих аттестации";
		
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 3 строки 1 таблицы 10 должно быть " + Знак + " значения показателя по графе 4 строки 1 таблицы 10.";
	...
	//
	НазваниеПоказателяЛевойЧасти = "всего количество рабочих мест, на которых проведена аттестация рабочих мест по условиям труда на начало года";
	...
	//
	НазваниеПоказателяЛевойЧасти = "общее число работников, занятых на работах с вредными и (или) опасными производственными факторами, подлежащих обязательным предварительным и периодическим медицинским осмотрам";
		
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 7 строки 2 таблицы 10 должно быть " + Знак + " значения показателя по графе 8 строки 2 таблицы 10.";
	...
	//
	Знак = "=";
	НазваниеПоказателяЛевойЧасти = "общее количество работников, занятых на работах с вредными и (или) опасными производственными факторами";
	НазваниеПоказателяПравойЧасти = "из них: работающих, занятых на работах с вредными и (или) опасными производственными факторами";
	
	ОписаниеКС = "Значение показателя """ + НазваниеПоказателяЛевойЧасти + """ по графе 7 строки 2 таблицы 10 должно быть " + Знак + 
		" 0, если показатель титульного листа """ + НазваниеПоказателяПравойЧасти + """ = 0.";
	
	ЛеваяЧасть = Раздел2Таблица10.П000100000207;
	
	ПраваяЧасть = СокрЛП(Титульный.ЧислВред);
	ПраваяЧасть = ?(ЗначениеЗаполнено(ПраваяЧасть), Число(ПраваяЧасть), 0);
	
	Расшифровка = Строка(ЛеваяЧасть) + " " + Знак + " 0, когда " + Строка(ПраваяЧасть) + " = 0.";
	
	Если НЕ ПраваяЧасть = 0 ИЛИ (ПраваяЧасть = 0 И ЛеваяЧасть = 0) Тогда
