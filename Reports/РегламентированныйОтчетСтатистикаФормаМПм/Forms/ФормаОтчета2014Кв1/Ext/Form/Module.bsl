...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мИдГруппы1 = "П0000100010"; // 1
	СтруктураРеквизитовФормы.мИдГруппы2 = "П0000500090"; // 2
	СтруктураРеквизитовФормы.мИдГруппы3 = "П0000600003"; // 3
	СтруктураРеквизитовФормы.мИдГруппы4 = "П0000400001"; // 4
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Приложение2_ДанныеДопСтрок", П0000500090);
...
Процедура ОчиститьТабличноеПоле(Форма, ВыбТабличноеПолеИмя) Экспорт
	...
	Для Инд = 0 По ВыбТабличноеПоле.Области.Количество() - 1 Цикл
		...
		Если ТекущаяОбласть.Имя = "" Тогда
			Продолжить;
		КонецЕсли;

		Если ТипЗнч(ТекущаяОбласть) = Тип("РисунокТабличногоДокумента") Тогда
			ТекущаяОбласть.Значение = "НомерКорректировки";
		Иначе
	...
	ИначеЕсли ИмяСтраницыПанели = "Приложение2" Тогда
		...
		Форма.ТабличныйДокумент.Области.ОргКодОКПО.Значение = ОргКодОКПО;
		Для Инд = 1 По 6 Цикл 
			Форма.ТабличныйДокумент.Области["П000010000100" + Инд].Значение = Инд;
		КонецЦикла;
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("Список2014Кв1");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодыОКАТО",                              254, , "Выбор территории",         КоллекцияСписковВыбора["КодыОКАТО"]);
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли СтрНайти(Область.Имя, "П000040000103_") = 1 Тогда
		...
		ТабличныйДокумент.Области[ОбластьНазвание].Значение = РезультатНазвание;
	ИначеЕсли СтрНайти(Область.Имя, "П000050009003_") = 1 Тогда
		ОбластьНазвание = СтрЗаменить(Область.Имя, "П000050009003_", "П000050009001_");
		ТабличныйДокумент.Области[ОбластьНазвание].Значение = РезультатНазвание;
	ИначеЕсли СтрНайти(Область.Имя, "П000010001002_") = 1 Тогда
		ОбластьНазвание = СтрЗаменить(Область.Имя, "П000010001002_", "П000010001001_");
		ТабличныйДокумент.Области[ОбластьНазвание].Значение = РезультатНазвание;
	КонецЕсли;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяТекущейСтраницыПанели = "Приложение2" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000200019003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000200019003.Значение = Области.П0000200020003.Значение
																    + Области.П0000200021003.Значение
																    + Области.П0000200022003.Значение
																    + Области.П0000200023003.Значение
																    + Области.П0000200024003.Значение
																    + Области.П0000200025003.Значение
																    + Области.П0000200026003.Значение
																    + Области.П0000200027003.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000300030003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000300030003.Значение = Области.П0000300031003.Значение
																    + Области.П0000300032003.Значение
																    + Области.П0000300034003.Значение
																    + Области.П0000300035003.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000300030004, ОбластьИмя) > 0 Тогда
			...
			Области.П0000300030004.Значение = Области.П0000300031004.Значение
																    + Области.П0000300032004.Значение
																    + Области.П0000300034004.Значение
																    + Области.П0000300035004.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400036004, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400036004.Значение = Области.П0000400037004.Значение
																	+ Области.П0000400039004.Значение
																	+ Области.П0000400040004.Значение
																	+ Области.П0000400041004.Значение
																	+ Области.П0000400042004.Значение
																	+ Области.П0000400043004.Значение
																	+ Области.П0000400044004.Значение
																	+ Области.П0000400045004.Значение
																	+ Области.П0000400046004.Значение
																	+ Области.П0000400047004.Значение
																	+ Области.П0000400048004.Значение
																	+ Области.П0000400051004.Значение
																	+ Области.П0000400052004.Значение
																	+ Области.П0000400053004.Значение
																	+ Области.П0000400054004.Значение
																	+ Области.П0000400055004.Значение
																	+ Области.П0000400056004.Значение
																	+ Области.П0000400057004.Значение
																	+ Области.П0000400058004.Значение
																	+ Области.П0000400059004.Значение
																	+ Области.П0000400060004.Значение
																	+ Области.П0000400061004.Значение
																	+ Области.П0000400062004.Значение
																	+ Области.П0000400063004.Значение
																	+ Области.П0000400064004.Значение
																	+ Области.П0000400065004.Значение
																	+ Области.П0000400066004.Значение
																	+ Области.П0000400067004.Значение
																	+ Области.П0000400068004.Значение
																	+ Области.П0000400069004.Значение
																	+ Области.П0000400070004.Значение
																	+ Области.П0000400071004.Значение
																	+ Области.П0000400072004.Значение
																	+ Области.П0000400073004.Значение
																	+ Области.П0000400074004.Значение
																	+ Области.П0000400075004.Значение
																	+ Области.П0000400076004.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400036005, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400036005.Значение = Области.П0000400039005.Значение
																	+ Области.П0000400040005.Значение
																	+ Области.П0000400041005.Значение
																	+ Области.П0000400042005.Значение
																	+ Области.П0000400043005.Значение
																	+ Области.П0000400044005.Значение
																	+ Области.П0000400045005.Значение
																	+ Области.П0000400046005.Значение
																	+ Области.П0000400047005.Значение
																	+ Области.П0000400048005.Значение
																	+ Области.П0000400051005.Значение
																	+ Области.П0000400052005.Значение
																	+ Области.П0000400053005.Значение
																	+ Области.П0000400054005.Значение
																	+ Области.П0000400055005.Значение
																	+ Области.П0000400056005.Значение
																	+ Области.П0000400057005.Значение
																	+ Области.П0000400058005.Значение
																	+ Области.П0000400059005.Значение
																	+ Области.П0000400060005.Значение
																	+ Области.П0000400061005.Значение
																	+ Области.П0000400062005.Значение
																	+ Области.П0000400063005.Значение
																	+ Области.П0000400064005.Значение
																	+ Области.П0000400065005.Значение
																	+ Области.П0000400066005.Значение
																	+ Области.П0000400067005.Значение
																	+ Области.П0000400068005.Значение
																	+ Области.П0000400069005.Значение
																	+ Области.П0000400070005.Значение
																	+ Области.П0000400071005.Значение
																	+ Области.П0000400072005.Значение
																	+ Области.П0000400073005.Значение
																	+ Области.П0000400074005.Значение
																	+ Области.П0000400075005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400036003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400036003.Значение = Области.П0000400036004.Значение
																    + Области.П0000400036005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400037003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400037003.Значение = Области.П0000400037004.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400038003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400038003.Значение = Области.П0000400038004.Значение;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400039003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400039003.Значение = Области.П0000400039004.Значение
																    + Области.П0000400039005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400040003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400040003.Значение = Области.П0000400040004.Значение
																    + Области.П0000400040005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400041003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400041003.Значение = Области.П0000400041004.Значение
																    + Области.П0000400041005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400042003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400042003.Значение = Области.П0000400042004.Значение
																    + Области.П0000400042005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400043003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400043003.Значение = Области.П0000400043004.Значение
																    + Области.П0000400043005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400044003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400044003.Значение = Области.П0000400044004.Значение
																    + Области.П0000400044005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400045003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400045003.Значение = Области.П0000400045004.Значение
																    + Области.П0000400045005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400046003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400046003.Значение = Области.П0000400046004.Значение
																    + Области.П0000400046005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400047003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400047003.Значение = Области.П0000400047004.Значение
																    + Области.П0000400047005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400048003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400048003.Значение = Области.П0000400048004.Значение
																    + Области.П0000400048005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400049003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400049003.Значение = Области.П0000400049004.Значение
																    + Области.П0000400049005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400050003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400050003.Значение = Области.П0000400050004.Значение
																    + Области.П0000400050005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400051003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400051003.Значение = Области.П0000400051004.Значение
																    + Области.П0000400051005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400052003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400052003.Значение = Области.П0000400052004.Значение
																    + Области.П0000400052005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400053003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400053003.Значение = Области.П0000400053004.Значение
																    + Области.П0000400053005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400054003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400054003.Значение = Области.П0000400054004.Значение
																    + Области.П0000400054005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400055003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400055003.Значение = Области.П0000400055004.Значение
																    + Области.П0000400055005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400056003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400056003.Значение = Области.П0000400056004.Значение
																    + Области.П0000400056005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400057003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400057003.Значение = Области.П0000400057004.Значение
																    + Области.П0000400057005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400058003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400058003.Значение = Области.П0000400058004.Значение
																    + Области.П0000400058005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400059003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400059003.Значение = Области.П0000400059004.Значение 
																    + Области.П0000400059005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400060003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400060003.Значение = Области.П0000400060004.Значение
																    + Области.П0000400060005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400061003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400061003.Значение = Области.П0000400061004.Значение
																    + Области.П0000400061005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400062003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400062003.Значение = Области.П0000400062004.Значение
																    + Области.П0000400062005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400063003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400063003.Значение = Области.П0000400063004.Значение
																    + Области.П0000400063005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400064003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400064003.Значение = Области.П0000400064004.Значение
																    + Области.П0000400064005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400065003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400065003.Значение = Области.П0000400065004.Значение
																    + Области.П0000400065005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400066003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400066003.Значение = Области.П0000400066004.Значение
																    + Области.П0000400066005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400067003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400067003.Значение = Области.П0000400067004.Значение
																    + Области.П0000400067005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400068003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400068003.Значение = Области.П0000400068004.Значение
																    + Области.П0000400068005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400069003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400069003.Значение = Области.П0000400069004.Значение
																    + Области.П0000400068005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400070003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400070003.Значение = Области.П0000400070004.Значение
																    + Области.П0000400070005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400071003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400071003.Значение = Области.П0000400071004.Значение
																    + Области.П0000400071005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400072003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400072003.Значение = Области.П0000400072004.Значение
																    + Области.П0000400072005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400073003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400073003.Значение = Области.П0000400073004.Значение
																    + Области.П0000400073005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400074003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400074003.Значение = Области.П0000400074004.Значение
																    + Области.П0000400074005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400075003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400075003.Значение = Области.П0000400075004.Значение
																    + Области.П0000400075005.Значение;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П0000400076003, ОбластьИмя) > 0 Тогда
			...
			Области.П0000400076003.Значение = Области.П0000400076004.Значение;
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Приложение3" Тогда
		...
		Пока Истина Цикл 
			Инд = Инд + 1;
			Если Области.Найти("П000060000304_" + Инд) = Неопределено Тогда 
				Прервать;
			КонецЕсли;
			Сумма = Сумма + Области["П000060000304_" + Инд].Значение;
		КонецЦикла;
		
		Области["П000060000204"].Значение = Сумма;
		
	ИначеЕсли ИмяТекущейСтраницыПанели = "Приложение1" Тогда
		
		Области["П0000100001003"].Значение = Области["П0000100002003"].Значение
			+ Области["П0000100003003"].Значение
			+ Области["П0000100005003"].Значение
			+ Области["П0000100010003"].Значение;
...
Процедура СохранитьДанныеРаздела(НаимРаздела, ОчищатьРазделЕслиЕстьМногострочность)
	...
	Если НаимРаздела = "МПм" Или НаимРаздела = "Приложение1" Или НаимРаздела = "Приложение2" Или НаимРаздела = "Приложение3" Тогда
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета)
	...
	//
	Если ИмяТекРаздела = "МПм" Или ИмяТекРаздела = "Приложение1" Или ИмяТекРаздела = "Приложение2" Или ИмяТекРаздела = "Приложение3" Тогда
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("МПм",         "ФормаОтчета2014Кв1_МПм");
	СоответствиеРазделовМакетам.Вставить("Приложение1", "ФормаОтчета2014Кв1_Приложение1");
	СоответствиеРазделовМакетам.Вставить("Приложение2", "ФормаОтчета2014Кв1_Приложение2");
	СоответствиеРазделовМакетам.Вставить("Приложение3", "ФормаОтчета2014Кв1_Приложение3");
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Приложение1" Тогда 
		Если СтрНайти(Область.Имя, "П000010001001_") = 1
			Или СтрНайти(Область.Имя, "П000010001002_") = 1 Тогда
			ОбластьИмя = Область.Имя;
			ОбластьКод = ТабличныйДокумент.Области[СтрЗаменить(ОбластьИмя, "1_", "2_")];
			
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтаФорма, "КодыОКАТО");
			//создание динамического списка выбора
			Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений <> Неопределено Тогда
				КодПоказателя = ПараметрВводаПоля.Показатель;
				КопироватьДанныеФормы(ПараметрВводаПоля.ТаблицаЗначений, ТЗВыбора);
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Приложение2" Тогда 
		...
		Если СтрНайти("П0000100001001,П0000100001002,П0000100001003,П0000100001004", Область.Имя) > 0 Тогда
			СтандартнаяОбработка = Ложь;
			Область.Значение = (-1) * Область.Значение;
			Модифицированность = Истина;
		ИначеЕсли Область.Имя = "П0000100001005" Тогда
			СтандартнаяОбработка = Ложь;
			Область.Значение = (-1) * Область.Значение;
			ТабличныйДокумент.Области["П0000100001006"].Значение = 6;
			Модифицированность = Истина;
		ИначеЕсли Область.Имя = "П0000100001006" Тогда
			СтандартнаяОбработка = Ложь;
			Область.Значение = (-1) * Область.Значение;
			ТабличныйДокумент.Области["П0000100001005"].Значение = 5;
			Модифицированность = Истина;
		ИначеЕсли СтрНайти(Область.Имя, "П000050009001_") = 1
			Или СтрНайти(Область.Имя, "П000050009003_") = 1 Тогда
			ОбластьИмя = Область.Имя;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяТекущейСтраницыПанели = "Приложение1"
		Или ИмяТекущейСтраницыПанели = "Приложение2" 
		Или ИмяТекущейСтраницыПанели = "Приложение3" Тогда
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	// Проверка соотношений в Приложении1.
	Если ПараметрыВыгрузки["ПР1_П0000100003003"] < ПараметрыВыгрузки["ПР1_П0000100004003"] Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Строка 03 должна быть больше либо равна строки 04", "Приложение1", "П0000100003003");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки["ПР1_П0000100003003"] < ПараметрыВыгрузки["ПР1_П0000100011003"]
		+ ПараметрыВыгрузки["ПР1_П0000100012003"] + ПараметрыВыгрузки["ПР1_П0000100013003"] Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Строка 03 должна быть больше либо равна суммы строк 11+12+13", "Приложение1", "П0000100003003");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки["ПР1_П0000100005003"] < ПараметрыВыгрузки["ПР1_П0000100006003"]
		+ ПараметрыВыгрузки["ПР1_П0000100007003"] + ПараметрыВыгрузки["ПР1_П0000100008003"]
		 + ПараметрыВыгрузки["ПР1_П0000100009003"]Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Строка 05 должна быть больше либо равна суммы строк 06+07+08+08", "Приложение1", "П0000100005003");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	// Проверка соотношений в Приложении2.
	Если ПараметрыВыгрузки["ПР2_П0000100009003"] < ПараметрыВыгрузки["ПР2_П0000100010003"] Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Строка 09 должна быть больше либо равна строки 10", "Приложение2", "П0000100009003");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки["ПР2_П0000100010003"] = 0 
		И (ПараметрыВыгрузки["ПР2_П0000100011003"] > 0 Или ПараметрыВыгрузки["ПР2_П0000100012003"] > 0 Или ПараметрыВыгрузки["ПР2_П0000100013003"] > 0
		Или ПараметрыВыгрузки["ПР2_П0000100014003"] > 0 Или ПараметрыВыгрузки["ПР2_П0000100015003"] > 0) Тогда 
		
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Если одна из строк 11-15 больше 0, то строка 10 должна быть больше 0", "Приложение2", "П0000100010003");
		СтатусПроверки = Ложь;
		
	КонецЕсли;
	
	Если ПараметрыВыгрузки["ПР2_П0000200016003"] < ПараметрыВыгрузки["ПР2_П0000200017003"] Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Строка 16 должна быть больше либо равна строки 17", "Приложение2", "П0000200016003");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки["ПР2_П0000300029003"] < ПараметрыВыгрузки["ПР2_П0000300030003"] Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Строка 29 должна быть больше либо равна строки 30", "Приложение2", "П0000300029003");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Для Гр = 3 По 4 Цикл
		Если ПараметрыВыгрузки["ПР2_П000030003200" + Гр] < ПараметрыВыгрузки["ПР2_П000030003300" + Гр] Тогда 
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "По графе " + Гр + " строка 32 должна быть больше либо равна строки 33", "Приложение2", "П000030003200" + Гр);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	
	Если ПараметрыВыгрузки["ПР2_П0000400037004"] < ПараметрыВыгрузки["ПР2_П0000400038004"] Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Ро грайе 4 строка 37 должна быть больше либо равна строки 38", "Приложение2", "П0000400037004");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки["ПР2_П0000500077001"] < ПараметрыВыгрузки["ПР2_П0000500078001"] Тогда 
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Строка 77 должна быть больше либо равна строки 78", "Приложение2", "П0000500077001");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Для Гр = 4 По 5 Цикл
		Если ПараметрыВыгрузки["ПР2_П000040004800" + Гр] < ПараметрыВыгрузки["ПР2_П000040004900" + Гр] + ПараметрыВыгрузки["ПР2_П000040005000" + Гр] Тогда 
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "По графе " + Гр + " строка 48 должна быть больше либо равна суммы значений по строкам 49 и 50", "Приложение2", "П000040004800" + Гр);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("Зн_П0000100001001", ТабДокумент.П0000100001001);
	ПараметрыВыгрузки.Вставить("Зн_П0000100001002", ТабДокумент.П0000100001002);
	ПараметрыВыгрузки.Вставить("Зн_П0000100001003", ТабДокумент.П0000100001003);
	ПараметрыВыгрузки.Вставить("Зн_П0000100001004", ТабДокумент.П0000100001004);
	...
	Для Инд = 1 По 13 Цикл
		ПараметрыВыгрузки.Вставить("ПР1_П00001000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003", СтруктураДанныхПриложение1["П00001000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003"]);
	КонецЦикла;
	
	// Раздел Приложение 2.
	Для Инд = 9 По 15 Цикл
		ПараметрыВыгрузки.Вставить("ПР2_П00001000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003", СтруктураДанныхПриложение2["П00001000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003"]);
	КонецЦикла;
	
	Для Инд = 16 По 17 Цикл
		ПараметрыВыгрузки.Вставить("ПР2_П00002000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003", СтруктураДанныхПриложение2["П00002000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003"]);
	КонецЦикла;
	
	Для Инд = 29 По 30 Цикл
		ПараметрыВыгрузки.Вставить("ПР2_П00003000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003", СтруктураДанныхПриложение2["П00003000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "003"]);
	КонецЦикла;
	
	Для Гр = 3 По 4 Цикл 
		Для Инд = 32 По 33 Цикл
			ПараметрыВыгрузки.Вставить("ПР2_П00003000" + Формат(Инд, "ЧЦ=2; ЧВН=") + Формат(Гр, "ЧЦ=3; ЧВН="), СтруктураДанныхПриложение2["П00003000" + Формат(Инд, "ЧЦ=2; ЧВН=") + Формат(Гр, "ЧЦ=3; ЧВН=")]);
		КонецЦикла;
	КонецЦикла;
	
	Для Инд = 37 По 38 Цикл
		ПараметрыВыгрузки.Вставить("ПР2_П00004000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "004", СтруктураДанныхПриложение2["П00004000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "004"]);
	КонецЦикла;
	
	Для Гр = 4 По 5 Цикл 
		Для Инд = 48 По 50 Цикл
			ПараметрыВыгрузки.Вставить("ПР2_П00004000" + Формат(Инд, "ЧЦ=2; ЧВН=") + Формат(Гр, "ЧЦ=3; ЧВН="), СтруктураДанныхПриложение2["П00004000" + Формат(Инд, "ЧЦ=2; ЧВН=") + Формат(Гр, "ЧЦ=3; ЧВН=")]);
		КонецЦикла;
	КонецЦикла;
	
	Для Инд = 77 По 78 Цикл
		ПараметрыВыгрузки.Вставить("ПР2_П00005000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "001", СтруктураДанныхПриложение2["П00005000" + Формат(Инд, "ЧЦ=2; ЧВН=") + "001"]);
	КонецЦикла;
