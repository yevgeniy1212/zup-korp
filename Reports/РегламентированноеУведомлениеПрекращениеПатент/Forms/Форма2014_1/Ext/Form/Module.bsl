...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РегламентированнаяОтчетность.ПолучитьПоказателиОдностраничногоУведомления(ЭтотОбъект, "СоставПоказателей2014_1");
	РегламентированнаяОтчетность.Раскрасить(ЭтотОбъект, ПредставлениеУведомления);
