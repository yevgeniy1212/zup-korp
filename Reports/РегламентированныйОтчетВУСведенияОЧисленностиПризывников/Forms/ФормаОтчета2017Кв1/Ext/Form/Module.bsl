...
Процедура ФормироватьСтруктуруСтраницОтчета() 
	...
	СтрокаУровня1.Представление            = "Сведения о численности на работающих (учащихся) военнообязанных и призывников";
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	Если ТабличныйДокумент.Области.Найти("Организация") <> Неопределено
		И Не ЗначениеЗаполнено(ТабличныйДокумент.Области["Организация"].Значение) Тогда
		ТабличныйДокумент.Области["Организация"].Значение = СведенияОбОрганизации.НаимЮЛПол;
	КонецЕсли;
	...
	Если ТабличныйДокумент.Области.Найти("ДатаОтчета") <> Неопределено
		...
		ТабличныйДокумент.Области["ДатаОтчета"].Значение = Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДЛФ=DD");
	КонецЕсли;
	...
	Если ТабличныйДокумент.Области.Найти("ДатаОтчета1") <> Неопределено
		...
		ТабличныйДокумент.Области["ДатаОтчета1"].Значение = Формат(ТекущаяДата(), "ДЛФ=DD");
	КонецЕсли;
...
Процедура ПодготовитьДеревоСтраницДляНастройки()
	...
	СтрокаУровня1.ИмяСтраницы              = "ФормаСтраница1";
	СтрокаУровня1.Представление            = "Список военнообязанных и призывников принятых или уволенных с работы";
