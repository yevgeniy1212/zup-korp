...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Устнавливаем границы периода построения отчета как год
...
Процедура УстановитьПредыдущийПериод(Команда)
	...
	Если мДатаКонцаПериодаОтчета <= КонецГода(Дата(2022,1,1)) Тогда
		Шаг = -1;
...
Процедура УстановитьСледующийПериод(Команда)
	...
	Если мДатаКонцаПериодаОтчета = КонецМесяца(Дата(2022,9,1)) Тогда
		Шаг = 1;
		мПериодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Год");
	ИначеЕсли мДатаКонцаПериодаОтчета >= КонецГода(Дата(2022,1,1)) Тогда
		Шаг = 4;
		мПериодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Год");
	Иначе
		Шаг = 1;
