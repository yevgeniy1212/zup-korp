...
Процедура ПредставлениеУведомленияПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(Область.Имя, "А01020000_") И СтрНачинаетсяС(ТекущееИДНаименования, "ЛистН") Тогда 
		Постфикс = Число(СтрЗаменить(Область.Имя, "А01020000_", ""));
		МногострочнаяЧасть = ?(ТекущееИДНаименования = "ЛистН1", МногострочнаяЧасть1, МногострочнаяЧасть2);
...
Процедура ВывестиМногострочнуюЧасть(МногострочнаяЧасть)
	...
	Если ТекущееИДНаименования = "ЛистН1" Тогда 
		Макет = УведомлениеОСпецрежимахНалогообложения.ПолучитьМакетТабличногоДокумента(ЭтотОбъект, "Форма2014_1_СтраницаН1");
	ИначеЕсли ТекущееИДНаименования = "ЛистН2" Тогда
		Макет = УведомлениеОСпецрежимахНалогообложения.ПолучитьМакетТабличногоДокумента(ЭтотОбъект, "Форма2014_1_СтраницаН2");
	КонецЕсли;
...
Функция СформироватьВыгрузкуИПолучитьДанные() Экспорт 
	...
	СтруктураВыгрузки.Вставить("Данные", УведомлениеОСпецрежимахНалогообложения.ПолучитьМакетДвоичныхДанных(Объект.ИмяОтчета, "TIFF_2014_1"));
	СтруктураВыгрузки.Вставить("ИмяФайла", "1111516_5.02000_06.tif");
...
Процедура ПечатьБРО(Команда)
	...
	РегламентированнаяОтчетностьКлиент.ОткрытьФормуПредварительногоПросмотра(ЭтотОбъект, "Открыть", Ложь,
		СтруктураРеквизитовУведомления.СписокПечатаемыхЛистов, Новый Структура("ЕстьВыходЗаГраницы", ЕстьВыходЗаГраницы));
КонецПроцедуры
