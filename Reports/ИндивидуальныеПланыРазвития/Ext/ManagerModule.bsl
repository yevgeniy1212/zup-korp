...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ИндивидуальныеПланыРазвития");
	НастройкиВарианта.Описание = НСтр("ru = 'Сведения об индивидуальных планах развития сотрудников. 
									  |Включают результаты по каждому мероприятию из программы плана.'");
