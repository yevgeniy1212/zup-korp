...
Функция ЭлектронноеПредставление(Объект, ИмяФормы, УникальныйИдентификатор) Экспорт
	Если ИмяФормы = "Форма2016_1" Или ИмяФормы = "Форма2022_1" Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Выгрузка отчета не предусмотрена'"));
		Возврат Неопределено;
	ИначеЕсли ИмяФормы = "Форма1900_1" Тогда
...
Функция СформироватьСписокЛистовФорма2022_1(Объект) Экспорт
	...
	Титульная = Объект.Ссылка.ДанныеУведомления.Получить().ДанныеУведомления;
