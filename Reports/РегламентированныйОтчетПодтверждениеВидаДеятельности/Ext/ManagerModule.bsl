...
Функция ТаблицаФормОтчета() Экспорт
	...
	= "Утверждены Приказом Минздравсоцразвития России от 31.01.2006 № 55 (в ред. Приказа Минтруда России от 27.12.2022 № 818н).";
	НоваяФорма.РедакцияФормы      = "от 27.12.2022 № 818н.";
