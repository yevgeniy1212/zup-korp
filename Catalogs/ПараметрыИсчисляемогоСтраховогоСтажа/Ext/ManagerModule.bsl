...
Процедура НачальноеЗаполнение() Экспорт
	...
	УстановитьРеквизитыИспользования2022();
...
Процедура УстановитьРеквизитыИспользования2022() Экспорт 
	
	ОбновитьОбъектКлассификатора("ВОЕНСЛ", "Мобилизованные или заключившие контракт", Истина);
