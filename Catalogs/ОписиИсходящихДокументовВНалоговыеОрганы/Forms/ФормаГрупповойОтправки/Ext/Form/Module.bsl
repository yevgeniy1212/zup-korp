...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоПакетСДопДокументами = Параметры.ЭтоПакетСДопДокументами;
	
	Если ЭтоПакетСДопДокументами Тогда
		Заголовок = "Отправка досылок прочих документов";
	Иначе
		НомерДата = Основание.НомерДокумента + " от " + Формат(Основание.ДатаДокумента, "ДЛФ=DD");
...
Процедура ОтправитьВсе(Команда)
	...
	Если ЕстьОтправленныеОписи Тогда
		ТекстВопроса = "Все неотправленные документы из списка будут отправлены в ФНС. Продолжить?";
	Иначе
		ТекстВопроса = "Все документы из списка будут отправлены в ФНС. Продолжить?";
	КонецЕсли;
