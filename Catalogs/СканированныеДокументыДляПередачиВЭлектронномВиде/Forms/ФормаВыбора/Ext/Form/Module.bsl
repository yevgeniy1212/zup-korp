...
Процедура КопироватьЭлемент(Команда)
	...
	Если ТекущаяСтрока <> Неопределено Тогда
		...
		ОткрытьФорму("Справочник.СканированныеДокументыДляПередачиВЭлектронномВиде.ФормаОбъекта", СтруктураПараметров, ЭтотОбъект);
	КонецЕсли;
...
Процедура ЗаполнитьСпискиВыбора()
	...
	МассивВидыДокументовСкан = КонтекстЭДОСервер.ВидыПредставляемыхДокументов();
