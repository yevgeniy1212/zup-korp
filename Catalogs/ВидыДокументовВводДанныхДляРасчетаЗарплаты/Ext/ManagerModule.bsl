...
Процедура ПриОбработкеПравилаРегистрацииПередИзменениемОбъекта(Объект, Отказ, Параметры) Экспорт
	ОрганизацияДляОтбора = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Ссылка, "Организация");
	ПриОбработкеПравилаРегистрации(Объект, Отказ, ОрганизацияДляОтбора, Параметры);
КонецПроцедуры
...
Процедура ПриОбработкеПравилаРегистрацииПослеИзмененияОбъекта(Объект, Отказ, Параметры) Экспорт
	ПриОбработкеПравилаРегистрации(Объект, Отказ, Объект.Организация, Параметры);
КонецПроцедуры
...
Процедура ПриОбработкеПравилаРегистрации(Объект, Отказ, ОрганизацияДляОтбора, Параметры) Экспорт
	
	Если ЗначениеЗаполнено(Объект.Организация) Тогда
		СинхронизацияДанныхЗарплатаКадры.ОграничитьРегистрациюОбъектаОтборомПоОрганизациям(Объект,
			ОрганизацияДляОтбора, Отказ, Параметры, "РегламентированныеДанные");
	КонецЕсли;
