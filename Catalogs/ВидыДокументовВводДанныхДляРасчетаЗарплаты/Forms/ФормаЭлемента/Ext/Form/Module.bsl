...
#Область ОбработчикиСобытийЭлементовТаблицыФормыВидыРабочегоВремени
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыВидыНеРабочегоВремени
...
Процедура ЗаписатьНастройкуИспользованияПоказателей(ТекущийОбъект)
	...
	МассивыВыбранныхПоказателей.Добавить(ВыбранныеПоказателиДляОрганизации);
	МассивыВыбранныхПоказателей.Добавить(ВыбранныеПоказателиДляПодразделения);
	МассивыВыбранныхПоказателей.Добавить(ВыбранныеПоказателиДляСотрудника);
