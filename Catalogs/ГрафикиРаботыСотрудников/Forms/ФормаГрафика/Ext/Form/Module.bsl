...
&НаКлиенте
Процедура АвтоОбновлениеПоПроизводственномуКалендарюПриИзменении(Элемент)
...
Процедура УстановитьУсловноеОформление()
	Для НомерДня = 1 По 31 Цикл
		...
		//ЗУПК
		ГрафикиРаботыСотрудниковЗУПК.ДобавитьЭлементОтбораВидДняДополнительныйВыходной(ГруппаОтбора, НомерДня);
		//ЗУПК
