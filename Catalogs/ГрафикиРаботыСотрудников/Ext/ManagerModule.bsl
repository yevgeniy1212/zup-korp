	...
	Пока ВыборкаДанныхОВремени.СледующийПоЗначениюПоля("ГрафикРаботы") Цикл
		...
		Пока ВыборкаДанныхОВремени.СледующийПоЗначениюПоля("Квартал") Цикл
			...
			Пока ВыборкаДанныхОВремени.СледующийПоЗначениюПоля("Месяц") Цикл 			
				...
				// ЗУПК
				ОбластьИтогоЗаМесяц.Параметры.ЧасовПоКалендарю = Формат(ВыборкаДанныхОВремени.РабочихЧасов, "ЧДЦ=1");
				// ЗУПК
			...
			// ЗУПК
			ОбластьИтогоЗаКвартал.Параметры.ЧасовЗаКварталПоКалендарю = Формат(РабочихЧасовЗаКварталПоКалендарю, "ЧДЦ=1");
			// ЗУПК
		...
		// ЗУПК
		ОбластьИтогоЗаГод.Параметры.ЧасовЗаГодПоКалендарю = Формат(РабочихЧасовЗаГодПоКалендарю, "ЧДЦ=1");
		// ЗУПК
...
Функция ЗапросДляПечатиГрафиков(МассивОбъектов, Год)
	...
	// ЗУПК
	Запрос.Текст = ГрафикиРаботыСотрудниковЗУПК.ЗаменитьТекстЗапросаРасчетРабочихЧасов(Запрос.Текст);
	// ЗУПК
