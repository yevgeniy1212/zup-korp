...
Процедура ОбработкаЗаполнения(СообщениеОснование)
	...
	Если ТипЗнч(СообщениеОснование) = Тип("Структура")
		...
		Если КонтекстЭДО.ЭтоРешениеПоЖалобе(ДокументыРеализацииПолномочийСсылка) Тогда
			Наименование = НСтр("ru = 'Ответ на: '")
				+ Справочники.ДокументыРеализацииПолномочийНалоговыхОрганов.НаименованиеДокументаРеализацииПолномочий(ДокументыРеализацииПолномочийСсылка);
		Иначе
