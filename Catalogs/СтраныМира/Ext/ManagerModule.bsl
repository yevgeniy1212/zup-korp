...
// Процедура заполняет справочник страны мира значениями по умолчанию.
//
Процедура НачальноеЗаполнение() Экспорт
	
	ЗаписатьПредопределенныйЭлемент(Справочники.СтраныМира.Армения);
	ЗаписатьПредопределенныйЭлемент(Справочники.СтраныМира.Беларусь);
	ЗаписатьПредопределенныйЭлемент(Справочники.СтраныМира.Казахстан);
	ЗаписатьПредопределенныйЭлемент(Справочники.СтраныМира.Киргизия);
	ЗаписатьПредопределенныйЭлемент(Справочники.СтраныМира.Россия);

КонецПроцедуры // ЗаполнитьВалютыПоУмолчанию()

Процедура ЗаписатьПредопределенныйЭлемент(Ссылка)
	
	ДанныеДляЗаполнения = ДанныеКлассификатораСтранМираПоКоду(Ссылка.Код);
	...
	Если ТипЗнч(ДанныеДляЗаполнения) = Тип("Структура") Тогда
		...
		Если ДанныеДляЗаполнения.Свойство("Код") Тогда
			СправочникОбъект.Код = ДанныеДляЗаполнения.Код;
		КонецЕсли;
		Если ДанныеДляЗаполнения.Свойство("КодАльфа2") Тогда
			СправочникОбъект.КодАльфа2 = ДанныеДляЗаполнения.КодАльфа2;
		КонецЕсли;
		Если ДанныеДляЗаполнения.Свойство("КодАльфа3") Тогда
			СправочникОбъект.КодАльфа3 = ДанныеДляЗаполнения.КодАльфа3;
		КонецЕсли;
		Если ДанныеДляЗаполнения.Свойство("Наименование") Тогда
			СправочникОбъект.Наименование = ДанныеДляЗаполнения.Наименование;
		КонецЕсли;
		Если ДанныеДляЗаполнения.Свойство("НаименованиеПолное") Тогда
			СправочникОбъект.НаименованиеПолное = ДанныеДляЗаполнения.НаименованиеПолное;
		КонецЕсли;
		Если ДанныеДляЗаполнения.Свойство("УчастникЕАЭС") Тогда
			СправочникОбъект.УчастникЕАЭС = ДанныеДляЗаполнения.УчастникЕАЭС;
		КонецЕсли;
