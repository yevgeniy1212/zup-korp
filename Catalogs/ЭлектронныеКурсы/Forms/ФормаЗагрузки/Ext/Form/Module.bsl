...
Функция ЗаписатьКурсыВБазу()
	...
	Попытка
		...
		Для каждого Строка Из ЭлектронныеКурсы Цикл
			...
			Если Строка.Загружать Тогда
				...
				Если Строка.Формат = Перечисления.ФорматыВыгрузкиЭлектронныхКурсов.ПолнаяКопия Тогда
					ЗагруженныйЭлектронныйКурс = РазработкаЭлектронныхКурсовСлужебный.ЗагрузитьВБазуПолныйПакет(Строка.ПутьКФайлуМанифеста, ЭтотОбъект.УникальныйИдентификатор);
				ИначеЕсли Строка.Формат = Перечисления.ФорматыВыгрузкиЭлектронныхКурсов.SCORM Тогда
					ЗагруженныйЭлектронныйКурс = РазработкаЭлектронныхКурсовСлужебный.ЗагрузитьВБазуПакетSCORM(Строка.ПутьКФайлуМанифеста, ЭтотОбъект.УникальныйИдентификатор);
				Иначе
		...
		РазработкаЭлектронныхКурсовПереопределяемый.ПослеЗагрузкиЭлектронногоКурсаВБазу(МассивЗагруженныхКурсов);
