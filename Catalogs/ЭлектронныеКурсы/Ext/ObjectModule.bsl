...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.Свойство("СтараяПометкаУдаления") И ПомечатьПодчиненные Тогда
		...
		Если НЕ ДополнительныеСвойства.СтараяПометкаУдаления
			...
			Справочники.ЭлектронныеКурсы.ПриУстановкеСнятииПометкиУдаленияЭлектронногоКурса(Ссылка, Истина, КонтекстРедактирования);
		...
		Если ДополнительныеСвойства.СтараяПометкаУдаления
			...
			Справочники.ЭлектронныеКурсы.ПриУстановкеСнятииПометкиУдаленияЭлектронногоКурса(Ссылка, Ложь, КонтекстРедактирования);
