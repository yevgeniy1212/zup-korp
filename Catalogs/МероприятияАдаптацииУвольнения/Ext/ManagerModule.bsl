...
Процедура НачальноеЗаполнение() Экспорт
	...
	Для Каждого СтрокаМероприятия Из ТаблицаМероприятий Цикл
		...
		СправочникОбъект.ВидСдвигаСрокаНачалаИсполнения = ПредопределенноеЗначение("Перечисление.ВидыСдвигаСрока.День");
		СправочникОбъект.ВидСдвигаСрокаОкончанияИсполнения = ПредопределенноеЗначение("Перечисление.ВидыСдвигаСрока.День");
