...
&НаКлиенте
Процедура ЦиклыОбменаЦБВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
...
Процедура УправлениеЭУ()
	...
	Элементы.Получатель.Видимость =
		(ТипПолучателя <> ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.ФСРАР")
		...
		И ТипПолучателя <> ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.ЦБ"));
...
Процедура УстановитьОтборыЦО()
	...
	// ЦБ
	ЦиклыОбменаЦБ.Параметры.УстановитьЗначениеПараметра("ТипКолонкаЦБ1",
		Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ);
	ЦиклыОбменаЦБ.Параметры.УстановитьЗначениеПараметра("ТипКолонкаЦБ2",
		Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ);
	ЦиклыОбменаЦБ.Параметры.УстановитьЗначениеПараметра("ТипКолонкаЦБ3",
		Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ);
	ЦиклыОбменаЦБ.Параметры.УстановитьЗначениеПараметра("ТипКолонкаЦБ4",
		Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ);
	
	ЦиклыОбменаЦБ.Параметры.УстановитьЗначениеПараметра("Предмет", Неопределено);
...
Процедура ОбработатьАктивизациюСтрокиОсновнойТаблицы()
	...
	Если ТекДанные = Неопределено
		...
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыВвоз")
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОстатки")
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОтчетОбОперациях")
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыПеремещение")
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.УведомлениеОбОстаткахПрослеживаемыхТоваров")
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.УведомлениеОВвозеПрослеживаемыхТоваров")
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.УведомлениеОПеремещенииПрослеживаемыхТоваров")
		...
		И ТекДанные_ТипПолучателя <> ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.ЦБ")
	...
	ИначеЕсли ТекДанные_ВидОтчета_ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыОтправляемыхДокументов.ИсходящееУведомлениеФНС")
		...
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыВвоз")
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОстатки")
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОтчетОбОперациях")
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыПеремещение")
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.УведомлениеОбОстаткахПрослеживаемыхТоваров")
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.УведомлениеОВвозеПрослеживаемыхТоваров")
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.УведомлениеОПеремещенииПрослеживаемыхТоваров")
	...
	ИначеЕсли ТекДанные_ТипПолучателя = ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.ЦБ") Тогда
		
		Элементы.ЦиклыОбмена.ТекущаяСтраница = Элементы.ГруппаЦиклыОбменаЦБ;
		
		ЦиклыОбменаЦБ.Параметры.УстановитьЗначениеПараметра("Предмет", ТекДанные_Ссылка);
