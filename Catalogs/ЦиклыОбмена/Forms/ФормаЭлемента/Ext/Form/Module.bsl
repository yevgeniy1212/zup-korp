...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоОтправкаВСФР = ДокументооборотСКОКлиентСервер.ЭтоОтправкаВСФР(
		...
		Объект.Вид,
		Объект.Тип);
	ВидТекстом = ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(Строка(Объект.Вид), Истина,, НЕ ЭтоОтправкаВСФР);
	Элементы.НадписьОрганПФР.Заголовок = ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(
		Элементы.НадписьОрганПФР.Заголовок, Истина,, НЕ ЭтоОтправкаВСФР);
	...
	И Объект.Тип <> Перечисления.ТипыЦикловОбмена.ОтчетностьФСГС
	И Объект.Тип <> Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ Тогда
...
Процедура ИнициализироватьСоответствия()
	...
	СоответствиеТипаСообщенияПорядку = КонтекстЭДОСервер.СоответствиеТипаСообщенияПорядку(Объект);
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.НеформализованнаяПерепискаПФРВходящие Тогда
		...
		//
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.ПисьмоВходящееПФР,
			"Первичное сообщение, содержащее письмо от ПФР, отсутствует");
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.ПисьмоВходящееКвитанцияПФР,
			"Квитанция о получении отсутствует");
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.РассылкаПФР Тогда		
		...
		//
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.ПисьмоВходящееПФР,
			"Первичное сообщение, содержащее рассылку от ПФР, отсутствует");
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.ПисьмоВходящееКвитанцияПФР,
			"Квитанция о получении отсутствует");
		...
		//
		СоответствиеТипаСообщенийТипамЦиклаОбмена.Вставить(Перечисления.ТипыТранспортныхСообщений.ПисьмоВходящееПФР, Перечисления.ТипыЦикловОбмена.РассылкаПФР);
		СоответствиеТипаСообщенийТипамЦиклаОбмена.Вставить(Перечисления.ТипыТранспортныхСообщений.ПисьмоВходящееКвитанцияПФР, Перечисления.ТипыЦикловОбмена.РассылкаПФР);
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.РассылкаШаблоновФСГС Тогда
		
		//
		СоответствиеТипаТранспортногоСообщенияКартинке.Вставить(Перечисления.ТипыТранспортныхСообщений.РассылкаШаблоновФСГС, Элементы.КартинкаРассылкаФСГС);
		
		//
		СоответствиеТипаТранспортногоСообщенияНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РассылкаШаблоновФСГС, Элементы.НадписьРассылкаФСГС);
		
		//
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РассылкаШаблоновФСГС, "Первичное сообщение, содержащее рассылку шаблонов из Росстата, отсутствует");
		
		//
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.НадписьРассылкаФСГС, Перечисления.ТипыТранспортныхСообщений.РассылкаШаблоновФСГС);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРассылкаФСГС, Перечисления.ТипыТранспортныхСообщений.РассылкаШаблоновФСГС);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРассылкаФСГСЭмблема, Перечисления.ТипыТранспортныхСообщений.РассылкаШаблоновФСГС);
		
		//
		СоответствиеТипаСообщенийТипамЦиклаОбмена.Вставить(Перечисления.ТипыТранспортныхСообщений.РассылкаШаблоновФСГС, Перечисления.ТипыЦикловОбмена.РассылкаШаблоновФСГС);
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ Тогда
		
		//
		СоответствиеТипаТранспортногоСообщенияКартинке.Вставить(Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ, Элементы.КартинкаПервичноеСообщениеЦБ);
		СоответствиеТипаТранспортногоСообщенияКартинке.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ, Элементы.КартинкаРезультатЗагрузкиЦБ);
		СоответствиеТипаТранспортногоСообщенияКартинке.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ, Элементы.КартинкаРезультатПриемаЦБ);
		СоответствиеТипаТранспортногоСообщенияКартинке.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ, Элементы.КартинкаРезультатОбработкиЦБ);
		
		//
		СоответствиеТипаТранспортногоСообщенияНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ, Элементы.НадписьПервичноеСообщениеЦБ);
		СоответствиеТипаТранспортногоСообщенияНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ, Элементы.НадписьРезультатЗагрузкиЦБ);
		СоответствиеТипаТранспортногоСообщенияНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ, Элементы.НадписьРезультатПриемаЦБ);
		СоответствиеТипаТранспортногоСообщенияНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ, Элементы.НадписьРезультатОбработкиЦБ);
		
		//
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ,	НСтр("ru = 'Первичное сообщение, содержащее файл отчетности, отсутствует'"));
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ,						НСтр("ru = 'Подтверждение загрузки отсутствует'"));
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ,					НСтр("ru = 'Результат приема отчета отсутствует'"));
		СоответствиеТипаТранспортногоСообщенияТекстуНадписи.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ,				НСтр("ru = 'Результат обработки отчета отсутствует'"));
		
		//
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.НадписьПервичноеСообщениеЦБ, Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаПервичноеСообщениеЦБ, Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаПервичноеСообщениеЦБЭмблема, Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ);
		
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.НадписьРезультатЗагрузкиЦБ, Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРезультатЗагрузкиЦБ, Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРезультатЗагрузкиЦБЭмблема, Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ);
		
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.НадписьРезультатПриемаЦБ, Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРезультатПриемаЦБ, Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРезультатПриемаЦБЭмблема, Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ);
		
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.НадписьРезультатОбработкиЦБ, Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРезультатОбработкиЦБ, Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ);
		СоответствиеЭлементовУправленияТипуТранспортногоСообщения.Вставить(Элементы.КартинкаРезультатОбработкиЦБЭмблема, Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ);
		
		//
		СоответствиеТипаСообщенийТипамЦиклаОбмена.Вставить(Перечисления.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ, Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ);
		СоответствиеТипаСообщенийТипамЦиклаОбмена.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ, Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ);
		СоответствиеТипаСообщенийТипамЦиклаОбмена.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ, Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ);
		СоответствиеТипаСообщенийТипамЦиклаОбмена.Вставить(Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ, Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ);
	...
	СоответствиеТипаЦиклаОбменаСтраницеПанелиСообщений.Вставить(Перечисления.ТипыЦикловОбмена.РассылкаПФР, Элементы.СтраницаНеформализованноеВходящиеПФР);
	...
	СоответствиеТипаЦиклаОбменаСтраницеПанелиСообщений.Вставить(Перечисления.ТипыЦикловОбмена.РассылкаШаблоновФСГС, Элементы.СтраницаРассылкаФСГС);
	...
	СоответствиеТипаЦиклаОбменаСтраницеПанелиСообщений.Вставить(Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ, Элементы.СтраницаОтчетностьЦБ);
...
Процедура ПрорисоватьСтатусыЧтенияСообщений()
	...
	Если ТаблицаНепрочитанныхСообщений.Найти(Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка,
		"Тип") <> Неопределено
		ИЛИ ТаблицаНепрочитанныхСообщений.Найти(Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеПФР,
		"Тип") <> Неопределено
		ИЛИ ТаблицаНепрочитанныхСообщений.Найти(Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС,
		"Тип") <> Неопределено
		ИЛИ ТаблицаНепрочитанныхСообщений.Найти(Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФСГС,
		"Тип") <> Неопределено
		ИЛИ ТаблицаНепрочитанныхСообщений.Найти(Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеЦБ,
		"Тип") <> Неопределено Тогда
...
Процедура ЗаполнитьДанными()
	...
	ИначеЕсли Объект.Вид = Перечисления.ВидыЦикловОбмена.ЦиклОбменаСЦБ Тогда
		Элементы.ГруппаСтраницыВторойСубъектПереписки.ТекущаяСтраница = Элементы.СтраницаОрганЦБ;
	Иначе
	...
	Иначе
		...
		ИЛИ Объект.Тип = Перечисления.ТипыЦикловОбмена.НеформализованнаяПерепискаПФРВходящие
		ИЛИ Объект.Тип = Перечисления.ТипыЦикловОбмена.РассылкаПФР Тогда
	...
	Для Каждого Стр Из СоответствиеТипаТранспортногоСообщенияТекстуНадписи Цикл
		Если СоответствиеТипаСообщенийТипамЦиклаОбмена[Стр.Ключ] = Объект.Тип Тогда
			СоответствиеТипаТранспортногоСообщенияНадписи[Стр.Ключ].Заголовок =
				ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(Стр.Значение,,, НЕ ЭтоОтправкаВСФР);
		КонецЕсли;
	КонецЦикла;
		...
		Для ИндСтр = 1 По ТаблицаСообщений.Количество() Цикл
			...
			Если СтрСообщение.Тип = Перечисления.ТипыТранспортныхСообщений.ПодтверждениеПолученияОтчетностиПФР Тогда
				...
				Иначе
					...
					Элементы.ГруппаПротоколКвитанцияПФР.Видимость =
						(Объект.ФорматДокументооборота <> Перечисления.ФорматыДокументооборотаСПФР.ЭДОК);
				КонецЕсли;
			КонецЕсли;
			...
			Если НадписьТекущегоТипаСообщения <> Неопределено Тогда
				Если КонтекстЭДОСервер = Неопределено Тогда 
					...
					НадписьТекущегоТипаСообщения.Доступность = Ложь;
				Иначе
					ЗаголовокТипаСообщения = КонтекстЭДОСервер.СформироватьСтрокуСостоянияТранспортногоСообщения(СтрСообщение.Ссылка);
					НадписьТекущегоТипаСообщения.Заголовок = ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(
						ЗаголовокТипаСообщения,,, НЕ ЭтоОтправкаВСФР);
				КонецЕсли;
				НадписьТекущегоТипаСообщения.Шрифт = ?(СтрСообщение.ПометкаУдаления, Новый Шрифт(НадписьТекущегоТипаСообщения.Шрифт, , , , , , Истина), Новый Шрифт);
			КонецЕсли;
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.НеформализованнаяПерепискаПФРВходящие
		Или Объект.Тип = Перечисления.ТипыЦикловОбмена.РассылкаПФР Тогда
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.РассылкаФСГС
		ИЛИ Объект.Тип = Перечисления.ТипыЦикловОбмена.РассылкаШаблоновФСГС Тогда
	...
	ИначеЕсли Объект.Тип = Перечисления.ТипыЦикловОбмена.ОтчетностьЦБ Тогда
		...
		Для ИндСтр = 1 По ТаблицаСообщений.Количество() Цикл
			...
			Если Картинка <> Неопределено Тогда
				...
				Если СтрСообщение.СтатусСообщения = Перечисления.СтатусыПисем.Отправленное
					ИЛИ СтрСообщение.СтатусСообщения = Перечисления.СтатусыПисем.Полученное Тогда
					
					Если СтрСообщение.СтатусСообщения = Перечисления.СтатусыПисем.Полученное
						И НЕ ЗначениеЗаполнено(СтрСообщение.КоличествоРасшифрованных) Тогда
					...
					Иначе
						Картинка.Картинка = ЗеленыйШар;
					КонецЕсли;
					СоответствиеТипаТранспортногоСообщенияНадписи[СтрСообщение.Тип].ЦветТекста =
						СоответствиеКартинкиЦветуНадписи[ЗеленыйШар];
					
				Иначе
					Картинка.Картинка = ?(ЗначениеЗаполнено(СтрСообщение.КоличествоНерасшифрованных), ЗолотойШарЗашифрованное,
						ЗолотойШар);
					СоответствиеТипаТранспортногоСообщенияНадписи[СтрСообщение.Тип].ЦветТекста =
						СоответствиеКартинкиЦветуНадписи[ЗолотойШар];
				КонецЕсли;
				
			КонецЕсли;
			
			// прорисовываем ЭУ протокола входного контроля
			Если СтрСообщение.Тип = Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ Тогда
				Элементы.ГруппаРезультатОбработкиЦБ.Видимость = Истина;
				Если СтрСообщение.ПротоколСОшибкой Тогда
					Элементы.НадписьРезультатОбработкиЦБ.ЦветТекста = КрасныйЦвет;
					Элементы.КартинкаРезультатОбработкиЦБКритическаяОшибка.Видимость = Истина;
				Иначе
					Элементы.НадписьРезультатОбработкиЦБ.ЦветТекста = ЗеленыйЦвет;
					Элементы.КартинкаРезультатОбработкиЦБКритическаяОшибка.Видимость = Ложь;
				КонецЕсли;
			КонецЕсли;
			...
			Если НадписьТекущегоТипаСообщения <> Неопределено Тогда
				Если КонтекстЭДОСервер = Неопределено Тогда 
					...
					НадписьТекущегоТипаСообщения.Доступность = Ложь;
				Иначе
					НадписьТекущегоТипаСообщения.Заголовок = КонтекстЭДОСервер.СформироватьСтрокуСостоянияТранспортногоСообщения(
						СтрСообщение.Ссылка);
				КонецЕсли;
				НадписьТекущегоТипаСообщения.Шрифт = ?(СтрСообщение.ПометкаУдаления,
					Новый Шрифт(НадписьТекущегоТипаСообщения.Шрифт,,,,,, Истина), Новый Шрифт);
			КонецЕсли;
			
			// регулируем видимость гиперссылки перехода к списку критичных ошибок
			Если СтрСообщение.Тип = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеЦБ
			ИЛИ СтрСообщение.Тип = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка Тогда
				Элементы.ГруппаВниманиеОшибкиЦО.Видимость = Истина;
			КонецЕсли;
...
Процедура НадписьСформироватьРезультатПриемаДокументНПНажатиеЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	КонтекстЭДОКлиент.СоздатьРезультатПриемаНаКлиентеСУчетомВопроса(Оповещение, СообщениеОснование, ПоложительныйРезультат);		
