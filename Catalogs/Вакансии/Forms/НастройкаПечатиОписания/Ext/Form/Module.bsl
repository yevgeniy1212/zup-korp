...
&НаКлиенте
Процедура ОбязанностиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	НачатьРедактированиеТекста(Элемент, ДанныеВыбора, СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ТребованияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	НачатьРедактированиеТекста(Элемент, ДанныеВыбора, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура Записать(Команда)
	...
	Если Модифицированность И СохранитьДанныеНаСервере() Тогда
...
Процедура Печать(Команда)
	...
	Если Модифицированность Тогда
		...
		ПоказатьВопрос(Оповещение, 
			НСтр("ru = 'Для печати вариант должен быть записан.
				|Продолжить ?'"), 
...
&НаКлиенте
Процедура НачатьРедактированиеТекста(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	Оповещение = Новый ОписаниеОповещения("ЗавершитьРедактированиеТекста", ЭтотОбъект, Новый Структура("ИмяРеквизита", Элемент.Имя));
...
&НаКлиенте
Процедура ЗавершитьРедактированиеТекста(РезультатВыбора, ДополнительныеПараметры) Экспорт
...
Функция СохранитьДанныеНаСервере()
	...
	Если (ЗначениеЗаполнено(НаименованиеВариантаПрежнее) И НаименованиеВариантаПрежнее <> НаименованиеВарианта) Тогда
