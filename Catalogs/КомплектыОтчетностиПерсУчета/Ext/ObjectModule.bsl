...
Функция ДанныеРСВ_2010_2011()
	...
	СвернутьТаблицуИтоговПоТарифамРСВ1(ДанныеРСВ.ИтогиПоТарифам);
...
Процедура СвернутьТаблицуИтоговПоТарифамРСВ1(Таблица)
	КолонкиСуммирования = 
		"НачисленоСтраховаяЗаОтчетныйПериод, 
		|НачисленоНакопительнаяЗаОтчетныйПериод, 
		|НачисленоСтраховаяЗаГод, 
		|НачисленоНакопительнаяЗаГод, 
		|ОбъектОбложения, 
		|ОблагаемаяБаза, 
		|БазаСверхПредельной, 
		|ОбъектОбложенияЗа1Месяц, 
		|ОблагаемаяБазаЗа1Месяц, 
		|БазаСверхПредельнойЗа1Месяц, 
		|ОбъектОбложенияЗа2Месяц, 
		|ОблагаемаяБазаЗа2Месяц, 
		|БазаСверхПредельнойЗа2Месяц, 
		|ОбъектОбложенияЗа3Месяц, 
		|ОблагаемаяБазаЗа3Месяц, 
		|БазаСверхПредельнойЗа3Месяц";
	
	Таблица.Свернуть("КодТарифа, КатегорияЗастрахованныхЛиц", КолонкиСуммирования);
КонецПроцедуры	
