...
Функция ДанныеЭлементаДляРедактирования(ЭлементРесурса, ТипЭлемента = Неопределено, ИдентификаторФормы = Неопределено) Экспорт
	...
	ИначеЕсли ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Document
		...
		Если ИдентификаторФормы = Неопределено Тогда
			ВызватьИсключение НСтр("ru = 'Для получения данных элемента ресурса необходимо передать идентификатор формы'");
		КонецЕсли;		
...
Функция ДанныеЭлементаДляВыгрузки(ЭлементРесурса, ТипЭлемента = Неопределено, ИдентификаторФормы = Неопределено) Экспорт
	...
	ИначеЕсли ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Audio
		...
		ИЛИ ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.DataProcessor
		ИЛИ ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Media
		ИЛИ ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Folder Тогда

		КодДанных = "ДвоичныеДанные";
		ИмяРеквизитаСДанными = "ПрисоединенныйФайл";		
		ХранениеФайла = ПроизвольныеДанныеЭлемента(ЭлементРесурса, ИмяРеквизитаСДанными, КодДанных, ИдентификаторФормы);

		Если ХранениеФайла = Неопределено Тогда
			ВызватьИсключение НСтр("ru = 'Данные элемента электронного ресурса для выгрузки не найдены'");
		КонецЕсли;
	...
	ИначеЕсли ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Video Тогда
		...
		Если ЗначениеЗаполнено(ИдентификаторФормы) И ИзучениеЭлектронныхКурсовСлужебный.ФайлыВыгружаютсяЛокально() Тогда
			Возврат Новый ОписаниеПередаваемогоФайла("video." + НРег(ФорматДляВыгрузки), ХранениеФайла);
		Иначе			
			Возврат ПолучитьИзВременногоХранилища(ХранениеФайла);
		КонецЕсли;
		
	ИначеЕсли ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Document
		ИЛИ ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Presentation
		ИЛИ ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.HTML Тогда
		
		Если ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Document
			ИЛИ ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.HTML Тогда
			КодДанных = "HTML";
		КонецЕсли;
...
Функция ПроизвольныеДанныеЭлемента(ЭлементРесурса, ИмяРеквизитаСДанными, КодДанных, ИдентификаторФормы = Неопределено) Экспорт
	...
	ИначеЕсли ИмяРеквизитаСДанными = "ДанныеДляИндексирования" Тогда		
		Возврат ВыборкаДетальныеЗаписи.Данные;					
	Иначе				
