...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОстатокОтпуска = ОстаткиОтпусков.ОстатокОтпускаСотрудникаНаДату(СотрудникСсылка, ОбщегоНазначения.ТекущаяДатаПользователя()).Примечание;
...
Процедура СправкаПоОтпускамСотрудника(Команда)
	...
	ПараметрыПечати = Новый Структура("ДатаОстатков", ТекущаяДатаПользователя());
