...
Процедура СформироватьИнформациюОбУдержаниях()
	...
	Запрос.Текст =
		...
		|ПОМЕСТИТЬ ВТИзмеренияДатыДляПолученияПериодовЗначенийПоказателей
		|ИЗ
	...
	ОписаниеФильтра = ЗарплатаКадрыОбщиеНаборыДанных.ОписаниеФильтраДляСоздатьВТИмяРегистра(
		"ВТИзмеренияДатыДляПолученияПериодовЗначенийПоказателей", "Организация,ФизическоеЛицо,Показатель");
	...
	Запрос.Текст =
		...
		|ПОМЕСТИТЬ ВТИзмеренияДатыДляПолученияУсловийИсполнительныхДокументов
		|ИЗ
	...
	Запрос.Выполнить();
	ОписаниеФильтра = ЗарплатаКадрыОбщиеНаборыДанных.ОписаниеФильтраДляСоздатьВТИмяРегистра(
		"ВТИзмеренияДатыДляПолученияУсловийИсполнительныхДокументов", "ИсполнительныйДокумент");
