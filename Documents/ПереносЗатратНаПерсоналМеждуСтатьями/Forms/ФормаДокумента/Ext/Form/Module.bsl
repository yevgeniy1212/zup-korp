...
Функция АдресВХранилищеВыделенныхСтрок(Знач ВыделенныеСтроки, РезультатПроверки)
	...
	ИначеЕсли ЕстьСтрокиПоВыбраннойСтатье И ЕстьСтрокиПоДругимСтатьям Тогда
		РезультатПроверки = НСтр("ru = 'Перенос затрат отменен. В выбранных строках не должно быть одновременно строк, по статье заданной в документе и другим статьям финансирования.'");	
	КонецЕсли;
