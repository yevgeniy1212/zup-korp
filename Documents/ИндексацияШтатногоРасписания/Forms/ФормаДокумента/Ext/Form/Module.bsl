...
Процедура ДополнитьСтруктуруНачислениямиИПоказателями(ИдентификаторСтрокиПозиции, ПараметрыОткрытия)
	...
	Для каждого СтрокаНачислений Из Начисления Цикл
		...
		ИначеЕсли СтрокаПозиции <> Неопределено И СтрокаНачислений.Начисление = ПланыВидовРасчета.Начисления.НачислениеСевернаяНадбавка() Тогда
		...
		ИначеЕсли СтрокаПозиции <> Неопределено И СтрокаНачислений.Начисление = ПланыВидовРасчета.Начисления.НачислениеРайонныйКоэффициент() Тогда
...
Процедура ПеренестиРезультатРедактированияФОТ(ПараметрыОповещения)
	...
	Для каждого СтруктураНачисление Из ПараметрыОповещения.Начисления Цикл
		...
		ИначеЕсли СтруктураНачисление.Начисление = ПланыВидовРасчета.Начисления.НачислениеРайонныйКоэффициент() Тогда
		...
		ИначеЕсли СтруктураНачисление.Начисление = ПланыВидовРасчета.Начисления.НачислениеСевернаяНадбавка() Тогда
