...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	БлокируемыеРеквизиты.Добавить(
		"ТабличныйДокументКонтекстноеМенюГруппаСтроки;ТабличныйДокументКонтекстноеМенюГруппаСтроки");
	БлокируемыеРеквизиты.Добавить(
		"ТабличныйДокументКонтекстноеМенюДобавитьСтроку;ТабличныйДокументКонтекстноеМенюДобавитьСтроку");
	БлокируемыеРеквизиты.Добавить(
		"ТабличныйДокументКонтекстноеМенюУдалитьСтроку;ТабличныйДокументКонтекстноеМенюУдалитьСтроку");
	БлокируемыеРеквизиты.Добавить(
		"ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюГруппаСтроки;ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюГруппаСтроки");
	БлокируемыеРеквизиты.Добавить(
		"ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюДобавитьСтроку;ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюДобавитьСтроку");
	БлокируемыеРеквизиты.Добавить(
		"ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюУдалитьСтроку;ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюУдалитьСтроку");
	БлокируемыеРеквизиты.Добавить(
		"ТабличныйДокументКонтекстноеМенюДобавитьСтрокуКопированием;ТабличныйДокументКонтекстноеМенюДобавитьСтрокуКопированием");
	БлокируемыеРеквизиты.Добавить(
		"ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюДобавитьСтрокуКопированием;ПолеТабличногоДокументаФормаОтчетаКонтекстноеМенюДобавитьСтрокуКопированием");
	БлокируемыеРеквизиты.Добавить(
		"РазделыОтчетаКонтекстноеМенюКнопкаДобавитьСтраницу;РазделыОтчетаКонтекстноеМенюКнопкаДобавитьСтраницу");
	БлокируемыеРеквизиты.Добавить(
		"РазделыОтчетаКонтекстноеМенюКнопкаУдалитьСтраницу;РазделыОтчетаКонтекстноеМенюКнопкаУдалитьСтраницу");
	БлокируемыеРеквизиты.Добавить(
		"РазделыОтчетаКонтекстноеМенюДобавитьСтраницу;РазделыОтчетаКонтекстноеМенюДобавитьСтраницу");
	БлокируемыеРеквизиты.Добавить(
		"РазделыОтчетаКонтекстноеМенюУдалитьСтраницу;РазделыОтчетаКонтекстноеМенюУдалитьСтраницу");
...
// Обработчик обновления БРО 1.2.1.75
Процедура ИзменитьНаименованияДекларацийПоФСРАР2021кв1(Параметры = Неопределено) Экспорт
		
	ИзменитьНаименованиеРеглОтчета("Прил. 01: Производство и оборот этилового спирта",
						 "(до 2021 г.) Прил. 01: Производство и оборот этилового спирта");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 02: Использование этилового спирта",
						 "(до 2021 г.) Прил. 02: Использование этилового спирта");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 03: Производство и оборот алкогольной и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 03: Производство и оборот алкогольной и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 04: Использование алкогольной и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 04: Использование алкогольной и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 05: Оборот этилового спирта, алкогольной и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 05: Оборот этилового спирта, алкогольной и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 06: Поставка этилового спирта, алкогольной и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 06: Поставка этилового спирта, алкогольной и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 07: Закупка этилового спирта, алкогольной и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 07: Закупка этилового спирта, алкогольной и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 08: Объем перевозки этилового спирта, алкогольной и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 08: Объем перевозки этилового спирта, алкогольной и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 09: Перевозка этилового спирта, алкогольной и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 09: Перевозка этилового спирта, алкогольной и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 10: Использование мощностей по производству этилового спирта и алкогольной продукции",
						 "(до 2021 г.) Прил. 10: Использование мощностей по производству этилового спирта и алкогольной продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 11: Розничная продажа алкогольной (за исключением пива и пивных напитков) и спиртосодержащей продукции",
						 "(до 2021 г.) Прил. 11: Розничная продажа алкогольной (за исключением пива и пивных напитков) и спиртосодержащей продукции");
	
	ИзменитьНаименованиеРеглОтчета("Прил. 12: Розничная продажа пива и пивных напитков",
						 "(до 2021 г.) Прил. 12: Розничная продажа пива и пивных напитков");
	
	
	ИзменитьНаименованиеРеглОтчета("Заявление о представлении корректирующих деклараций в ФСРАР",
						 "Прил.11: заявление о представлении корректирующих деклараций в ФСРАР");
	
	ИзменитьНаименованиеРеглОтчета("Объем производства и поставки фармацевтической субстанции спирта этилового",
						 "(до 2021 г.) Объем производства и поставки фармацевтической субстанции спирта этилового");
	
	ИзменитьНаименованиеРеглОтчета("Объем использования для собственных нужд фармацевтической субстанции спирта этилового",
						 "(до 2021 г.) Объем использования для собственных нужд фармацевтической субстанции спирта этилового");
	
	ИзменитьНаименованиеРеглОтчета("Объем поставки фармацевтической субстанции спирта этилового",
						 "(до 2021 г.) Объем поставки фармацевтической субстанции спирта этилового");
