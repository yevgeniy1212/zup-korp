...
Функция ВыборкаПоШапкеДокумента(МассивСсылок) Экспорт
	...
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Номер КАК Номер,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Дата КАК Дата,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.НалоговыйПериод КАК НалоговыйПериод,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Организация КАК Организация,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.ИдентификаторФайла КАК ИдентификаторФайла,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.КодИФНС КАК КодИФНС,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Ответственный КАК Ответственный,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Комментарий КАК Комментарий,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Руководитель КАК Руководитель,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.КоличествоПодтверждающихДокументов КАК КоличествоПодтверждающихДокументов,
	...
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Организация.ИНН КАК ОрганизацияИНН,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Организация.Наименование КАК ОрганизацияНаименование,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.Телефон КАК Телефон,
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ.РегистрацияВНалоговомОргане КАК РегистрацияВНалоговомОргане
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛСотрудники.Ссылка КАК Ссылка,
	...
	|	ДанныеДокументов.ГоловнаяОрганизация КАК ГоловнаяОрганизация,
	|	ВЫБОР
	|		КОГДА НЕ ДанныеДокументов.ЭтоЮрЛицо
	...
	|	ДанныеДокументов.ОрганизацияИНН КАК ОрганизацияИНН,
	|	ЕСТЬNULL(ВЫБОР
	|			КОГДА ДанныеДокументов.РегистрацияВНалоговомОргане = ЗНАЧЕНИЕ(Справочник.РегистрацииВНалоговомОргане.ПустаяСсылка)
	|				ТОГДА СведенияОбОрганизациях.КПП
	|			ИНАЧЕ ДанныеДокументов.РегистрацияВНалоговомОргане.КПП
	|		КОНЕЦ, """") КАК ОрганизацияКПП,
	|	ДанныеДокументов.ЭтоЮрЛицо КАК ЭтоЮрЛицо,
	...
	|	ДанныеДокументов.КодИФНС КАК КодИФНС,
	|	ДанныеДокументов.НалоговыйПериод КАК НалоговыйПериод,
	|	ДанныеДокументов.КоличествоПодтверждающихДокументов КАК КоличествоПодтверждающихДокументов,
