...
Процедура ЗаполнитьУдержаниеВознагражденияПлатежногоАгента()
	...
	Объект.УдержаниеВознагражденияПлатежногоАгента = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.ИсполнительныйЛист, "УдержаниеВознагражденияПлатежногоАгента");
	
	Если Не ЗначениеЗаполнено(Объект.УдержаниеВознагражденияПлатежногоАгента) Тогда
