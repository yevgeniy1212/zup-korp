...
Функция СформироватьВыходнойФайл(Ссылка)
	...
	Если ВыборкаПоШапкеДокумента.ОтчетныйПериод >= Дата(2023, 1, 1) Тогда 
		Возврат СформироватьВыходнойФайлЕФС1(СписокДокументов, ВыборкаПоШапкеДокумента);
	КонецЕсли;
...
Функция СформироватьВыходнойФайлЕФС1(СписокДокументов, ВыборкаПоШапкеДокумента)
	...
	Возврат ПерсонифицированныйУчет.СформироватьВыходнойФайлЕФС1(РазделыЕФС1, ВыборкаПоШапкеДокумента, , , ВыборкаПоДаннымДНП);
...
Функция ПечатнаяФормаЕФС_1(МассивОбъектов, ОбъектыПечати)
	...
	ВыборкаПоШапкеДокумента = ПерсонифицированныйУчет.ЗапросПоШапкеДляПечатиОДВ_1(МассивОбъектов, "ОписьОДВ_1").Выбрать();
	ВыборкаПоДаннымДНП = ПерсонифицированныйУчет.ЗапросПоДаннымДосрочногоНазначенияПенсииОДВ_1(МассивОбъектов, "ОписьОДВ_1").Выбрать();
	
	РазделыЕФС1 = ПерсонифицированныйУчет.СписокРазделовЕФС1();
	РазделыЕФС1.ДНП = Истина;
	
	Возврат ПерсонифицированныйУчет.ПечатнаяФормаЕФС_1(ОбъектыПечати, РазделыЕФС1, ВыборкаПоШапкеДокумента, , , ВыборкаПоДаннымДНП);
