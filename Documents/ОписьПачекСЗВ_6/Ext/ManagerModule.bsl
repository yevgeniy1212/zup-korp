...
Функция СформироватьПечатнуюФормуАДВ6_2(ОписьСсылка, ОбъектыПечати) Экспорт
	
	ВыборкаПоШапкеДокумента = СформироватьЗапросПоШапкеДокумента(ОписьСсылка).Выбрать();
	ВыборкаПоШапкеДокумента.Следующий();
	...
	ВыборкаПоПачкам = СформироватьЗапросПоПачкам(ОписьСсылка).Выбрать();
	...
	УправлениеПечатью.ЗадатьОбластьПечатиДокумента(ДокументРезультат, 1, ОбъектыПечати, ОписьСсылка);
