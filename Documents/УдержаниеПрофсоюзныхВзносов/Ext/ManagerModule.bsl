...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ТолькоДокументыОснования") И Параметры.ТолькоДокументыОснования Тогда
		Параметры.Отбор.Вставить("ДокументОснование", ОбщегоНазначения.ПредопределенныйЭлемент("Документ.УдержаниеПрофсоюзныхВзносов.ПустаяСсылка"));
...
Функция ОписаниеСоставаОбъекта() Экспорт
	...
	МетаданныеДокумента = Метаданные.Документы.УдержаниеПрофсоюзныхВзносов;
