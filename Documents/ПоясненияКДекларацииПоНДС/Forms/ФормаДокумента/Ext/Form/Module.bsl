...
Функция КоличествоОтобранныхСтрок(Имя)
    ...
    Для Каждого СтрокаТаблицыФормы Из Таблица Цикл
        ...
        Если Элемент.ПроверитьСтроку(ИдентификаторСтроки) = Истина Тогда
	...
	Для каждого Имя Из ТЧ Цикл
		...
		Иначе
			...
			Для Каждого СтрокаТаблицыФормы Из Таблица Цикл
				...
				ИдентификаторСтроки = СтрокаТаблицыФормы.ПолучитьИдентификатор();
		        Если ТолькоОтобранные И Элемент.ПроверитьСтроку(ИдентификаторСтроки) = Истина ИЛИ НЕ ТолькоОтобранные Тогда
