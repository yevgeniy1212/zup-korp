	...
	Пока ГруппировкаПоДокументу.Следующий() Цикл
		...
		Пока ГруппировкаПоСотрудникам.Следующий() Цикл
			...
			Если ДанныеФизическогоЛица.Количество() > 0 Тогда
				...
				ФизическиеЛицаЗарплатаКадры.Просклонять(ДанныеФизическогоЛица[0].ФИОПолные, 2, ФамилияИО, ДанныеФизическогоЛица[0].Пол, ДанныеФизическогоЛица[0].ФизическоеЛицо);
