...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Сотрудник") И ТипЗнч(Параметры.Отбор.Сотрудник) = Тип("СправочникСсылка.Сотрудники") Тогда
		Параметры.Отбор.Вставить("ОсновнойСотрудник", Параметры.Отбор.Сотрудник);
