...
Функция ДанныеПоНДФЛ(Сотрудники = Неопределено)
	...
	|КатегорияДохода, КодВычетаЛичный";
	
	СтрокаРесурсов = УчетНДФЛ.РассчитываемыеРесурсыПоОсновнойСтавке() 
		+ ", НалогПоСтавке09, НалогПоСтавке35, ЗачтеноАвансовыхПлатежейПоСтавке13, ЗачтеноАвансовыхПлатежейСПревышенияПоСтавке13, ЗачтеноАвансовыхПлатежейПоСтавке35";
