...
// 				 
// Параметры:
//  ДокументОбъект - ДокументОбъект.ВосстановлениеВДолжности, ДанныеФормыСтруктура - объект или данные формы, 
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	Если Пользователи.РолиДоступны("ДобавлениеИзменениеДанныхДляНачисленияЗарплаты,ЧтениеДанныхДляНачисленияЗарплаты", , Ложь) Тогда
		...
		КомандаПечати.Обработчик = "УправлениеПечатьюБЗККлиент.ВыполнитьКомандуПечати";
		КомандаПечати.МенеджерПечати = "Документ.ВосстановлениеВДолжности";
		КомандаПечати.Идентификатор = "ПФ_MXL_ПриказОВосстановленииНаРаботе_ПоПравиламВеденияДО";
		КомандаПечати.Представление = НСтр("ru = 'Приказ о восстановлении на работе (По утвержденным правилам ДО)'");
		КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
		// ЗУПК
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	// ЗУПК
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ПриказОВосстановленииНаРаботе_ПоПравиламВеденияДО") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ПФ_MXL_ПриказОВосстановленииНаРаботе_ПоПравиламВеденияДО",
			НСтр("ru = 'Приказ о восстановлении на работе'"), ПечатьПриказаПоПравиламВеденияДО(МассивОбъектов, ОбъектыПечати), ,
			"Документ.ВосстановлениеВДолжности.ПФ_MXL_ПриказОВосстановленииНаРаботе_ПоПравиламВеденияДО");
	КонецЕсли;
	// ЗУПК
...
Функция ПечатьПриказаПоПравиламВеденияДО(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент = Новый ТабличныйДокумент;
	ТабличныйДокумент.КлючПараметровПечати = "ПФ_MXL_ПриказОВосстановленииНаРаботе_ПоПравиламВеденияДО";
	
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ВосстановлениеВДолжности.ПФ_MXL_ПриказОВосстановленииНаРаботе_ПоПравиламВеденияДО");
	...
	Пока Выборка.Следующий() Цикл
		...
		ФормированиеПечатныхФормПоПравиламВеденияДО.ЗаполнениеРеквизитовШапкиЧерезМассивОбъектов(ОбластьШапка, МассивОбъектов, "ВосстановлениеВДолжности", Выборка.НаименованиеОрганизации);
...
Функция ВыборкаДанныхДляПечатиДокументов(МассивОбъектов)
	...
	Запрос.Текст =
		...
		// ЗУПК
		|	ДанныеДокументовУвольнение.СтатьяТКРФ КАК ОснованиеУвольнения
		// ЗУПК
		|ИЗ
		|	ВТДанныеДокументовВосстановлениеВДолжности КАК ДанныеДокументовВосстановлениеВДолжности
