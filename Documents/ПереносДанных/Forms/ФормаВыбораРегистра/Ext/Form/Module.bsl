...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    // ЗУПК
	ОтключенныйФункционалЗарплатаКадры = Метаданные.ФункциональныеОпции.ОтключенныйФункционалЗарплатаКадры;
	// ЗУПК
	...
	Для Каждого Регистр Из Метаданные.Документы.ПереносДанных.Движения Цикл
		...
		Если Метаданные.РегистрыРасчета.Содержит(Регистр) Тогда
            ...
            // ЗУПК
			Если ОтключенныйФункционалЗарплатаКадры.Состав.Найти(Регистр) = Неопределено 
