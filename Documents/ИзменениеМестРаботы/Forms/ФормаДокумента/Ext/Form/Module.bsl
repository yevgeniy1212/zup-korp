...
Процедура ДополнитьСтруктуруНачислениямиИПоказателями(ПараметрыОткрытия, ТекущиеДанные)
	...
	Для Каждого СтрокаНачислений Из ТаблицаНачислений Цикл
		...
		Если СтрокаНачислений.ИдентификаторСтрокиВидаРасчета = 0 Тогда
		...
		Если ИнфоОВидеРасчета.Рассчитывается Тогда
			...
			Для каждого ОписаниеПоказателя Из ИнфоОВидеРасчета.Показатели Цикл
				...
				Если ОписаниеПоказателя.ЗапрашиватьПриВводе Тогда
					...
					СтруктураПоказателя.ИдентификаторСтрокиВидаРасчета = СтруктураНачисления.ИдентификаторСтрокиВидаРасчета;
					
					Отбор = Новый Структура("Показатель,ИдентификаторСтрокиВидаРасчета,ДокументОснование",
						СтруктураПоказателя.Показатель, СтрокаНачислений.ИдентификаторСтрокиВидаРасчета, СтруктураНачисления.ДокументОснование);
					...
					Отбор.Удалить("ИдентификаторСтрокиВидаРасчета");
