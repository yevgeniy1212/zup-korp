...
Процедура УстановитьПредставлениеАдресов()
	...
	КонтактнаяИнформацияБЗК.ОбновитьПолеВводаАдреса(ЭтотОбъект, "Адрес", Объект.Адрес);
	КонтактнаяИнформацияБЗК.ОбновитьПолеВводаАдреса(ЭтотОбъект, "АдресЗарубежом", Объект.АдресЗарубежом);
