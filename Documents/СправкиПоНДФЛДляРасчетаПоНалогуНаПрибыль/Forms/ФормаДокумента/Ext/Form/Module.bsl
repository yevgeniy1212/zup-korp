...
Процедура УстановитьПредставлениеАдресов(ДанныеСправок)
	...
	Для Каждого ДанныеСправкиПоСотруднику Из ДанныеСправок Цикл
		...
		Если Не ПустаяСтрока(ДанныеСправкиПоСотруднику.Адрес) Тогда
			ДанныеСправкиПоСотруднику.АдресПредставление = УправлениеКонтактнойИнформацией.ПредставлениеКонтактнойИнформации(
				ДанныеСправкиПоСотруднику.Адрес);
		Иначе
		...
		Если Не ПустаяСтрока(ДанныеСправкиПоСотруднику.АдресЗарубежом) Тогда
			ДанныеСправкиПоСотруднику.АдресЗарубежомПредставление = УправлениеКонтактнойИнформацией.ПредставлениеКонтактнойИнформации(
				ДанныеСправкиПоСотруднику.АдресЗарубежом);
		Иначе
