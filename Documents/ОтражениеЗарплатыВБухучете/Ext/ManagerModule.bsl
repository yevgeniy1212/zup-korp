...
Процедура ОчиститьПоляРезервовПоОплатеТруда(ПараметрыОбновления = Неопределено) Экспорт
	...
	ИмяТаблицы = "Документ.ОтражениеЗарплатыВБухучете";
	ОтражениеЗарплатыВБухучетеРасширенный.ОчиститьПоляРезервовПоОплатеТрудаВДокументах(ИмяТаблицы, ПараметрыОбновления);
