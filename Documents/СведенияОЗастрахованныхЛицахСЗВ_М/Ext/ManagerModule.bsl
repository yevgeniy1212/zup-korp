...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт	
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, ПерсонифицированныйУчет.ИдентификаторПечатнойФормыФормаСЗВМ()) Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, ПерсонифицированныйУчет.ИдентификаторПечатнойФормыФормаСЗВМ(),
			"Форма СЗВ-М'", СформироватьПечатнуюФормуСЗВ_М(МассивОбъектов, ОбъектыПечати));
	КонецЕсли;
...
Функция ДанныеДляЗаполнения(ДанныеОбъекта) Экспорт
	...
	Если НЕ УчетСтраховыхВзносов.ОрганизацияОтчитываетсяПоВзносамСамостоятельно(ДанныеОбъекта.Организация, ДанныеОбъекта.ОтчетныйПериод) Тогда
...
Процедура СоздатьВТФизическиеЛицаОрганизации(МенеджерВременныхТаблиц, ДанныеОбъекта, СписокФизическихЛиц = Неопределено) Экспорт 
	...
	Организации = УчетСтраховыхВзносов.ОрганизацииДляКонсолидацииОтчетовПоВзносам(ДанныеОбъекта.Организация, ДанныеОбъекта.ОтчетныйПериод);
	...
	КадровыеДанные = ПараметрыПолученияСотрудников.КадровыеДанные + ", ЯвляетсяОпекуномПенсионером";
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ФизическиеЛицаОрганизацииПредварительно.ФизическоеЛицо КАК ФизическоеЛицо,
	|	ФизическиеЛицаОрганизацииПредварительно.ЯвляетсяПрокурором КАК ЯвляетсяПрокурором,
	|	ФизическиеЛицаОрганизацииПредварительно.ЯвляетсяВоеннослужащим КАК ЯвляетсяВоеннослужащим,
	|	ФизическиеЛицаОрганизацииПредварительно.РаботаетВСтуденческомОтряде КАК РаботаетВСтуденческомОтряде,
	|	ФизическиеЛицаОрганизацииПредварительно.СтраховойНомерПФР КАК СтраховойНомерПФР,
	|	ВЫБОР
	...
	|				И (НЕ ФизическиеЛицаОрганизацииПредварительно.ЯвляетсяОпекуномПенсионером
	|					ИЛИ КоличествоТиповДокументаОснования.КоличествоТипов > 1)
	...
	|		ПО ФизическиеЛицаОрганизацииПредварительно.ФизическоеЛицо = КоличествоТиповДокументаОснования.ФизическоеЛицо
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ВТФизическиеЛицаОрганизацииКоличествоТиповДокументаОснования
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ВТФизическиеЛицаОрганизацииРазличныеТипыДокументаОснования"; 
...
Функция СформироватьВыходнойФайл(Ссылка) 
	...
	Если ВыборкаПоРаботникиОрганизации.Количество() > 0 Тогда
		...
		Пока ВыборкаПоРаботникиОрганизации.Следующий()	Цикл
			...
			ПерсонифицированныйУчет.УстановитьВыводВФайлСвойстваЗначенияЭлемента(НаборЗаписейЗЛ.ФИО, "УТ__Фамилия");
			ПерсонифицированныйУчет.УстановитьВыводВФайлСвойстваЗначенияЭлемента(НаборЗаписейЗЛ.ФИО, "УТ__Имя");
			ПерсонифицированныйУчет.УстановитьВыводВФайлСвойстваЗначенияЭлемента(НаборЗаписейЗЛ.ФИО, "УТ__Отчество");
