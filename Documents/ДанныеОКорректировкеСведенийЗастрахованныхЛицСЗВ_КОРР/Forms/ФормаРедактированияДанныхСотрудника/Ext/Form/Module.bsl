...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьПараметрыВыбораКатегорииЗастрахованногоЛица();
...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ЭтоЕФС1 = ПерсонифицированныйУчетКлиентСервер.ЭтоФормаЕФС1(ОтчетныйГод);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДатаРождения", "Видимость", ЭтоЕФС1);
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЗаписиОСтажеРайонныйКоэффициент", "Видимость", ЭтоЕФС1);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЗаписиОСтажеРайонныйКоэффициентЗаголовок", "Видимость", ЭтоЕФС1);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЗаписиОСтажеСпецоценка", "Видимость", ЭтоЕФС1);
...
Функция ОписаниеКолонокЗаголовковТаблицыЗаписиОСтаже()
	...
	ОписаниеЗаголовка = ПерсонифицированныйУчетКлиентСервер.СтруктураОписанияКолонокЗаголовков();
	ОписаниеЗаголовка.ПолеТаблицы = "ЗаписиОСтажеНомерРабочегоМеста";
	ОписаниеЗаголовка.Заголовок = "Номер";
	
	ОписаниеЗаголовковКолонок.Добавить(ОписаниеЗаголовка);
	
	ОписаниеЗаголовка = ПерсонифицированныйУчетКлиентСервер.СтруктураОписанияКолонокЗаголовков();
	ОписаниеЗаголовка.ПолеТаблицы = "ЗаписиОСтажеКлассПодклассУсловийТруда";
	ОписаниеЗаголовка.Заголовок = "Класс";
	
	ОписаниеЗаголовковКолонок.Добавить(ОписаниеЗаголовка);
	
	ОписаниеЗаголовка = ПерсонифицированныйУчетКлиентСервер.СтруктураОписанияКолонокЗаголовков();
	ОписаниеЗаголовка.ПолеТаблицы = "ЗаписиОСтажеРайонныйКоэффициент";
	ОписаниеЗаголовка.Заголовок = "Коэф.";
...
&НаСервере
Процедура УстановитьПараметрыВыбораКатегорииЗастрахованногоЛица()
	
	ПерсонифицированныйУчет.УстановитьПараметрыВыбораКатегорииЗастрахованногоЛица(Элементы, "КатегорияЗастрахованныхЛиц", Период); 
