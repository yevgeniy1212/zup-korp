...
Процедура ПриОткрытии(Отказ)
	...
	// ЗУПК
	ЗарплатаКадрыКлиентЗУПК.УстановитьВидимостьКомандыСоздатьВедомостиПрочихДоходов(ЭтотОбъект);
	ЗарплатаКадрыКлиентЗУПК.УстановитьВидимостьКомандыСоздатьВедомостиНаВыплатуЗарплаты(ЭтотОбъект);
	// ЗУПК
...
Процедура Подключаемый_НалогиВзносыОтчисленияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	УчетНалоговВзносовОтчисленийКлиентРасширенный.ОткрытьФормуРасчетаНалогаВзносаОтчисления(
			Объект, ЭтаФорма, ДополнительныеПараметрыНВО, ОписаниеДокумента(ЭтаФорма), Ложь);
...
Процедура ДополнитьФорму(ОтложенноеИзменение = Неопределено, КонтролируемыеПоля = Неопределено, ОписаниеПанелиВычеты = Неопределено, ОписаниеКлючевыхРеквизитов = Неопределено, ТаблицыОчищаемыеПриИзменении = Неопределено)
	...
	Иначе
		...
		// ЗУПК
		РасчетЗарплатыРасширенныйФормы.ДокументыВыполненияНачисленийДополнитьФорму(
			// добавлять элементы формы (команды отмены исправлений) не нужно.
			ЭтотОбъект, ОписаниеТаблицыНалогиВзносыОтчисления(), "", "НалогиВзносыОтчисленияАвтоКоманды" , , КонтролируемыеПоля, ДобавлятьЭлементыФормы, ДобавлятьРеквизитыФормы, ОтложенноеИзменение, Объект.Ссылка);
		// ЗУПК
...
Процедура РассчитатьСотрудникаНаСервере(Сотрудник, ОписаниеТаблицы = Неопределено, РассчитатьИтоги = Истина)
	...
	// ЗУПК
	ЗарплатаКадрыРасширенный.ВводНачисленийЗаполнитьВторичныеДанныеПоказателей(ЭтаФорма, МассивОписанийТаблицФормы(),Отбор.СотрудникиКРасчету);
	// ЗУПК
...
Процедура ДанныеФормыВДанныеМенеджераРасчета(МенеджерРасчета, Отбор, ПозицииВставки)
	...
	// ЗУПК
	УчетНалоговВзносовОтчисленийРасширенный.НалогиВзносыОтчисленияВДанныеМенеджераРасчета(Объект.НалогиВзносыОтчисления, Объект.ВычетыИПН, Объект.ДоходыНеПодлежащиеНалогообложению, МенеджерРасчета, Отбор, ПозицииВставки);
	// ЗУПК
...
Процедура ЗаполнитьНастройкиМенеджераРасчета(СотрудникиФизическиеЛица, МенеджерРасчета)
	...
	// ЗУПК
	МенеджерРасчета.НастройкиРасчета.РассчитыватьНДФЛ = ПолучитьФункциональнуюОпцию("ОтключенныйФункционалЗарплатаКадры");
	...
	МенеджерРасчета.НастройкиНДФЛ.ДатаВыплаты = Объект.Дата;
...
Функция РезультатЗаполненияВДлительнойОперации()
	...
	// ЗУПК - передаем порядок выплаты, для корректного расчета налогов
	СтруктураПараметров.ПорядокВыплаты 		= Объект.ПорядокВыплаты;
	// ЗУПК
...
Функция ОписаниеТаблицыНачисленийПоДоговорам()
	...
	Иначе
		Описание.РаспределениеРезультатовЗависимыеТаблицы = "Удержания,КорректировкиВыплаты";
	КонецЕсли;
	// ЗУПК
...
Функция УдалитьДанныеСотрудникаНаСервере(СотрудникФизическоеЛицо)
	...
	// ЗУПК
	ИменаТаблиц.Добавить("ДоходыНеПодлежащиеНалогообложению");
	// ЗУПК
...
Функция КлючевыеРеквизитыТаблицыОчищаемыеПриИзменении() 
	...
	// ЗУПК
	УчетНалоговВзносовОтчисленийРасширенныйКлиентСервер.ДополнитьКлючевыеРеквизитыТаблицыОчищаемыеПриИзменении(Массив, Ложь);
	// ЗУПК
