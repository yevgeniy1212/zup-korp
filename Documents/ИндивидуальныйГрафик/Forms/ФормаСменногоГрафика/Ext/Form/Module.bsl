...
Процедура ДобавитьДанныеИндивидуальногоГрафикаПоСотрудникам(СписокСотрудников)
	...
	Для Каждого СтрокаДобавляемыхДанных Из ДобавляемыеДанные.ДанныеОВремени Цикл
		СтрокаДанныхИндивидуальногоГрафика = Объект.ДанныеОВремени.Добавить();
		ЗаполнитьЗначенияСвойств(СтрокаДанныхИндивидуальногоГрафика, СтрокаДобавляемыхДанных);
		
		ДобавленныеСтрокиДанных.Добавить(СтрокаДанныхИндивидуальногоГрафика);
	КонецЦикла;	
...
&НаКлиенте
Процедура ПриУдаленииСтрокТаблицыПредставления(ИдентификаторыСтрокТаблицыПредставления)
	Для Каждого ИдентификаторСтрокиТаблицыФормы Из ИдентификаторыСтрокТаблицыПредставления Цикл
		СтрокаТаблицыПредставления = ПредставлениеДанныхСменногоГрафика.НайтиПоИдентификатору(ИдентификаторСтрокиТаблицыФормы);
		Если СтрокаТаблицыПредставления <> Неопределено Тогда 
