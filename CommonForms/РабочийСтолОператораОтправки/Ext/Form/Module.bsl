...
Процедура ВойтиВВыбраннуюОбласть(Команда = Неопределено)
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТаблицаФормыОбновить(Элементы.ОтправкиОтчетности);
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТаблицаФормыОбновить(Элементы.СобытияОтправкиОтчетности);
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТаблицаФормыОбновить(Элементы.РегистрацииВИФНС);
