...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует(
		"ЗарплатаКадрыКорпоративнаяПодсистемы.ИнтеграцияРекрутинговыхСайтов.ЗагрузкаКандидатовИзИнтернета") Тогда
		МодульЗагрузкаКандидатовИзИнтернетаФормы = ОбщегоНазначения.ОбщийМодуль("ЗагрузкаКандидатовИзИнтернетаФормы");
		МодульЗагрузкаКандидатовИзИнтернетаФормы.ПерсональныеНастройкиПриСозданииНаСервере(ЭтотОбъект, Отказ);
	КонецЕсли;
...
Процедура ПерсональнаяНастройкаДоступаКРекрутинговымСайтам(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ИнтеграцияРекрутинговыхСайтов") Тогда
		МодульРекрутинговыеСайтыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("РекрутинговыеСайтыКлиент");
		МодульРекрутинговыеСайтыКлиент.ОткрытьФормуРедактированияПараметровДоступаКСайтам(ЭтаФорма);
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Процедура НастроитьРаботуРасширенияБраузера(Команда)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ИнтеграцияРекрутинговыхСайтов.ЗагрузкаКандидатовИзИнтернета") Тогда
		МодульЗагрузкаКандидатовИзИнтернетаКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ЗагрузкаКандидатовИзИнтернетаКлиент");
		МодульЗагрузкаКандидатовИзИнтернетаКлиент.ОткрытьФормуНастройкиДоступа(ЭтотОбъект);
	КонецЕсли;
...
&НаКлиенте
Процедура ПерсональнаяНастройкаРазборРезюме(Команда)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ПодборПерсонала.РазборРезюме") Тогда
		МодульРазбораРезюме = ОбщегоНазначенияКлиент.ОбщийМодуль("РазборРезюмеКлиент");
		МодульРазбораРезюме.НачатьВыборСпособаРазбора(Ложь);
	КонецЕсли;
...
Процедура УстановитьВидимостьЭлементовФормы()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ИнтеграцияРекрутинговыхСайтов") Тогда
		МодульРекрутинговыеСайтыФормы = ОбщегоНазначения.ОбщийМодуль("РекрутинговыеСайтыФормы");
		МодульРекрутинговыеСайтыФормы.УстановитьВидимостьЭлементаФормы(Элементы.ИнтеграцияРекрутинговыхСайтов);
	КонецЕсли;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.СинхронизацияMSExchange") Тогда
		...
		МодульСинхронизацияMSExchange.УстановитьВидимостьЭлементаФормы(Элементы.СинхронизацияMSExchange);
	КонецЕсли;
