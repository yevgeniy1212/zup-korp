...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если КадровыйУчетКлиентСервер.ПредставлениеРациональногоЧисла(КоличествоСтавок, Числитель, Знаменатель) Тогда
	...
	Если Не КадровыйУчет.ПравоИзмененияКадровогоСостояния() Тогда
...
Процедура КоличествоСтавокРегулирование(Элемент, Направление, СтандартнаяОбработка)
	...
	КадровыйУчетКлиент.КоличествоСтавокРегулирование(ЭтаФорма, КоличествоСтавок, Направление, СтандартнаяОбработка);
...
Процедура РассчитатьКоличествоСтавокПоЧислителюИЗнаменателю()
	...
	ТочностьВПолеВводаКоличестваСтавок = КадровыйУчетКлиентСервер.ТочностьКоличестваСтавок(КоличествоСтавок);
...
Процедура РассчитатьЧислительИЗнаменательКоличестваСтавок()
	...
	КадровыйУчетКлиентСервер.ПредставлениеРациональногоЧисла(КоличествоСтавок, Числитель, Знаменатель);
...
Процедура УстановитьВыбранноеКоличествоСтавок(Форма)
	...
	ИначеЕсли Форма.КоличествоСтавокПредопределенное = 0 Тогда
		...
		ТочностьВПолеВводаКоличестваСтавок = КадровыйУчетКлиентСервер.ТочностьКоличестваСтавок(Форма.КоличествоСтавок);
		
	ИначеЕсли Форма.КоличествоСтавокПредопределенное <> 0 Тогда
		
		КадровыйУчетКлиентСервер.ПредставлениеРациональногоЧисла(Форма.КоличествоСтавок, Форма.Числитель, Форма.Знаменатель);
		ТочностьВПолеВводаКоличестваСтавок = 20;
