...
&НаСервере
Функция ДеревоXMLИзВременногоХранилища(Адрес)
	...
	// Прочитаем данные из созданного временного файла.
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Загрузка файлов сведений физических лиц'", ОбщегоНазначения.КодОсновногоЯзыка()), 
...
Функция ОбновитьСписокФайловНаСервере(ПомещенныеФайлы, ДобавитьВСписок = Ложь)
	...
	Для Каждого ПомещенныйФайл Из ПомещенныеФайлы Цикл
		...
		ДеревоXML = ДеревоXMLИзВременногоХранилища(ПомещенныйФайл.Хранение);
...
Процедура ДобавитьФайлСведений(ПомещенныйФайл)
	...
	Для Каждого ФайлСписка Из СписокФайлов Цикл
		...
		ДеревоXML = ДеревоXMLИзВременногоХранилища(ФайлСписка.ОписаниеПереданныхФайлов[0].Хранение);
