...
Процедура ФормироватьРезервОтпусковБУПриИзменении(Элемент)
	...
	Иначе
		...
		// ЗУПК
		НастройкиРасчетаРезервовОтпусков.КоэффициентРасчетаОплачиваемыхДнейОтпуска = 1;
		// ЗУПК
...
Процедура ПрочитатьДанные()
	...
	// ЗУПК
	Элементы.ФормироватьРезервОтпусковНУ.Видимость = ЭтоЮрЛицо И ПолучитьФункциональнуюОпцию("ОтключенныйФункционалЗарплатаКадры");
	// ЗУПК
...
Процедура ОбновитьДоступностьНастроек(Форма)
	...
	// ЗУПК
	Форма.Элементы.КоэффициентРасчетаОплачиваемыхДнейОтпуска.Доступность                 = Форма.НастройкиРасчетаРезервовОтпусков.ФормироватьРезервОтпусковБУ;
	// ЗУПК
