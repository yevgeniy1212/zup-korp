...
#Область ОбработчикиСобытийЭлементовТаблицыФормыСписокНачислений
...
Функция ИзмененныеВидыРасчетаСтруктура()
	...
	УдаленныеВидыРасчета = ОбщегоНазначенияКлиентСервер.РазностьМассивов(МассивИсходныхВидовРасчета, ТекущиеВидыРасчета);
	ДобавленныеВидыРасчета = ОбщегоНазначенияКлиентСервер.РазностьМассивов(ТекущиеВидыРасчета, МассивИсходныхВидовРасчета);
...
Процедура ОбработатьИсправлениеСвязейНаСервере(Действие)
	...
	Иначе 
		МассивВидовРасчета = ОбщегоНазначенияКлиентСервер.РазностьМассивов(МассивВидовРасчета, УдаляемыеНачисления);
	КонецЕсли;
	ВыбранныеВидыРасчета.ЗагрузитьЗначения(МассивВидовРасчета);
