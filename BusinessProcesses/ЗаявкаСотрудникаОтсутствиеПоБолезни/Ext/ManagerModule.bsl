...
Функция ФормаВыполненияЗадачи(ЗадачаСсылка, ТочкаМаршрутаБизнесПроцесса) Экспорт
	...
	Результат.Вставить("ИмяФормы", "БизнесПроцесс.ЗаявкаСотрудникаОтсутствиеПоБолезни.Форма.Действие" + ?(ТочкаМаршрутаБизнесПроцесса.Имя = "Выполнить",
																										  "СоздатьБольничный", ТочкаМаршрутаБизнесПроцесса.Имя));
	Возврат Результат;	
КонецФункции
