...
Функция СтруктураИнициализацииЗаявки() Экспорт
	...
	СтруктураИнициализации.Вставить("ЕдиновременнаяВыплата",				Ложь);
	СтруктураИнициализации.Вставить("МатериальнаяПомощь",					Ложь);
...
Функция ПервыйЭтап() Экспорт
	Возврат Справочники.ЭтапыЗаявокСотрудников.СогласованиеКадрыОтпуск;	
КонецФункции
