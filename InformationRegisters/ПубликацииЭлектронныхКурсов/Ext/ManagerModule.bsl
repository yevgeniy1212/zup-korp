...
Процедура ПриЗаполненииНастроекОбработчиковПравилРегистрации(Настройки) Экспорт
	ЗарплатаКадрыРасширенныйСинхронизацияДанных.ДляНезависимогоРегистра(Настройки, "ЭлектронныйКурс",
			"ПодборПерсонала");
КонецПроцедуры
...
Процедура Опубликовать(ЭлектронныйКурс, ОпубликоватьБезРазрешения, ИдентификаторФормы = Неопределено) Экспорт
	...
	Попытка
		...
		// Фиксируем факт публикации, чтобы не было ложных срабатываний о том, что курс не опубликован
		
		РегистрыСведений.ИзмененныеЭлектронныеКурсы.ЗафиксироватьПубликациюКурса(ЭлектронныйКурс);
		
		// Сохраняем в базу данные опубликованного курса
		...
		Если ЗначениеЗаполнено(ПутьКОбщемуКаталогу) Тогда		
			...
			ПутьККаталогуРесурсов = ИзучениеЭлектронныхКурсовСлужебныйКлиентСервер.ПутьККаталогуРесурсовКурса(ПутьККаталогуЭлектронныйКурсов, ЭлектронныйКурс);
