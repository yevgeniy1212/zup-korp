...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ТолькоЭлектронныеДокументы", ТолькоЭлектронныеДокументы);
	...
	Если ТолькоЭлектронныеДокументы Тогда
		Элементы.Список.РежимВыделения = РежимВыделенияТаблицы.Множественный;
		Элементы.Список.МножественныйВыбор = ТолькоЭлектронныеДокументы;
	Иначе
		УстановитьОтборСписка(Список.Отбор, "Готовность", Ложь);
	КонецЕсли;
	
	Список.Параметры.УстановитьЗначениеПараметра(
		"ТолькоЭлектронныеДокументы", 
		ТолькоЭлектронныеДокументы);
...
Процедура ОтборВидДокументаФНСПриИзменении(Элемент)
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ОтборВидДокументаФНСПриИзменении(ЭтотОбъект);
...
Функция ОписаниеВыбранныхСтрок()
	...
	Для каждого ВыделеннаяСтрока Из Элементы.Список.ВыделенныеСтроки Цикл
		...
		СтруктураСвойств.Вставить("ВыбранныйДокумент", 	ВыделеннаяСтрока.Источник);
		СтруктураСвойств.Вставить("ВидДокументаФНС", 	ВыделеннаяСтрока.ВидДокументаФНС);
...
Процедура УстановитьОтборыДляРежимаВыбора()
	...
	КонтекстЭДОСервер.УстановитьОтборыДляРежимаВыбора(ЭтотОбъект); 
...
Процедура ЗаполнитьСпискиВыбора()
	...
	КонтекстЭДОСервер = ДокументооборотСКО.ПолучитьОбработкуЭДО();
	КонтекстЭДОСервер.ЗаполнитьСписокВыбораВидДокументаФНС(Элементы.ОтборВидДокументаФНС);
	КонтекстЭДОСервер.ЗаполнитьСписокВыбораНаправление(Элементы.ОтборНаправление);
...
Процедура УстановитьОтборСписка(ОтборСписка, ИмяПоля, ПравоеЗначение, ВидСравненияОтбора = Неопределено)
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.УстановитьОтборСписка(ОтборСписка, ИмяПоля, ПравоеЗначение, ВидСравненияОтбора);
...
Процедура ОтключитьОтборСписка(ОтборСписка, СтрокаЛевоеЗначение)
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ОтключитьОтборСписка(ОтборСписка, СтрокаЛевоеЗначение);
