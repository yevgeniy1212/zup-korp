...
Процедура ПриЗаполненииНастроекОбработчиковПравилРегистрации(Настройки) Экспорт
	ЗарплатаКадрыРасширенныйСинхронизацияДанных.ДляНезависимогоРегистра(Настройки, "ИмпортированныйЭлемент",
			"ПодборПерсонала");
КонецПроцедуры
...
Функция РанееИмпортированныйЭлемент(ИдентификаторПакета, ИмяЭлемента, ИдентификаторЭлемента) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	РегистрСведений.ИмпортированныеЭлементыЭлектронныхКурсов КАК ИмпортированныеЭлементы
	               |ГДЕ
...
Процедура ЗапомнитьИмпортЭлемента(ИмпортированныйЭлемент, ИдентификаторПакета, ИмяЭлемента, ИдентификаторЭлемента) Экспорт
	...
	МенеджерЗаписи = РегистрыСведений.ИмпортированныеЭлементыЭлектронныхКурсов.СоздатьМенеджерЗаписи();
