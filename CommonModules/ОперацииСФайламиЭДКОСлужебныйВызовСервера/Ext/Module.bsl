...
Функция РаспаковатьАрхив(Адрес) Экспорт
	...
	Для Каждого ИзвлеченныйФайл Из ИзвлеченныеФайлы Цикл
		...
		ХранениеРаспакованногоФайла = ?(ИзвлеченныйФайл.ЭтоФайл(),
			ПоместитьВоВременноеХранилище(Новый ДвоичныеДанные(ИзвлеченныйФайл.ПолноеИмя)), Неопределено);
		РаспакованныйФайл.Вставить("Хранение", ХранениеРаспакованногоФайла);
...
Функция ПоместитьДанныеВоВременноеХранилище(СписокДанныхИАдресов) Экспорт
	
	Результат = Новый Массив;
	
	Для каждого ДанныеИАдрес Из СписокДанныхИАдресов Цикл
		АдресРезультата = ПоместитьВоВременноеХранилище(ДанныеИАдрес.Данные, ДанныеИАдрес.Адрес);
		Результат.Добавить(АдресРезультата);
	КонецЦикла;
