...
Функция МесячныйРасчетныйПоказатель(ДатаАктуальности) Экспорт
	...
	Возврат РегистрыСведений.МесячныйРасчетныйПоказатель.ДанныеРазмераМесячногоРасчетногоПоказателя(ДатаАктуальности)["Размер"];
...
Функция МесячныйРасчетныйПоказательДляПособийИныхСоциальныхВыплат(ДатаАктуальности) Экспорт
	...
	Возврат РегистрыСведений.МесячныйРасчетныйПоказатель.ДанныеРазмераДляПособийИныхСоциальныхВыплат(ДатаАктуальности)["РазмерДляПособийИныхСоциальныхВыплат"];
