...
Процедура ПриЗакрытииФормыЭлектронногоКурса(ЭлектронныйКурс, Контекст, Учащийся, Данные) Экспорт
	...
	ЭлектронноеТестированиеКандидатов.ПриЗакрытииФормыЭлектронногоКурса(ЭлектронныйКурс, Контекст, Учащийся, Данные.ИзучениеЭлектронногоКурса, СтандартнаяОбработка);
...
Процедура ПриСозданииФормыЭлектронногоКурса(ПараметрыФормы, СтандартнаяОбработка) Экспорт
	...
	ПараметрыФормы.ИмяОповещенияПриЗакрытии = "ЗакрытиеФормыЭлектронногоКурса";
	
КонецПроцедуры

Процедура ПриОпределенииСоответствияВерсийОбработчиковОбновлений(СоответствиеВерсий) Экспорт
	
	Если СоответствиеВерсий = Неопределено Тогда
	...
	СоответствиеВерсий.Вставить("4.0.1.21", "3.1.19.3");
	СоответствиеВерсий.Вставить("4.0.1.26", "3.1.19.3");
	СоответствиеВерсий.Вставить("4.0.1.34", "3.1.19.77");
