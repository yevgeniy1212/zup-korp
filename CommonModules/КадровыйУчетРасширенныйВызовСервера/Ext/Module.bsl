...
Функция ПродолжительностьСтажа(Знач ОписаниеСтажа, Знач ДатаАктуальности) Экспорт
	...
	Если ДатаАктуальности = ОписаниеСтажа.ДатаОтсчета
		Или Не ЗначениеЗаполнено(ОписаниеСтажа.ДатаОтсчета)
		Или ОписаниеСтажа.Прерван Тогда
		
		ПродолжительностьСтажа = ЗарплатаКадрыРасширенныйКлиентСервер.ПродолжительностьСтажаПоДаннымОСтаже(
			ОписаниеСтажа.Лет, ОписаниеСтажа.Месяцев, ОписаниеСтажа.Дней);
		
	ИначеЕсли ДатаАктуальности > ОписаниеСтажа.ДатаОтсчета Тогда
