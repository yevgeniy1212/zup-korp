...
Функция АвторизованныеУдостоверяющиеЦентры() Экспорт
	...
	УдостоверяющиеЦентры.Добавить(
		УдостоверяющийЦентр(
			...
			"Федеральное казначейство|Корневой тестовый УЦ ФК ГОСТ-2012|Подчинённый тестовый УЦ ФК ГОСТ-2012|Казначейство России"));
	...
	УдостоверяющиеЦентры.Добавить(
		УдостоверяющийЦентр(
			...
			"ЗАО «Национальный удостоверяющий центр»|ЗАО ""Национальный удостоверяющий центр""|БАНК РОССИИ|Банк России|Центральный банк Российской Федерации"));
