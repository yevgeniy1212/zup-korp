...
Функция РеглОтчетыИсполнителиТребований() Экспорт
	...
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2022_П2Год",                  "РегламентированныйОтчетСтатистикаФормаП2");
	...
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2022_1ДАПКвартал",            "РегламентированныйОтчетСтатистикаФорма1ДАП");
	...
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2022_7Травматизм",            "РегламентированныйОтчетСтатистикаФорма7ТравматизмПриложение");
	...
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2019_1-НАНО",
								   "РегламентированныйОтчетСтатистикаФорма1НАНО");
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2017_1-вывоз",
								   "РегламентированныйОтчетСтатистикаФорма1Вывоз");
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2022_1СОНКОР",
								   "РегламентированныйОтчетСтатистикаФорма1СОНКОР");
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2023_7ТравматизмПриложение",
								   "РегламентированныйОтчетСтатистикаФорма7ТравматизмПриложение");
	ИсполнителиТребований.Вставить("СтатистическаяОтчетность.2023_1ФЦП",
