...
Функция ВыгрузитьРегламентированныйОтчет(
		...
		Если ТипЗнч(ДанныеВыгрузки) = Тип("Массив") Тогда
			Для Каждого ЭлементВыгрузки Из ДанныеВыгрузки Цикл
				...
				Если ТипЗнч(ЭлементВыгрузки) = Тип("Структура")
					...
					И (Лев(ЭлементВыгрузки.ТипФайлаВыгрузки, 4) = "НДС2"
					И Прав(ЭлементВыгрузки.ТипФайлаВыгрузки, 10) = "Разделы1_7"
					ИЛИ ЭлементВыгрузки.ТипФайлаВыгрузки = "ЕНВД"
					ИЛИ ЭлементВыгрузки.ТипФайлаВыгрузки = "РеестрАкцизыВычетыДенатурированныйЭтиловыйСпирт"
					ИЛИ ЭлементВыгрузки.ТипФайлаВыгрузки = "РеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло"
					ИЛИ ЭлементВыгрузки.ТипФайлаВыгрузки = "РеестрАкцизыВычетыВиноград") Тогда
	...
	Иначе
		...
		СвойстваФайлаВыгрузки = ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ВыгрузитьДокументСервер(
			Отчет,
