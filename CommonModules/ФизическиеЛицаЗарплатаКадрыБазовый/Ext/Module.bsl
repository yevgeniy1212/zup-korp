...
Процедура ЗаписатьСвязанныеОбъекты(ФизическоеЛицо) Экспорт
	...
	Если СвязанныеОбъекты.Свойство("ФИО") Тогда
		Для Каждого ДанныеФИО Из СвязанныеОбъекты.ФИО Цикл
			РегистрыСведений.ФИОФизическихЛиц.ДобавитьФИОФизическогоЛица(ФизическоеЛицо.Ссылка, ДанныеФИО.ФИО,
				ДанныеФИО.Период);
		КонецЦикла;
	КонецЕсли;

	Если СвязанныеОбъекты.Свойство("Гражданство") Тогда
		Для Каждого ДанныеОГражданстве Из СвязанныеОбъекты.Гражданство Цикл
			РегистрыСведений.ГражданствоФизическихЛиц.ДобавитьГражданствоФизическогоЛица(ФизическоеЛицо.Ссылка,
				ДанныеОГражданстве.Гражданство, ДанныеОГражданстве.Период);
		КонецЦикла;
	КонецЕсли;
