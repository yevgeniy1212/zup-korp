...
Функция СоответствиеИдентификаторовСтрокОтчетностиРасходовИЧисленностиВидамДолжностей(ФормаОтчетаОРасходахИЧисленности) Экспорт
	
	СоответствиеСтрокОтчетности = Новый Соответствие;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ГосударственнаяСлужба") Тогда
		Модуль = ОбщегоНазначения.ОбщийМодуль("ГосударственнаяСлужба");
		СоответствиеСтрокОтчетности = Модуль.СоответствиеИдентификаторовСтрокОтчетностиРасходовИЧисленностиВидамДолжностей(ФормаОтчетаОРасходахИЧисленности);
	КонецЕсли;
...
Функция ПолучитьСтрокуОтчетностиРасходовИЧисленностиПоВидуДолжности(ВидДолжности, ФормаОтчетаОРасходахИЧисленности) Экспорт
	
	СоответствиеСтрокОтчетности = СоответствиеИдентификаторовСтрокОтчетностиРасходовИЧисленностиВидамДолжностей(ФормаОтчетаОРасходахИЧисленности);
