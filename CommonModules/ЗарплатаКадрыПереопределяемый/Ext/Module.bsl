...
Функция СистемаНалогообложенияПоУмолчанию(Организация, Период) Экспорт
...
Функция ПолучитьКНППоВидуОперации(ВидОперации) Экспорт
	...
	Если ВидОперации = Перечисления.ВидыОперацийПлатежногоПоручения.ПеречислениеЗарплаты Тогда
		Возврат "332";
	КонецЕсли;
