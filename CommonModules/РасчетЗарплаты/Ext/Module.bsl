...
Функция ДокументНачисленияЗарплаты(МесяцНачисления, Организация, Подразделение = Неопределено, ПерваяПоловинаМесяца = Ложь) Экспорт
	...
	РасчетЗарплатыВнутренний.ПодобратьДокументНачисленияЗарплаты(ДокументСсылка, МесяцНачисления, Организация, Подразделение, ПерваяПоловинаМесяца);
...
Процедура ЗаполнитьДанныеНДФЛ(ДанныеДляПроведения, ДокументСсылка, ФизическиеЛица = Неопределено, РаспределениеУдержаний = Истина) Экспорт
	РасчетЗарплатыВнутренний.ЗаполнитьДанныеНДФЛ(ДанныеДляПроведения, ДокументСсылка, ФизическиеЛица, РаспределениеУдержаний);
КонецПроцедуры
...
//		
Процедура ЗаполнитьДокументНачисленияЗарплаты(ДанныеНачисленияЗарплаты, ПерваяПоловинаМесяца = Ложь) Экспорт
	РасчетЗарплатыВнутренний.ЗаполнитьДокументНачисленияЗарплаты(ДанныеНачисленияЗарплаты, ПерваяПоловинаМесяца);
КонецПроцедуры	
...
//		Результат
//
Функция РезультатНачисленияРасчетаЗарплаты(Организация, МесяцНачисления, Документ, Подразделение = Неопределено, Сотрудники = Неопределено, ПерваяПоловинаМесяца = Ложь) Экспорт
	Возврат РасчетЗарплатыВнутренний.РезультатНачисленияРасчетаЗарплаты(Организация, МесяцНачисления, Документ, Подразделение, Сотрудники, ПерваяПоловинаМесяца);
КонецФункции
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "РасчетЗарплаты.ДобавитьРолиПВРНачисления";
...
Процедура ДобавитьРолиПВРНачисления() Экспорт
	
	ЗаменяемыеРоли = Новый Соответствие;
	
	РасчетЗарплатыВнутренний.ДобавитьРолиПВРНачисления(ЗаменяемыеРоли);
