...
Функция РегистрацияВНалоговомОрганеОрганизации(Организация, Знач ДатаАктуальности = Неопределено) Экспорт
    ...
    // ЗУПК
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Для организации %1 на %2 не указана регистрация в налоговом органе.	
																|В карточке организации необходимо заполнить сведения о регистрации в налоговом органе.'"), 
																Организация,
																Формат(ДатаАктуальности, "ДФ='ММММ гггг'"));
...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	ЗарплатаКадрыВнутренний.ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики);
КонецПроцедуры
...
Процедура УстановитьПараметрыСеанса(ИмяПараметра, УстановленныеПараметры) Экспорт
	...
	Если ИмяПараметра = "ИсключаемыеИсточникиДанныхДатЗапретаИзмененияБЗК" Тогда
		
		РегистрыСведений.РазделыДатЗапретаИзмененияОбъектовБЗК.УстановитьПараметрСеансаИсключаемыеИсточникиДанныхДатЗапретаИзмененияБЗК();
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	ЗарплатаКадрыВнутренний.ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры);
КонецПроцедуры
...
Процедура ПриДобавленииИсключенийПоискаСсылок(ИсключенияПоискаСсылок) Экспорт
	...
	КадровыйУчет.ПриДобавленииИсключенийПоискаСсылок(ИсключенияПоискаСсылок);
КонецПроцедуры
...
Процедура ПриЗаполненииНаборовЗначенийДоступаБизнесПроцессовИЗадач(Объект, Таблица) Экспорт
	ЗарплатаКадрыВнутренний.ПриЗаполненииНаборовЗначенийДоступаБизнесПроцессовИЗадач(Объект, Таблица);
КонецПроцедуры
...
Процедура ПриЗаполненииНаборовЗначенийДоступаВзаимодействий(Объект, Таблица) Экспорт
	ЗарплатаКадрыВнутренний.ПриЗаполненииНаборовЗначенийДоступаВзаимодействий(Объект, Таблица);
КонецПроцедуры
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	РегистрыСведений.РазделыДатЗапретаИзмененияОбъектовБЗК.ПриЗаполненииРазделовДатЗапретаИзменения(Разделы);
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	РегистрыСведений.РазделыДатЗапретаИзмененияОбъектовБЗК.ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных);
...
Процедура ПередПроверкойЗапретаИзменения(Объект, ПроверкаЗапретаИзменения, УзелПроверкиЗапретаЗагрузки, ВерсияОбъекта) Экспорт
	...
	Если Не ЭтоОбъектЗарплатноКадровойБиблиотеки(МетаданныеОбъекта.ПолноеИмя()) Тогда
		Возврат;
	КонецЕсли;
	...
	Если ПроверкаЗапретаИзменения Тогда
		...
		УстановитьПривилегированныйРежим(Истина);
		Если ПараметрыСеанса.ИсключаемыеИсточникиДанныхДатЗапретаИзмененияБЗК.Получить(МетаданныеОбъекта.ПолноеИмя()) = Истина Тогда
			ПроверкаЗапретаИзменения = Ложь;
			УзелПроверкиЗапретаЗагрузки = Неопределено;
		КонецЕсли;
...
Процедура ДополнитьДанныеСубъектовПерсональныхДанных(СубъектыПерсональныхДанных, ДатаАктуальности) Экспорт 
	...
	ОбщегоНазначенияБЗККлиентСервер.УдалитьВсеВхожденияКромеТипаИзМассива(СписокФизическихЛиц,
...
// См. КалендарныеГрафикиПереопределяемый.ПриОбновленииПроизводственныхКалендарей
Процедура ПриОбновленииПроизводственныхКалендарей(УсловияОбновления) Экспорт
	ЗарплатаКадрыВнутренний.ПриОбновленииПроизводственныхКалендарей(УсловияОбновления)	
КонецПроцедуры

// См. КалендарныеГрафикиПереопределяемый.ПриОбновленииДанныхЗависимыхОтПроизводственныхКалендарей
Процедура ПриОбновленииДанныхЗависимыхОтПроизводственныхКалендарей(УсловияОбновления) Экспорт
	ЗарплатаКадрыВнутренний.ПриОбновленииДанныхЗависимыхОтПроизводственныхКалендарей(УсловияОбновления)	
КонецПроцедуры

// См. КалендарныеГрафикиПереопределяемый.ПриЗаполненииИзменяемыхОбъектовЗависимыхОтПроизводственныхКалендарей
Процедура ПриЗаполненииИзменяемыхОбъектовЗависимыхОтПроизводственныхКалендарей(ИзменяемыеОбъекты) Экспорт
	ЗарплатаКадрыВнутренний.ПриЗаполненииИзменяемыхОбъектовЗависимыхОтПроизводственныхКалендарей(ИзменяемыеОбъекты)
КонецПроцедуры
...
Процедура ПриСбореПоказателейСтатистикиКонфигурации() Экспорт
	ЗарплатаКадрыВнутренний.ПриСбореПоказателейСтатистикиКонфигурации();
КонецПроцедуры
...
Процедура ПриПолученииКомандПечати(КомандыПечати, ИмяОбъекта) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПолученииКомандПечати(КомандыПечати, ИмяОбъекта);
...
Процедура ПриОпределенииОбъектовПечатнойФормы(ОбъектыПечатнойФормы, ИдентификаторПечатнойФормы, ИмяМенеджераПечати, ПараметрыПечати) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОбъектовПечатнойФормы(ОбъектыПечатнойФормы, ИдентификаторПечатнойФормы, ИмяМенеджераПечати, ПараметрыПечати);
...
Процедура ПриПечати(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПечати(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода);
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	РегулярнаяОтправкаСотрудников.ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений);
...
Процедура ПриПолученииСпискаШаблоновОчередиЗаданий(Шаблоны) Экспорт
	...
	КадровыйЭДО.ПриПолученииСпискаШаблоновОчередиЗаданий(Шаблоны);
	СЭДОФСС.ПриПолученииСпискаШаблоновОчередиЗаданий(Шаблоны);
	РегулярнаяОтправкаСотрудников.ПриПолученииСпискаШаблоновОчередиЗаданий(Шаблоны);
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	КадровыйЭДО.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	СЭДОФСС.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	РегулярнаяОтправкаСотрудников.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
...
Процедура ПриОпределенииСправочниковХраненияФайлов(ТипВладелецФайла, ИменаСправочников) Экспорт
	ЗарплатаКадрыВнутренний.ПриОпределенииСправочниковХраненияФайлов(ТипВладелецФайла, ИменаСправочников);
КонецПроцедуры
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	КадровыйЭДО.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	СЭДОФСС.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	РегулярнаяОтправкаСотрудников.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
...
Процедура ПриЗапретеРаботыСВнешнимиРесурсами() Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриЗапретеРаботыСВнешнимиРесурсами();
...
Процедура ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты);
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	ЗарплатаКадрыВнутренний.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления);
КонецПроцедуры
...
Процедура ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры) Экспорт
	...
	|ТелОрганизации_JSON,
	|АдрЮР_JSON";
	ПолученныеСведения = СведенияОбОрганизации(Организация, ИменаПолей);
	
	// Передача сведений об организации.
	Параметры.ЭтоИндивидуальныйПредприниматель = Не ПолученныеСведения.ЭтоЮридическоеЛицо;
	Параметры.НаименованиеСокращенное          = ПолученныеСведения.НаимЮЛСокр;
	Параметры.НаименованиеПолное               = ПолученныеСведения.НаимЮЛПол;
	Параметры.ИНН                              = ПолученныеСведения.ИННЮЛ;
	Параметры.КПП                              = ПолученныеСведения.КППЮЛ;
	Параметры.ОГРН                             = ПолученныеСведения.ОГРН;
	Параметры.РасчетныйСчет                    = ПолученныеСведения.БанкСчетНомер;
	Параметры.БИК                              = ПолученныеСведения.БанкСчетБИКБанка;
	Параметры.КорреспондентскийСчет            = ПолученныеСведения.БанкСчетКоррСчетБанка;
	Параметры.Телефон                          = ПолученныеСведения.ТелОрганизации_JSON;
	Параметры.ЮридическийАдрес                 = ПолученныеСведения.АдрЮР_JSON;
...
Процедура ПриЗаполненииРеквизитовВладельцаВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// Получение сведений об ответственных лицах организации.
	Организация = Параметры.Организация;
	Если ЗначениеЗаполнено(Организация) И ТипЗнч(Организация) = Тип("СправочникСсылка.Организации") Тогда
		
		ИменаПолей = "РукСсылка,БухСсылка,ЭтоЮридическоеЛицо,ИндивидуальныйПредприниматель";
		Сведения = СведенияОбОрганизации(Организация, ИменаПолей);
		
		Параметры.Директор         = Сведения.РукСсылка;
		Параметры.ГлавныйБухгалтер = Сведения.БухСсылка;
		
		Если Не Сведения.ЭтоЮридическоеЛицо И Не ЗначениеЗаполнено(Параметры.Сотрудник) Тогда
			Параметры.Сотрудник = Сведения.ИндивидуальныйПредприниматель;
		КонецЕсли;
	...
	// Получение сведений о физическом лице и сотруднике.
	ФизическоеЛицо = Параметры.Сотрудник;
	Если ЗначениеЗаполнено(ФизическоеЛицо) И ТипЗнч(ФизическоеЛицо) = Тип("СправочникСсылка.ФизическиеЛица") Тогда
		...
		|ТелефонРабочий,
		|ТелефонМобильный";
		Сведения = КадровыйУчет.КадровыеДанныеОсновногоСотрудникаФизическогоЛица(Организация, ФизическоеЛицо, ИменаПолей);
		
		Если Сведения <> Неопределено Тогда
			Телефон = ?(ЗначениеЗаполнено(Сведения.ТелефонРабочий), Сведения.ТелефонРабочий, Сведения.ТелефонМобильный);
			
			Параметры.Фамилия            = Сведения.Фамилия;
			Параметры.Имя                = Сведения.Имя;
			Параметры.Отчество           = Сведения.Отчество;
			Параметры.ДатаРождения       = Сведения.ДатаРождения;
			// АПК:1297-выкл Не локализуется, т.к. является частью программного интерфейса регламентированной формы РФ.
			Параметры.Пол                = ?(Сведения.Пол = Перечисления.ПолФизическогоЛица.Женский, "Женский", "Мужской");
			// АПК:1297-вкл
			Параметры.МестоРождения      = Строка(Сведения.МестоРождения);
			Параметры.Гражданство        = Сведения.Страна;
			Параметры.ИНН                = Сведения.ИНН;
			Параметры.СтраховойНомерПФР  = Сведения.СтраховойНомерПФР;
			Параметры.Должность          = Строка(Сведения.Должность);
			Параметры.Подразделение      = Строка(Сведения.Подразделение);
			Параметры.ДокументВид        = Сведения.ДокументКодМВД;
			Параметры.ДокументНомер      = СокрЛП(СокрП(Сведения.ДокументСерия) + " " + СокрЛ(Сведения.ДокументНомер));
			Параметры.ДокументКемВыдан   = Сведения.ДокументКемВыдан;
			Параметры.ДокументКодПодразделения = Сведения.ДокументКодПодразделения;
			Параметры.ДокументДатаВыдачи = Сведения.ДокументДатаВыдачи;
			Параметры.АдресРегистрации   = Сведения.АдресПоПрописке;
			Параметры.ЭлектроннаяПочта   = Сведения.EMail;
			Параметры.Телефон            = Телефон;
		КонецЕсли;
...
Процедура ПриЗаполненииРеквизитовРуководителяВЗаявленииНаСертификат(Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(Организация) И ТипЗнч(Организация) = Тип("СправочникСсылка.Организации") Тогда
		...
		Сведения = СведенияОбОрганизации(Организация, "РукСсылка, ДолжнРук");
		Если Не ЗначениеЗаполнено(Параметры.Руководитель) Тогда
			Параметры.Руководитель = Сведения.РукСсылка;
		КонецЕсли;
		Если Параметры.Руководитель = Сведения.РукСсылка Тогда
			Параметры.Должность = Строка(Сведения.ДолжнРук);
...
Процедура ПриВключенииРазделенияПоОбластямДанных() Экспорт
	ЗарплатаКадрыВнутренний.ПриВключенииРазделенияПоОбластямДанных();
КонецПроцедуры
...
Процедура УстановитьПраваПоУмолчанию(Пользователь) Экспорт
	ЗарплатаКадрыВнутренний.УстановитьПраваПоУмолчанию(Пользователь)
КонецПроцедуры
...
Процедура ПолучитьОбработчикиПоставляемыхДанных(Обработчики) Экспорт
	ЗарплатаКадрыВнутренний.ПолучитьОбработчикиПоставляемыхДанных(Обработчики)	
КонецПроцедуры

// Конец ТехнологияСервиса.ПоставляемыеДанные
...
Процедура ПослеПолученияОшибокЛогическогоКонтроляСЭДО(Страхователь, ИсходноеСообщение, ТекстОшибки, Результат) Экспорт
	...
	УчетПособийСоциальногоСтрахования.ПослеПолученияОшибокЛогическогоКонтроляСЭДО(
		Страхователь,
		ИсходноеСообщение,
		ТекстОшибки,
		Результат);
...
Процедура ПриДобавленииКлассификаторов(Классификаторы) Экспорт
	...
	Для Каждого СтрокаТаблицы Из ТаблицаКлассификаторов Цикл
		...
		ЗаполнитьЗначенияСвойств(Описание, СтрокаТаблицы, "Наименование, Идентификатор, ОбработкаРазделенныхДанных");
...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Иначе 
		...
		ЧтениеJSON.Закрыть();
		Менеджер = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(СтрокаТаблицы.ПолноеИмя);
		Менеджер.ОбновитьИзСервиса(Идентификатор, КлассификаторJSON);
		Если Идентификатор = "ReglIndicatorsKz" Тогда
			// Для классификатора регламентированных расчетных показателей также используется "Месячный расчетный показатель" 
			РегистрыСведений.МесячныйРасчетныйПоказатель.ОбновитьИзСервиса(Идентификатор, КлассификаторJSON);
		КонецЕсли;
	КонецЕсли;
	// ЗУПК
КонецПроцедуры
...
Процедура ПриИзмененииДанныхАутентификацииИнтернетПоддержки(ДанныеПользователя) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриИзмененииДанныхАутентификацииИнтернетПоддержки(ДанныеПользователя);
...
Процедура ПриОпределенииОбъектовСПоискомДублей(Объекты) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОбъектовСПоискомДублей(Объекты);
...
Процедура ПриОпределенииОбъектовСКомандамиУчетаОригиналов(СписокОбъектов) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОбъектовСКомандамиУчетаОригиналов(СписокОбъектов);
...
Процедура ПриОпределенииМногосотрудниковыхДокументов(СписокОбъектов) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииМногосотрудниковыхДокументов(СписокОбъектов);
...
Процедура ЗаполнитьТаблицуУчетаОригиналов(ТаблицаУчетаОригиналов) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьТаблицуУчетаОригиналов(ТаблицаУчетаОригиналов);
	
КонецПроцедуры

// См. РегламентированнаяОтчетностьПереопределяемый.ПолучитьНастройкиВидимостиЭлементовФормы.
Процедура ПолучитьНастройкиВидимостиЭлементовФормы(ИДОтчета, ИДРедакцииОтчета, НастройкиВидимости) Экспорт
	
	ЭтоНоваяФормаОтчета = ЗарплатаКадрыВнутренний.НоваяФормаРегламентированногоОтчета(ИДОтчета, ИДРедакцииОтчета);
	Если ЭтоНоваяФормаОтчета Тогда
		НастройкиВидимости.ПостояннаяВидимость = Истина;
		ТекстПредупреждения = НСтр("ru = 'Автоматическое заполнение этой редакции формы будет реализовано в будущих версиях программы.'");
...
Процедура ДополнитьСоответствиеТипов(Таблица) Экспорт
	...
	ЗарплатаКадрыВнутренний.ДополнитьСоответствиеТипов(Таблица);
...
Процедура ЗаполнитьРеквизитыОбъектаДокументооборота(Прокси, ОбъектXDTO, СсылкаНаПотребитель) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьРеквизитыОбъектаДокументооборота(Прокси, ОбъектXDTO, СсылкаНаПотребитель);
...
Процедура ПриЗаполненииСвойстваОбъектаXDTOПоЗначению(Значение, Свойства, ТипОбъекта, ИмяСвойства, ТипСвойства,
	...
	ЗарплатаКадрыВнутренний.ПриЗаполненииСвойстваОбъектаXDTOПоЗначению(
		Значение,
		Свойства,
		ТипОбъекта,
		ИмяСвойства,
...
Процедура ПриИзмененииСостоянияСогласования(ПредметСогласования, Состояние, ВызовИзФормыОбъекта) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриИзмененииСостоянияСогласования(ПредметСогласования, Состояние, ВызовИзФормыОбъекта);
...
Процедура ПриОпределенииЗначенияРеквизитаПоОбъектуXDTO(Результат, ЗначениеЗаполнения, ТипРеквизита, ИмяРеквизита,
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииЗначенияРеквизитаПоОбъектуXDTO(
		Результат,
		ЗначениеЗаполнения,
		ТипРеквизита,
		ИмяРеквизита,
...
Процедура ПриОпределенииНеобходимостиВыводитьКомандуПрисоединенныхФайловДО(Форма, Результат, СтандартнаяОбработка) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииНеобходимостиВыводитьКомандуПрисоединенныхФайловДО(
		Форма,
		Результат,
		СтандартнаяОбработка);
...
Процедура ПриОпределенииОбновляемыхРеквизитовПроведенногоДокумента(ПолноеИмя, ОбновляемыеРеквизиты) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОбновляемыхРеквизитовПроведенногоДокумента(ПолноеИмя, ОбновляемыеРеквизиты);
...
Процедура ПриОпределенииСокращенногоНаименованияКонфигурации(СокращенноеНаименование) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииСокращенногоНаименованияКонфигурации(СокращенноеНаименование);
...
Процедура ПриСозданииПоСсылке(ОбъектИС, ОбъектXDTO, ЗаполняемыйОбъектИС) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриСозданииПоСсылке(ОбъектИС, ОбъектXDTO, ЗаполняемыйОбъектИС);
...
// Устарела. Следует использовать ЗаполнитьФИОФизическогоЛица
// См. ЗащитаПерсональныхДанныхПереопределяемый.ЗаполнитьФИОФизическогоЛица.
Процедура ПриЗаполненииФИОФизическогоЛица(ФизическоеЛицо, ФИО) Экспорт
	ЗаполнитьФИОФизическогоЛица(ФизическоеЛицо, ФИО)
КонецПроцедуры
...
Процедура ДобавитьИдентификаторКомандыДляПечатиВПакетномРежиме(ИдентификаторыПФ, КомандаПечати) Экспорт
	...
	Если ДобавитьКоманду Тогда
		ИдентификаторыПФ.Добавить(ПолныйИдентификаторКомандыПечати(
			КомандаПечати.Идентификатор, КомандаПечати.МенеджерПечати));
	КонецЕсли;
	
КонецПроцедуры

Процедура ОбновитьЗначенияМинимальнойОплатыТрудаРФ(ТекстXML, ПолучатьДанныеИзСервиса) Экспорт
	ЗарплатаКадрыВнутренний.ОбновитьЗначенияМинимальнойОплатыТрудаРФ(ТекстXML, ПолучатьДанныеИзСервиса);
КонецПроцедуры

#Область РегламентированнаяОтчетность

	// Возвращает сведения об организации с учетом проектных решений прикладной конфигурации.
	//
	// Параметры:
	//   Организация   - СправочникСсылка.Организации
	...
	//   Структура
	//
	Функция СведенияОбОрганизации(Знач Организация, Знач ИменаПолей, Знач ДатаПолучения = Неопределено) Экспорт
		...
		Для Каждого КлючИЗначение Из Результат Цикл
			СписокПоказателей.Добавить(, КлючИЗначение.Ключ);
		КонецЦикла;
		
		РезультатБРО = РегламентированнаяОтчетностьПереопределяемый.ПолучитьСведенияОбОрганизации(
			Организация,
			ДатаПолучения,
			СписокПоказателей);
		
		ЗаполнитьЗначенияСвойств(Результат, РезультатБРО);
		
		Если Результат.Свойство("ЭтоЮридическоеЛицо") И Результат.ЭтоЮридическоеЛицо = Неопределено Тогда
			Результат.ЭтоЮридическоеЛицо = РегламентированнаяОтчетностьПереопределяемый.ЭтоЮридическоеЛицо(Организация);
		КонецЕсли;
		Если Результат.Свойство("ТелОрганизации_JSON") И Результат.ТелОрганизации_JSON = Неопределено Тогда
			ВидКИ = УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("ТелефонОрганизации");
			ТаблицаКИ = КонтактнаяИнформацияБЗК.КонтактнаяИнформацияОбъектов(Организация, , ВидКИ);
			Результат.ТелОрганизации_JSON = КонтактнаяИнформацияБЗК.ЗначениеКонтактнойИнформации(ТаблицаКИ, , ВидКИ);
		КонецЕсли;
		Если Результат.Свойство("РегистрационныйНомерФСС") И СтрДлина(Результат.РегистрационныйНомерФСС) > 10 Тогда
			Результат.РегистрационныйНомерФСС = Лев(СокрЛП(Результат.РегистрационныйНомерФСС), 10);
		КонецЕсли;
		Если Результат.Свойство("ДополнительныйКодФСС") И Результат.ДополнительныйКодФСС = Неопределено Тогда
			Результат.ДополнительныйКодФСС = Лев(СокрЛП(Организация.ДополнительныйКодФСС), 10);
		КонецЕсли;
		Если Результат.Свойство("НомерСтрахователяФСС") И Результат.НомерСтрахователяФСС = Неопределено Тогда
			...
			Если ЭтоГоловнаяОрганизация Или ДатаПолучения < '20150121' Тогда
				Результат.НомерСтрахователяФСС = Лев(СокрЛП(Организация.РегистрационныйНомерФСС), 10);
			Иначе // Для обособленных подразделений с 2015 года используется дополнительный код ФСС.
				Результат.НомерСтрахователяФСС = Лев(СокрЛП(Организация.ДополнительныйКодФСС), 10);
			КонецЕсли;
		КонецЕсли;
...
Функция КлючевыеРеквизитыПредставлениеПредупреждения(ПредставлениеРеквизита, ДействиеПриИзмененииОчистка)
	...
	Если ДействиеПриИзмененииОчистка Тогда
		ПредставлениеПредупреждения = НСтр("ru = 'Редактирование %1 приведет к очистке табличных частей документа'");
	Иначе 
		ПредставлениеПредупреждения = НСтр("ru = 'Редактирование %1 приведет к перезаполнению табличных частей документа'");
	КонецЕсли;
	
	Возврат	СтрШаблон(ПредставлениеПредупреждения, ПредставлениеРеквизита);
...
Процедура ПриСозданииФормыСпискаФайлов(Форма) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриСозданииФормыСпискаФайлов(Форма);
...
Функция МесячныйРасчетныйПоказатель(ДатаАктуальности) Экспорт
	...
	Возврат ЗарплатаКадрыПовтИсп.МесячныйРасчетныйПоказатель(ДатаАктуальности);
	
КонецФункции	

Функция МесячныйРасчетныйПоказательДляПособийИныхСоциальныхВыплат(ДатаАктуальности) Экспорт
	
	Возврат ЗарплатаКадрыПовтИсп.МесячныйРасчетныйПоказательДляПособийИныхСоциальныхВыплат(ДатаАктуальности);
...
Процедура ПроверитьПользовательскиеНастройкиДинамическогоСписка(Форма, ПользовательскиеНастройкиПередЗагрузкой = Неопределено, СтандартнаяОбработка = Истина) Экспорт
	...
	ОтборПоОрганизацииДобавлен = Ложь;
	КоллекцияОтборов = ЗарплатаКадрыКлиентСервер.ФиксированныйОтборДинамическогоСписка(Форма, Список);
		...
		Если ТипЗнч(НастройкаКомпоновщика) = Тип("ОтборКомпоновкиДанных") Тогда
			...
			Если Не НайденОтборПоОрганизации Тогда
				Если ФиксированныеОтборы.Получить(ДоступноеПолеВыбораОрганизация.Поле) <> Неопределено Тогда
					НайденОтборПоОрганизации = Истина;
				КонецЕсли;
				Если ФиксированныеОтборы.Получить(Новый ПолеКомпоновкиДанных("ГоловнаяОрганизация")) <> Неопределено Тогда
					НайденОтборПоОрганизации = Истина;
				КонецЕсли;
			КонецЕсли;
			Если Не НайденОтборПоОрганизации Тогда
...
Функция СообщениеОНеприменимостиПечатнойФормы(ДатаДокумента,
	...
	Если ВыводитьСообщение И (ДатаДокумента > ДатаВступленияВСилуНормативногоДокумента) Тогда
		...
		СообщениеОНеприменимости = СтрШаблон(
...
Функция АвтообновляемыеКлассификаторы() Экспорт
	...
	ТаблицаКлассификаторов.Колонки.Добавить("ОбработкаРазделенныхДанных", Новый ОписаниеТипов("Булево"));
...
Процедура ОбработкаДокументовПечатныхФорм() Экспорт
	...
	ЗарплатаКадрыВнутренний.ОбработкаДокументовПечатныхФорм();
	
КонецПроцедуры

#Область УстаревшиеПроцедурыИФункции

// Устарела. Следует использовать РаботаСАдресами.СведенияОбАдресе. См. также интерфейс модуля КонтактнаяИнформацияБЗК.
...
Процедура УстановитьВерсиюДанныхДатЗапретаИзмененияБЗК(Версия = "") Экспорт
	Константы.ВерсияДанныхДатЗапретаИзмененияБЗК.Установить(Версия);
КонецПроцедуры

Функция НеобходимоОбновитьРазделыДатЗапретаИзмененияБЗК() Экспорт
	Возврат Константы.ВерсияДанныхДатЗапретаИзмененияБЗК.Получить() <> Метаданные.Версия;
КонецФункции
...
Функция ПолныйИдентификаторКомандыПечати(ИдентификаторКоманды, МенеджерПечати)
	
	Если ЗначениеЗаполнено(МенеджерПечати)
		И Не СтрНачинаетсяС(ВРег(ИдентификаторКоманды), ВРег(МенеджерПечати) + ".") Тогда
		
		Возврат МенеджерПечати + "." + ИдентификаторКоманды;
	КонецЕсли;
