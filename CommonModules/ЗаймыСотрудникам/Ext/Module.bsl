...
Функция ОстатокЗадолженности(Договор, ДатаАктуальности, Регистратор = Неопределено) Экспорт
	...
	ОстатокЗадолженности.Вставить("Валюта", "тенге");
...
//
Функция РасчетЗаймовСотрудникам(Организация, ДатаОперации, Регистратор, ДоговорыЗайма = Неопределено, Сотрудники = Неопределено, Подразделение = Неопределено, ИсключатьУволенныхСотрудников = Ложь, ИсключаемыеРегистраторы = Неопределено) Экспорт
...
Процедура ЗаполнитьНастройкиПечатныхФормПоУмолчанию(ОписанияНастроек) Экспорт
	...
	КадровыйЭДО.ДобавитьНастройкуПечатнойФормы(
		ОписанияНастроек,
		Метаданные.Документы.ДоговорЗаймаСотруднику.Макеты.ПФ_MXL_ГрафикПогашенияЗайма.Имя,
		Перечисления.СодержимоеДокументов.СодержитЗарплату);
	
	КадровыйЭДО.ДобавитьНастройкуПечатнойФормы(
		ОписанияНастроек,
		Метаданные.Документы.ДоговорЗаймаСотруднику.Макеты.ПФ_MXL_ДоговорЗайма.Имя,
		Перечисления.СодержимоеДокументов.СодержитЗарплату);
