...
Функция МассивЗаписейИсторииВФорме(Форма, ИмяРегистра)
	...
	// ЗУПК
	Возврат 	
		ОбщегоНазначенияБЗККлиентСервер.КоллекцияВМассив(
			Форма[ИмяРегистра + "НаборЗаписей"], 
			ОбщегоНазначенияКлиентСервер.КлючиСтруктурыВСтроку(Форма[ИмяРегистра + "Прежняя"]));
	// ЗУПК
	//-- НЕ УТ
