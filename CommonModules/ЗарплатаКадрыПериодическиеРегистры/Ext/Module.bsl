...
Процедура УстановитьПсевдонимыПолейСКД(ОписаниеЗапроса, ПараметрыПостроения) Экспорт
	Если ПараметрыПостроения.СоответствиеПсевдонимовПолейСКД = Неопределено Тогда
		Возврат;
	КонецЕсли; 
...
Функция ЗапросВТИзмененияВНаборе(ИмяРегистра, РегистраторТекущегоНабора)
	...
	|	&ИзменившиесяРесурсыРеквизиты,
	|	&СтарыеЗначениеРесурсовРеквизитов,
	|	&НовыеЗначенияРесурсовРеквизитов,
	|	ВЫБОР
	...
	|		СтарыйНабор._РесурсыРеквизиты КАК _РесурсыРеквизиты,
	...
	|		ИЛИ &УсловиеИзменившиесяРесурсыРеквизиты)";
	...
	ПоляРесурсыРеквизитыСтарогоНабора = Новый Массив;
	ПоляРесурсыРеквизитыНовогоНаборы = Новый Массив;
	ПоляСтарыеЗначенияРесурсовРеквизитов = Новый Массив;
	ПоляНовыеЗначенияРесурсовРеквизитов = Новый Массив;	
	ПоляИзменившиесяРесурсыРеквизиты = Новый Массив;
	ЧастиУсловияИзменившиесяРесурсыРеквизиты = Новый Массив;
	
	ШаблонПоляИзменениеРесурсаРеквизита = 
	"	ВЫБОР
	...
	ШаблонУсловияИзмененияРесурсаРеквизита = 
	"	ВЫБОР
	|		КОГДА МАКСИМУМ(ВложенныйЗапрос._Ресурс) <> МИНИМУМ(ВложенныйЗапрос._Ресурс)
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	...
	ШаблонПоляСтарогоЗначенияРесурсаРеквизита = 
	"	МАКСИМУМ(ВЫБОР
	...
	ШаблонПоляНовогоЗначенияРесурсаРеквизита = 
	"	МАКСИМУМ(ВЫБОР
	...
	Для Каждого Ресурс Из ОписаниеРегистра.Ресурсы Цикл
		ПоляРесурсыРеквизитыСтарогоНабора.Добавить("СтарыйНабор." + Ресурс + " КАК " + Ресурс);
		ПоляРесурсыРеквизитыНовогоНаборы.Добавить("НовыйНабор." + Ресурс);
		
		ТекстПоляИзменившиесяРесурсы = СтрЗаменить(ШаблонПоляИзменениеРесурсаРеквизита, "_Ресурс", Ресурс);
		ПоляИзменившиесяРесурсыРеквизиты.Добавить(ТекстПоляИзменившиесяРесурсы);
		
		ТекстУсловияИзменившиесяРесурсы = СтрЗаменить(ШаблонУсловияИзмененияРесурсаРеквизита, "_Ресурс", Ресурс);
		ЧастиУсловияИзменившиесяРесурсыРеквизиты.Добавить(ТекстУсловияИзменившиесяРесурсы);
		
		ТекстПоляСтароеЗначениеРесурса = СтрЗаменить(ШаблонПоляСтарогоЗначенияРесурсаРеквизита, "_Ресурс", Ресурс);
		ПоляСтарыеЗначенияРесурсовРеквизитов.Добавить(ТекстПоляСтароеЗначениеРесурса);
		
		ТекстПоляНовоеЗначениеРесурса = СтрЗаменить(ШаблонПоляНовогоЗначенияРесурсаРеквизита, "_Ресурс", Ресурс);
		ПоляНовыеЗначенияРесурсовРеквизитов.Добавить(ТекстПоляНовоеЗначениеРесурса);
	КонецЦикла;	
	...
	Если ОписаниеРегистра.ЕстьВозвратныеСобытия Тогда
		Для Каждого Ресурс Из ОписаниеРегистра.ВозвратныеРесурсы Цикл
			...
			ПоляРесурсыРеквизитыСтарогоНабора.Добавить("СтарыйНабор." + РесурсПоОкончании + " КАК " + РесурсПоОкончании);
			ПоляРесурсыРеквизитыНовогоНаборы.Добавить("НовыйНабор." + РесурсПоОкончании);
			
			ТекстПоляИзменившиесяРесурсы = СтрЗаменить(ШаблонПоляИзменениеРесурсаРеквизита, "_Ресурс", РесурсПоОкончании);
			ПоляИзменившиесяРесурсыРеквизиты.Добавить(ТекстПоляИзменившиесяРесурсы);
			
			ТекстУсловияИзменившиесяРесурсы = СтрЗаменить(ШаблонУсловияИзмененияРесурсаРеквизита, "_Ресурс", РесурсПоОкончании);
			ЧастиУсловияИзменившиесяРесурсыРеквизиты.Добавить(ТекстУсловияИзменившиесяРесурсы);
			
			ТекстПоляСтароеЗначениеРесурса = СтрЗаменить(ШаблонПоляСтарогоЗначенияРесурсаРеквизита, "_Ресурс", РесурсПоОкончании);
			ПоляСтарыеЗначенияРесурсовРеквизитов.Добавить(ТекстПоляСтароеЗначениеРесурса);
			
			ТекстПоляНовоеЗначениеРесурса = СтрЗаменить(ШаблонПоляНовогоЗначенияРесурсаРеквизита, "_Ресурс", РесурсПоОкончании);
			ПоляНовыеЗначенияРесурсовРеквизитов.Добавить(ТекстПоляНовоеЗначениеРесурса);
	...
	Для Каждого Реквизит Из ОписаниеРегистра.Реквизиты Цикл
		ПоляРесурсыРеквизитыСтарогоНабора.Добавить("СтарыйНабор." + Реквизит + " КАК " + Реквизит);
		ПоляРесурсыРеквизитыНовогоНаборы.Добавить("НовыйНабор." + Реквизит);
		Если ОписаниеРегистра.РеквизитыСТипами[Реквизит] = Новый ОписаниеТипов("Строка")
			...
			ПолеРеквизитаВнешнегоЗапроса = "ПОДСТРОКА(ВложенныйЗапрос." + Реквизит + ", 0, 1000)";
		Иначе
			ПолеРеквизитаВнешнегоЗапроса = "ВложенныйЗапрос." + Реквизит;
		КонецЕсли;
		
		ТекстПоляИзменившиесяРеквизиты = СтрЗаменить(ШаблонПоляИзменениеРесурсаРеквизита, "ВложенныйЗапрос._Ресурс", ПолеРеквизитаВнешнегоЗапроса);
		ТекстПоляИзменившиесяРеквизиты = СтрЗаменить(ТекстПоляИзменившиесяРеквизиты, "ИзменилсяРесурс_Ресурс", "ИзменилсяРеквизит" + Реквизит);
		ПоляИзменившиесяРесурсыРеквизиты.Добавить(ТекстПоляИзменившиесяРеквизиты);
		
		ТекстУсловияИзменившиесяРесурсы = СтрЗаменить(ШаблонУсловияИзмененияРесурсаРеквизита, "ВложенныйЗапрос._Ресурс", ПолеРеквизитаВнешнегоЗапроса);
		ЧастиУсловияИзменившиесяРесурсыРеквизиты.Добавить(ТекстУсловияИзменившиесяРесурсы);
		
		ТекстПоляСтароеЗначениеРесурса = СтрЗаменить(ШаблонПоляСтарогоЗначенияРесурсаРеквизита, "ВложенныйЗапрос._Ресурс", ПолеРеквизитаВнешнегоЗапроса);
		ТекстПоляСтароеЗначениеРесурса = СтрЗаменить(ТекстПоляСтароеЗначениеРесурса, "_Ресурс", Реквизит);
		ПоляСтарыеЗначенияРесурсовРеквизитов.Добавить(ТекстПоляСтароеЗначениеРесурса);
		
		ТекстПоляНовоеЗначениеРесурса = СтрЗаменить(ШаблонПоляНовогоЗначенияРесурсаРеквизита, "ВложенныйЗапрос._Ресурс", ПолеРеквизитаВнешнегоЗапроса);
		ТекстПоляНовоеЗначениеРесурса = СтрЗаменить(ТекстПоляНовоеЗначениеРесурса, "_Ресурс", Реквизит);
		ПоляНовыеЗначенияРесурсовРеквизитов.Добавить(ТекстПоляНовоеЗначениеРесурса);
	КонецЦикла;
	
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "СтарыйНабор._РесурсыРеквизиты КАК _РесурсыРеквизиты", СтрСоединить(ПоляРесурсыРеквизитыСтарогоНабора, РазделительПолейЗапроса));
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НовыйНабор._РесурсыРеквизиты", СтрСоединить(ПоляРесурсыРеквизитыНовогоНаборы, РазделительПолейЗапроса));
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ИзменившиесяРесурсыРеквизиты", СтрСоединить(ПоляИзменившиесяРесурсыРеквизиты, РазделительПолейЗапроса));	
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&СтарыеЗначениеРесурсовРеквизитов", СтрСоединить(ПоляСтарыеЗначенияРесурсовРеквизитов, РазделительПолейЗапроса));
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&НовыеЗначенияРесурсовРеквизитов", СтрСоединить(ПоляНовыеЗначенияРесурсовРеквизитов, РазделительПолейЗапроса));
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеИзменившиесяРесурсыРеквизиты", СтрСоединить(ЧастиУсловияИзменившиесяРесурсыРеквизиты, " ИЛИ "));
...
Функция ФильтрСписокЗначений(ОписаниеПериода, ЗначенияИзмерения = Неопределено, ДополнительныеПоля = Неопределено)
	...
	ЗначениеФильтра.Вставить("ДополнительныеПоля", Новый Массив);
	...
	Если ДополнительныеПоля <> Неопределено Тогда
		ЗначениеФильтра.ДополнительныеПоля = ДополнительныеПоля;
	КонецЕсли;
...
Процедура ДобавитьЗапросВТПериодыСреза(ОписаниеПакетаЗапросов, ИмяРегистра, ТолькоРазрешенные, ОписаниеФильтра, ПараметрыПостроения = Неопределено, СрезПоследних = Истина)	
	...
	УстановитьПсевдонимыПолейСКД(ОписаниеЗапроса, ПараметрыПостроения);
