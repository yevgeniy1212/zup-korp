...
// Открывает общую форму "Отсутствия, сдвигающие рабочий год". Используется 
// в документах ввода начальных остатков отпусков.
//
Процедура ОткрытьФормуВводаОтсутствийСдвигающихРабочийГод(Форма, ВидЕжегодногоОтпуска, АдресСведенийОбОтсутствиях) Экспорт 
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ВидЕжегодногоОтпуска", ВидЕжегодногоОтпуска);
	ПараметрыФормы.Вставить("АдресСведенийОбОтсутствиях", АдресСведенийОбОтсутствиях);
	
	ОткрытьФорму("ОбщаяФорма.ОтсутствияСдвигающиеРабочийГод", ПараметрыФормы, Форма, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ПередУдалениемЕжегодногоОтпуска(Форма, Отказ, ФиксирующиеРеквизиты = "ДействующийОтпуск", ЕстьТабличнаяЧастьОстатков = Ложь) Экспорт
	...
	Иначе	
		Если ЕстьТабличнаяЧастьОстатков Тогда
			ОчиститьОстаткиОтпусковПоВидуОтпуска(ТекущийОбъект.ОстаткиОтпусковПоРабочимГодам, ДанныеТекущейСтроки.ВидЕжегодногоОтпуска);
			ОчиститьОстаткиОтпусковПоВидуОтпуска(ТекущийОбъект.ОтсутствияСдвигающиеРабочийГод, ДанныеТекущейСтроки.ВидЕжегодногоОтпуска);
		КонецЕсли;
