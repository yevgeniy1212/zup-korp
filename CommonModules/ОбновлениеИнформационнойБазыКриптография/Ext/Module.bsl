...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "БиблиотекаКриптографии";
	Описание.Версия = КриптографияКлиентСервер.ВерсияБиблиотеки();
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	КриптографияСервер.ПриДобавленииОбработчиковОбновления(Обработчики);
