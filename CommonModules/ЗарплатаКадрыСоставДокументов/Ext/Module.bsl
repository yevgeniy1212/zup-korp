...
Функция СоставОбъекта(Источник) Экспорт
	Если Источник.ДополнительныеСвойства.Свойство("СоставОбъекта_СотрудникиФизическиеЛица") Тогда	
		Возврат Источник.ДополнительныеСвойства.СоставОбъекта_СотрудникиФизическиеЛица;
	КонецЕсли;	
	
	ОписаниеИсточника = ОписаниеОбъектаПоСсылке(Источник.Ссылка);
	Если ОписаниеИсточника = Неопределено Тогда
		ВызватьИсключение НСтр("ru = 'Отсутствует описание объекта.'");
	КонецЕсли;
	
	СоставОбъекта = НовыйСоставОбъекта();
	...
	Источник.ДополнительныеСвойства.Вставить("СоставОбъекта_СотрудникиФизическиеЛица", СоставОбъекта);	
...
Функция СоставОбъектаПоСсылке(Ссылка) Экспорт
	ОписаниеИсточника = ОписаниеОбъектаПоСсылке(Ссылка);
...
Функция СоставОбъектаПоДаннымФормы(ДанныеФормыОбъекта) Экспорт
	ОписаниеИсточника = ОписаниеОбъектаПоСсылке(ДанныеФормыОбъекта.Ссылка);
	Если ОписаниеИсточника = Неопределено Тогда
		ВызватьИсключение НСтр("ru = 'Отсутствует описание объекта.'");
	КонецЕсли;
	...
	СоставОбъекта.СотрудникиФизическиеЛица = СотрудникиФизическиеЛица(ДанныеФормыОбъекта, ОписаниеИсточника);
	СоставОбъекта.ФизическиеЛица = ОбщегоНазначения.ВыгрузитьКолонку(СоставОбъекта.СотрудникиФизическиеЛица, "ФизическоеЛицо", Истина);
...
// Описание - возвращает структуру для хранения состава документа
// 
// Возвращаемое значение:
// 	Структура - Описание:
//   * СотрудникиФизическиеЛица - см. НовыйСотрудникиФизическиеЛица - таблица с сотрудниками 
//		и физическими лицами документа
//   * ФизическиеЛица - Массив из СправочникСсылка.ФизическиеЛица- массив физических диц документа
//
Функция НовыйСоставОбъекта()
	СоставДокумента = Новый Структура;
	СоставДокумента.Вставить("ФизическиеЛица", Новый Массив);
	СоставДокумента.Вставить("СотрудникиФизическиеЛица", НовыйСотрудникиФизическиеЛица());
	
	Возврат СоставДокумента;
КонецФункции	

// Описание - таблица для хранения состава документа 
// 
// Возвращаемое значение:
// 	ТаблицаЗначений - Описание:
//   * ФизическоеЛицо - СправочникСсылка.ФизическиеЛица - физическое лицо
//   * ГоловнойСотрудник - СправочникСсылка.Сотрудники - головной сотрудник
//   * Сотрудник - СправочникСсылка.Сотрудники - сотрудник
//   * ВключатьВКраткийСостав - Булево - определяет необходимость включения в краткий состав документа
//
Функция НовыйСотрудникиФизическиеЛица()
...
Функция СотрудникиФизическиеЛица(Источник, ОписаниеИсточника) Экспорт
	СотрудникиФизическиеЛица = НовыйСотрудникиФизическиеЛица();
