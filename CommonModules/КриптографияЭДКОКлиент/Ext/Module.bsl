...
Процедура СоздатьКонтейнерКлючей(
		...
		ЭкспортируемыйКлюч = Истина) Экспорт
...
Процедура ОтобразитьПредставленияСертификатов(ПараметрыОтображенияСертификатов, Форма, МестоХраненияКлюча, ВыполняемоеОповещение = Неопределено) Экспорт
	...
	КриптографияЭДКОСлужебныйКлиент.ОтобразитьПредставленияСертификатов(ПараметрыОтображенияСертификатов, Форма, МестоХраненияКлюча, ВыполняемоеОповещение);
...
Процедура ХешироватьДанные(
		...
		ВыводитьСоообщения = Истина,
		МенеджерКриптографии = Неопределено,
		АлгоритмИлиСертификат = Неопределено,
