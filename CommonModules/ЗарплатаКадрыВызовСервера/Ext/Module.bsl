...
Функция СвойстваОтветсвенногоЛица(Пользователь) Экспорт
	
	СвойстваОтветсвенного = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Пользователь, "Ссылка,ПометкаУдаления,Недействителен,Служебный,СвойстваПользователяИБ");
	СвойстваОтветсвенного.СвойстваПользователяИБ = СвойстваОтветсвенного.СвойстваПользователяИБ.Получить();
	Возврат СвойстваОтветсвенного;
