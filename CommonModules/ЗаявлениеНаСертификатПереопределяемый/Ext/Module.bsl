...
Процедура ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры) Экспорт
	...
	ЗарплатаКадры.ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры);
...
Процедура ПриЗаполненииРеквизитовВладельцаВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// ЗарплатаКадрыПодсистемы
	ЗарплатаКадры.ПриЗаполненииРеквизитовВладельцаВЗаявленииНаСертификат(Параметры);
	// Конец ЗарплатаКадрыПодсистемы
...
Процедура ПриЗаполненииРеквизитовРуководителяВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// ЗарплатаКадрыПодсистемы
	ЗарплатаКадры.ПриЗаполненииРеквизитовРуководителяВЗаявленииНаСертификат(Параметры);
	// Конец ЗарплатаКадрыПодсистемы
...
Процедура ПриЗаполненииРеквизитовПартнераВЗаявленииНаСертификат(Параметры) Экспорт
	...
	// ЗарплатаКадрыПодсистемы
	ЗарплатаКадры.ПриЗаполненииРеквизитовПартнераВЗаявленииНаСертификат(Параметры);
	// Конец ЗарплатаКадрыПодсистемы
