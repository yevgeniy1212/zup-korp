...
Процедура ПолучитьНастройкиВидимостиЭлементовФормы(ИДОтчета, ИДРедакцииОтчета, НастройкиВидимости) Экспорт
	ЗарплатаКадры.ПолучитьНастройкиВидимостиЭлементовФормы(ИДОтчета, ИДРедакцииОтчета, НастройкиВидимости)	
КонецПроцедуры
...
Процедура ЗаполнитьОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	// ЗУПК
	РегламентированнаяОтчетностьРК.ЗаполнитьОтчетРК(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер);
	// ЗУПК
...
Функция ИДКонфигурации() Экспорт
	Возврат КонфигурацииЗарплатаКадры.ИДКонфигурации();
КонецФункции
...
Функция КраткоеНазваниеПрограммы() Экспорт
	Возврат КонфигурацииЗарплатаКадры.КраткоеНазваниеПрограммы();
КонецФункции
...
Функция ПолучитьСписокРегламентированныхОтчетов() Экспорт
	...
	// ЗУПК
	СписокРегламентированныхОтчетов = РегламентированнаяОтчетностьРК.ПолучитьСписокРегламентированныхОтчетовРК(СписокРегламентированныхОтчетов);
	// ЗУПК
...
Процедура ПолучитьУИДКонфигурации(УИДКонфигурации) Экспорт
	КонфигурацииЗарплатаКадры.ПолучитьУИДКонфигурации(УИДКонфигурации);
КонецПроцедуры
