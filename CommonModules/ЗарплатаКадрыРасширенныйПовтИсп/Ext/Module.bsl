...
Функция ПоказателиПереопределяемогоРасчета() Экспорт
	...
	Показатели.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.КоэффициентИндексацииСохраняемогоДенежногоДовольствия"));
	Показатели.Добавить(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.НормаЧасовПриСуммированномУчете"));
...
Функция ИспользоватьРаспределениеПоТерриториямУсловиямТруда(Знач Организация = Неопределено) Экспорт
	...
	Если Организация = Неопределено Тогда
		Возврат ПолучитьФункциональнуюОпцию("ИспользоватьОбособленныеТерритории") Или ПолучитьФункциональнуюОпцию("ИспользоватьОсобыеУсловияТрудаВОрганизации");
	КонецЕсли;
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьОбособленныеТерритории", Параметры) 
		Или ПолучитьФункциональнуюОпцию("ИспользоватьОсобыеУсловияТрудаВОрганизации", Параметры)  Тогда
		Возврат Истина;
	КонецЕсли;
...
Функция ПоказателиПоТерриториямУсловиямТруда() Экспорт
	...
	ИменаПоказателей.Добавить("РайонныйКоэффициентРФ");
