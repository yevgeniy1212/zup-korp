...
Процедура ОснованияУвольненияПоказатьНеИспользуемые(УправляемаяФорма) Экспорт
	
	УправляемаяФорма.Элементы.ФормаПоказатьНеИспользуемые.Пометка =
		Не УправляемаяФорма.Элементы.ФормаПоказатьНеИспользуемые.Пометка;
	
	КадровыйУчетКлиентСервер.ОснованияУвольненияУстановитьОтборПоказатьНеИспользуемые(УправляемаяФорма);
	
КонецПроцедуры

Процедура ОснованияУвольненияТолькоДействующие(УправляемаяФорма) Экспорт
	
	УправляемаяФорма.Элементы.ФормаТолькоДействующие.Пометка =
		Не УправляемаяФорма.Элементы.ФормаТолькоДействующие.Пометка;
