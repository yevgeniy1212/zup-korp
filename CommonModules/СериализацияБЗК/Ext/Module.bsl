	...
	Для Каждого ВложенныйЭлементDOM Из ЭлементDOM.ДочерниеУзлы Цикл
		...
		Если Все Тогда
			Если Результат.Свойство(ВложенныйЭлементDOM.ЛокальноеИмя) Тогда
				Массив = Результат[ВложенныйЭлементDOM.ЛокальноеИмя];
				...
				Результат[ВложенныйЭлементDOM.ЛокальноеИмя] = Массив;
			Иначе
				Результат.Вставить(ВложенныйЭлементDOM.ЛокальноеИмя, ВложенныйЭлементDOM);
			КонецЕсли;
		ИначеЕсли Результат.Свойство(ВложенныйЭлементDOM.ЛокальноеИмя) Тогда
