...
Процедура ПередЗапускомПрограммы()
	...
	МинимальнаяВерсияПлатформы = "8.3.23.2040";
	...
	Если ТекущийРежим = Режимы.НеИспользовать Тогда
		ПоддерживаемыеВерсииПлатформы = СтрРазделить("8.3.21, 8.3.22, 8.3.23", ", ", Ложь);
	...
	Иначе
		...
		Если СтрЗаканчиваетсяНа(ТекущийРежимСтрокой, "8_3_21")
			ИЛИ СтрЗаканчиваетсяНа(ТекущийРежимСтрокой, "8_3_22")
			ИЛИ СтрЗаканчиваетсяНа(ТекущийРежимСтрокой, "8_3_23") Тогда
			НеПоддерживаемаяВерсияПлатформы = "";
		Иначе
