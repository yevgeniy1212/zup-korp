...
Процедура ВывестиЛоготипВТабличныйДокумент(Макет, ОбластьШапка, Эмблема, Организация) Экспорт
	
	// В ЗУП не поддерживается хранение логотипов организации, поэтому скрываем поле в печатных формах
	ОбластьШапка.Области.Логотип.ВыводитьНаПечать = Ложь;
