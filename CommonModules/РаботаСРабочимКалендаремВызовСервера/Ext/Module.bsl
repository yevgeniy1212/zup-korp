...
//
Функция ПроверитьДоступностьПользователей(МассивПользователей, ДатаНачала, ДатаОкончания, ИсключенияЗанятости, АдресТаблицыЗанятостиИзВнешнихСистем = "") Экспорт
	
	Возврат РаботаСРабочимКалендарем.ПроверитьДоступностьПользователей(МассивПользователей, 
																	   ДатаНачала, 
																	   ДатаОкончания, 
																	   ИсключенияЗанятости,
