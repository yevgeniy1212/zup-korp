...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.МашиночитаемыеДоверенностиФСС");
	Если ДокументооборотСКОКлиентСервер.ПодсистемаЦБСуществует() Тогда
		ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
			"Справочник.МашиночитаемыеДоверенностиЦБ");
	КонецЕсли;
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ВходящийДокументСЭДОФСС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ОтветСтрахователяНаТребованиеПроверкиФСС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ЗаявлениеНаФормированиеСправкиОРасчетах");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОписиВходящихДокументовИзНалоговыхОрганов");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОписиИсходящихДокументовВНалоговыеОрганы");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.УдалитьОтправкиБанкРоссии");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиРЭЦ");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиРегистрацияЮЛ");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.УведомлениеОПредоставленииПолномочийПредставителю");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.УведомлениеОПрекращенииПолномочийПредставителя");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.УдалитьНастройкиОбменаБанкРоссии");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОбменаРЭЦ");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ИсключенныеОрганизацииОбменаСКО");
	
	// ФСРАР. (Алкогольные отчеты).
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ОтчетностьПоАлкогольнойПродукции") Тогда
		...
		Если НЕ ОбщийМодульРегламентированнаяОтчетностьАЛКО = Неопределено Тогда		
			...
			СписокАлкоРегистров = ОбщийМодульРегламентированнаяОтчетностьАЛКО.СписокРегистровСведенийАлкоОтчетов();
			Для каждого ЭлементСписка Из СписокАлкоРегистров Цикл
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ОтчетыПереданныеВСПАРК");
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.МашиночитаемыеДоверенностиФНС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ЗаявленияОбОтзывеМЧДФНС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.МашиночитаемыеДоверенностиФСС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	Если ДокументооборотСКОКлиентСервер.ПодсистемаЦБСуществует() Тогда
		ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.МашиночитаемыеДоверенностиЦБ");
		Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ВходящийДокументСЭДОФСС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ОтветСтрахователяНаТребованиеПроверкиФСС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ЗаявлениеНаФормированиеСправкиОРасчетах");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.УведомлениеОПредоставленииПолномочийПредставителю");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.УведомлениеОПрекращенииПолномочийПредставителя");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.УдалитьОтправкиБанкРоссии");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
		
		Описание = Описание + "
		|Справочник.УдалитьОтправкиБанкРоссии.Чтение.Организации
		|Справочник.УдалитьОтправкиБанкРоссии.Изменение.Организации";
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиРЭЦ");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиРегистрацияЮЛ");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.УдалитьНастройкиОбменаБанкРоссии");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
		
		Описание = Описание + "
		|РегистрСведений.УдалитьНастройкиОбменаБанкРоссии.Чтение.Организации
		|РегистрСведений.УдалитьНастройкиОбменаБанкРоссии.Изменение.Организации";
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиОбменаРЭЦ");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ИсключенныеОрганизацииОбменаСКО");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
		
		Описание = Описание + "
		|РегистрСведений.ИсключенныеОрганизацииОбменаСКО.Чтение.Организации
		|РегистрСведений.ИсключенныеОрганизацииОбменаСКО.Изменение.Организации";
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ОтчетностьПоАлкогольнойПродукции") Тогда
		...
		Если НЕ ОбщийМодульРегламентированнаяОтчетностьАЛКО = Неопределено Тогда		
			...
			Для каждого ЭлементСписка Из СписокАлкоРегистров Цикл
				...
				ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени(ЭлементСписка.Значение);
				Если НЕ ОбъектМетаданных = Неопределено Тогда
					
					Описание = Описание + "
					|" + ЭлементСписка.Значение + ".Чтение.Организации
					|" + ЭлементСписка.Значение + ".Изменение.Организации";
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ОтчетыПереданныеВСПАРК");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
...
Процедура ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты) Экспорт
	Объекты.Вставить(Метаданные.Документы.РегламентированныйОтчет.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Документы.УведомлениеОСпецрежимахНалогообложения.ПолноеИмя(), "");
КонецПроцедуры
...
Функция ПустаяТаблицаОписанияОбъектовРегламентированнойОтчетности() Экспорт
	...
	ТаблицаОписания.Колонки.Добавить("Код");
...
Функция ТаблицаСозданныхВидовОтчетов(Организации = Неопределено) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ РАЗРЕШЕННЫЕ
	                      ...
	                      |
	                      |УПОРЯДОЧИТЬ ПО
	                      |	Наименование, ЕСТЬNULL(ИсточникОтчета, """") УБЫВ");
	//Порядок сортировки по полю, содержащему значения NULL, может отличаться на разных СУБД,
	//используем ЕСТЬNULL() для замены значений NULL в поле упорядочивания.
	...
	Для Каждого ЭлементЗагруженныйОтчет Из ЗагруженныеОтчеты Цикл
		...
		Если Инд > 0 Тогда
			ПредыдущаяСтрокаТаблицы = ТаблицаСозданных[Инд - 1];
			Если ПредыдущаяСтрокаТаблицы.Наименование = ЭлементЗагруженныйОтчет.Ключ
			   И ПредыдущаяСтрокаТаблицы.ПолноеИмя = "Документ.РегламентированныйОтчет" Тогда
...
Функция МассивВнешнихРегламентированныхОтчетов() Экспорт
	...
	ТаблицаС1Колонкой = РезультатЗапроса.Выгрузить();
	Возврат ТаблицаС1Колонкой.ВыгрузитьКолонку(0);
...
Процедура ЗаполнениеДанныхПоДоговорамДляПроверкиВРЭЦ(ПараметрыЗаполнения) Экспорт
	...
	РегламентированнаяОтчетностьПереопределяемый.ЗаполнениеДанныхПоДоговорамДляПроверкиВРЭЦ(ПараметрыЗаполнения);
...
Процедура СохранитьСтатусОтправкиРеглОтчета(Форма) Экспорт
	...
	Если ВыборкаЖОС.Следующий() Тогда
		...
		ТекСтатусМодифицирован = НСтр("ru = 'Сдан, модифицирован'");
		
		Если РегламентированнаяОтчетностьКлиентСервер.ОбъектНеОтправлялсяЧерез1СОтчетность(
				ВыборкаЖОС.СостояниеСдачиОтчетности)
			ИЛИ ТекСтатус = ТекСтатусМодифицирован
			ИЛИ ЭтоОтчетМинобороны Тогда
			...
			Если СтатусыОбъектов.Найти(ТекСтатус) <> Неопределено
				ИЛИ ТекСтатус = ТекСтатусМодифицирован
				ИЛИ ЭтоОтчетМинобороны Тогда
...
Процедура СохранитьСтатусОтправкиУведомления(Форма) Экспорт
	ВыборкаЖОКО = РегистрыСведений.ЖурналОтправокВКонтролирующиеОрганы.Выбрать(Новый Структура("Ссылка", Форма.Объект.Ссылка));
	Если ВыборкаЖОКО.Следующий() Тогда
		ТекСтатус = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1'"), Форма.Элементы.НаименованиеЭтапа.Заголовок);
		ТекСтатусМодифицирован = НСтр("ru = 'Сдан, модифицирован'");
		
		Если РегламентированнаяОтчетностьКлиентСервер.ОбъектНеОтправлялсяЧерез1СОтчетность(ВыборкаЖОКО.СостояниеСдачиОтчетности)
			ИЛИ ТекСтатус = ТекСтатусМодифицирован Тогда
			
			СтатусыОбъектов = РегламентированнаяОтчетностьКлиентСервер.СтатусыОбъектовРеглОтчетностиПриРучномВводе(Форма);
			
			Если Форма.Элементы.Найти("НаименованиеЭтапа") = Неопределено Тогда
				ТекСтатус = НСтр("ru = 'В работе'");
			Иначе
				ТекСтатус = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = '%1'"), Форма.Элементы.НаименованиеЭтапа.Заголовок);
			КонецЕсли;
			
			Если СтатусыОбъектов.Найти(ТекСтатус) <> Неопределено ИЛИ ТекСтатус = ТекСтатусМодифицирован Тогда
...
Функция АдресВФормате9Запятых(Запись) Экспорт
	...
	Иначе
		...
		Возврат "398," + АдресБезКодаСтраны;
...
Функция НазваниеИВерсияПрограммы() Экспорт
	Возврат РегламентированнаяОтчетностьПовтИсп.НазваниеИВерсияПрограммы();
КонецФункции
...
Функция СвойстваПрочихОтчетов(Ссылка, ТолькоВозвращенныеПереопределяемой = Ложь) Экспорт
	...
	Если НЕ ТолькоВозвращенныеПереопределяемой Тогда
...
Функция СвойстваРегламентированногоОтчета(Ссылка) Экспорт
	...
	Если ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ПФР Тогда
		...
		ОрганизацияОтчета, , "КодОрганаПФР").КодОрганаПФР));
	...
	ИначеЕсли ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ФНС Тогда
		...
		Если Ссылка.ИсточникОтчета = "РегламентированныйОтчетСоответствиеУсловийТруда"
			ИЛИ Ссылка.ИсточникОтчета = "РегламентированныйОтчетСоответствиеУслТрудаМикропредприятия" Тогда
	...
	ИначеЕсли ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.УдалитьБанкРоссии Тогда
	...
	Если ТипЗнч(ПараметрыОтбора) = Тип("Структура") Тогда
		...
		Для Инд = 0 По КолРегистраций - 1 Цикл
			...
			Если ПараметрыОтбора.Свойство("ОКТМО") Тогда
				ПараметрыОтбораОКТМО = СокрЛП(ПараметрыОтбора.ОКТМО);
				Если ПараметрыОтбора.Свойство("ИскатьПоПервымСимволамОКТМО")
					И ТипЗнч(ПараметрыОтбора.ИскатьПоПервымСимволамОКТМО) = Тип("Булево")
					И ПараметрыОтбора.ИскатьПоПервымСимволамОКТМО И ЗначениеЗаполнено(ПараметрыОтбораОКТМО) Тогда
					Если НЕ СтрНачинаетсяС(СокрЛП(Регистрации[ОбрИнд].КодПоОКТМО), ПараметрыОтбораОКТМО) Тогда
						Регистрации.Удалить(ОбрИнд);
						Продолжить;
					КонецЕсли;
				Иначе
					Если СокрЛП(Регистрации[ОбрИнд].КодПоОКТМО) <> ПараметрыОтбораОКТМО Тогда
						Регистрации.Удалить(ОбрИнд);
						Продолжить;
					КонецЕсли;
				КонецЕсли;
...
//   АдресХранилища       - Строка - параметр необходим для совместимости с БСП.
//
...
Процедура ЗаполнитьОтчетВФоне_Уведомления(ПараметрыОтчета, АдресХранилища) Экспорт
	
	РегламентированнаяОтчетностьПереопределяемый.ЗаполнитьОтчет(
		ПараметрыОтчета.ИДОтчета, ПараметрыОтчета.ИДРедакцииОтчета,
		ПараметрыОтчета.ПараметрыОтчета, ПараметрыОтчета.Контейнер);
	
	ПоместитьВоВременноеХранилище(Новый Структура("Контейнер", ПараметрыОтчета.Контейнер), АдресХранилища);
...
Процедура ЗагрузитьОбщиеСправочникиРПН(Форма) Экспорт 
	Если Не ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ОтчетностьПрочая") Тогда 
		Возврат;
	КонецЕсли;
	
	ОбщиеСправочникиРПН = ПолучитьОбщийМакет("ОбщиеСправочникиРПН");
	...
	Для Каждого Область Из ОбщиеСправочникиРПН.Области Цикл
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			ВерхОбласти = Область.Верх;
			НизОбласти = Область.Низ;
			ТаблСписка = Новый ТаблицаЗначений;
			ТаблСписка.Колонки.Добавить("Код",     Строка16   ,, ОбщиеСправочникиРПН.Область(ВерхОбласти, 2, ВерхОбласти, 2).ШиринаКолонки);
			ТаблСписка.Колонки.Добавить("Название",Строка512  ,, ОбщиеСправочникиРПН.Область(ВерхОбласти, 1, ВерхОбласти, 1).ШиринаКолонки);
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				КодПоказателя = СокрП(ОбщиеСправочникиРПН.Область(НомСтр, 2).Текст);
				Если КодПоказателя <> "###" Тогда
					НовСтрока = ТаблСписка.Добавить();
					НовСтрока.Код = КодПоказателя;
					НовСтрока.Название = СокрП(ОбщиеСправочникиРПН.Область(НомСтр, 1).Текст);
				КонецЕсли;
			КонецЦикла;
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(Форма.СвойстваПоказателей,
		"ОКТМО", 512, , "Выбор кода ОКТМО", КоллекцияСписковВыбора["ОКТМО"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(Форма.СвойстваПоказателей,
		"ОКТМОРегионы", 512, , "Выбор кода ОКТМО", КоллекцияСписковВыбора["ОКТМОРегионы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(Форма.СвойстваПоказателей,
		"РПН", 512, , "Выбор органа РПН", КоллекцияСписковВыбора["РПН"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(Форма.СвойстваПоказателей,
		"ОКВЭД", 512, , "Выбор кода ОКВЭД", КоллекцияСписковВыбора["ОКВЭД"]);
КонецПроцедуры
...
//                                     1 - возвращаемое свойство "МуниципальныйРайонВид" не может быть равно "4", "5";
//                                     2 - возвращаемое свойство "МуниципальныйРайонВид" может быть равно "4",
//                                         не может быть равно "5";
//                                     3 - возвращаемое свойство "МуниципальныйРайонВид" может быть равно "4", "5".
//
// Возвращаемое значение:
...
//                                          "4" - муниципальный округ; "5" - федеральная территория).
...
//        * НомерЗемельногоУчастка        - Строка - земельный участок.
//
Функция АдресВФорматеФИАС(Адрес, ДополнительныеПараметры = Неопределено) Экспорт
	...
	= СтруктураАдресаЗаписи.Свойство("НаселенныйПункт") И СтруктураАдресаЗаписи.Свойство("Город")
	И НЕ ЗначениеЗаполнено(СтруктураАдресаЗаписи.НаселенныйПункт) И ЗначениеЗаполнено(СтруктураАдресаЗаписи.Город);
	...
	Если ПолучатьНаселенныйПунктИзГорода Тогда
		...
		?(СтруктураАдресаЗаписи.Свойство("ГородСокращение"), СтруктураАдресаЗаписи["ГородСокращение"], ""));
	КонецЕсли;
	...
	Если СтруктураАдресаЗаписи.Свойство("КодМуниципальногоРайона", ЗначениеСвойства) Тогда
		ВозможныеКодыМуниципальногоРайона = СтрРазделить("1,2,3,4,5", ",", Ложь);
	...
	Иначе
		...
		ИначеЕсли Сокращение = "мун. окр." Тогда
			ЗначениеСвойства = "4";
		ИначеЕсли Сокращение = "ф.т." Тогда
			ЗначениеСвойства = "5";
		КонецЕсли;
	КонецЕсли;
	Если ВерсияАдреса = 1 И ЗначениеСвойства = "4" Тогда
		ЗначениеСвойства = "1";
	ИначеЕсли (ВерсияАдреса = 1 ИЛИ ВерсияАдреса = 2) И ЗначениеСвойства = "5" Тогда
		ЗначениеСвойства = "2";
	КонецЕсли;
	...
	Если ПолучатьНаселенныйПунктИзГорода Тогда
		ВозвращаемыйАдрес.Вставить("НаселенныйПунктВид", ?(СтруктураАдресаЗаписи.Свойство("ГородСокращение"),
		СтруктураАдресаЗаписи["ГородСокращение"], ""));
	КонецЕсли;
...
// Возвращает признак разделения авансов по видам активов для отражения в бухгалтерской отчетности.
// 
// Параметры:
...
//
/// Возвращаемое значение:
//   Истина - авансы разделяются по видам актива.
//   Ложь   - авансы не разделяются по видам актива.
//
Функция АвансыРазделеныПоВидамАктивов(Организация, Период) Экспорт
	
	РазделятьАвансы = Ложь;
	
	РегламентированнаяОтчетностьПереопределяемый.ОпределитьРазделениеАвансовПоВидамАктивов(
		РазделятьАвансы, Организация, Период);
	
	Возврат РазделятьАвансы;
	
КонецФункции

// Возвращает признак применения ФСБУ 25/2018.
// 
// Параметры:
//   Организация - СправочникСсылка.Организации - организация, по которой нужно определить признак.
//   Период - Дата - дата, на которую нужно получить признак.
//
// Возвращаемое значение:
//   Истина - Организация применяет ФСБУ 25/2018.
//   Ложь   - Организация не применяет ФСБУ 25/2018.
//
Функция ПрименяетсяФСБУ25(Организация, Период) Экспорт
	
	// ФСБУ 25/2018 применяется, начиная с бухгалтерской (финансовой) отчетности за 2022 год.
	ПрименяетсяФСБУ25 = (Период >= '2022-01-01');
	
	// Возможно досрочное применение ФСБУ 25/20118.
	РегламентированнаяОтчетностьПереопределяемый.ОпределитьПрименениеФСБУ25(
		ПрименяетсяФСБУ25, Организация, Период);
...
#Область ИнтерфейсРаботыСДаннымиРеестровПоНДСИОтчетаОбОперацияхСПрослеживаемымиТоварами
...
Процедура Автозаполнение_ПрослеживаемыеТоварыОтчетОбОперациях(ПереданныеПараметры, НеиспользуемыйАдресХранилища) Экспорт
	...
	СуммыПоКодамОперПостранично = Новый ТаблицаЗначений;
	ОписаниеТиповСтрока7   = Новый ОписаниеТипов("Строка", , Новый КвалификаторыСтроки(7));
	ОписаниеТиповЧисло25_2 = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(25, 2));
	ТипКоличествоПрослеживаемогоТовара
	= Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(26, 11, ДопустимыйЗнак.Неотрицательный));
	СуммыПоКодамОперПостранично.Колонки.Добавить("Код",   ОписаниеТиповСтрока7);
	СуммыПоКодамОперПостранично.Колонки.Добавить("Сумма", ОписаниеТиповЧисло25_2);
	...
	Для Инд = 0 По ДеревоДанныхРеестр.Строки.Количество() - 1 Цикл
		...
		// Особая обработка для редакции ФормаОтчета2021Кв1 в графе 12.
		УстановитьЧисловойФорматОбласти(ТабличныйДокумент, ТипКоличествоПрослеживаемогоТовара);
		...
		НумераторПоКодуОпер = 0;
		Если НумераторыПоКодамОпер.Свойство("_" + КодОперации) Тогда
			НумераторПоКодуОпер = НумераторыПоКодамОпер["_" + КодОперации];
		КонецЕсли;
		...
		Для Инд_П10000 = 0 По Дерево_П10000.Строки.Количество() - 1 Цикл
			...
			Для Инд_П11000 = 0 По Дерево_П11000.Строки.Количество() - 1 Цикл
				...
				СуммаПоКодуОперации = СуммаПоКодуОперации + ТекВетка_П11000.Данные["П1100013"];
	...
	Для Каждого Стр Из СуммыПоКодамОперПостранично Цикл
		...
		Если СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет Тогда
			ИтоговыеСуммыПоКодамОпераций.Добавить(Новый Структура("КодОперации,СтоимостьИтого", Стр.Код, 0));
			ИтогоСуммаПоКодуОпер = 0;
		Иначе
			ИтоговыеСуммыПоКодамОпераций.Добавить(Новый Структура("КодОперации,СтоимостьИтого", Стр.Код, Стр.Сумма));
			ИтогоСуммаПоКодуОпер = СуммыПоКодамОперИтого.Найти(Стр.Код, "Код").Сумма;
		КонецЕсли;
		
		Инд = СуммыПоКодамОперПостранично.Индекс(Стр);
		ТекВетка = ДеревоДанныхРеестр.Строки[Инд];
		ТекВетка.Данные["СтоимостьИтого"] = ИтогоСуммаПоКодуОпер;
		ТекВетка.АдресТабличногоДокумента.Область("СтоимостьИтого").Значение = ИтогоСуммаПоКодуОпер;
...
Процедура УстановитьЧисловойФорматОбласти(ТабличныйДокумент, ТипКоличествоПрослеживаемогоТовара)
	
	Для каждого Обл Из ТабличныйДокумент.Области Цикл
		Если СтрНачинаетсяС(Обл.Имя, "П1100012") Тогда
			Обл.ТипЗначения = ТипКоличествоПрослеживаемогоТовара;
		КонецЕсли;
	КонецЦикла;
...
// Производит замену полученных сведений по данным организации - сведениями крупнейшего налогоплательщика,
// если организация является крупнейшим налогоплательщиком.
//
// Параметры:
//   СтруктураПараметров - Структура:
//        * Организация  - СправочникСсылка.Организации - ссылка на элемент справочника "Организации".
//        * ДатаЗначения - Дата - дата, на которую нужно получить сведения о крупнейшем налогоплательщике.
//        * СведенияОбОрганизации - Структура:
//             * КодНО  - Строка - код налогового органа организации.
//             * НаимНО - Строка - наименование налогового органа организации.
//             * КППЮЛ  - Строка - КПП организации.
//             * ОКТМО  - Строка - код по ОКТМО организации.
//             * ОКАТО  - Строка - код по ОКАТО организации.
//
Процедура ЗаменитьСведенияОбОрганизацииСведениямиОКрупнейшемНалогоплательщике(СтруктураПараметров) Экспорт
	
	СведОсн = СтруктураПараметров.СведенияОбОрганизации;
	
	СведКрупн = СведенияОКрупнейшемНалогоплательщике(СтруктураПараметров);
	
	Если СведКрупн.Свойство("ПризнакНПЛКрупнейший") И СведКрупн.ПризнакНПЛКрупнейший = Истина
		И СведКрупн.Свойство("КодНОКрупнейший") И ЗначениеЗаполнено(СведКрупн.КодНОКрупнейший)
		И СведКрупн.Свойство("КППЮЛКрупнейший") И ЗначениеЗаполнено(СведКрупн.КППЮЛКрупнейший) Тогда
		Если СведОсн.Свойство("КодНО") Тогда
			СведОсн.КодНО = СведКрупн.КодНОКрупнейший;
		КонецЕсли;
		Если СведОсн.Свойство("НаимНО") Тогда
			СведОсн.НаимНО = СведКрупн.НаимНОКрупнейший;
		КонецЕсли;
		Если СведОсн.Свойство("КППЮЛ") Тогда
			СведОсн.КППЮЛ = СведКрупн.КППЮЛКрупнейший;
		КонецЕсли;
		Если СведОсн.Свойство("ОКТМО") Тогда
			СведОсн.ОКТМО = СведКрупн.ОКТМОКрупнейший;
		КонецЕсли;
		Если СведОсн.Свойство("ОКАТО") Тогда
			СведОсн.ОКАТО = СведКрупн.ОКАТОКрупнейший;
		КонецЕсли;
	КонецЕсли;
	
КонецПроцедуры

// Возвращает код налогового органа получателя отчетности.
//
// Параметры:
//   СтруктураПараметров - Структура:
//        * Организация  - СправочникСсылка.Организации - ссылка на элемент справочника "Организации".
//        * ДатаЗначения - Дата - дата, на которую нужно получить код налогового органа получателя отчетности.
//
// Возвращаемое значение:
//   Строка - код налогового органа крупнейшего налогоплательщика, если организация является крупнейшим
//            налогоплательщиком; пустая строка, если организация не является крупнейшим налогоплательщиком.
//
Функция КодНалоговогоОрганаПолучателяОтчетности(СтруктураПараметров) Экспорт
	
	СведКрупн = СведенияОКрупнейшемНалогоплательщике(СтруктураПараметров);
	
	Если СведКрупн.Свойство("ПризнакНПЛКрупнейший") И СведКрупн.ПризнакНПЛКрупнейший = Истина
		И СведКрупн.Свойство("КодНОКрупнейший") И ЗначениеЗаполнено(СведКрупн.КодНОКрупнейший) Тогда
		
		Возврат СокрЛП(СведКрупн.КодНОКрупнейший);
		
	Иначе
		
		Организация = СтруктураПараметров.Организация;
		РеквизитыОрганизации = Организация.Метаданные().Реквизиты;
		
		Если РеквизитыОрганизации.Найти("КрупнейшийНалогоплательщик") <> Неопределено
			И Организация.КрупнейшийНалогоплательщик = Истина
			И РеквизитыОрганизации.Найти("КодНалоговогоОрганаПолучателя") <> Неопределено Тогда
			
			Возврат СокрЛП(Организация.КодНалоговогоОрганаПолучателя);
...
// Возвращает признак крупнейшего налогоплательщика для организации.
//
// Параметры:
//   СтруктураПараметров - Структура:
//        * Организация  - СправочникСсылка.Организации - ссылка на элемент справочника "Организации".
//        * ДатаЗначения - Дата - дата, на которую нужно получить признак крупнейшего налогоплательщика.
//
// Возвращаемое значение:
//   Истина - организация является крупнейшим налогоплательщиком;
//   Ложь   - организация не является крупнейшим налогоплательщиком.
//
Функция ОрганизацияЯвляетсяКрупнейшимНалогоплательщиком(СтруктураПараметров) Экспорт
	
	СведКрупн = СведенияОКрупнейшемНалогоплательщике(СтруктураПараметров);
	
	Если СведКрупн.Свойство("ПризнакНПЛКрупнейший") Тогда
		
		Возврат СведКрупн.ПризнакНПЛКрупнейший = Истина;
	...
	Иначе
		...
		Если РеквизитыОрганизации.Найти("КрупнейшийНалогоплательщик") <> Неопределено Тогда
			
			Возврат Организация.КрупнейшийНалогоплательщик = Истина;
...
// Возвращает сведения о крупнейшем налогоплательщике.
//
// Параметры:
//   СтруктураПараметров - Структура:
//        * Организация  - СправочникСсылка.Организации - ссылка на элемент справочника "Организации".
...
//
// Возвращаемое значение:
//   Структура - сведения о крупнейшем налогоплательщике:
//        * ПризнакНПЛКрупнейший - Булево - признак того, что организация является крупнейшим налогоплательщиком.
//        * КодНОКрупнейший      - Строка - код налогового органа крупнейшего налогоплательщика.
//        * КППЮЛКрупнейший      - Строка - КПП крупнейшего налогоплательщика.
//        * НаимНОКрупнейший     - Строка - наименование налогового органа крупнейшего налогоплательщика.
//        * ОКТМОКрупнейший      - Строка - код по ОКТМО крупнейшего налогоплательщика.
//
Функция СведенияОКрупнейшемНалогоплательщике(СтруктураПараметров)
	
	Возврат РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(
	СтруктураПараметров.Организация, СтруктураПараметров.ДатаЗначения,
	"ПризнакНПЛКрупнейший, КодНОКрупнейший, НаимНОКрупнейший, КППЮЛКрупнейший, ОКТМОКрупнейший, ОКАТОКрупнейший");
	
КонецФункции

// Возвращает признак прекращения деятельности организации.
//
// Параметры:
//   СтруктураПараметров - Структура:
//        * Организация   - СправочникСсылка.Организации - ссылка на элемент справочника "Организации".
//        * ДатаНачала    - Дата - дата начала периода, для которого нужно получить признак прекращения деятельности
//                          организации (необязательный параметр).
//        * ДатаОкончания - Дата - дата окончания периода, для которого нужно получить признак прекращения
//                          деятельности.
//
// Возвращаемое значение:
//   Истина - организация прекратила деятельность;
//   Ложь   - организация не прекратила деятельность.
//
Функция ОрганизацияПрекратилаДеятельность(СтруктураПараметров) Экспорт
	
	СведенияОбОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(
	СтруктураПараметров.Организация, СтруктураПараметров.ДатаОкончания, "ДатаЗакрытия");
	
	ДатаНач = ?(СтруктураПараметров.Свойство("ДатаНачала"), СтруктураПараметров["ДатаНачала"],
	РегламентированнаяОтчетностьКлиентСервер.ПустоеЗначениеТипа(Тип("Дата")));
	
	Если СведенияОбОрганизации.Свойство("ДатаЗакрытия")
		И ТипЗнч(СведенияОбОрганизации["ДатаЗакрытия"]) = Тип("Дата")
		И ЗначениеЗаполнено(СведенияОбОрганизации["ДатаЗакрытия"])
		И НачалоДня(СведенияОбОрганизации["ДатаЗакрытия"]) >= НачалоДня(ДатаНач)
		И НачалоДня(СведенияОбОрганизации["ДатаЗакрытия"]) <= НачалоДня(СтруктураПараметров["ДатаОкончания"]) Тогда
...
Функция ФорматВыгрузкиСтатистическойОтчетностиВЭлектронномВиде(Организация) Экспорт
	...
	АктуальныйФорматВыгрузки = 2;
	
	Возврат АктуальныйФорматВыгрузки;
...
Функция СформироватьСтруктуруОбязательныхРеквизитовСтатистическогоОтчета(Организация = Неопределено) Экспорт 
	...
	Если ЗначениеЗаполнено(Организация) Тогда
		...
		Иначе
			...
			КИ = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъекта(Организация, ВидКИ, ТекущаяДатаСеанса(), Ложь);
			Если ТипЗнч(КИ) = Тип("ТаблицаЗначений") И КИ.Количество() = 0 Тогда
...
Процедура УдалитьНомерКорректировки(ТитульнаяСтраница) Экспорт 
	...
	Если НК <> Неопределено Тогда
		ТитульнаяСтраница.УдалитьОбласть(НК, ТипСмещенияТабличногоДокумента.ПоВертикали);
	КонецЕсли;
	НК = ТитульнаяСтраница.Области.Найти("ДанныеПредыдущегоПериода");
	Если НК <> Неопределено Тогда
		ТитульнаяСтраница.УдалитьОбласть(НК, ТипСмещенияТабличногоДокумента.ПоВертикали);
	КонецЕсли;
КонецПроцедуры
...
Функция ВидКонтролирующегоОргана(ИмяОтчета) Экспорт
	...
	Иначе
		...
		ИначеЕсли СтрНайти(ИмяОтчета, "ОкрСреда") > 0
				...
				ИЛИ СтрНайти(ИмяОтчета, "ДекларацияОВоздействииНаОкружающуюСреду") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.РПН;
		ИначеЕсли СтрНайти(ИмяОтчета, "ОперацииСДенежнымиСредствамиНФО") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.УдалитьБанкРоссии;
		ИначеЕсли СтрНайти(ИмяОтчета, "СтатистикаБанкРоссии") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ЦБ;
		ИначеЕсли СтрНайти(ИмяОтчета, "Статистика") > 0 Тогда // должна осуществляться после проверки на "СтатистикаБанкРоссии"
...
Процедура ЗаписьОбъектовРегламентированнойОтчетности(Источник, Отказ) Экспорт
	...
	ИначеЕсли ТипЗнч(Ссылка) = Тип("СправочникСсылка.МашиночитаемыеДоверенностиРаспределенныйРеестр") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьМашиночитаемыеДоверенностиРРВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
	ИначеЕсли ТипЗнч(Ссылка) = Тип("СправочникСсылка.МашиночитаемыеДоверенностиФНС") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьМашиночитаемыеДоверенностиФНСВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
	ИначеЕсли ТипЗнч(Ссылка) = Тип("СправочникСсылка.ЗаявленияОбОтзывеМЧДФНС") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьЗаявлениеОбОтзывеМЧДФНСВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
	ИначеЕсли ТипЗнч(Ссылка) = Тип("СправочникСсылка.МашиночитаемыеДоверенностиФСС") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьМашиночитаемыеДоверенностиФССВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
	ИначеЕсли ДокументооборотСКОКлиентСервер.ПодсистемаЦБСуществует()
		...
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьМашиночитаемыеДоверенностиЦБВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
	...
	ИначеЕсли ТипЗнч(Ссылка) = Тип("ДокументСсылка.УведомлениеОПредоставленииПолномочийПредставителю") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьУведомлениеОПредоставленииПолномочийПредставителюВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
	ИначеЕсли ТипЗнч(Ссылка) = Тип("ДокументСсылка.УведомлениеОПрекращенииПолномочийПредставителя") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьУведомлениеОПрекращенииПолномочийПредставителяВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
...
Процедура ВставитьПоказательВТаблицуОценкиРисков(ТаблицаПоказателей, ОписаниеОтчета)
	...
	ИначеЕсли ОписаниеОтчета.ИсточникОтчета = "РегламентированныйОтчетЕФС1ОСС" Тогда
		ВставитьПоказатели_ЕФС1ОСС(ТаблицаПоказателей, ОписаниеОтчета);
...
Процедура ВставитьПоказатели_Имущество(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2022Кв4"
...
Процедура ВставитьПоказатели_НалогНаИгорныйБизнес(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2021Кв4" Тогда
...
Процедура ВставитьПоказатели_УСН(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2023Кв1"
		...
		Если ЗначениеЗаполнено(ПоказательОтчета(Раздел11, "П000110002003"))
		 ...
		 ИЛИ ЗначениеЗаполнено(ПоказательОтчета(Раздел11, "П000110010103"))
		...
		Если ЗначениеЗаполнено(ПоказательОтчета(Раздел12, "П000120002003"))
		 ...
		 ИЛИ ЗначениеЗаполнено(ПоказательОтчета(Раздел12, "П000120010103"))
...
Процедура ВставитьПоказатели_3НДФЛ(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Отчеты["РегламентированныйОтчет3НДФЛ"].ВставитьПоказателиОценкиРискаВыезднойНалоговойПроверки(ТаблицаПоказателей, ОписаниеОтчета);
...
Процедура ВставитьПоказатели_4ФСС(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2022Кв2"
		ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2017Кв3"
		ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2017Кв1" Тогда
...
Процедура ВставитьПоказатели_АкцизыАлкоголь(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2020Кв4"
...
Процедура ВставитьПоказатели_ЕФС1ОСС(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2023Кв1" Тогда
		...
		Иначе
			...
			СреднесписочнаяЧисленность = ПоказательОтчета(Раздел2, "П000020000100");
			СуммаВыплатФизическимЛицам = ПоказательОтчета(Раздел2, "П000210000103");
...
Функция РеглОтчеты(Наим, НеЗапоминатьВКэше = Ложь, ВыводитьСообщение = Истина) Экспорт
	...
	Если НЕ ПризнакИспользованияВнешнегоОтчетаСУчетомКэша(НайденныйЭлемент, НеЗапоминатьВКэше) ИЛИ НайденныйЭлемент.ВнешнийОтчетХранилище = Неопределено Тогда // используется внутренний отчет
		...
		Иначе
			Если ВыводитьСообщение Тогда
				ОбщегоНазначения.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не найден отчет %1!'"), СокрП(Наим)));
			КонецЕсли;
	...
	Иначе // используется внешний отчет
		...
		Исключение
			Если ВыводитьСообщение Тогда
				ОбщегоНазначения.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не удалось запустить внешний отчет %1!'"), СокрП(Наим)));
			КонецЕсли;
...
Функция ПродолжитьПриНесоответствииВерсийФорм(Знач ВерсияФормы, Знач мВерсияФормы) Экспорт
	...
	Если ДатамВерсияФормы < ДатаВерсияФормы Тогда
		ОбщегоНазначения.СообщитьПользователю(
			...
			НСтр("ru='Сохраненные данные не могут быть открыты текущей версией отчета!%1Версия отчета - от %2Версия данных - от %3'"),
				Символы.ПС, Формат(ДатамВерсияФормы, "ДЛФ=DD; ДП='Пустая дата'") + Символы.ПС, Формат(ДатаВерсияФормы,  "ДЛФ=DD; ДП='Пустая дата'")));
		Возврат Ложь;
	КонецЕсли;
...
Функция ВывестиСведенияСлужебнойЧасти30(Текст, Организация = Неопределено, Знач ДатаДок = Неопределено, Знач ОргИНН = Неопределено, Знач ОргКПП = Неопределено, Знач КодИнсп = Неопределено, ТипИнф = "ОТЧЕТНОСТЬНП", ВерсияФормата = "3.00") Экспорт
	...
	Если ПустаяСтрока(ОргИНН) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Невозможно определить ИНН организации! Выгрузка прервана!'"));
		Возврат Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(КодИНСП) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Невозможно определить код налоговой инспекции! Выгрузка прервана!'"));
		Возврат Ложь;
	КонецЕсли;
...
Функция ВывестиСведенияОбОтправителе30(Текст, Организация = Неопределено, Знач ОргНазв = Неопределено, Знач ОргТелефон = Неопределено, Знач ОргБухгалтер = Неопределено, ВыгрузкаДекларацииПоАлкоголю = Ложь) Экспорт
	...
	Если ПустаяСтрока(ИНН) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Невозможно определить вид налогоплательщика! Выгрузка прервана!'"));
		Возврат Ложь;
	КонецЕсли;
	...
	Если ПустаяСтрока(ОргНазв) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Невозможно определить полное название организации! Выгрузка прервана!'"));
		Возврат Ложь;
	КонецЕсли;
	
	Если КатегорияНП = 1 И ПустаяСтрока(ОргБухгалтер) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Невозможно определить ФИО главного бухгалтера организации! Выгрузка прервана!'"));
		Возврат Ложь;
	КонецЕсли;
	...
	Иначе
		...
		Если ПустаяСтрока(ФИООтпрФЛ) Тогда
			ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Невозможно определить ФИО индивидуального предпринимателя! Выгрузка прервана!'"));
			Возврат Ложь;
		КонецЕсли;
		...
		Если БылаЦифра Тогда
			...
			Исключение
				ОбщегоНазначения.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Ошибки преобразования номера из окончания: %1 === %2'"), Корень, Номер));
			КонецПопытки;
			Стр.Имя = Корень;
		КонецЕсли;
...
Функция ПолучитьСчетчикВыгруженныхФайлов(Организация, ТипСчетчика = Неопределено, Знач ДатаОтчета = Неопределено, ИФНС = "") Экспорт
	...
	Запрос.УстановитьПараметр("ИФНС", ИФНС);
	РезультатЗапроса = Запрос.Выполнить();
	Если НЕ РезультатЗапроса.Пустой() Тогда
		Выборка = РезультатЗапроса.Выбрать();
		Если Выборка.Следующий() Тогда
...
Функция ВывестиНаПечатьЛистРаздела(ЗаголовокФормы, СтруктураПараметровЛиста, ТабличноеПоле)
	...
	Пока МаксимальноеКоличествоОбластейМногострочнойЧасти(МногострочныеЧасти) > 0 Цикл
		...
		Для Сч = 0 По СписокВыводимыхНаПечатьОбластей.Количество() - 1 Цикл
			...
			Если КолвоЛистов > 1 И СтрНачинаетсяС(
				ВРЕГ(СписокВыводимыхНаПечатьОбластей.Получить(Сч).Представление), ВРЕГ("ЧастьТолькоДляПервойСтраницы")) Тогда
				Продолжить;
			КонецЕсли;
...
Процедура ВставитьДополнительнуюСтраницуНаСервере(Форма, ИмяТекущейСтраницыПанели = Неопределено, СохранятьДанныеТекущейСтраницы = Истина) Экспорт
	...
	Иначе
		...
		Если МаксКолвоЭкз<>0 И Форма[Форма.мСтруктураМногостраничныхРазделов[ИмяТекущейСтраницыПанели]].Количество() >= МаксКолвоЭкз Тогда
			...
			ОбщегоНазначения.СообщитьПользователю(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='В разделе ""%1"" максимальное количество экземпляров страниц равно %2.'"), ЗаголовокСтраницы, МаксКолвоЭкз));
			Возврат;
		КонецЕсли;
	КонецЕсли;
...
Функция СтруктураНастроекВидимости()
	Возврат Новый Структура("ПостояннаяВидимость,ТекстПредупреждения,ПоказыватьВФорме,ОбщаяФормаЗаголовок,ОбщаяФормаСсылка", Ложь,,Ложь);
КонецФункции

Функция НастройкиВидимостиЭлементовФормы(Форма, НастройкиВидимости = Неопределено) Экспорт
	Форма_ИмяФормы = СтрЗаменить(Форма.ИмяФормы, "Внешний", "");
	ИДОтчета = Сред(Лев(Форма_ИмяФормы, СтрНайти(Форма_ИмяФормы, ".Форма.") - 1), 7);
	ИДРедакцииОтчета = Сред(Форма_ИмяФормы, СтрНайти(Форма_ИмяФормы, ".Форма.") + 7);
	НастройкиВидимости = СтруктураНастроекВидимости();
...
Функция ПолучитьАктуальнуюФормуУведомления(ВидУведомления, Дата = Неопределено) Экспорт 
	...
	Если ТаблицаФорм.Количество() > 0 Тогда 
		Возврат ТаблицаФорм[ТаблицаФорм.Количество() - 1].ИмяФормы;
	КонецЕсли;
...
Функция ОтображаетсяРазделДопФайловБухотчетности(ФормаВПриложении) Экспорт
	
	Результат =  Ложь;
	
	Для Каждого СтрокаУровня1 Из ФормаВПриложении.мДеревоВыбранныхСтраниц.ПолучитьЭлементы() Цикл
		ЭтоЗакладкаДополнительныхФайлов = (СтрокаУровня1.ИмяСтраницы = "ДополнительныеФайлы");
		Если НЕ ЭтоЗакладкаДополнительныхФайлов Тогда
			Продолжить;
		КонецЕсли;
...
Процедура БлокировкаКнопокПриОтстутствииФорматаРосстата(Форма) Экспорт
	
	ВерсияФорматаВыгрузки = ПолучитьВерсиюФорматаВыгрузки(Форма);
	
	Если ВерсияФорматаВыгрузки <> Перечисления.ВерсииФорматовВыгрузки.ВерсияФСГС Тогда 
		СпрятатьЭлемент(Форма.Элементы, "ФормаПроверитьКонтрольныеСоотношенияИзШаблона");
		СпрятатьЭлемент(Форма.Элементы, "ПроверитьВыгрузку");
		СпрятатьЭлемент(Форма.Элементы, "ПроверитьВИнтернете");
		СпрятатьЭлемент(Форма.Элементы, "ОтправитьЧерезПредставителя");
		СпрятатьЭлемент(Форма.Элементы, "ОтправитьВКонтролирующийОрган");
		СпрятатьЭлемент(Форма.Элементы, "Выгрузить");
		СпрятатьЭлемент(Форма.Элементы, "Загрузить");
		СпрятатьЭлемент(Форма.Элементы, "Сравнить");
		
		СпрятатьЭлемент(Форма.Элементы, "Проверка");
		СпрятатьЭлемент(Форма.Элементы, "Отправка");
	КонецЕсли;
КонецПроцедуры

Функция ВидимостьОбластиДанныеПредыдущегоПериода(Форма, ИмяТД = "ПолеТабличногоДокументаФормаОтчета") Экспорт
	
	Если ПолучитьВерсиюФорматаВыгрузки(Форма) = Неопределено Тогда
		
		ТабДок = Форма[ИмяТД];
		ОблДанные = ТабДок.Области.Найти("ДанныеПредыдущегоПериода");
		Если ОблДанные <> Неопределено Тогда
			ТабДок.УдалитьОбласть(ОблДанные, ТипСмещенияТабличногоДокумента.ПоВертикали);
		КонецЕсли;
...
Процедура ДополнитьСтруктуруМногострочныхЧастей(Параметры, СтруктураМногострочныхЧастей) Экспорт
	...
	РегламентированнаяОтчетностьПереопределяемый.ДополнитьСтруктуруМногострочныхЧастей(
		Параметры, СтруктураМногострочныхЧастей);
	
КонецПроцедуры

// Конструктор параметров процеруры РегламентированнаяОтчетность.ДополнитьСтруктуруМногострочныхЧастей.
// 
// Возвращаемое значение:
//   Структура:
//     * Организация - СправочникСсылка.Организации -
...
//
Функция ПараметрыДополненияСтруктурыМногострочныхЧастей() Экспорт
	
	Параметры = Новый Структура();
	Параметры.Вставить("Организация", Справочники.Организации.ПустаяСсылка());
	Параметры.Вставить("ГруппаОрганизаций", Новый СписокЗначений());
	Параметры.Вставить("мДатаНачалаПериодаОтчета", '0001-01-01');
	Параметры.Вставить("мДатаКонцаПериодаОтчета", '0001-01-01');
...
Процедура ИзменитьВерсиюФорматаСПроверкойСовместимостиШаблонов(Форма, ИмяМакетаАттрибутов, ИмяМакетаШаблона, ПараметрыВыгрузки) Экспорт
	Попытка
		...
		Пока Выборка.Следующий() Цикл
			...
			ИтоговоеИмяШаблона = ИмяМакетаШаблона;
			Для Каждого Мкт Из ОбъектОтчетаСтатистики.Метаданные().Макеты Цикл 
				Если СтрНачинаетсяС(Мкт.Имя, "EF_")
					И СтрЗаканчиваетсяНа(Мкт.Имя, ИмяМакетаШаблона) Тогда 
					ИтоговоеИмяШаблона = Мкт.Имя;
				КонецЕсли;
			КонецЦикла;
			
			Если НЕ УниверсальныйОтчетСтатистики.СравнитьСтруктурыШаблонов(Выборка.Шаблон,
				ОбъектОтчетаСтатистики.ПолучитьМакет(ИтоговоеИмяШаблона)) Тогда
				Продолжить;
			КонецЕсли;
...
Процедура ПриСозданииНаСервере(Форма, Объект)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПроцессыОбработкиДокументов") Тогда
		...
		Источник.Вставить("Ссылка", Объект);
		Источник.Вставить("ИсточникОтчета", РегламентированнаяОтчетностьВызовСервера.ИсточникОтчета(Форма.ИмяФормы));
	
		МодульПроцессыОбработкиДокументов = ОбщегоНазначения.ОбщийМодуль("ПроцессыОбработкиДокументов");
	
		МодульПроцессыОбработкиДокументов.ПриСозданииНаСервере(Форма, Источник, , Форма.КоманднаяПанель);
...
Процедура ЗапретитьРедактированиеРеквизитовСданногоОтчета(Форма, КонтролирующийОрган = "ФНС") Экспорт
	...
	Если НЕ (ТипЗнч(СвойстваФормы.СтруктураРеквизитовФормы) = Тип("Структура")
		И СвойстваФормы.СтруктураРеквизитовФормы.Свойство("мСохраненныйДок", СохраненныйДок)
		И ЗначениеЗаполнено(СохраненныйДок)) Тогда
		Возврат;
	КонецЕсли;
	...
	СтатусОтправкиВЖурнале = СохраненныйСтатусОтправкиРеглОтчета(СохраненныйДок);
	...
	Если ЗапретитьРедактированиеПользователем Тогда
		Попытка
			...
			Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ЗапретРедактированияРеквизитовОбъектов") Тогда
				...
				МодульЗапретРедактированияРеквизитовОбъектов.ЗаблокироватьРеквизиты(Форма,,
					НСтр("ru = 'Разрешить редактирование отчета'"), СохраненныйДок);
			КонецЕсли;
			
			ПараметрыЗапретаРедактированияРеквизитов = Неопределено; // заполнен, если форма потготовлена.
			РеквизитыФормы = Форма.ПолучитьРеквизиты();
			Для Каждого РеквизитФормы Из РеквизитыФормы Цикл
				Если РеквизитФормы.Имя = "ПараметрыЗапретаРедактированияРеквизитов" Тогда
					ПараметрыЗапретаРедактированияРеквизитов = РеквизитФормы;
					Прервать;
				КонецЕсли;
			КонецЦикла;
			
			Если ПараметрыЗапретаРедактированияРеквизитов = Неопределено Тогда
				
				БлокируемыеРеквизиты = 
					ОбщегоНазначения.МенеджерОбъектаПоСсылке(СохраненныйДок.Ссылка).ПолучитьБлокируемыеРеквизитыОбъекта();
				...
				Для Каждого БлокируемыйРеквизит Из БлокируемыеРеквизиты Цикл
					БлокируемыеЭлементы = СтрРазделить(БлокируемыйРеквизит, ";,");
					Если БлокируемыеЭлементы.Количество() > 1 Тогда
						БлокируемыеЭлементы.Удалить(0);
					КонецЕсли;
					Для Каждого БлокируемыйЭлемент Из БлокируемыеЭлементы Цикл
						ЭлементФормы = Форма.Элементы.Найти(БлокируемыйЭлемент);
			...
			ИменаПолейТабличногоДокумента = СтрРазделить("ТабличныйДокумент;ПолеТабличногоДокументаФормаОтчета", ";");
			...
			// Для проверки доступности нужных файлов в ИБ.
			...
			// Получение последнего цикла обмена отчета для последующего формирования штампа ЭП.
			...
			Если ТекущееСостояние <> Неопределено И ЗначениеЗаполнено(ЦиклОбмена) Тогда
				...
				СвойстваФормы.СтруктураРеквизитовФормы.Вставить("ПоследнийЦиклОбмена", ЦиклОбмена);
				
				ИзменитьЗаголовокКнопкиПечати = Истина;
				
				Если ЦиклОбмена.Тип = Перечисления.ТипыЦикловОбмена.ОтчетностьПФР Тогда
					ИзменитьЗаголовокКнопкиПечати = Ложь;
				КонецЕсли;
				
				// Подготовка кнопок печати.
				ЭлементПоказатьБланк = Форма.Элементы.Найти("ПоказатьБланк");
				Если ЭлементПоказатьБланк <> Неопределено И ИзменитьЗаголовокКнопкиПечати Тогда
					КомандаПоказатьБланк = Форма.Команды.Найти(ЭлементПоказатьБланк.ИмяКоманды);
					Если КомандаПоказатьБланк <> Неопределено Тогда
						ЗаголовокУточнение = "(со штампом ЭП)";
						Если ЗначениеЗаполнено(ЭлементПоказатьБланк.Заголовок) Тогда
							ЭлементПоказатьБланк.Заголовок = ЭлементПоказатьБланк.Заголовок + " " + ЗаголовокУточнение;
						Иначе
							КомандаПоказатьБланк.Заголовок = КомандаПоказатьБланк.Заголовок + " " + ЗаголовокУточнение;
						КонецЕсли;
					КонецЕсли;
					
					Если Форма.Элементы.Найти("Печать") <> Неопределено
					   И Форма.Элементы.Найти("ПоказатьСДвухмернымШтрихкодомPDF417") <> Неопределено Тогда
						Если Форма.СтруктураРеквизитовФормы.Свойство("мПечатьБезШтрихкодаРазрешена") Тогда
			...
			// Доступность элемента регулируется из модуля формы, поэтому - скрываем его.
			ЭлементОбновить = Форма.Элементы.Найти("Обновить");
			Если ЭлементОбновить <> Неопределено Тогда
				ЭлементОбновить.Видимость = Ложь; 
			КонецЕсли;
			
			Если СтатусОтправкиВЖурнале <> Неопределено Тогда
				ЭлементНаименованиеЭтапа = Форма.Элементы.Найти("НаименованиеЭтапа");
				Если ЭлементНаименованиеЭтапа <> Неопределено Тогда
					ЭлементНаименованиеЭтапа.Заголовок = СтатусОтправкиВЖурнале;
				КонецЕсли;
			КонецЕсли;
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Установка запрета редактирования сданного регламентированного отчета'"), 
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура РазрешитьРедактированиеРеквизитовОтчета(Форма) Экспорт
	...
	Для Каждого ИмяПоляТабличногоДокумента Из ИменаПолейТабличногоДокумента Цикл
		ЭлементФормыПолеТабличногоДокумента = Форма.Элементы.Найти(ИмяПоляТабличногоДокумента);
		Если НЕ ЭлементФормыПолеТабличногоДокумента = Неопределено Тогда
			// Включить действие "Выбор" в поле табличного документа.
			ЭлементФормыПолеТабличногоДокумента.УстановитьДействие("Выбор",
				СтрЗаменить(ЭлементФормыПолеТабличногоДокумента.ПолучитьДействие("Выбор"), "Отключенный_", ""));
		КонецЕсли;
	КонецЦикла;
	
	// Восстановить заголовок кнопки печати.
	ЭлементПоказатьБланк = Форма.Элементы.Найти("ПоказатьБланк");
	Если ЭлементПоказатьБланк <> Неопределено Тогда
		КомандаПоказатьБланк = Форма.Команды.Найти(ЭлементПоказатьБланк.ИмяКоманды);
		Если КомандаПоказатьБланк <> Неопределено Тогда
			Если ЗначениеЗаполнено(ЭлементПоказатьБланк.Заголовок) Тогда
				ЭлементПоказатьБланк.Заголовок = СокрП(СтрРазделить(ЭлементПоказатьБланк.Заголовок, "(")[0]);
			Иначе
				КомандаПоказатьБланк.Заголовок = СокрП(СтрРазделить(КомандаПоказатьБланк.Заголовок, "(")[0]);
			КонецЕсли; 
		КонецЕсли;
	КонецЕсли;
	
	// Удалить ссылку на последний цикл обмена - не будут выводиться в печатных формах штампы ЭП.
	Если Форма.СтруктураРеквизитовФормы.Свойство("ПоследнийЦиклОбмена") Тогда
		Форма.СтруктураРеквизитовФормы.Удалить("ПоследнийЦиклОбмена"); 
	КонецЕсли;
