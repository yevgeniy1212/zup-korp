...
Процедура ИзменитьНастройкиСкрытияПерсональныхДанных(Параметры, АдресРезультата = "") Экспорт
	...
	ИзменитьНастройкиУничтоженияПерсональныхДанных(
		Новый Структура("ИспользоватьУничтожениеПерсональныхДанных", Параметры.ИспользоватьСкрытиеПерсональныхДанных),
		АдресРезультата);
...
//   * ДатаСобытия - Дата
// 
// Возвращаемое значение - см. НоваяТаблицаСроковХранения
