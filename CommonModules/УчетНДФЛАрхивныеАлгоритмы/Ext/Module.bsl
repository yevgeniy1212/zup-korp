...
Функция ДанныеОДоходахНалогахВычетах2020(Сотрудники, НалоговыйПериод, Организация, РегистрацияВНалоговомОргане, ДатаАктуальности, КППОтправки, ПодробныеДанные, ДополнительныйОтбор) Экспорт
		...
		Для Каждого ТекущаяСтрока Из ДоходыТекущегоРегистратора Цикл
			...
			Если СоответствиеФизическихЛиц[ТекущаяСтрока.ФизическоеЛицо] = Истина
				...
				Если ОкончательныйРасчет И ЗначениеЗаполнено(ТекущаяСтрока.ЗарегистрированоПриНачисленииАванса) Тогда
					// Зачтем выплаченное в аванс в счет начисленного в окончательном расчете с сохраненением фактической даты получения дохода по выплаченному авансу.
