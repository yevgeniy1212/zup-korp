...
Процедура ОснованияУвольненияУстановитьОтборПоказатьНеИспользуемые(УправляемаяФорма) Экспорт
	
	Если УправляемаяФорма.Элементы.ФормаПоказатьНеИспользуемые.Пометка Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
			УправляемаяФорма.Список, "ВАрхиве", Ложь, Ложь);
		
	Иначе
		
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
			УправляемаяФорма.Список, "ВАрхиве", Ложь, Истина);
		
	КонецЕсли;
	
КонецПроцедуры

Процедура ОснованияУвольненияУстановитьОтборТолькоДействующих(УправляемаяФорма) Экспорт
	
	Если УправляемаяФорма.Элементы.ФормаТолькоДействующие.Пометка Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
			УправляемаяФорма.Список, "РабочаяДата", УправляемаяФорма.РабочаяДата, Истина);
		
	Иначе
		
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
			УправляемаяФорма.Список, "РабочаяДата", УправляемаяФорма.РабочаяДата, Ложь);
