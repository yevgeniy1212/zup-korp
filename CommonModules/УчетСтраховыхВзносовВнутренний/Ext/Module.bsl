...
Процедура СформироватьВТКадровыхДанных(Организация, ПериодРегистрации, МенеджерВременныхТаблиц, УточнятьПериодКадровыхДанных = Истина, МенеджерКадровогоУчета = Неопределено) Экспорт
	УчетСтраховыхВзносовРасширенный.СформироватьВТКадровыхДанных(Организация, ПериодРегистрации, МенеджерВременныхТаблиц, МенеджерКадровогоУчета)
КонецПроцедуры
...
Процедура ДополнитьПоляЗапросаРабочимМестом(Запрос, ИмяТаблицы, ДобавитьПредставление, ВключатьИспользованиеРесурса, ЗамещатьДолжность) Экспорт
	УчетСтраховыхВзносовРасширенный.ДополнитьПоляЗапросаРабочимМестом(Запрос, ИмяТаблицы, ДобавитьПредставление, ВключатьИспользованиеРесурса, ЗамещатьДолжность);
КонецПроцедуры
