	...
	Для Каждого Задание Из Найденные Цикл
		...
		Иначе
			...
			Исключение
				...
				ТекстОшибки = НСтр("ru = 'Не удалось удалить дублирующее регламентное задание по причине:'") + Подробно;
