...
Процедура ОбновлениеКлассификаторов() Экспорт
	...
	ИначеЕсли РежимОбновления = 1 Тогда
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		// ЗУПК
		Если НЕ (ВыборкаДетальныеЗаписи.Идентификатор = "MinMonthlyWageKz" 
			ИЛИ ВыборкаДетальныеЗаписи.Идентификатор = "MonthlyCalcIndexKz"
			ИЛИ ВыборкаДетальныеЗаписи.Идентификатор = "EffectiveDatesOfRegulatoryActs") Тогда
