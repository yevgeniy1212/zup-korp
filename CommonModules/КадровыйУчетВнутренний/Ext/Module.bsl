...
Процедура ДополнитьИменаКадровыхДанных(КадровыеДанные) Экспорт
	...
	КадровыйУчетРасширенный.ДополнитьИменаКадровыхДанных(КадровыеДанные);
	
КонецПроцедуры

Процедура ДополнитьПоляЗапросаВТКадровыхДанных(Запрос) Экспорт
	
	КадровыйУчетРасширенный.ДополнитьПоляЗапросаВТКадровыхДанных(Запрос);
...
Процедура ДобавитьВКоллекциюКадровыеДанныеДляСведенийОКлассахУсловийТруда(ИсточникиДанных, ИмяПоля) Экспорт
	КадровыйУчетРасширенный.ДобавитьВКоллекциюКадровыеДанныеДляСведенийОКлассахУсловийТруда(ИсточникиДанных, ИмяПоля);
КонецПроцедуры

Функция ИмяИсточникаДанныхКадровойИсторииСотрудников(ИсточникиДанных) Экспорт
	Возврат КадровыйУчетРасширенный.ИмяИсточникаДанныхКадровойИсторииСотрудников(ИсточникиДанных);
КонецФункции

Процедура ДобавитьСоединениеСКадровымиДанными(ОписательВременнойТаблицыОтборов, ЧастиЗапроса, ИмяПоляДолжность) Экспорт
	КадровыйУчетРасширенный.ДобавитьСоединениеСКадровымиДанными(ОписательВременнойТаблицыОтборов, ЧастиЗапроса, ИмяПоляДолжность);
КонецПроцедуры
...
Функция ПутьКДаннымСведенийОбУсловияхДоговоровОпеки(ИмяПоля) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ПутьКДаннымСведенийОбУсловияхДоговоровОпеки(ИмяПоля);
...
Процедура ДобавитьТекстЗапросаВТСведенияОбУсловияхДоговоровОпеки(Запрос, ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных) Экспорт
	...
	КадровыйУчетРасширенный.ДобавитьТекстЗапросаВТСведенияОбУсловияхДоговоровОпеки(Запрос, ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных);
...
Функция ДобавитьПолеСведенийМестРаботыСотрудников(ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ДобавитьПолеСведенийМестРаботыСотрудников(ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных);
	
КонецФункции

Функция ПутьКДаннымСведенийМестРаботыСотрудников(Знач ИмяПоля) Экспорт
	
	Возврат КадровыйУчетРасширенный.ПутьКДаннымСведенийМестРаботыСотрудников(ИмяПоля);
...
Процедура ПриЗаписиНастроекКадровогоУчета(НаборЗаписей, Отказ) Экспорт
	...
	КадровыйУчетРасширенный.ПриЗаписиНастроекКадровогоУчета(НаборЗаписей, Отказ);
...
Функция ПравоИзмененияКадровогоСостояния() Экспорт
	...
	Возврат КадровыйУчетРасширенный.ПравоИзмененияКадровогоСостояния();
...
Функция ПутьКДаннымСведенийОДолеНеполногоРабочегоВремени(ИмяПоля) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ПутьКДаннымСведенийОДолеНеполногоРабочегоВремени(ИмяПоля);
...
Процедура ОписаниеГрафикаРаботыДляСправкиПоБезработице(ВходящиеДанные, ШаблонОписанияГрафика, СуммированныйУчетРабочегоВремени, ИсходящиеДанные) Экспорт
	...
	КадровыйУчетРасширенный.ОписаниеГрафикаРаботыДляСправкиПоБезработице(ВходящиеДанные, ШаблонОписанияГрафика, СуммированныйУчетРабочегоВремени, ИсходящиеДанные);
...
// См. КадровыйУчетРасширенный.СвязанныеОбъектыДанныхФизическогоЛица
Функция СвязанныеОбъектыДанныхФизическогоЛица(ДанныеФизическогоЛица) Экспорт
	
	Возврат КадровыйУчетРасширенный.СвязанныеОбъектыДанныхФизическогоЛица(ДанныеФизическогоЛица);
...
Процедура ЗаполнитьНастройкиПечатныхФормПоУмолчанию(ОписанияНастроек) Экспорт
	...
	КадровыйУчетРасширенный.ЗаполнитьНастройкиПечатныхФормПоУмолчанию(ОписанияНастроек);
...
Функция ПриостановленияТрудовыхДоговоров(ТолькоРазрешенные, ТаблицаОтбора, Отбор) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ПриостановленияТрудовыхДоговоров(ТолькоРазрешенные, ТаблицаОтбора, Отбор);
