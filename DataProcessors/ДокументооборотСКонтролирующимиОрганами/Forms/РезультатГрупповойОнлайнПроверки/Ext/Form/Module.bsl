...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТаблицаСРезультатами.Колонки.Найти("РезультатПроверкиВУниверсальномФормате") <> Неопределено Тогда
		ТаблицаСРезультатами.Колонки.Удалить("РезультатПроверкиВУниверсальномФормате");
	КонецЕсли;
