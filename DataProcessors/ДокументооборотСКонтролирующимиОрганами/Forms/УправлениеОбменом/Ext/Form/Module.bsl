...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаПФР.Заголовок = ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(Элементы.ГруппаПФР.Заголовок,
		Истина);
	Элементы.ГруппаФСС.Заголовок = ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(Элементы.ГруппаФСС.Заголовок,
		Истина);
	...
	ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров =
		ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСерверПереопределяемый.ИмяОбъектаМетаданных(
		"УведомлениеОбОстаткахПрослеживаемыхТоваров");
	ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров =
		ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСерверПереопределяемый.ИмяОбъектаМетаданных(
		"УведомлениеОВвозеПрослеживаемыхТоваров");
	ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров =
		ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСерверПереопределяемый.ИмяОбъектаМетаданных(
	...
	сохрТекущаяСтраницаПанелиРПН = Неопределено;
	
	ВосстановитьНастройкиСтраниц(
		сохрТекущаяСтраницаПанелиФормы,
		сохрТекущаяСтраницаПанелиФНС,
		сохрТекущаяСтраницаПанелиПФР,
		сохрТекущаяСтраницаПанелиФСГС,
		сохрТекущаяСтраницаПанелиРПН);
	...
	Если ДокументооборотСКОКлиентСервер.ПодсистемаЦБСуществует() Тогда
		КартинкаЦБ = "ЦБ";
		Элементы.ГруппаЦБ.Картинка = БиблиотекаКартинок[КартинкаЦБ];
		Элементы.ГруппаЦБ.Видимость = Истина;
	КонецЕсли;
	
	УправлениеЗакладкойУведомлений();
	УправлениеЗакладкойОтветыНаТребования();
	
	УстановитьПараметрыПроизвольныхЗапросов(
		сохрТекущаяСтраницаПанелиФормы,
		сохрТекущаяСтраницаПанелиФНС,
		сохрТекущаяСтраницаПанелиПФР,
		сохрТекущаяСтраницаПанелиФСГС,
...
Процедура ТаблицаИсходящиеДокументыПФРПриАктивизацииСтроки(Элемент)
	...
	Если Элемент.Видимость Тогда
		Если ЦиклыОбменаИсходящиеПФР.Параметры.Элементы.Найти(Новый ПараметрКомпоновкиДанных("СсылкаДляОтбора")) <> Неопределено
			...
			ЭтоУведомление = (ТипЗнч(Ссылка) = Тип("ДокументСсылка.УведомлениеОПредоставленииПолномочийПредставителю")
				ИЛИ ТипЗнч(Ссылка) = Тип("ДокументСсылка.УведомлениеОПрекращенииПолномочийПредставителя"));
			Элементы.ТаблицаЦиклыОбменаИсходящиеПФРКолонка5.Видимость = ЭтоЗаявление ИЛИ ЭтоУведомление;
			Элементы.ТаблицаЦиклыОбменаИсходящиеПФРКолонка6.Видимость = ЭтоЗаявление ИЛИ ЭтоУведомление;
...
&НаКлиенте
Процедура КоманднаяПанельЦиклыОбменаНайтиОтчетЦБВСписке(Команда)
	
	Если Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.ВыделенныеСтроки.Количество() > 0 Тогда
		ПредметыЦиклаОбмена = КонтекстЭДОКлиент.ПолучитьПредметыЦиклаОбмена(Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.ВыделенныеСтроки[0]);
		Для Каждого Предмет Из ПредметыЦиклаОбмена Цикл
			ТипЗнчПредмет = ТипЗнч(Предмет);
			Если ТипЗнчПредмет = Тип("ДокументСсылка.РегламентированныйОтчет") Тогда
				НачатьЗамерВремени();
...
&НаКлиенте
Процедура КоманднаяПанельОтчетностьЦБВыгрузить(Команда)
	
	ВидимыеЦиклы = Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.ВыделенныеСтроки;
...
&НаКлиенте
Процедура КоманднаяПанельОтчетностьЦБВыгрузитьКонтейнеры(Команда)
...
&НаКлиенте
Процедура КоманднаяПанельОтчетностьЦБВыгрузитьСодержимое(Команда)
...
&НаКлиенте
Процедура КоманднаяПанельЦиклыОбменаРегламентированныйОтчетЦБ(Команда)
	
	Предмет = Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.ТекущиеДанные;
	
	КоличествоВыделенныхСтрок = Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.ВыделенныеСтроки.Количество();
	Если КоличествоВыделенныхСтрок > 0 Тогда
		Предмет = Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.ВыделенныеСтроки[0];
		ПоказатьЗначение(, ПолучитьСсылкуНаРеквизит(Предмет, "Предмет"));
	КонецЕсли;
...
&НаКлиенте
Процедура КомандаИсходящиеДокументыПФРСоздатьУведомлениеОПредоставленииПолномочийПредставителю(Команда)
	
	ДокументооборотСКОКлиент.СоздатьНовоеИлиОткрытьУведомлениеОПредоставленииПолномочийПредставителю();
	
КонецПроцедуры

&НаКлиенте
Процедура КомандаИсходящиеДокументыПФРСоздатьУведомлениеОПрекращенииПолномочийПредставителя(Команда)
	
	ДокументооборотСКОКлиент.СоздатьНовоеИлиОткрытьУведомлениеОПрекращенииПолномочийПредставителя();
...
Процедура КомандаОбновитьОтчетностьФНС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаЦиклыОбменаОтчетностьФНС);
...
Процедура КомандаОбновитьИсходящиеДокументыФНС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаИсходящиеДокументыФНС);
...
Процедура КомандаОбновитьВходящиеДокументыФНС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаВходящиеДокументыФНС);
...
Процедура КомандаОбновитьОтчетностьПФР(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаЦиклыОбменаОтчетностьПФР);
...
Процедура КомандаОбновитьИсходящиеДокументыПФР(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаИсходящиеДокументыПФР);
...
Процедура КомандаОбновитьВходящиеДокументыПФР(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаВходящиеДокументыПФР);
...
Процедура КомандаОбновитьТранспортноеСообщение(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТранспортноеСообщение);
...
Процедура КомандаОбновитьОтчетностьФСГС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаЦиклыОбменаОтчетностьФСГС);
	
КонецПроцедуры

&НаКлиенте
Процедура КомандаОбновитьОтчетностьЦБ(Команда)
	
	Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.Обновить();
...
Процедура КомандаОбновитьИсходящиеДокументыФСГС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаИсходящиеДокументыФСГС);
...
Процедура КомандаОбновитьВходящиеДокументыФСГС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаВходящиеДокументыФСГС);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИмяСобытияЗаписиДокументаУведомлениеОКонтролируемыхСделках = 
		?(НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОКонтролируемыхСделках),
		"", "Запись_" + ИмяДокументаУведомлениеОКонтролируемыхСделках);
	ИмяСобытияЗаписиДокументаЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ =
		?(НЕ ЗначениеЗаполнено(ИмяДокументаЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ),
		"", "Запись_" + ИмяДокументаЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ);
	ИмяСобытияЗаписиДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров =
		?(НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров),
		"", "Запись_" + ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров);
	ИмяСобытияЗаписиДокументаУведомлениеОВвозеПрослеживаемыхТоваров =
		?(НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров),
		"", "Запись_" + ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров);
	ИмяСобытияЗаписиДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров =
		?(НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров),
		"", "Запись_" + ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров);
	...
	ИначеЕсли ИмяСобытия = "Запись_ЭлектронныеПредставленияРегламентированныхОтчетов" 
		...
		ИЛИ ИмяСобытия = ИмяСобытияЗаписиДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров
		ИЛИ ИмяСобытия = ИмяСобытияЗаписиДокументаУведомлениеОВвозеПрослеживаемыхТоваров
		ИЛИ ИмяСобытия = ИмяСобытияЗаписиДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров
	...
	ИначеЕсли ИмяСобытия = "Запись_ОписиИсходящихДокументовВНалоговыеОрганы" 
		...
		И ТипЗнч(Источник) = Тип("ДокументСсылка.ЗаявленияПоЭлДокументооборотуСПФР")
		ИЛИ ИмяСобытия = "Запись_УПУП"
		И ТипЗнч(Источник) = Тип("ДокументСсылка.УведомлениеОПредоставленииПолномочийПредставителю")
		ИЛИ ИмяСобытия = "Запись_УПРУП"
		И ТипЗнч(Источник) = Тип("ДокументСсылка.УведомлениеОПрекращенииПолномочийПредставителя") Тогда
		
		
		ТаблицаФормыОбновить(Элементы.ТаблицаТребования);
		ТаблицаФормыОбновить(Элементы.ТаблицаПредставления);
		ТаблицаФормыОбновить(Элементы.ТаблицаИсходящиеДокументыПФР);
		ТаблицаФормыОбновить(Элементы.ТаблицаИсходящиеДокументыФСГС);
		ТаблицаФормыОбновить(Элементы.ТаблицаИсходящиеДокументыФНС);
	...
	ИначеЕсли ИмяСобытия = "Показать циклы обмена уведомления" 
		...
		Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров) Тогда
			Если Тип("ДокументСсылка." + ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров) = ТипЗначенияПараметра Тогда
				СменитьЗакладкуУведомленийПриНеобходимости("УведомленияОбОстаткахПрослеживаемыхТоваров", Ложь);
			КонецЕсли;
		КонецЕсли;
		
		Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров) Тогда
			Если Тип("ДокументСсылка." + ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров) = ТипЗначенияПараметра Тогда
				СменитьЗакладкуУведомленийПриНеобходимости("УведомленияОВвозеПрослеживаемыхТоваров", Ложь);
			КонецЕсли;
		КонецЕсли;
		
		Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров) Тогда
			Если Тип("ДокументСсылка." + ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров) = ТипЗначенияПараметра Тогда
				СменитьЗакладкуУведомленийПриНеобходимости("УведомленияОПеремещенииПрослеживаемыхТоваров", Ложь);
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли ИмяСобытия = "Показать циклы обмена отчета ЦБ"
		И ДокументооборотСКОКлиентСервер.ПодсистемаЦБСуществует() Тогда
		
		Элементы.ГруппаСтраниц.ТекущаяСтраница = Элементы.ГруппаЦБ;
		Элементы.ГруппаСтраницыЦБ.ТекущаяСтраница = Элементы.ОтчетностьЦБ;
		ПриСменеСтраницы(Неопределено, Неопределено);
		
		Элементы.ОтобратьОтчетностьЦБ.Пометка = Истина;
		УстановитьВидимостьПоляПредставленияПредмета(ЭтаФорма);
		
		ПредметОтчетностиЦБ = Параметр;
...
Процедура КомандаОбновитьЗапросыИОН(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаЗапросыИОН);
...
Процедура ПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	Попытка
		ТекущаяСтраницаРПН = Элементы.ГруппаСтраницыРПН.ТекущаяСтраница.Имя;
	Исключение
		Элементы.ГруппаСтраницыРПН.ТекущаяСтраница = Элементы.ОтчетностьРПН;
		ТекущаяСтраницаРПН = Элементы.ГруппаСтраницыРПН.ТекущаяСтраница.Имя;
	КонецПопытки;
...
Процедура КомандаОбновитьЗаявление(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаЦиклыОбменаЗаявление);
...
Процедура КомандаОбновитьЗапросыИОС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаЗапросыИОС);
...
Процедура КомандаОбновитьОтчетностьФСС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаОтправкиОтчетностьФСС);
...
Функция СодержимоеОтправкиФССВоВременномХранилищеНаСервере(РежимВыгрузки, СсылкаНаОбъектОтправкиФСС)
	...
	ИначеЕсли РежимВыгрузки = 1 Тогда
		...
		ЭтоРеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам = (Результат.ВидОтчета =
		...
		Результат.ИмяФайлаДляКлиента = СсылкаНаОбъектОтправкиФСС["ИдентификаторОтправкиНаСервере"]
			+ ?(ЭтоПодтверждениеВидаДеятельности ИЛИ ЭтоРеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам, ".xml", ".p7e");
...
Процедура ВыгрузитьСодержимоеОтправкиФСС(РежимВыгрузки)
	...
	Если КоличествоВыделенныхСтрок <= 0 Тогда
		ТекстПредупреждения = ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(
			НСтр("ru = 'Не выбраны отправки ФСС!'"), Истина);
	...
	ИначеЕсли РежимВыгрузки = 1 Тогда
		...
		Если АдресВоВременномХранилище = Неопределено Тогда
			...
			ЭтоРеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам = (ВидОтчетаОтправки =
				ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.РеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам"));
			ПоказатьПредупреждение(, ?(ЭтоПодтверждениеВидаДеятельности
				ИЛИ ЭтоРеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам,
				НСтр("ru = 'Квитанция отсутствует.'"), НСтр("ru = 'Квитанция об успехе отсутствует.'")));
			Возврат;
		КонецЕсли;
...
Процедура КомандаОбновитьУведомления(Команда)
	ТаблицаФормыОбновить(Элементы.ТаблицаУведомления);
...
&НаСервереБезКонтекста
Функция СуществуетРегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки()
	Если Метаданные.Отчеты.Найти("РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки") <> Неопределено Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ()
	Если Метаданные.Отчеты.Найти("РегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ") <> Неопределено Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях()
	Если Метаданные.Отчеты.Найти("РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях") <> Неопределено Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция СуществуетРегламентированныйОтчетПрослеживаемыеТоварыВвоз()
	Если Метаданные.Отчеты.Найти("РегламентированныйОтчетПрослеживаемыеТоварыВвоз") <> Неопределено Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция СуществуетРегламентированныйОтчетПрослеживаемыеТоварыПеремещение()
	Если Метаданные.Отчеты.Найти("РегламентированныйОтчетПрослеживаемыеТоварыПеремещение") <> Неопределено Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОстатки()
	Если Метаданные.Отчеты.Найти("РегламентированныйОтчетПрослеживаемыеТоварыОстатки") <> Неопределено Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
Процедура КомандаУведомленияСоздать(Команда)
	...
	Если СуществуетРегламентированныйОтчетРозничныеЦеныНаТабак() Тогда
		СписокВариантовВыбора.Добавить("УведомленияОРозничныхЦенахНаТабак",
			НСтр("ru = 'Уведомление о розничных ценах на табак'"));
	КонецЕсли;
	
	СписокВариантовВыбора.Добавить("УведомленияОПолучателеДокументов",
		НСтр("ru = 'Уведомление о получателе документов'"));
	
	СписокВариантовВыбора.Добавить("МашиночитаемыеДоверенностиФНС",
		НСтр("ru = 'Машиночитаемая доверенность (ФНС)'"));
	
	СписокВариантовВыбора.Добавить("ЗаявленияОбОтзывеМЧДФНС",
		НСтр("ru = 'Заявление об отзыве машиночитаемой доверенности (ФНС)'"));
	
	СписокВариантовВыбора.Добавить("РеестрыФНС", НСтр("ru = 'Реестр по НДС'"));
	
	СписокВариантовВыбора.Добавить("РеестрыАкцизы", НСтр("ru = 'Реестр по акцизам'"));
	
	Если ЗначениеЗаполнено(ИмяДокументаЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ) Тогда
		СписокВариантовВыбора.Добавить("АвансыНДФЛ",
			НСтр("ru = 'Заявление о подтверждении права на зачет авансов по НДФЛ'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетСтрановойОтчет() Тогда
		СписокВариантовВыбора.Добавить("СтрановыеОтчеты", НСтр("ru = 'Страновый отчет'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетУчастиеВМеждународнойГруппеКомпаний() Тогда
		СписокВариантовВыбора.Добавить("УведомленияОбУчастииВМеждународнойГруппеКомпаний",
			НСтр("ru = 'Уведомление об участии в международной группе компаний'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки() Тогда
		СписокВариантовВыбора.Добавить("ДоходыОтДеятельностиМузеяТеатраБиблиотеки",
			НСтр("ru = 'Доходы от деятельности музея, театра, библиотеки'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ() Тогда
		СписокВариантовВыбора.Добавить("ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ",
			НСтр("ru = 'Движение средств по счету в банке за пределами РФ'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях() Тогда
		СписокВариантовВыбора.Добавить("ПрослеживаемыеТоварыОтчетОбОперациях",
			НСтр("ru = 'Отчет об операциях с товарами, подлежащими прослеживаемости'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыВвоз()
		И НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров) Тогда
		СписокВариантовВыбора.Добавить("ПрослеживаемыеТоварыВвоз",
			НСтр("ru = 'Уведомление о ввозе товаров, подлежащих прослеживаемости'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыПеремещение()
		И НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров) Тогда
		СписокВариантовВыбора.Добавить("ПрослеживаемыеТоварыПеремещение",
			НСтр("ru = 'Уведомление о перемещении товаров, подлежащих прослеживаемости'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОстатки()
		И НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров) Тогда
		СписокВариантовВыбора.Добавить("ПрослеживаемыеТоварыОстатки",
			НСтр("ru = 'Уведомление об остатках товаров, подлежащих прослеживаемости'"));
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров) Тогда
		СписокВариантовВыбора.Добавить("УведомленияОбОстаткахПрослеживаемыхТоваров",
			НСтр("ru = 'Уведомление об остатках прослеживаемого товара'"));
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров) Тогда
		СписокВариантовВыбора.Добавить("УведомленияОВвозеПрослеживаемыхТоваров",
			НСтр("ru = 'Уведомление о ввозе прослеживаемых товаров'"));
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров) Тогда
		СписокВариантовВыбора.Добавить("УведомленияОПеремещенииПрослеживаемыхТоваров",
...
Процедура КомандаУведомленияСоздатьЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыбора <> Неопределено Тогда
		...
		ИначеЕсли РезультатВыбора.Значение = "МашиночитаемыеДоверенностиФНС" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("МашиночитаемыеДоверенностиФНС");
			
			ОткрытьФорму("Справочник.МашиночитаемыеДоверенностиФНС.ФормаОбъекта",
				Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "ЗаявленияОбОтзывеМЧДФНС" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ЗаявленияОбОтзывеМЧДФНС");
			
			ОткрытьФорму("Справочник.ЗаявленияОбОтзывеМЧДФНС.ФормаОбъекта",
				Новый Структура("Организация", Организация));
		...
		ИначеЕсли РезультатВыбора.Значение = "ДоходыОтДеятельностиМузеяТеатраБиблиотеки" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ДоходыОтДеятельностиМузеяТеатраБиблиотеки");
			
			ИсточникОтчета = "РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки";
			
			ОткрытьФорму("Отчет." + ИсточникОтчета + ".Форма.ОсновнаяФорма", Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ");
			
			ИсточникОтчета = "РегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ";
			
			ОткрытьФорму("Отчет." + ИсточникОтчета + ".Форма.ОсновнаяФорма", Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "ПрослеживаемыеТоварыОтчетОбОперациях" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ПрослеживаемыеТоварыОтчетОбОперациях");
			
			ИсточникОтчета = "РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях";
			
			ОткрытьФорму("Отчет." + ИсточникОтчета + ".Форма.ОсновнаяФорма", Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "ПрослеживаемыеТоварыВвоз" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ПрослеживаемыеТоварыВвоз");
			
			ИсточникОтчета = "РегламентированныйОтчетПрослеживаемыеТоварыВвоз";
			
			ОткрытьФорму("Отчет." + ИсточникОтчета + ".Форма.ОсновнаяФорма", Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "ПрослеживаемыеТоварыПеремещение" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ПрослеживаемыеТоварыПеремещение");
			
			ИсточникОтчета = "РегламентированныйОтчетПрослеживаемыеТоварыПеремещение";
			
			ОткрытьФорму("Отчет." + ИсточникОтчета + ".Форма.ОсновнаяФорма", Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "ПрослеживаемыеТоварыОстатки" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ПрослеживаемыеТоварыОстатки");
			
			ИсточникОтчета = "РегламентированныйОтчетПрослеживаемыеТоварыОстатки";
			
			ОткрытьФорму("Отчет." + ИсточникОтчета + ".Форма.ОсновнаяФорма", Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "УведомленияОбОстаткахПрослеживаемыхТоваров" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("УведомленияОбОстаткахПрослеживаемыхТоваров");
			ОткрытьФорму("Документ." + ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров + ".ФормаОбъекта",
				Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "УведомленияОВвозеПрослеживаемыхТоваров" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("УведомленияОВвозеПрослеживаемыхТоваров");
			ОткрытьФорму("Документ." + ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров + ".ФормаОбъекта",
				Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "УведомленияОПеремещенииПрослеживаемыхТоваров" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("УведомленияОПеремещенииПрослеживаемыхТоваров");
			ОткрытьФорму("Документ." + ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров + ".ФормаОбъекта",
				Новый Структура("Организация", Организация));
			
		ИначеЕсли РезультатВыбора.Значение = "ПрочиеУведомления" Тогда
			СменитьЗакладкуУведомленийПриНеобходимости("ПрочиеУведомления");
			
			МассивВидовУведомлений = ВидыПрочихОтправляемыхУведомлений(Истина);
			СтруктураПараметров = Новый Структура;
			СтруктураПараметров.Вставить("ВидыПрочихУведомлений", МассивВидовУведомлений);
...
Процедура КомандаОбновитьОтчетностьФСРАР(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаОтправкиОтчетностьФСРАР);
...
Процедура КомандаОбновитьОтчетностьРПН(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаОтправкиОтчетностьРПН);
...
Процедура КомандаОбновитьОтчетностьФТС(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаОтправкиОтчетностьФТС);
...
Процедура КомандаОбновитьЗапросыНаВыпискуЕГР(Команда)
	...
	ТаблицаФормыОбновить(Элементы.ТаблицаЗапросыЕГР);
...
&НаКлиенте
Процедура КомандаОткрытьМашиночитаемыеДоверенностиФНС(Команда)
	УправлениеЗакладкойУведомлений("МашиночитаемыеДоверенностиФНС");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьЗаявленияОбОтзывеМЧДФНС(Команда)
	УправлениеЗакладкойУведомлений("ЗаявленияОбОтзывеМЧДФНС");
КонецПроцедуры
...
&НаКлиенте
Процедура КомандаОткрытьУведомленияОбОстаткахПрослеживаемыхТоваров(Команда)
	УправлениеЗакладкойУведомлений("УведомленияОбОстаткахПрослеживаемыхТоваров");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьУведомленияОВвозеПрослеживаемыхТоваров(Команда)
	УправлениеЗакладкойУведомлений("УведомленияОВвозеПрослеживаемыхТоваров");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьУведомленияОПеремещенииПрослеживаемыхТоваров(Команда)
	УправлениеЗакладкойУведомлений("УведомленияОПеремещенииПрослеживаемыхТоваров");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьДоходыОтДеятельностиМузеяТеатраБиблиотеки(Команда)
	УправлениеЗакладкойУведомлений("ДоходыОтДеятельностиМузеяТеатраБиблиотеки");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьДвижениеСредствПоСчетуВБанкеЗаПределамиРФ(Команда)
	УправлениеЗакладкойУведомлений("ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьПрослеживаемыеТоварыОтчетОбОперациях(Команда)
	УправлениеЗакладкойУведомлений("ПрослеживаемыеТоварыОтчетОбОперациях");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьПрослеживаемыеТоварыВвоз(Команда)
	УправлениеЗакладкойУведомлений("ПрослеживаемыеТоварыВвоз");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьПрослеживаемыеТоварыПеремещение(Команда)
	УправлениеЗакладкойУведомлений("ПрослеживаемыеТоварыПеремещение");
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьПрослеживаемыеТоварыОстатки(Команда)
	УправлениеЗакладкойУведомлений("ПрослеживаемыеТоварыОстатки");
КонецПроцедуры

&НаСервереБезКонтекста
Функция ВидыПрочихОтправляемыхУведомлений(ВернутьМассивВидовПрочихУведомленийПоддерживающихДокументооборот = Ложь)
	...
	Если ВернутьМассивВидовПрочихУведомленийПоддерживающихДокументооборот Тогда
		МассивВидов = ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.МассивВидовПрочихУведомленийПоддерживающихДокументооборот(
			МассивВидов);
	КонецЕсли;
...
Процедура УбратьОтборПоПредмету(Форма)
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТаблицаФормыОбновить(ТаблицаДинамическогоСписока);
	...
	Если КнопкаОтбора.Пометка Тогда
		...
		Если ЗначениеЗаполнено(Предмет) Тогда
			...
			Если ИмяДинамическогоСписка <> "ЦиклыОбменаОтчетностьФНС" И ИмяДинамическогоСписка <> "ЦиклыОбменаЗаявление"
				И ИмяДинамическогоСписка <> "ЦиклыОбменаОтчетностьЦБ"
...
Функция ИменаРеквизитовФормы(Форма)
	...
	ИначеЕсли ТекущаяСтраница = Элементы.ГруппаФСГС Тогда
		...
		КонецЕсли;
	ИначеЕсли ТекущаяСтраница = Элементы.ГруппаЦБ Тогда
		// ЦБ
		Если Элементы.ГруппаСтраницыЦБ.ТекущаяСтраница = Элементы.ОтчетностьЦБ Тогда
			ИмяПредмета				= "ПредметОтчетностиЦБ";
			ИмяДинамическогоСписка	= "ЦиклыОбменаОтчетностьЦБ";
			ИмяКнопкиОтбора 		= "ОтобратьОтчетностьЦБ";
		КонецЕсли;
...
Функция ПолучитьНастройкиДляДинамическогоСписка(ИмяДинамическогоСписка)
	...
	ИначеЕсли ИмяДинамическогоСписка = "ИсходящиеДокументыПФР" Тогда
		...
		|ВЫБРАТЬ
		|	ВЫБОР
		|		КОГДА УведомлениеОПредоставленииПолномочийПредставителю.ПометкаУдаления
		|			ТОГДА ВЫБОР
		|					КОГДА СтатусПереписки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПисем.Полученное)
		|						ТОГДА 7
		|					ИНАЧЕ ВЫБОР
		...
		|			КОНЕЦ
		|	КОНЕЦ,
		|	УведомлениеОПредоставленииПолномочийПредставителю.Дата,
		|	УведомлениеОПредоставленииПолномочийПредставителю.Получатель,
		|	""Уведомление о предоставлении полномочий представителю"",
		|	УведомлениеОПредоставленииПолномочийПредставителю.Организация,
		|	УведомлениеОПредоставленииПолномочийПредставителю.Ссылка
		|ИЗ
		|	Документ.УведомлениеОПредоставленииПолномочийПредставителю КАК УведомлениеОПредоставленииПолномочийПредставителю
		|		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
		|			СтатусыОтправки.Объект КАК Объект,
		|			СтатусыОтправки.Статус КАК Статус
		|		ИЗ
		|			РегистрСведений.СтатусыОтправки КАК СтатусыОтправки) КАК СтатусПереписки
		|		ПО (СтатусПереписки.Объект = УведомлениеОПредоставленииПолномочийПредставителю.Ссылка)
		|ГДЕ
		|	УведомлениеОПредоставленииПолномочийПредставителю.Организация В(&Организация)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		|	ВЫБОР
		|		КОГДА УведомлениеОПрекращенииПолномочийПредставителя.ПометкаУдаления
		|			ТОГДА ВЫБОР
		|					КОГДА СтатусПереписки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПисем.Полученное)
		|						ТОГДА 7
		|					ИНАЧЕ ВЫБОР
		...
		|			КОНЕЦ
		|	КОНЕЦ,
		|	УведомлениеОПрекращенииПолномочийПредставителя.Дата,
		|	УведомлениеОПрекращенииПолномочийПредставителя.Получатель,
		|	""Уведомление о прекращении полномочий представителя"",
		|	УведомлениеОПрекращенииПолномочийПредставителя.Организация,
		|	УведомлениеОПрекращенииПолномочийПредставителя.Ссылка
		|ИЗ
		...
		|		ИЗ
		|			РегистрСведений.СтатусыОтправки КАК СтатусыОтправки) КАК СтатусПереписки
		|		ПО (СтатусПереписки.Объект = УведомлениеОПрекращенииПолномочийПредставителя.Ссылка)
		|ГДЕ
		|	УведомлениеОПрекращенииПолномочийПредставителя.Организация В(&Организация)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
	...
	ИначеЕсли ИмяДинамическогоСписка = "ОтправкиОтчетностьРПН" Тогда
		...
		Настройки.ТекстЗапроса =
			...
			|	И ОтправкиРПН.ВидОтчета <> ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.УведомлениеПриродопользователю)
			|	{ГДЕ (ОтправкиРПН.Организация В (&Организация))}";
		
	ИначеЕсли ИмяДинамическогоСписка = "ОтправкиУведомленияРПН" Тогда
		Настройки.ОсновнаяТаблица = "Справочник.ОтправкиРПН";
		Настройки.ДинамическоеСчитываниеДанных = Истина;
		Настройки.ТекстЗапроса =
			"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	ИначеЕсли ИмяДинамическогоСписка = "ЦиклыОбменаИсходящиеПФР" Тогда
		...
		|	И ТИПЗНАЧЕНИЯ(ЦиклыОбмена.Предмет) <> ТИП(Документ.УведомлениеОПредоставленииПолномочийПредставителю)
		|	И ТИПЗНАЧЕНИЯ(ЦиклыОбмена.Предмет) <> ТИП(Документ.УведомлениеОПрекращенииПолномочийПредставителя))
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|	И ЦиклыОбмена.Предмет = &СсылкаДляОтбора
		|	И (ТИПЗНАЧЕНИЯ(ЦиклыОбмена.Предмет) = ТИП(Документ.ЗаявленияПоЭлДокументооборотуСПФР)
		|	ИЛИ ТИПЗНАЧЕНИЯ(ЦиклыОбмена.Предмет) = ТИП(Документ.УведомлениеОПредоставленииПолномочийПредставителю)
		|	ИЛИ ТИПЗНАЧЕНИЯ(ЦиклыОбмена.Предмет) = ТИП(Документ.УведомлениеОПрекращенииПолномочийПредставителя))
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
	...
	ИначеЕсли ИмяДинамическогоСписка = "ЦиклыОбменаОтчетностьПФР" Тогда
		...
		|	И ЦиклыОбмена.ВидОтчета <> ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.УведомлениеОПредоставленииПолномочийПредставителю)
		|	И ЦиклыОбмена.ВидОтчета <> ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.УведомлениеОПрекращенииПолномочийПредставителя))
		|{ГДЕ
	...
	ИначеЕсли ИмяДинамическогоСписка = "ЦиклыОбменаОтчетностьЦБ" Тогда
		Настройки.ОсновнаяТаблица = "Справочник.ЦиклыОбмена";
		Настройки.ДинамическоеСчитываниеДанных = Истина;
		
		#Область ЗапросЦиклыОбменаОтчетностьЦБ
		Настройки.ТекстЗапроса =
		"ВЫБРАТЬ РАЗЛИЧНЫЕ
		|	ТранспортноеСообщение.ЦиклОбмена КАК ЦиклОбмена
		|ПОМЕСТИТЬ втНовыеСообщения
		...
		|	РегистрСведений.ТранспортныеКонтейнеры КАК ТранспортныеКонтейнеры
		|ГДЕ
		|	ТранспортныеКонтейнеры.ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ)
		|
		|СГРУППИРОВАТЬ ПО
		|	ТранспортныеКонтейнеры.ТранспортноеСообщение
		|;
		...
		|		ПО (ТранспортныйКонтейнер.ТранспортныйКонтейнерСообщение = ТранспортноеСообщение.Ссылка)
		|ГДЕ
		|	ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.ПервичноеСообщениеСодержащееОтчетностьЦБ)
		|	И ТранспортноеСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ЦиклОбмена
		...
		|	Документ.ТранспортноеСообщение КАК КрайнееСообщение
		|ГДЕ
		|	КрайнееСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ)
		|	И КрайнееСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|СГРУППИРОВАТЬ ПО
		|	КрайнееСообщение.ЦиклОбмена
		...
		|	РегистрСведений.СодержимоеТранспортныхКонтейнеров КАК СодержимоеТранспортныхКонтейнеров
		|ГДЕ
		|	СодержимоеТранспортныхКонтейнеров.ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ)
		|
		|СГРУППИРОВАТЬ ПО
		|	СодержимоеТранспортныхКонтейнеров.ТранспортноеСообщение
		|;
		...
		|		ПО ТранспортноеСообщение.Ссылка = СодержимоеТранспортногоКонтейнера.ТранспортноеСообщениеСсылка
		|ГДЕ
		|	ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатЗагрузкиЦБ)
		|	И ТранспортноеСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ЦиклОбмена
		...
		|	Документ.ТранспортноеСообщение КАК КрайнееСообщение
		|ГДЕ
		|	КрайнееСообщение.Тип  = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ)
		|	И КрайнееСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|СГРУППИРОВАТЬ ПО
		|	КрайнееСообщение.ЦиклОбмена
		...
		|	РегистрСведений.СодержимоеТранспортныхКонтейнеров КАК СодержимоеТранспортныхКонтейнеров
		|ГДЕ
		|	СодержимоеТранспортныхКонтейнеров.ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ)
		|
		|СГРУППИРОВАТЬ ПО
		|	СодержимоеТранспортныхКонтейнеров.ТранспортноеСообщение
		|;
		...
		|		ПО ТранспортноеСообщение.Ссылка = СодержимоеТранспортногоКонтейнера.ТранспортноеСообщениеСсылка
		|ГДЕ
		|	ТранспортноеСообщение.Тип  = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатПриемаДокументЦБ)
		|	И ТранспортноеСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ЦиклОбмена
		...
		|	Документ.ТранспортноеСообщение КАК КрайнееСообщение
		|ГДЕ
		|	КрайнееСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ)
		|	И КрайнееСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|СГРУППИРОВАТЬ ПО
		|	КрайнееСообщение.ЦиклОбмена
		...
		|	РегистрСведений.СодержимоеТранспортныхКонтейнеров КАК СодержимоеТранспортныхКонтейнеров
		|ГДЕ
		|	СодержимоеТранспортныхКонтейнеров.ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ)
		|
		|СГРУППИРОВАТЬ ПО
		|	СодержимоеТранспортныхКонтейнеров.ТранспортноеСообщение
		|;
		...
		|		ПО ТранспортноеСообщение.Ссылка = СодержимоеТранспортногоКонтейнера.ТранспортноеСообщениеСсылка
		|ГДЕ
		|	ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.РезультатОбработкиДокументЦБ)
		|	И ТранспортноеСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ЦиклОбмена
		...
		|	Документ.ТранспортноеСообщение КАК КрайнееСообщение
		|ГДЕ
		|	(КрайнееСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.УведомлениеОбОшибкеЦБ)
		|			ИЛИ КрайнееСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.КритическаяОшибка))
		|
		|СГРУППИРОВАТЬ ПО
		|	КрайнееСообщение.ЦиклОбмена
		...
		|			И ТранспортноеСообщение.Ссылка = КрайнееСообщение.СсылкаКрайнегоСообщения
		|ГДЕ
		|	(ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.УведомлениеОбОшибкеЦБ)
		|			ИЛИ ТранспортноеСообщение.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыТранспортныхСообщений.КритическаяОшибка))
		|	И ТранспортноеСообщение.ЦиклОбмена.Организация В (&Организация)
		|
		|ИНДЕКСИРОВАТЬ ПО
		...
		|		ПО ЦиклыОбмена.Ссылка = ПротоколСУведомлениемОшибкой.ЦиклОбмена
		|ГДЕ
		|	ЦиклыОбмена.Вид = ЗНАЧЕНИЕ(Перечисление.ВидыЦикловОбмена.ЦиклОбменаСЦБ)
		|	И ЦиклыОбмена.ПометкаУдаления = ЛОЖЬ
		|	И ЦиклыОбмена.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыЦикловОбмена.ОтчетностьЦБ)
		|	И ЦиклыОбмена.Организация В (&Организация)";
		#КонецОбласти
...
Функция ПолучитьСоответствиеСписокСтраница()
	...
	// ЦБ
	СоответствиеСписокСтраница.Вставить("ЦиклыОбменаОтчетностьЦБ", "ОтчетностьЦБ");
	...
	СоответствиеСписокСтраница.Вставить("ОтправкиУведомленияРПН", "ГруппаУведомленияРПН");
...
Функция ПолучитьСоответствиеСтраницаНадпись()
	...
	// ЦБ
	СоответствиеСтраницаНадпись.Вставить("ОтчетностьЦБ", "СтраницаОтчетностьЦБ");
	...
	СоответствиеСтраницаНадпись.Вставить("ГруппаУведомленияРПН", "СтраницаУведомленияРПН");
...
Процедура УправлениеЗакладкойЗаявлений()
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТаблицаФормыОбновить(Элементы.ТаблицаЦиклыОбменаЗаявление);
...
&НаСервере
Процедура ВосстановитьНастройкиСтраниц(
		сохрТекущаяСтраницаПанелиФормы,
		сохрТекущаяСтраницаПанелиФНС,
		сохрТекущаяСтраницаПанелиПФР,
		сохрТекущаяСтраницаПанелиФСГС,
	...
	// восстанавливаем текущую страницу панели обмена с Росстатом
	сохрТекущаяСтраницаПанелиРПН = ХранилищеОбщихНастроек.Загрузить("КонтекстЭДО_ТекущаяСтраницаПанелиРПН");
	Если сохрТекущаяСтраницаПанелиРПН <> Неопределено Тогда 
		Для Каждого Страница Из Элементы.ГруппаСтраницыРПН.ПодчиненныеЭлементы Цикл 
			Если сохрТекущаяСтраницаПанелиРПН = Страница.Имя Тогда
				Элементы.ГруппаСтраницыРПН.ТекущаяСтраница = Страница;
				Прервать;
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
Процедура ВосстановитьНастройкиОтборов()
	...
	Элементы.ПредметОтчетностиЦБПредставление.Видимость 	= Ложь;
	...
	// Закладка ЦБ, Отчетность
	СохраненноеЗначениеПредмета = ХранилищеОбщихНастроек.Загрузить("КонтекстЭДО_ЦБОтчетностьОтбор");
	Если СохраненноеЗначениеПредмета <> Неопределено Тогда
		Элементы.ОтобратьОтчетностьЦБ.Пометка	= Истина;
		ПредметОтчетностиЦБ 					= СохраненноеЗначениеПредмета;
		ПредметОтчетностиЦБПредставление		= Представление(СохраненноеЗначениеПредмета);
	КонецЕсли;
...
Процедура СохранитьНастройки()
	...
	ХранилищеОбщихНастроек.Сохранить("КонтекстЭДО_ТекущаяСтраницаПанелиРПН", , Элементы.ГруппаРПН.ПодчиненныеЭлементы.ГруппаСтраницыРПН.ТекущаяСтраница.Имя);
	...
	// Закладка ЦБ, Отчетность
	ХранилищеОбщихНастроек.Сохранить("КонтекстЭДО_ЦБОтчетностьОтбор",,
		?(Элементы.ОтобратьОтчетностьЦБ.Пометка, ПредметОтчетностиЦБ, Неопределено));
...
&НаСервере
Процедура УстановитьПараметрыПроизвольныхЗапросов(
		сохрТекущаяСтраницаПанелиФормы,
		сохрТекущаяСтраницаПанелиФНС,
		сохрТекущаяСтраницаПанелиПФР,
		сохрТекущаяСтраницаПанелиФСГС,
		сохрТекущаяСтраницаПанелиРПН,
		ВыбранныеУчетныеЗаписи = Неопределено)
	...
	ИначеЕсли сохрТекущаяСтраницаПанелиФормы = "ГруппаЦБ" Тогда
		
		Если ВыбранныеУчетныеЗаписи = Неопределено Тогда 
			ВыбранныеУчетныеЗаписи = ВыбранныеУчетныеЗаписи(ЭтаФорма, );
		КонецЕсли;
		
		ЗаполнитьЗначенияСвойств(ЦиклыОбменаОтчетностьЦБ, ПолучитьНастройкиДляДинамическогоСписка("ЦиклыОбменаОтчетностьЦБ"));
		
		// Если установлен отбор по предмету, то отбор по организации игнорируем
		Если Элементы.ОтобратьОтчетностьЦБ.Пометка = Истина И ЗначениеЗаполнено(ПредметОтчетностиЦБ) Тогда 
			Если ЦиклыОбменаОтчетностьЦБ.Параметры.Элементы.Найти(Новый ПолеКомпоновкиДанных("Организация")) <> Неопределено Тогда
				ЦиклыОбменаОтчетностьЦБ.Параметры.Элементы.Найти(Новый ПолеКомпоновкиДанных("Организация")).Использование = Ложь;
			КонецЕсли;
		Иначе
			ЦиклыОбменаОтчетностьЦБ.Параметры.УстановитьЗначениеПараметра("Организация", ВыбранныеУчетныеЗаписи);
		КонецЕсли;
		
		ЦиклыОбменаОтчетностьЦБ.Параметры.УстановитьЗначениеПараметра("ПолученныеТранспортныеСообщения",  ЗначениеПараметраПолученныеТС);
		
		Элементы.СтраницаОтчетностьЦБ.Видимость = Ложь;
		Элементы.ТаблицаЦиклыОбменаОтчетностьЦБ.Видимость = Истина;
	...
	ИначеЕсли сохрТекущаяСтраницаПанелиФормы = "ГруппаРПН" Тогда
		...
		Если сохрТекущаяСтраницаПанелиРПН = "ГруппаОтчетностьРПН" Тогда
			Если ВыбранныеУчетныеЗаписи = Неопределено Тогда
				ВыбранныеУчетныеЗаписи = ВыбранныеУчетныеЗаписи(ЭтаФорма, );
			КонецЕсли;
		...
		ИначеЕсли сохрТекущаяСтраницаПанелиРПН = "ГруппаУведомленияРПН" Тогда
			Если ВыбранныеУчетныеЗаписи = Неопределено Тогда
				ВыбранныеУчетныеЗаписи = ВыбранныеУчетныеЗаписи(ЭтаФорма, );
			КонецЕсли;
			
			ЗаполнитьЗначенияСвойств(ОтправкиУведомленияРПН, ПолучитьНастройкиДляДинамическогоСписка("ОтправкиУведомленияРПН"));
			
			// Если установлен отбор по предмету, то отбор по организации игнорируем
			ОтправкиУведомленияРПН.Параметры.УстановитьЗначениеПараметра("Организация", ВыбранныеУчетныеЗаписи);
			
			Элементы.СтраницаУведомленияРПН.Видимость = Ложь;
			Элементы.ТаблицаОтправкиУведомленияРПН.Видимость = Истина;
		КонецЕсли;
...
Процедура УправлениеЗакладкойУведомлений(Вид = Неопределено)
	...
	Элементы.ТаблицаУведомленияКомандаОткрытьМашиночитаемыеДоверенностиФНС.Видимость 		= Истина; // машиночитаемые доверенности ФНС
	Элементы.ТаблицаУведомленияКомандаОткрытьЗаявленияОбОтзывеМЧДФНС.Видимость 				= Истина; // заявления об отзыве машиночитаемых доверенностей
	...
	Элементы.ТаблицаУведомленияКомандаОткрытьДоходыОтДеятельностиМузеяТеатраБиблиотеки.Видимость = Истина; // сведения о доле доходов от деятельности музея, театра, библиотеки
	Элементы.ТаблицаУведомленияКомандаОткрытьДвижениеСредствПоСчетуВБанкеЗаПределамиРФ.Видимость = Истина; // движение средств по счету в банке за пределами РФ
	Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОтчетОбОперациях.Видимость = Истина; // отчет об операциях с товарами, подлежащими прослеживаемости
	Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыВвоз.Видимость 			= Истина; // уведомление о ввозе товаров, подлежащих прослеживаемости
	Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыПеремещение.Видимость 		= Истина; // уведомление о перемещении товаров, подлежащих прослеживаемости
	Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОстатки.Видимость 			= Истина; // уведомление об остатках товаров, подлежащих прослеживаемости
	Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОбОстаткахПрослеживаемыхТоваров.Видимость = Истина; // уведомления об остатках прослеживаемого товара
	Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОВвозеПрослеживаемыхТоваров.Видимость = Истина; // уведомление о ввозе прослеживаемых товаров
	Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОПеремещенииПрослеживаемыхТоваров.Видимость = Истина; // уведомление о перемещении прослеживаемых товаров
	...
	Если НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОКонтролируемыхСделках) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьДокументы.Видимость = Ложь;
	КонецЕсли;
	
	// уведомления о розничных ценах на табак (регламентированный отчет)
	Если НЕ СуществуетРегламентированныйОтчетРозничныеЦеныНаТабак() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОРозничныхЦенахНаТабак.Видимость = Ложь;
	КонецЕсли;
	
	// документ Заявление о подтверждении права на зачет авансов по НДФЛ
	Если НЕ ЗначениеЗаполнено(ИмяДокументаЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьАвансыНДФЛ.Видимость = Ложь;
	КонецЕсли;
	
	// страновые отчеты (регламентированный отчет)
	Если НЕ СуществуетРегламентированныйОтчетСтрановойОтчет() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьСтрановыеОтчеты.Видимость = Ложь;
	КонецЕсли;
	
	// уведомления об участии в международной группе компаний (регламентированный отчет)
	Если НЕ СуществуетРегламентированныйОтчетУчастиеВМеждународнойГруппеКомпаний() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОбУчастииВМеждународнойГруппеКомпаний.Видимость = Ложь;
	КонецЕсли;
	
	// сведения о доле доходов от деятельности музея, театра, библиотеки
	Если НЕ СуществуетРегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьДоходыОтДеятельностиМузеяТеатраБиблиотеки.Видимость = Ложь;
	КонецЕсли;
	
	// движение средств по счету в банке за пределами РФ
	Если НЕ СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьДвижениеСредствПоСчетуВБанкеЗаПределамиРФ.Видимость = Ложь;
	КонецЕсли;
	
	// отчет об операциях с товарами, подлежащими прослеживаемости
	Если НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОтчетОбОперациях.Видимость = Ложь;
	КонецЕсли;
	
	// уведомление о ввозе товаров, подлежащих прослеживаемости
	Если НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыВвоз()
		ИЛИ ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыВвоз.Видимость = Ложь;
	КонецЕсли;
	
	// уведомление о перемещении товаров, подлежащих прослеживаемости
	Если НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыПеремещение()
		ИЛИ ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыПеремещение.Видимость = Ложь;
	КонецЕсли;
	
	// уведомление об остатках товаров, подлежащих прослеживаемости
	Если НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОстатки()
		ИЛИ ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОстатки.Видимость = Ложь;
	КонецЕсли;
	
	// документ Уведомление об остатках прослеживаемых товаров
	Если НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОбОстаткахПрослеживаемыхТоваров.Видимость = Ложь;
	КонецЕсли;
	
	// документ Уведомление о ввозе прослеживаемых товаров
	Если НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОВвозеПрослеживаемыхТоваров.Видимость = Ложь;
	КонецЕсли;
	
	// документ Уведомление о перемещении прослеживаемых товаров
	Если НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров) Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОПеремещенииПрослеживаемыхТоваров.Видимость = Ложь;
	КонецЕсли;
	...
	ИначеЕсли Вид = "УведомленияОПолучателеДокументов" Тогда
		...
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "МашиночитаемыеДоверенностиФНС" Тогда
		// справочник МашиночитаемыеДоверенностиФНС
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьМашиночитаемыеДоверенностиФНС.Пометка = Истина;
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "ЗаявленияОбОтзывеМЧДФНС" Тогда
		// справочник ЗаявленияОбОтзывеМЧДФНС
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьЗаявленияОбОтзывеМЧДФНС.Пометка = Истина;
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "РеестрыФНС" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетРозничныеЦеныНаТабак, нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьРеестрыФНС.Пометка = Истина;
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "РеестрыАкцизы" Тогда
		...
		// РегламентированныйОтчетРеестрАкцизыВычетыВиноград, нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьРеестрыАкцизы.Пометка = Истина;
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "АвансыНДФЛ" Тогда
		// документ ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ, нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьАвансыНДФЛ.Пометка = Истина;
	ИначеЕсли Вид = "СтрановыеОтчеты" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетСтрановойОтчет, нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьСтрановыеОтчеты.Пометка = Истина;
	ИначеЕсли Вид = "УведомленияОбУчастииВМеждународнойГруппеКомпаний" Тогда
		...
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОбУчастииВМеждународнойГруппеКомпаний.Пометка = Истина;
	ИначеЕсли Вид = "ДоходыОтДеятельностиМузеяТеатраБиблиотеки" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки,
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьДоходыОтДеятельностиМузеяТеатраБиблиотеки.Пометка = Истина;
	ИначеЕсли Вид = "ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки,
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьДвижениеСредствПоСчетуВБанкеЗаПределамиРФ.Пометка = Истина;
	ИначеЕсли Вид = "ПрослеживаемыеТоварыОтчетОбОперациях" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях,
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОтчетОбОперациях.Пометка = Истина;
	ИначеЕсли Вид = "ПрослеживаемыеТоварыВвоз" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетПрослеживаемыеТоварыВвоз,
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыВвоз.Пометка = Истина;
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "ПрослеживаемыеТоварыПеремещение" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетПрослеживаемыеТоварыПеремещение,
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыПеремещение.Пометка = Истина;
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "ПрослеживаемыеТоварыОстатки" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетПрослеживаемыеТоварыОстатки,
		// нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОстатки.Пометка = Истина;
		Элементы.ТаблицаУведомленияОтчетныйГод.Видимость = Ложь;
	ИначеЕсли Вид = "УведомленияОбОстаткахПрослеживаемыхТоваров" Тогда
		// документ УведомлениеОбОстаткахПрослеживаемыхТоваров, нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОбОстаткахПрослеживаемыхТоваров.Пометка = Истина;
		Элементы.ТаблицаУведомленияНалоговыйОрган.Видимость = Ложь;
	ИначеЕсли Вид = "УведомленияОВвозеПрослеживаемыхТоваров" Тогда
		// документ УведомлениеОВвозеПрослеживаемыхТоваров, нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОВвозеПрослеживаемыхТоваров.Пометка = Истина;
		Элементы.ТаблицаУведомленияНалоговыйОрган.Видимость = Ложь;
	ИначеЕсли Вид = "УведомленияОПеремещенииПрослеживаемыхТоваров" Тогда
		// документ УведомлениеОПеремещенииПрослеживаемыхТоваров, нажатость подменю
		Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОПеремещенииПрослеживаемыхТоваров.Пометка = Истина;
		Элементы.ТаблицаУведомленияНалоговыйОрган.Видимость = Ложь;
	...
	Если НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОКонтролируемыхСделках) И НЕ СуществуетРегламентированныйОтчетРозничныеЦеныНаТабак()
		...
		И НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров)
		И НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров)
		И НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров)
		И НЕ СуществуетРегламентированныйОтчетСтрановойОтчет()
		И НЕ СуществуетРегламентированныйОтчетУчастиеВМеждународнойГруппеКомпаний()
		И НЕ СуществуетРегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки()
		И НЕ СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ()
		И НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях()
		И НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыВвоз()
		И НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыПеремещение()
		И НЕ СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОстатки() Тогда
	...
	// УведомлениеОРозничныхЦенахНаТабак, СтрановойОтчет, УведомлениеОбУчастииВМеждународнойГруппеКомпаний
	// ДоходыОтДеятельностиМузеяТеатраБиблиотеки, ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ,
	// ПрослеживаемыеТоварыОтчетОбОперациях, ПрослеживаемыеТоварыВвоз, ПрослеживаемыеТоварыПеремещение
	// и ПрослеживаемыеТоварыОстатки будет в любом случае
	...
	Если Вид = "МашиночитаемыеДоверенностиФНС" Тогда
		
		ТекстЗапроса = ТекстЗапроса + "ВЫБРАТЬ
									  |	ВЫБОР
									  |		КОГДА МашиночитаемыеДоверенностиФНС.ПометкаУдаления
									  |			ТОГДА ВЫБОР
									  |					КОГДА СтатусОтправки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыОтправки.Отправлен)
									  |						ТОГДА 10
									  |					ИНАЧЕ ВЫБОР
									  ...
									  |			КОНЕЦ
									  |	КОНЕЦ КАК СтатусКартинка,
									  |	МашиночитаемыеДоверенностиФНС.ДатаВыдачи КАК ДатаСоздания,
									  |	ВЫРАЗИТЬ(МашиночитаемыеДоверенностиФНС.Организация КАК Справочник.Организации) КАК Организация,
									  |	ГОД(МашиночитаемыеДоверенностиФНС.ДатаВыдачи) КАК ОтчетныйГод,
									  |	МашиночитаемыеДоверенностиФНС.Ссылка,
									  |	МашиночитаемыеДоверенностиФНС.КодНалоговогоОрганаПредставления КАК НалоговыйОрган,
									  |	ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.МашиночитаемыеДоверенностиФНС) КАК ВидУведомления
									  |ИЗ
									  ...
									  |		ИЗ
									  |			РегистрСведений.СтатусыОтправки КАК СтатусыОтправки) КАК СтатусОтправки
									  |		ПО (СтатусОтправки.Объект = МашиночитаемыеДоверенностиФНС.Ссылка)
									  |ГДЕ
									  |	МашиночитаемыеДоверенностиФНС.Организация В(&Организация)";
		
		Уведомления.ОсновнаяТаблица = "Справочник.МашиночитаемыеДоверенностиФНС";
		
	КонецЕсли;  
	
	Если Вид = "ЗаявленияОбОтзывеМЧДФНС" Тогда
		
		ТекстЗапроса = ТекстЗапроса + "ВЫБРАТЬ
									  |	ВЫБОР
									  |		КОГДА ЗаявленияОбОтзывеМЧДФНС.ПометкаУдаления
									  |			ТОГДА ВЫБОР
									  |					КОГДА СтатусОтправки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыОтправки.Отправлен)
									  |						ТОГДА 10
									  |					ИНАЧЕ ВЫБОР
									  ...
									  |			КОНЕЦ
									  |	КОНЕЦ КАК СтатусКартинка,
									  |	ЗаявленияОбОтзывеМЧДФНС.ДатаВыдачи КАК ДатаСоздания,
									  |	ВЫРАЗИТЬ(ЗаявленияОбОтзывеМЧДФНС.Организация КАК Справочник.Организации) КАК Организация,
									  |	ГОД(ЗаявленияОбОтзывеМЧДФНС.ДатаВыдачи) КАК ОтчетныйГод,
									  |	ЗаявленияОбОтзывеМЧДФНС.Ссылка,
									  |	ЗаявленияОбОтзывеМЧДФНС.КодНалоговогоОрганаПредставления КАК НалоговыйОрган,
									  |	ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.ЗаявленияОбОтзывеМЧДФНС) КАК ВидУведомления
									  |ИЗ
									  ...
									  |		ИЗ
									  |			РегистрСведений.СтатусыОтправки КАК СтатусыОтправки) КАК СтатусОтправки
									  |		ПО (СтатусОтправки.Объект = ЗаявленияОбОтзывеМЧДФНС.Ссылка)
									  |ГДЕ
									  |	ЗаявленияОбОтзывеМЧДФНС.Организация В(&Организация)";
		
		Уведомления.ОсновнаяТаблица = "Справочник.ЗаявленияОбОтзывеМЧДФНС";
	...
	Если Вид = "РеестрыАкцизы" Тогда
		МассивИсточниковОтчетов = Новый Массив;
		МассивИсточниковОтчетов.Добавить("РеестрАкцизыПриложение");
		МассивИсточниковОтчетов.Добавить("РеестрАкцизыВычетыДенатурированныйЭтиловыйСпирт");
		МассивИсточниковОтчетов.Добавить("РеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло");
		МассивИсточниковОтчетов.Добавить("РеестрАкцизыВычетыВиноград");
		ТекстЗапроса = ТекстЗапроса + ТекстЗапросаДляОтчетовНаЗакладкеИсходящиеУведомления(МассивИсточниковОтчетов);
		Уведомления.ОсновнаяТаблица = "Документ.РегламентированныйОтчет";
	КонецЕсли;
	
	// Если в системе существует документ ЗаявлениеОПодтвержденииПраваНаЗачетАвансовПоНДФЛ
	// тогда добавляем в запрос для динамического списка по документу
	// Заявление о подтверждении права на зачет авансов по НДФЛ
	...
	// Если в системе существует документ УведомлениеОбОстаткахПрослеживаемыхТоваров
	// тогда добавляем в запрос для динамического списка по документу Уведомление об остатках прослеживаемых товаров
	Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров)
		И Вид = "УведомленияОбОстаткахПрослеживаемыхТоваров" Тогда
		
		ТекстЗапроса = ТекстЗапроса
			+ "ВЫБРАТЬ
			  |	ВЫБОР
			  |		КОГДА УведомлениеОбОстаткахПрослеживаемыхТоваров.ПометкаУдаления
			  |			ТОГДА ВЫБОР
			  |					КОГДА СтатусОтправки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыОтправки.Отправлен)
			  |						ТОГДА 10
			  |					ИНАЧЕ ВЫБОР
			  ...
			  |	ВЫРАЗИТЬ(УведомлениеОбОстаткахПрослеживаемыхТоваров.Организация КАК Справочник.Организации) КАК Организация,
			  |	ГОД(УведомлениеОбОстаткахПрослеживаемыхТоваров.Дата) КАК ОтчетныйГод,
			  |	УведомлениеОбОстаткахПрослеживаемыхТоваров.Ссылка,
			  |	"""" КАК НалоговыйОрган,
			  |	ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.УведомлениеОбОстаткахПрослеживаемыхТоваров) КАК ВидУведомления
			  |ИЗ
			  ...
			  |		ИЗ
			  |			РегистрСведений.СтатусыОтправки КАК СтатусыОтправки) КАК СтатусОтправки
			  |		ПО (СтатусОтправки.Объект = УведомлениеОбОстаткахПрослеживаемыхТоваров.Ссылка)
			  |ГДЕ
			  |	УведомлениеОбОстаткахПрослеживаемыхТоваров.Организация В(&Организация)";
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "УведомлениеОбОстаткахПрослеживаемыхТоваров",
			ИмяДокументаУведомлениеОбОстаткахПрослеживаемыхТоваров);
		
		Уведомления.ОсновнаяТаблица = "Документ.УведомлениеОбОстаткахПрослеживаемыхТоваров";
	КонецЕсли;
	
	// Если в системе существует документ УведомлениеОВвозеПрослеживаемыхТоваров
	// тогда добавляем в запрос для динамического списка по документу Уведомление о ввозе прослеживаемых товаров
	Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров)
		И Вид = "УведомленияОВвозеПрослеживаемыхТоваров" Тогда
		
		ТекстЗапроса = ТекстЗапроса
			+ "ВЫБРАТЬ
			  |	ВЫБОР
			  |		КОГДА УведомлениеОВвозеПрослеживаемыхТоваров.ПометкаУдаления
			  |			ТОГДА ВЫБОР
			  |					КОГДА СтатусОтправки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыОтправки.Отправлен)
			  |						ТОГДА 10
			  |					ИНАЧЕ ВЫБОР
			  ...
			  |	ВЫРАЗИТЬ(УведомлениеОВвозеПрослеживаемыхТоваров.Организация КАК Справочник.Организации) КАК Организация,
			  |	ГОД(УведомлениеОВвозеПрослеживаемыхТоваров.Дата) КАК ОтчетныйГод,
			  |	УведомлениеОВвозеПрослеживаемыхТоваров.Ссылка,
			  |	"""" КАК НалоговыйОрган,
			  |	ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.УведомлениеОВвозеПрослеживаемыхТоваров) КАК ВидУведомления
			  |ИЗ
			  ...
			  |		ИЗ
			  |			РегистрСведений.СтатусыОтправки КАК СтатусыОтправки) КАК СтатусОтправки
			  |		ПО (СтатусОтправки.Объект = УведомлениеОВвозеПрослеживаемыхТоваров.Ссылка)
			  |ГДЕ
			  |	УведомлениеОВвозеПрослеживаемыхТоваров.Организация В(&Организация)";
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "УведомлениеОВвозеПрослеживаемыхТоваров",
			ИмяДокументаУведомлениеОВвозеПрослеживаемыхТоваров);
		
		Уведомления.ОсновнаяТаблица = "Документ.УведомлениеОВвозеПрослеживаемыхТоваров";
	КонецЕсли;
	
	// Если в системе существует документ УведомлениеОПеремещенииПрослеживаемыхТоваров
	// тогда добавляем в запрос для динамического списка по документу Уведомление о перемещении прослеживаемых товаров
	Если ЗначениеЗаполнено(ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров)
		И Вид = "УведомленияОПеремещенииПрослеживаемыхТоваров" Тогда
		
		ТекстЗапроса = ТекстЗапроса
			+ "ВЫБРАТЬ
			  |	ВЫБОР
			  |		КОГДА УведомлениеОПеремещенииПрослеживаемыхТоваров.ПометкаУдаления
			  |			ТОГДА ВЫБОР
			  |					КОГДА СтатусОтправки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыОтправки.Отправлен)
			  |						ТОГДА 10
			  |					ИНАЧЕ ВЫБОР
			  ...
			  |	ВЫРАЗИТЬ(УведомлениеОПеремещенииПрослеживаемыхТоваров.Организация КАК Справочник.Организации) КАК Организация,
			  |	ГОД(УведомлениеОПеремещенииПрослеживаемыхТоваров.Дата) КАК ОтчетныйГод,
			  |	УведомлениеОПеремещенииПрослеживаемыхТоваров.Ссылка,
			  |	"""" КАК НалоговыйОрган,
			  |	ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.УведомлениеОПеремещенииПрослеживаемыхТоваров) КАК ВидУведомления
			  |ИЗ
			  ...
			  |		ИЗ
			  |			РегистрСведений.СтатусыОтправки КАК СтатусыОтправки) КАК СтатусОтправки
			  |		ПО (СтатусОтправки.Объект = УведомлениеОПеремещенииПрослеживаемыхТоваров.Ссылка)
			  |ГДЕ
			  |	УведомлениеОПеремещенииПрослеживаемыхТоваров.Организация В(&Организация)";
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "УведомлениеОПеремещенииПрослеживаемыхТоваров",
			ИмяДокументаУведомлениеОПеремещенииПрослеживаемыхТоваров);
		
		Уведомления.ОсновнаяТаблица = "Документ.УведомлениеОПеремещенииПрослеживаемыхТоваров";
	КонецЕсли;
	...
	// Добавляем в запрос для динамического списка запрос по документу РегламентированныйОтчет
	// с источником РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки.
	Если СуществуетРегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки()
		И Вид = "ДоходыОтДеятельностиМузеяТеатраБиблиотеки" Тогда
		
		ТекстЗапроса = ТекстЗапроса + ТекстЗапросаДляОтчетовНаЗакладкеИсходящиеУведомления(
			"РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки");
		Уведомления.ОсновнаяТаблица = "Документ.РегламентированныйОтчет";
	КонецЕсли;
	
	// Добавляем в запрос для динамического списка запрос по документу РегламентированныйОтчет
	// с источником РегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ.
	Если СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ()
		И Вид = "ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ" Тогда
	...
	// Добавляем в запрос для динамического списка запрос по документу РегламентированныйОтчет
	// с источником РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях.
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях()
		И Вид = "ПрослеживаемыеТоварыОтчетОбОперациях" Тогда
	...
	// Добавляем в запрос для динамического списка запрос по документу РегламентированныйОтчет
	// с источником РегламентированныйОтчетПрослеживаемыеТоварыВвоз.
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыВвоз()
		И Вид = "ПрослеживаемыеТоварыВвоз" Тогда
	...
	// Добавляем в запрос для динамического списка запрос по документу РегламентированныйОтчет
	// с источником РегламентированныйОтчетПрослеживаемыеТоварыПеремещение.
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыПеремещение()
		И Вид = "ПрослеживаемыеТоварыПеремещение" Тогда
	...
	// Добавляем в запрос для динамического списка запрос по документу РегламентированныйОтчет
	// с источником РегламентированныйОтчетПрослеживаемыеТоварыОстатки.
	Если СуществуетРегламентированныйОтчетПрослеживаемыеТоварыОстатки()
		И Вид = "ПрослеживаемыеТоварыОстатки" Тогда
	...
	Если Уведомления.Параметры.ДоступныеПараметры.НайтиПараметр(Новый ПараметрКомпоновкиДанных("ВидУведомления")) <> Неопределено Тогда
		МассивВидовУведомлений = ВидыПрочихОтправляемыхУведомлений(Истина);
		Уведомления.Параметры.УстановитьЗначениеПараметра("ВидУведомления", МассивВидовУведомлений);
	КонецЕсли;
	...
	Если Вид = "Файлы" Тогда
		...
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.ДоходыОтДеятельностиМузеяТеатраБиблиотеки);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОтчетОбОперациях);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыВвоз);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыПеремещение);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОстатки);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.УведомлениеОбОстаткахПрослеживаемыхТоваров);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.УведомлениеОВвозеПрослеживаемыхТоваров);
		ВидыУведомлений.Добавить(Справочники.ВидыОтправляемыхДокументов.УведомлениеОПеремещенииПрослеживаемыхТоваров);
...
Функция ТекстЗапросаДляОтчетовНаЗакладкеИсходящиеУведомления(ИсточникОтчета)
	...
	МассивИсточниковОтчетов = ?(ТипЗнч(ИсточникОтчета) = Тип("Массив")
		ИЛИ ТипЗнч(ИсточникОтчета) = Тип("ФиксированныйМассив"),
		ИсточникОтчета, ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ИсточникОтчета));
	
	КоличествоИсточниковОтчетов = МассивИсточниковОтчетов.Количество();
	ТекстОтбораПоИсточникамОтчетов = "";
	Для ИндексИсточникаОтчета = 0 По КоличествоИсточниковОтчетов - 1 Цикл
		ТекстОтбораПоИсточникамОтчетов = ТекстОтбораПоИсточникамОтчетов + ?(ЗначениеЗаполнено(ТекстОтбораПоИсточникамОтчетов), "
			|	ИЛИ ", "") + "РегламентированныйОтчет.ИсточникОтчета ПОДОБНО ""%_ИсточникОтчета"
			+ ?(ИндексИсточникаОтчета > 0, Формат(ИндексИсточникаОтчета + 1, "ЧДЦ=; ЧН=; ЧГ="), "") + "_%""";
	КонецЦикла;
	...
	ТекстЗапроса = "ВЫБРАТЬ
	                ...
	                |			ИЛИ РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки""
	                |			ИЛИ РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ""
	                |			ИЛИ РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях""
	                |			ИЛИ РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыВвоз""
	                |			ИЛИ РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыПеремещение""
	                |			ИЛИ РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыОстатки""
	                ...
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетРеестрАкцизыВычетыДенатурированныйЭтиловыйСпирт""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.РеестрАкцизыВычетыДенатурированныйЭтиловыйСпирт)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетРеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.РеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетРеестрАкцизыВычетыВиноград""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.РеестрАкцизыВычетыВиноград)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетСтрановойОтчет""
	                ...
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.ДоходыОтДеятельностиМузеяТеатраБиблиотеки)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОтчетОбОперациях)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыВвоз""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыВвоз)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыПеремещение""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыПеремещение)
	                |		КОГДА РегламентированныйОтчет.ИсточникОтчета = ""РегламентированныйОтчетПрослеживаемыеТоварыОстатки""
	                |			ТОГДА ЗНАЧЕНИЕ(Справочник.ВидыОтправляемыхДокументов.ПрослеживаемыеТоварыОстатки)
	                ...
	                |ГДЕ
	                |	РегламентированныйОтчет.Организация В(&Организация)" + ?(КоличествоИсточниковОтчетов > 0, "
	                |	И ", "") + ?(КоличествоИсточниковОтчетов > 1, "(", "") + ТекстОтбораПоИсточникамОтчетов
	                	+ ?(КоличествоИсточниковОтчетов > 1, ")", "");
	
	Для ИндексИсточникаОтчета = 0 По МассивИсточниковОтчетов.Количество() - 1 Цикл
		НомерСтрокойИсточникаОтчета = Формат(ИндексИсточникаОтчета + 1, "ЧДЦ=; ЧН=; ЧГ=");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "_ИсточникОтчета" + НомерСтрокойИсточникаОтчета + "_",
			МассивИсточниковОтчетов[ИндексИсточникаОтчета]);
	КонецЦикла;
...
Процедура СменитьЗакладкуУведомленийПриНеобходимости(ИмяСобытия, ВыводитьПредупреждение = Истина)
	...
	Если ИмяСобытия = "Документы" И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьДокументы.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ПрочиеУведомления"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьПрочиеУведомления.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "УведомленияОРозничныхЦенахНаТабак"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОРозничныхЦенахНаТабак.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "УведомленияОПолучателеДокументов"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОПолучателеДокументов.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "МашиночитаемыеДоверенностиФНС"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьМашиночитаемыеДоверенностиФНС.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ЗаявленияОбОтзывеМЧДФНС"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьЗаявленияОбОтзывеМЧДФНС.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	...
	ИначеЕсли ИмяСобытия = "СтрановыеОтчеты" И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьСтрановыеОтчеты.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "УведомленияОбУчастииВМеждународнойГруппеКомпаний"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОбУчастииВМеждународнойГруппеКомпаний.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ДоходыОтДеятельностиМузеяТеатраБиблиотеки"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьДоходыОтДеятельностиМузеяТеатраБиблиотеки.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьДвижениеСредствПоСчетуВБанкеЗаПределамиРФ.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ПрослеживаемыеТоварыОтчетОбОперациях"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОтчетОбОперациях.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ПрослеживаемыеТоварыВвоз"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыВвоз.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ПрослеживаемыеТоварыПеремещение"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыПеремещение.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "ПрослеживаемыеТоварыОстатки"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьПрослеживаемыеТоварыОстатки.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "УведомленияОбОстаткахПрослеживаемыхТоваров"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОбОстаткахПрослеживаемыхТоваров.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "УведомленияОВвозеПрослеживаемыхТоваров"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОВвозеПрослеживаемыхТоваров.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
	ИначеЕсли ИмяСобытия = "УведомленияОПеремещенииПрослеживаемыхТоваров"
		И НЕ Элементы.ТаблицаУведомленияКомандаОткрытьУведомленияОПеремещенииПрослеживаемыхТоваров.Пометка Тогда
		НужноВыполнитьСменуЗакладки = Истина;
...
Процедура ТаблицаУведомленияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ТипЗнч(ИсхСсылка) = Тип("ДокументСсылка.УведомлениеОСпецрежимахНалогообложения")
		ИЛИ ТипЗнч(ИсхСсылка) = Тип("СправочникСсылка.МашиночитаемыеДоверенностиФНС") 
		ИЛИ ТипЗнч(ИсхСсылка) = Тип("СправочникСсылка.ЗаявленияОбОтзывеМЧДФНС") Тогда
		СтандартнаяОбработка = Ложь;
	КонецЕсли;
КонецПроцедуры

&НаКлиенте
Процедура ТаблицаФормыОбновить(ТекущаяТаблицаФормы)
	
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТаблицаФормыОбновить(ТекущаяТаблицаФормы);
