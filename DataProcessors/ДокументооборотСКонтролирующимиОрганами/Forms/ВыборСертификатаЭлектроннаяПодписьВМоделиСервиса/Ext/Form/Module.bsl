...
Функция СтруктураВСтроку(Структура, ЗаменятьПоляX501 = Ложь)
	
	КлючЗначение = Новый Массив;
	Для Каждого Элемент Из Структура Цикл
		ИмяКлючаСтруктуры = Элемент.Ключ;
		Если ЗаменятьПоляX501 И ИмяКлючаСтруктуры = "_1_2_643_100_4" Тогда
			ИмяКлючаСтруктуры = "INNLE";
		КонецЕсли;
		КлючЗначение.Добавить(СтрШаблон("%1=%2", ИмяКлючаСтруктуры, Элемент.Значение));
	КонецЦикла;
...
Процедура ЗаполнитьТаблицуСертификатовИзЗащищенногоХранилищаНаСервере()
	...
	Для Каждого СертификатИзХранилища Из СертификатыИзХранилища Цикл
		...
		НоваяСтрока.Поставщик               = СтруктураВСтроку(СертификатИзХранилища.Издатель, Истина);
		НоваяСтрока.Наименование            = СертификатИзХранилища.Субъект.CN;
		НоваяСтрока.Владелец                = СтруктураВСтроку(СертификатИзХранилища.Субъект, Истина);
		...
		КонецЕсли;
		Если СертификатИзХранилища.Субъект.Свойство("INNLE") Тогда
			НоваяСтрока.ИНН = ЗначениеПоля(СертификатИзХранилища.Субъект.INNLE);
		ИначеЕсли СертификатИзХранилища.Субъект.Свойство("_1_2_643_100_4") Тогда
			НоваяСтрока.ИНН = ЗначениеПоля(СертификатИзХранилища.Субъект._1_2_643_100_4);
		ИначеЕсли СертификатИзХранилища.Субъект.Свойство("INN") Тогда
