...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если КриптографияЭДКО.ИспользованиеОблачнойПодписиВозможно() Тогда
		...
		КартинкаСтроки = МодульСервисКриптографииDSS.ПолучитьКартинкуПодсистемы("ТипыСертификатов");
	КонецЕсли;
	
	Если КартинкаСтроки.Вид <> ВидКартинки.Пустая Тогда
		Элементы.МестоХранения.Видимость = Истина;
		Элементы.ЭлектроннаяПодписьВМоделиСервиса.Видимость = Ложь;
		Элементы.МестоХранения.КартинкаЗначений = КартинкаСтроки;
	Иначе
		Элементы.МестоХранения.Видимость = Ложь;
		Элементы.ЭлектроннаяПодписьВМоделиСервиса.Видимость = Истина;
	КонецЕсли;
