...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	ТребованияФНСКлиентСервер.ДополнитьОтборПоТипуВходящих(ЭтотОбъект);
...
Функция ТекущийРазделФормы(Форма)
	...
	Возврат РегламентированнаяОтчетностьКлиентСервер.ТекущийРазделФормы(Форма, Истина);
...
Функция ТекущаяТаблица(Форма)
	...
	Возврат РегламентированнаяОтчетностьКлиентСервер.ТекущаяТаблица(Форма, Истина);
...
&НаКлиентеНаСервереБезКонтекста
Функция Разделы(Форма) Экспорт
	
	Возврат РегламентированнаяОтчетностьКлиентСервер.Разделы(Форма, Истина);
