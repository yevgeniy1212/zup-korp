...
Функция РазложитьСтрокуВладелец(Знач ВладелецСтруктура)
	...
	// ИНН
	Если ВладелецСтруктура.Свойство("OID1_2_643_100_4") Тогда
		ИНН = ВладелецСтруктура["OID1_2_643_100_4"];
	ИначеЕсли ВладелецСтруктура.Свойство("OID1_2_643_3_131_1_1") Тогда
