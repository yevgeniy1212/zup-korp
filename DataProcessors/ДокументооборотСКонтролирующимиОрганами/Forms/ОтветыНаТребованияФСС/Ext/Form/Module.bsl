...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Ответы.Параметры.УстановитьЗначениеПараметра("Основание", Параметры.Основание);
...
Процедура ОтветыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ОтветыСтатусОтправки" Тогда
		Если НЕ Элемент.ТекущиеДанные.СтатусОтправки = "Отправлен"
			И НЕ Элемент.ТекущиеДанные.СтатусОтправки = "Подготовлен" Тогда
