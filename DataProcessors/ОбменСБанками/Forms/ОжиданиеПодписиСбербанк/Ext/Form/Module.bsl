...
Процедура ПриОткрытии(Отказ)
	...
	ОбменСБанкамиСлужебныйКлиент.ПодключитьКомпоненту(Оповещение, ИмяМодуля);
...
&НаКлиенте
Процедура ОбработатьОшибкуПолученияДанныхПодписи(
	ИнформацияОбОшибке,
...
Процедура ОбработатьОшибку(ВидОперации, ПодробныйТекстОшибки, ТекстОшибки="")
	ЭлектронноеВзаимодействие.ОбработатьОшибку(ВидОперации, ПодробныйТекстОшибки, ТекстОшибки, "ОбменСБанками");
КонецПроцедуры
