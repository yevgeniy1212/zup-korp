...
Функция ИсключаемыеИзОчистки()
	...
	МассивИсключаемыхИзОчистки.Добавить(Метаданные.РегистрыСведений.ТекущиеКадровыеДанныеСотрудников.ПолноеИмя());
	...
	МассивИсключаемыхИзОчистки.Добавить(Метаданные.РегистрыСведений.СтатусФизическихЛицКакНалогоплательщиковНДФЛВторичный.ПолноеИмя());
	МассивИсключаемыхИзОчистки.Добавить(Метаданные.РегистрыСведений.НакопленныеСтажиФизическихЛиц.ПолноеИмя());
...
Функция ОписаниеСравниваемыхРегистровСведений() Экспорт
	...
	Иначе
		МассивИменРегистровСведений.Добавить(Новый Структура("ИмяРегистра,ИмяКлючевогоРеквизита", "ДоходыПредыдущегоМестаРаботы"));
		МассивИменРегистровСведений.Добавить(Новый Структура("ИмяРегистра,ИмяКлючевогоРеквизита", "СведенияОФизическихЛицахУчастникахВОВ"));
		МассивИменРегистровСведений.Добавить(Новый Структура("ИмяРегистра,ИмяКлючевогоРеквизита", "СведенияОПенсионномОбеспеченииФизическихЛиц"));
		МассивИменРегистровСведений.Добавить(Новый Структура("ИмяРегистра,ИмяКлючевогоРеквизита", "СтатусФизическихЛицКакНалогоплательщиков"));
	КонецЕсли;
