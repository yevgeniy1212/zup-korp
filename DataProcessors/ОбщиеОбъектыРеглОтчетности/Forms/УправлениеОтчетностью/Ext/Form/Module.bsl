...
Процедура ПроверитьВыгрузку(Команда)
	...
	Если НаименованиеОтчета = "Реестр для налоговых вычетов по акцизам на виноград"
		И ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока).ВыбраннаяФорма = "ФормаОтчета2021Кв4" Тогда
		ПоказатьПредупреждение(, НСтр(
		"ru='Проверка выгрузки в электронном виде формы
		|отчета не предусмотрена'"));
		Возврат;
...
Процедура ОбработатьАктивизациюСтрокиОсновнойТаблицы()
	...
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетРеестрАкцизыВычетыВиноматериалыВиногрИФруктСусло");
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетРеестрАкцизыВычетыВиноград");
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетРеестрАкцизыВычетыДенатурированныйЭтиловыйСпирт");
	...
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки");
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ");
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетПрослеживаемыеТоварыВвоз");
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетПрослеживаемыеТоварыОстатки");
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях");
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетПрослеживаемыеТоварыПеремещение");
	...
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма7ТравматизмПриложение");
	...
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма30");
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма18КС");
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма1НАНО");
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма1Вывоз");
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма1СОНКОР");
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма1ФЦП");
	
	ИсточникиОтчетовФСНБР = Новый Массив;
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма1ПИ");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма1ИЦБ");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма1МЕД");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма1АРЕНДА");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма1ПОЕЗДКИ");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма1РОУМИНГ");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма1ТРАНСПОРТ");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма2ТРАНСПОРТ");
	ИсточникиОтчетовФСНБР.Добавить("РегламентированныйОтчетСтатистикаБанкРоссииФорма3ТРАНСПОРТ");
	...
	Если ТекДанные = Неопределено
	 ИЛИ (ИсточникиОтчетовПФР.Найти(ТекДанные_ИсточникОтчета) = Неопределено
		...
		И ИсточникиОтчетовФСНБР.Найти(ТекДанные_ИсточникОтчета) = Неопределено
...
Процедура ПоказатьСДвухмернымШтрихкодомPDF417(Команда)
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Платежи за пользование недрами" Тогда
		ОписаниеРегОтч = ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока);
		Если ОписаниеРегОтч.ДатаКонцаПериодаОтчета >= '2022-01-01' Тогда
			ПоказатьПредупреждение(, НСтр(
			"ru='Печать с двухмерным штрихкодом PDF417 формы
			|отчета, соответствующей формату электронного
			|представления версии 3.00004, будет реализована
