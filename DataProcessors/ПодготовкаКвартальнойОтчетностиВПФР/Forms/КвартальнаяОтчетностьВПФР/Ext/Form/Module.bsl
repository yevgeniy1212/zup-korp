...
Процедура АктивныйОтчетныйПериодСтрокаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПерсонифицированныйУчетКлиент.ОтчетныйПериодНачалоВыбора(ЭтотОбъект, ЭтотОбъект, "АктивныйОтчетныйПериод", "АктивныйОтчетныйПериодСтрока", '20100101', ,Оповещение);	
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыФормыКвартальнойОтчетностиВПФР

&НаКлиенте
Процедура ФормыКвартальнойОтчетностиВПФРВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
...
Процедура СоздатьКорректирующуюФормуРСВ(Команда)
	...
	ПерсонифицированныйУчетКлиент.ОтчетныйПериодНачалоВыбора(ЭтотОбъект, ЭтотОбъект, "КорректируемыйПериод", "КорректируемыйПериодСтрока", , ,Оповещение);
...
Процедура ЗагрузитьКомплекты(Команда)
	...
	ОткрытьФорму("ОбщаяФорма.ВыборФайловСведенийФизическихЛиц", СтруктураПараметровВыбора, ЭтотОбъект, , , , Оповещение, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		...
		Если ФормаДлительнойОперации.Открыта() 
			...
			Если ЗаданиеВыполнено(ИдентификаторЗадания) Тогда
				...
				Если СтруктураОповещения <> Неопределено Тогда
					Оповестить(СтруктураОповещения.ИмяСобытия, СтруктураОповещения.Параметр, ЭтотОбъект);
				КонецЕсли;
