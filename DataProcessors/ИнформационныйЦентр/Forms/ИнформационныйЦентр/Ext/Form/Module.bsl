...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Элементы.ГруппаСозданияСообщенияВТехподдержку.Видимость = ЭтоПолноправныйПользователь
			Или ИнформационныйЦентрСервер.УстановленаИнтеграцияСоСлужбойПоддержки();
		Элементы.НастройкиПодключенияВСлужбуПоддержки.Видимость = ЭтоПолноправныйПользователь;
