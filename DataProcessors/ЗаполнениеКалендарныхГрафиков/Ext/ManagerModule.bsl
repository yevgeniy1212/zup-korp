...
Функция ОсновнойПроизводственныйКалендарь() Экспорт
	...
	ПроизводственныйКалендарь = Справочники.ПроизводственныеКалендари.НайтиПоКоду("РК");
...
Процедура ЗаполнитьПраздничныеДни(КодПроизводственногоКалендаря, НомерГода, ПраздничныеДни) Экспорт
    ...
    // ЗУПК
	ЗаполнитьПраздничныеДниРеспубликаКазахстан(КодПроизводственногоКалендаря, НомерГода, ПраздничныеДни);
	Возврат;
    // ЗУПК
...
Процедура ЗаполнитьПраздничныеДниРеспубликаКазахстан(КодПроизводственногоКалендаря, НомерГода, ПраздничныеДни)
	
	Если КодПроизводственногоКалендаря <> "РК" Тогда
		Возврат;
	КонецЕсли;
		
	ДобавитьПраздничныеДниРеспубликиКазахстан(НомерГода, ПраздничныеДни);
	
КонецПроцедуры

Процедура ДобавитьПраздничныеДниРеспубликиКазахстан(НомерГода, ПраздничныеДни)
	...
	ДобавитьПраздничныйДень(ПраздничныеДни, 8, 3, НомерГода, , Ложь);
	Если НомерГода > 2009 Тогда
		// Законом РК № 152-IV ЗРК от 22 апреля 2009 года увеличена продолжительность Наурыза
	    ДобавитьПраздничныйДень(ПраздничныеДни, 21, 3, НомерГода, , Ложь);
		ДобавитьПраздничныйДень(ПраздничныеДни, 22, 3, НомерГода, , Ложь);
		ДобавитьПраздничныйДень(ПраздничныеДни, 23, 3, НомерГода, , Ложь);
	Иначе
		ДобавитьПраздничныйДень(ПраздничныеДни, 22, 3, НомерГода, , Ложь);	
	КонецЕсли;
	
	ДобавитьПраздничныйДень(ПраздничныеДни, 1, 5, НомерГода, , Ложь);
	ДобавитьПраздничныйДень(ПраздничныеДни, 9, 5, НомерГода, , Ложь);
	ДобавитьПраздничныйДень(ПраздничныеДни, 30, 8, НомерГода, , Ложь);
	
	Если НомерГода <= 2008 
		ИЛИ НомерГода >= 2022 Тогда
		// Законом РК № 152-IV ЗРК от 22 апреля 2009 года исключен День Республики
		ДобавитьПраздничныйДень(ПраздничныеДни, 25, 10, НомерГода, , Ложь);	
	КонецЕсли;
	
	ДобавитьПраздничныйДень(ПраздничныеДни, 16, 12, НомерГода, , Ложь);		
	
	Если НомерГода < 2022 Тогда
		ДобавитьПраздничныйДень(ПраздничныеДни, 17, 12, НомерГода, , Ложь);			
	КонецЕсли;	
		
	Если НомерГода >= 2006 Тогда
		// В соответствии с изменениями, внесенными в Закон о Труде 04.01.2006
		ДобавитьПраздничныйДень(ПраздничныеДни, 7, 1, НомерГода, Ложь, Ложь);
		
		// Первый день Курбан-айта является плавающей датой
		Если НомерГода = 2006 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 10, 1, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2007 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 20, 12, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2008 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 8, 12, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2009 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 27, 11, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2010 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 16, 11, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2011 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 6, 11, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2012 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 26, 10, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2013 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 15, 10, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2014 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 4, 10, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2015 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 24, 9, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2016 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 12, 9, НомерГода, Ложь, Ложь);
		...
		ИначеЕсли НомерГода = 2018 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 21, 8, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2019 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 11, 8, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2020 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 31, 7, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2021 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 20, 7, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2022 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 9, 7, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2023 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 28, 6, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2024 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 16, 6, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2025 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 6, 6, НомерГода, Ложь, Ложь);
		ИначеЕсли НомерГода = 2026 Тогда
			ДобавитьПраздничныйДень(ПраздничныеДни, 27, 5, НомерГода, Ложь, Ложь);
		КонецЕсли;
	КонецЕсли;
	
	Если НомерГода >= 2008 Тогда
		ДобавитьПраздничныйДень(ПраздничныеДни, 6, 7, НомерГода, , Ложь);
	КонецЕсли;
	
	Если НомерГода >= 2012
		И НомерГода < 2022 Тогда
		ДобавитьПраздничныйДень(ПраздничныеДни, 1, 12, НомерГода, , Ложь);
	КонецЕсли;
	
	Если НомерГода >= 2013 Тогда
		ДобавитьПраздничныйДень(ПраздничныеДни, 7, 5, НомерГода, , Ложь);
	КонецЕсли;
