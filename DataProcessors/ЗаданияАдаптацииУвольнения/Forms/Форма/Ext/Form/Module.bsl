...
Процедура ВыполнитьЗадачи(ИдентификаторыВыделенныхСтрок, ЗаданияВыполнены = Истина)
	...
	Если ИдентификаторыВыделенныхСтрок.Количество() > ВыполняемыеЗадачи.Количество() Тогда
		ПоказатьПредупреждение(,
			НСтр("ru = 'Нельзя выполнить/остановить уже выполненные, остановленные или отложенные задания.'"));
	КонецЕсли;
