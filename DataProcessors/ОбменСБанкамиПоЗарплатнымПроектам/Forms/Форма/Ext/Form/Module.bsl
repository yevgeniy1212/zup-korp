...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьУсловноеОформлениеЗачислениеЗарплаты();
	...
	ДоступныКомандыОбменаСБанками = УправлениеДоступом.ЕстьРоль("ВыполнениеОбменаСБанкамиПоЗарплатнымПроектам");
...
Процедура ЗачислениеЗарплатыПриАктивизацииСтроки(Элемент)
	...
	ОбновитьКомандыОбменаФормыСписка();
	Элементы.КаталогФайлов.Видимость = Элементы.ЗагрузитьПодтвержденияБанка.Видимость;
...
Процедура ВыполнитьСинхронизациюСБанком(Команда)
	...
	ЗачислениеЗарплатыТекущийЭлемент = Элементы.ЗачислениеЗарплаты.ТекущиеДанные;
	Если ЗачислениеЗарплатыТекущийЭлемент = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ЗарплатныйПроект = ЗачислениеЗарплатыТекущийЭлемент.ЗарплатныйПроект;
	Организация = Элементы.ЗачислениеЗарплаты.ТекущиеДанные.Организация;
	
	Если ЗначениеЗаполнено(ЗарплатныйПроект) Тогда
		БанкЗарплатногоПроекта = БанкЗарплатногоПроекта(ЗарплатныйПроект);
		ОбменСБанкамиКлиент.СинхронизироватьСБанком(Организация, БанкЗарплатногоПроекта);
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	// Объект.ОткрытиеЛицевыхСчетов.Состояние Равно "Заявка не заполнена"

	ЭлементОформления = УсловноеОформление.Элементы.Добавить();

	ЭлементОтбора = ЭлементОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗаявкиНаОткрытиеЛицевогоСчетаСотрудника.ЗаявкаНеЗаполнена;

	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Шрифт", Новый Шрифт(WindowsШрифты.ШрифтДиалоговИМеню, , , Истина, Ложь, Ложь, Ложь, 100));

	ОформляемоеПоле = ЭлементОформления.Поля.Элементы.Добавить();
	ОформляемоеПоле.Поле = Новый ПолеКомпоновкиДанных("ОткрытиеЛицевыхСчетовФизическоеЛицо");
	ОформляемоеПоле = ЭлементОформления.Поля.Элементы.Добавить();
	ОформляемоеПоле.Поле = Новый ПолеКомпоновкиДанных("ОткрытиеЛицевыхСчетовСостояние");

	// Объект.ОткрытиеЛицевыхСчетов.Состояние Равно "Выгружен в банк"
	...
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗаявкиНаОткрытиеЛицевогоСчетаСотрудника.ОжидаетПодтверждения;

	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.РезультатОжидаетсяЦвет);
	...
	// Объект.ОткрытиеЛицевыхСчетов.Состояние Равно "Отложено открытие лицевого счета"
	...
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗаявкиНаОткрытиеЛицевогоСчетаСотрудника.ОтложеноОткрытиеЛицевогоСчета;
	...
	// Объект.ОткрытиеЛицевыхСчетов.Состояние Равно "Лицевой счет не открыт"
	...
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗаявкиНаОткрытиеЛицевогоСчетаСотрудника.ЛицевойСчетНеОткрыт;

	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.РезультатПроблемаЦвет);
	...
	//   (Объект.ОткрытиеЛицевыхСчетов.Состояние           "Заявка не заполнена" Или "Готов к выгрузке") 
	// И (Объект.ОткрытиеЛицевыхСчетов.ПредыдущееСостояние "Выгружен в банк"     Или "Лицевой счет не открыт")
	...
	ГруппаЭлементовОтбора.ТипГруппы = ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ;
		...
		ГруппаЭлементовОтбораИли.ТипГруппы = ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИли;
			ЭлементОтбора = ГруппаЭлементовОтбораИли.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.Состояние");
			ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
			ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗаявкиНаОткрытиеЛицевогоСчетаСотрудника.ЗаявкаНеЗаполнена;
			ЭлементОтбора = ГруппаЭлементовОтбораИли.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.Состояние");
			ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
			ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗаявкиНаОткрытиеЛицевогоСчетаСотрудника.ГотовКВыгрузке;
		ГруппаЭлементовОтбораИли = ГруппаЭлементовОтбора.Элементы.Добавить(Тип("ГруппаЭлементовОтбораКомпоновкиДанных"));
		ГруппаЭлементовОтбораИли.ТипГруппы = ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИли;
			ЭлементОтбора = ГруппаЭлементовОтбораИли.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.ПредыдущееСостояние");
			ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
			ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗаявкиНаОткрытиеЛицевогоСчетаСотрудника.ОжидаетПодтверждения;
			ЭлементОтбора = ГруппаЭлементовОтбораИли.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.ПредыдущееСостояние");
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Отменить'"));

	ОформляемоеПоле = ЭлементОформления.Поля.Элементы.Добавить();
	ОформляемоеПоле.Поле = Новый ПолеКомпоновкиДанных("ОткрытиеЛицевыхСчетовКоманда");

	//  (Объект.ОткрытиеЛицевыхСчетов.Состояние "Заявка не заполнена" Или "Готов к выгрузке") 
	// И Объект.ОткрытиеЛицевыхСчетов.ПредыдущееСостояние Не равно "Выгружен в банк" 
	// И Объект.ОткрытиеЛицевыхСчетов.ПредыдущееСостояние Не равно "Лицевой счет не открыт"
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Отложить'"));
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Оформить повторно'"));
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Возобновить'"));

	ОформляемоеПоле = ЭлементОформления.Поля.Элементы.Добавить();
	ОформляемоеПоле.Поле = Новый ПолеКомпоновкиДанных("ОткрытиеЛицевыхСчетовКоманда");

	// Объект.ОткрытиеЛицевыхСчетов.Пол Не заполнено

	ЭлементОформления = УсловноеОформление.Элементы.Добавить();

	ЭлементОтбора = ЭлементОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.ОткрытиеЛицевыхСчетов.Пол");
	ЭлементОтбора.ВидСравнения  = ВидСравненияКомпоновкиДанных.НеЗаполнено;

	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ПоясняющийОшибкуТекст);

	ОформляемоеПоле = ЭлементОформления.Поля.Элементы.Добавить();
	ОформляемоеПоле.Поле = Новый ПолеКомпоновкиДанных("ОткрытиеЛицевыхСчетовПол");

КонецПроцедуры

&НаСервере
Процедура УстановитьУсловноеОформлениеЗачислениеЗарплаты()
	
	ЗачислениеЗарплатыНастройкаСписка = ЗачислениеЗарплаты.КомпоновщикНастроек.Настройки;
	ЗачислениеЗарплатыНастройкаСписка.УсловноеОформление.Элементы.Очистить();
	
	// Состояние Равно "Выгружен в банк"

	ЭлементОформления = ЗачислениеЗарплатыНастройкаСписка.УсловноеОформление.Элементы.Добавить();

	ЭлементОтбора = ЭлементОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗачисленияЗарплаты.ОжидаетПодтверждения;

	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.РезультатОжидаетсяЦвет);

	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("Дата");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("ПериодРегистрации");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("Номер");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("Подразделение");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("Состояние");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("СпособВыплаты");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("ЗарплатныйПроект");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("Организация");
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("СуммаПоДокументу");

	// Состояние Равно "Зачислено полностью"
	...
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗачисленияЗарплаты.ЗачисленоПолностью;
	...
	// Состояние Равно "Зачислено с ошибками (частично)"
	...
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗачисленияЗарплаты.ЗачисленоСОшибками;
	...
	// Состояние Равно "Не зачислено (все строки - ошибки)"
	...
	ЭлементОтбора.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("Состояние");
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Перечисления.СостояниеЗачисленияЗарплаты.НеЗачислено;
	...
	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("Команда");

	// Состояние Равно "Зачислено с ошибками (частично)" И Тип документа Равно "Ведомость в банк"
	...
	ЭлементОтбора.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбора.ПравоеЗначение = Тип("ДокументСсылка.ВедомостьНаВыплатуЗарплатыВБанк");
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", Новый ПолеКомпоновкиДанных("ПериодРегистрацииПредставление"));

	ЭлементОформления.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("ПериодРегистрации");

	// Выплата Не заполнено

	ЭлементОформления = ЗачислениеЗарплатыНастройкаСписка.УсловноеОформление.Элементы.Добавить();

	ЭлементОтбора = ЭлементОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("СпособВыплаты");
	ЭлементОтбора.ВидСравнения  = ВидСравненияКомпоновкиДанных.НеЗаполнено;

	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", Новый ПолеКомпоновкиДанных("СпособВыплатыПредставление"));
...
Функция БанкЗарплатногоПроекта(ЗарплатныйПроект)
	Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ЗарплатныйПроект, "Банк");
КонецФункции
...
Функция ОткрытиеЛицевыхСчетовВыгрузитьЗаявкуНаНаСервере()
	...
	Возврат ОбменСБанкамиПоЗарплатнымПроектам.РезультатВыгрузкиФайловОбменаСБанком(ЭтотОбъект, ПодготовленныеДокументы);
...
Функция ЗачислениеЗарплатыВыгрузитьНаСервере()
	...
	Результат = ОбменСБанкамиПоЗарплатнымПроектам.РезультатВыгрузкиФайловОбменаСБанком(ЭтотОбъект, МассивДокументов);
...
Функция ЗагрузитьПодтвержденияИзБанкаНаСервере(МассивИменФайлов)
	...
	Возврат ОбменСБанкамиПоЗарплатнымПроектамВызовСервера.ЗагрузитьПодтвержденияИзБанка(МассивИменФайлов);
...
Процедура УстановитьЗачислениеЗарплатыСводныеСведения()
	...
	Для Каждого ТипВедомости Из Метаданные.ОпределяемыеТипы.ВедомостьВБанкЗарплатаКадры.Тип.Типы() Цикл
		// ЗУПК
		Если ТипВедомости = Тип("ДокументСсылка.ВедомостьНаВыплатуЗарплатыПеречислением") Тогда
			Продолжить;
		КонецЕсли;
		// ЗУПК
...
Процедура УстановитьВидимостьЭлементовНаСервере()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "КаталогФайловГруппа", "Видимость", (Не ИспользоватьПрямойЭОИСБанком) И ДоступныКомандыОбменаСБанками);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗакрытиеЛицевыхСчетовВыгрузить", "Видимость", ДоступныКомандыОбменаСБанками);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗачислениеЗарплатыВыгрузить", "Видимость", ДоступныКомандыОбменаСБанками);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗачислениеЗарплатыИзменить", "Видимость", ДоступныКомандыОбменаСБанками);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ОткрытиеЛицевыхСчетовВвести", "Видимость", ДоступныКомандыОбменаСБанками);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ОткрытиеЛицевыхСчетовВыгрузить", "Видимость", ДоступныКомандыОбменаСБанками);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "РедактироватьАнкету", "Видимость", ДоступныКомандыОбменаСБанками);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗачислениеЗарплатыСоздатьПлатежныйДокумент", "Видимость", ДоступныКомандыОбменаСБанками);
...
Процедура ДополнитьПлатежныйДокумент(Строка, МассивЗаписей, ВедомостьВБанкТипы, Отказ)
	...
	ПлатежныйДокумент = Строка.ДокументЗачисленияЗарплаты;
