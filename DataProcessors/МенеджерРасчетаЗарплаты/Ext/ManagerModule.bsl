...
Функция ТаблицаПоказателей() Экспорт
	...
	Показатели.Колонки.Добавить("Показатель", Новый ОписаниеТипов(МассивТиповПоказателей));
...
Функция ВидыНДФЛДополненияРасчетнойБазыУдержаний() Экспорт 
	...
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.НДФЛСПревышения);
...
// Функция определяет состав видов удержания ИПН, 
//	исключаемых из состава расчетной базы.
//
Функция ВидыИПНДополненияРасчетнойБазыУдержаний() Экспорт 
	
	ВидыНачислений = Новый Массив;
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ИПН);
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ИПНДоходыКонтрагентов);
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ИПНРасчетыСБывшимиСотрудниками);
		
	Возврат ВидыНачислений;
	
КонецФункции

// Функция определяет состав видов удержания ОПВ, 
//	исключаемых из состава расчетной базы.
//
Функция ВидыОПВДополненияРасчетнойБазыУдержаний() Экспорт 
	
	ВидыНачислений = Новый Массив;
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ОПВ);
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ОПВДоходыКонтрагентов);
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ОПВРасчетыСБывшимиСотрудниками);
		
	Возврат ВидыНачислений;
	
КонецФункции

// Функция определяет состав видов удержания ВОСМС, 
//	исключаемых из состава расчетной базы.
//
Функция ВидыВОСМСДополненияРасчетнойБазыУдержаний() Экспорт 
	
	ВидыНачислений = Новый Массив;
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ВОСМС);
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ВОСМСДоходыКонтрагентов);
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.ВОСМСРасчетыСБывшимиСотрудниками);
...
//	исключаемых из состава расчетной базы.
//
Функция ВидыСОДополненияРасчетнойБазыУдержаний() Экспорт 
	
	ВидыНачислений = Новый Массив;
	ВидыНачислений.Добавить(Перечисления.ВидыОсобыхНачисленийИУдержаний.СОДоходыКонтрагентов);
	
	Возврат ВидыНачислений;
	
КонецФункции

// Функция определяет состав видов удержания налогов и взносов, 
//	исключаемых из состава расчетной базы.
//
Функция ВидыНалоговВзносовДополненияРасчетнойБазыУдержаний() Экспорт 
