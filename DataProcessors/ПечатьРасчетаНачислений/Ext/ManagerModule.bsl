...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если МассивОбъектов.Количество() > 0 Тогда
		...
		Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПодробныйРасчетНачислений") Тогда
			...
			ТабличныйДокумент = ТабличныйДокументПодробногоРасчетаНачислений(ПараметрыПечати, МассивОбъектов, ОбъектыПечати, "ПодробныйРасчетНачислений");
...
Функция ТабличныйДокументПодробногоРасчетаНачислений(ПараметрыПечати, МассивСсылок, ОбъектыПечати, ИмяМакета)	
	...
	Для каждого ОписаниеМенеджера Из МассивОписанийМенеджеров Цикл
		...
		Если ОписаниеМенеджера.ОписаниеДокумента.ЕстьРасчетСреднегоЗаработка Тогда
			Если ОписаниеМенеджера.ОписаниеДокумента.СреднийЗаработокОбщий Тогда
				...
				ОбластиСреднегоЗаработкаДляВстраивания = Обработки.ПечатьРасчетаСреднегоЗаработка.ОбластиДляВстраивания(ПараметрыПечати, ДанныеДокументов, "РасчетСреднегоЗаработкаКомпактный");
			Иначе 
		...
		Для каждого Ссылка Из ОписаниеМенеджера.МассивСсылок Цикл
			...
			Для каждого ДанныеДокумента Из СтрокиДанныхДокументов Цикл
				...
				ЗаполнитьТабличныйДокументПодробногоРасчетаНачислений(ПараметрыПечати, ДанныеДляПечати, ОбъектыПечати, ИмяМакета, ТабличныйДокумент);			
...
Процедура ЗаполнитьТабличныйДокументПодробногоРасчетаНачислений(ПараметрыПечати, ДанныеДляПечати, ОбъектыПечати, ИмяМакета, ТабличныйДокумент)
	...
	Для Каждого Сотрудник Из ДанныеДокумента.МассивСотрудников Цикл
		...
		КадровыйЭДО.ЗадатьДетальнуюОбластьПечати(ПараметрыПечати, ТабличныйДокумент, ИмяМакета,
			НомерСтрокиНачало, ДанныеСотрудника, ДанныеДляПечати.Ссылка);
