...
&НаКлиенте
Процедура ФлажокУведомлятьОбОшибкахПриИзменении(Элемент)
...
Процедура СохранитьНастройкиСервер()
	...
	Если ИзменениеОбщихНастроекРазрешено Тогда
		ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.
			СохранитьОбщиеНастройкиМеханизмаОнлайнСервисовРО(МеханизмВключен,
				УведомлятьОбОшибках,
				АвтоподключениеРОВключено);
	КонецЕсли;
...
Функция РезультатПроверкиПараметровДоступа()
	...
	Соединение = ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.
		УстановитьСоединениеССерверомМеханизмаОнлайнСервисовРО(СообщениеОбОшибке);
	...
	РезультатПолученияФайла = ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.
		ПолучитьРесурсССервера(Соединение, "infomap.dat", СообщениеОбОшибке);
