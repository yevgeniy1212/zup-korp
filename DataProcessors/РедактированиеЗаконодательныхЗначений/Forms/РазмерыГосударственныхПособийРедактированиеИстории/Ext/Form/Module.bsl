...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ТолькоПросмотр Тогда
		ТолькоПросмотр = Не ПравоДоступа("Редактирование", Метаданные.РегистрыСведений.РазмерыГосударственныхПособий);
	КонецЕсли; 
...
Процедура КомандаОК(Команда)
	...
	РедактированиеПериодическихСведенийКлиент.ОповеститьОЗавершении(ЭтаФорма, "РазмерыГосударственныхПособий", СтруктураОбъектовВладельцев);
