...
Процедура ЗагрузитьДеревоБизнесПроцессовИЗадач()
	...
	Если Найти(ВнешнийОбъектТип,"BusinessProcess")<>0 Тогда
		...
		Процесс.objectID = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(Прокси, ВнешнийОбъектID, ВнешнийОбъектТип);
		Процесс.name = "";
	...
	ИначеЕсли Найти(ВнешнийОбъектТип, "Document") <> 0
		...
		Предмет.objectID = ИнтеграцияС1СДокументооборотБазоваяФункциональность.СоздатьObjectID(Прокси, ВнешнийОбъектID, ВнешнийОбъектТип);
		Предмет.name = "";
